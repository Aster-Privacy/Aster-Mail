...
export interface SettingsTranslations {
  ...
  alias_watch_title: string;
  alias_watch_beta_badge: string;
  alias_watch_description: string;
  alias_watch_info: string;
  alias_watch_active: string;
  alias_watch_enable: string;
  alias_watch_disable: string;
  alias_watch_enabled_toast: string;
  alias_watch_disabled_toast: string;
  alias_watch_coverage_title: string;
  alias_watch_stat_main: string;
  alias_watch_stat_aliases: string;
  alias_watch_stat_ghost: string;
  alias_watch_stat_domain: string;
  alias_watch_scan_now: string;
  alias_watch_scanning: string;
  alias_watch_last_scanned: string;
  alias_watch_never_scanned: string;
  alias_watch_matches_found: string;
  alias_watch_scan_found: string;
  alias_watch_scan_clean: string;
  alias_watch_scan_failed: string;
  alias_watch_match_tagged: string;
  alias_watch_match_automatic: string;
  alias_watch_spam_surge_title: string;
  alias_watch_spam_surge_detail: string;
  alias_watch_spam_surge_badge: string;
  alias_breach_badge_title: string;
