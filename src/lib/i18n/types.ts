...
export interface SettingsTranslations {
  ...
  special_offer_feature_aliases_body: string;
  special_offer_feature_storage_body: string;
  special_offer_feature_domains: string;
  special_offer_feature_domains_body: string;
  special_offer_feature_vanguard_body: string;
  special_offer_why_label: string;
  special_offer_why_body: string;
