...
export const es = {
  common: {
    ...
    more_contact_groups: "{{count}} grupos más",
    more_contact_groups_one: "{{count}} grupo más",
    more_contact_groups_other: "{{count}} grupos más",
    ...
    add_contacts_to_group_hint: "Crea un grupo para organizar a las personas a las que más escribes.",
    contact_group_name_too_long: "Los nombres de grupo pueden tener hasta {{ max }} caracteres.",
    contact_group_already_exists: "Ya existe un grupo con este nombre.",
    contact_group_limit_reached: "Puedes crear hasta {{ max }} grupos.",
    delete_contact_group_confirm: "¿Eliminar este grupo? Tus contactos permanecen en tu libreta de direcciones.",
    failed_to_fetch_contact_groups: "Los grupos no se cargaron. Inténtalo de nuevo.",
    ...
    failed_to_delete_contact_group: "El grupo no se eliminó. Inténtalo de nuevo.",
    ...
    contacts_removed_from_group_other: "{{count}} contactos eliminados del grupo",
