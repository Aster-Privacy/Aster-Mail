...
export const es = {
  common: {
    ...
    adding_file_would_exceed_limit: "Agregar este archivo superaría el límite",
    ...
    contacts_starred: "Contactos marcados con estrella",
    contacts_unstarred: "Estrella quitada de los contactos",
    ...
    file_already_attached: "Este archivo ya está adjunto",
    file_exceeds_max_size: "El archivo supera el tamaño máximo",
    folder_fallback: "Carpeta",
    found_n_contacts: "{n} contactos encontrados",
    ...
    import_n_contacts: "Importar {n} contactos",
    ...
    marking_as_read_count: "{count} marcado(s) como leído(s)",
    mention_notification: "Te han mencionado",
    message_will_be_sent_shortly: "El mensaje se enviará en breve",
    more_aliases: "Más alias",
    n_contacts_imported: "{n} contactos importados",
    n_emails: "{n} correos",
    n_more: "{n} más",
    n_more_recipients: "{n} destinatario(s) más",
    new_email_notification: "Nuevo correo",
    ...
    recovery_text_code_used_on: "Código usado el",
    ...
    reply_notification: "Nueva respuesta",
    ...
    unlock_with_biometry: "Desbloquear con biometría",
    ...
    use_biometry_to_unlock: "Usar biometría para desbloquear",
  ...
  settings: {
    ...
    too_many_requests:
      "Has hecho eso muchas veces en poco tiempo. Un momento, y otro intento, funcionará.",
    ...
    incoming_server_required:
      "Añade el servidor de correo entrante.",
    ...
    connect_modal_description: "Conecta tu cuenta para importar tus correos.",
    connect_modal_privacy_note: "Tus credenciales nunca se almacenan.",
    connect_modal_title: "Conectar una cuenta",
    ...
    credit_task_android_hint: "Gana créditos instalando la aplicación Android.",
    credit_task_android_title: "Instalar en Android",
    credit_task_desktop_hint: "Gana créditos instalando la aplicación de escritorio.",
    ...
    crypto_modal_price: "Monto: {price}",
    ...
    desktop_bridge_set_up: "Configurar",
    ...
    dev_databases_count_one: "1 base de datos",
    dev_databases_count_other: "{count} bases de datos",
    dev_days_ago: "Hace {days} día(s)",
    dev_encryption_label: "Cifrado",
    dev_hours_ago: "Hace {hours} hora(s)",
    ...
    export_progress_eta: "Tiempo restante estimado: {time}",
    export_progress_messages: "{count} mensajes procesados",
    ...
    ghost_alias_expires_in: "Expira en {time}",
    ...
    ghost_aliases_this_month: "Este mes",
    ...
    import_folder_prep_status: "Preparando carpetas...",
    ...
    n_minutes: "{n} minuto(s)",
    n_skipped: "{n} omitido(s)",
    ...
    oauth_folders_partial: "Algunas carpetas no pudieron configurarse",
    ...
    plan_f_mail_rules: "Reglas de correo",
    plan_f_tracker_protection: "Protección contra rastreo",
    promo_forever: "Para siempre",
    promo_once_reverts: "Primer período, luego precio normal",
    promo_then_reverts: "Luego {price}",
    ...
    referral_email_body: "Uso Aster Mail, un servicio de correo privado y cifrado. Únete con mi enlace de referido.",
    ...
    switch_billing_loss: "Cambiar el ciclo de facturación resultará en la pérdida del descuento.",
    ...
    sync_progress_count: "{count} correo(s) sincronizado(s)",
    ...
    trusted_2fa_expires: "Expira el {date}",
    trusted_2fa_last_used: "Último uso: {date}",
    ...
    trusted_devices_created: "Agregado el {date}",
    ...
    trusted_devices_last_seen: "Última actividad: {date}",
    ...
    trusted_devices_revoke_confirm: "¿Revocar este dispositivo de confianza?",
    ...
    upgrade_modal_description_specific: "Esta función está disponible con {plan}.",
    ...
    vacation_n_replies_sent: "{n} respuestas automáticas enviadas",
    vacation_one_reply_sent: "1 respuesta automática enviada",
    vacation_reply_count_one: "1 respuesta",
  ...
  mail: {
    ...
    add_link_to_selection: "Agregar enlace a la selección",
    advanced_search: "Búsqueda avanzada",
    all_in_folder_selected: "Todos los elementos de la carpeta seleccionados",
    all_on_page_selected: "Todos los elementos de la página seleccionados",
    all_search_results_for: "Todos los resultados para",
    attachment_singular: "archivo adjunto",
    bounced: "Rebotado",
    copy_headers: "Copiar encabezados",
    create_filter: "Crear filtro",
    delivered: "Entregado",
    download_file_named: "Descargar {name}",
    ...
    filter_after: "Después de",
    filter_before: "Antes de",
    filter_date: "Fecha",
    filter_filename: "Nombre de archivo",
    filter_folder: "Carpeta",
    filter_from: "De",
    filter_has_type: "Tipo de adjunto",
    filter_id: "Identificador",
    filter_in: "En",
    filter_label: "Etiqueta",
    filter_larger: "Mayor que",
    filter_no_attachments: "Sin adjuntos",
    filter_no_type: "Sin tipo",
    filter_not_prefix: "no",
    filter_not_starred: "Sin estrella",
    filter_read: "Leído",
    filter_size: "Tamaño",
    filter_smaller: "Menor que",
    ...
    folder_item_count_singular: "1 elemento",
    font: "Fuente",
    fonts: "Fuentes",
    ...
    n_blocked: "{n} bloqueado(s)",
    n_forwarded: "{n} reenviado(s)",
    n_messages: "{n} mensaje(s)",
    no_emails_match_query: "Ningún correo coincide con la búsqueda",
    ...
    notification_mention: "Te han mencionado",
    notification_new_email: "Nuevo correo",
    notification_reply: "Nueva respuesta",
    ...
    param_removed_from_n_links: "Parámetro eliminado de {n} enlace(s)",
    ...
    select_all_in_folder: "Seleccionar todo en esta carpeta",
    show_headers: "Mostrar encabezados",
    show_trimmed_content: "Mostrar contenido recortado",
    size_label: "Tamaño",
    spam_auto_delete_notice: "El spam se elimina automáticamente después de 30 días.",
    spy_pixels_blocked: "Píxeles espía bloqueados",
    spy_pixels_blocked_count: "{count} píxel(es) espía bloqueado(s)",
    stylesheet: "Hoja de estilo",
    to_recipients_prefix: "Para:",
    tracker: "Rastreador",
    tracker_domain: "Dominio rastreador",
    ...
    trash_auto_delete_notice: "Los elementos de la papelera se eliminan después de 30 días.",
  ...
  auth: {
    ...
    password_invalid_chars:
      "Usa solo caracteres estándar del teclado.",
    ...
    device_code_expires_in: "Expira en {time}",
    ...
    pair_device_confirm: "Confirmar vinculación",
  ...
  errors: {
    ...
    rate_limit: "Has hecho eso muchas veces en poco tiempo. Un momento, y otro intento, funcionará.",
    ...
    all_emails_rejected: "Todos los correos fueron rechazados",
    ...
    cannot_send_no_keys: "No se puede enviar: no hay claves disponibles",
    ...
    email_skipped_size: "Correo omitido - demasiado grande",
    ...
    failed_parse_csv: "Error al analizar el archivo CSV",
    failed_parse_email: "Error al analizar el correo",
    failed_parse_eml: "Error al analizar el archivo EML",
    failed_parse_pst: "Error al analizar el archivo PST",
    failed_parse_pst_file: "Error al abrir el archivo PST",
    ...
    max_accounts: "Número máximo de cuentas alcanzado",
    ...
    unknown_error: "Error desconocido",
    unrecognized_format: "Formato no reconocido",
