...
export const es = {
  common: {
    ...
    delete_account_error: "No pudimos eliminar tu cuenta ahora mismo. Otro intento en un momento suele resolverlo, y support@aster.com puede ayudar si sigue fallando.",
    ...
    account_suspended_default_reason:
      "Tu cuenta está suspendida por una infracción de las Condiciones del servicio. Escribe a support@aster.com para apelar o saber más.",
    submit_an_appeal: "Submit an appeal",
    settings_disabled_suspended:
      "Los ajustes están desactivados mientras tu cuenta está suspendida. Escribe a support@aster.com para apelar o saber más.",
    ...
    decrypt_try_sign_out:
      "Cierra sesión y vuelve a iniciarla para recargar tus claves, y si el mensaje sigue sin abrirse, escribe a support@aster.com.",
    n_files: "{{count}} file",
  ...
  auth: {
    ...
    abuse_account_limit:
      "Nuestro sistema de seguridad automático marcó este registro, y no podemos crear la cuenta. support@aster.com puede ayudar si crees que es un error.",
    abuse_flagged_message:
      "Nuestro sistema de seguridad ha detenido los nuevos registros desde esta red por ahora. Escribe a support@aster.com si crees que es un error.",
  ...
  errors: {
    ...
    invalid_credentials: "Ese correo y esa contraseña no coinciden. Otro intento, o un restablecimiento en aster.com/reset, lo resolverá.",
    session_expired:
      "Tu sesión ha terminado. Iniciar sesión de nuevo te permitirá retomar donde lo dejaste. Tus datos y borradores están guardados en el servidor.",
    ...
    account_not_found: "No encontramos ninguna cuenta con ese nombre. Revisar la escritura, o restablecer en aster.com/reset, suele resolverlo.",
    login_failed: "El inicio de sesión no se completó. Otro intento debería resolverlo. Tu cuenta no está bloqueada.",
    decrypt_failed: "Esa contraseña no desbloqueó tus claves en este dispositivo. Otro intento funcionará, y un código de recuperación en aster.com/reset es la alternativa si sigue fallando. Tus datos en el servidor no han cambiado.",
    send_limit_reached:
    ...
    wrong_vault_password: "Esa contraseña no desbloqueó tus claves en este dispositivo. Otro intento debería resolverlo, y un código de recuperación en aster.com/reset es la alternativa si sigue fallando. Tus datos en el servidor no han cambiado.",
    vault_tampered: "Los datos cifrados en este dispositivo no coinciden con lo esperado, lo que puede indicar manipulación. Visitar Ajustes y luego Seguridad te permite revisarlo, y si el aviso vuelve a aparecer, support@aster.com puede ayudar. Tus datos en el servidor están intactos.",
    ...
    decrypt_corrupt_ciphertext: "Este correo está en el servidor pero parece dañado en la transmisión. Actualizar y otro intento suele resolverlo, y support@aster.com puede ayudar si sigue fallando.",
    ...
    cdn_relay_misconfigured: "El relay del CDN no está configurado para esta versión. Cambiar a conexión directa en Ajustes te devolverá en línea, y support@aster.com puede ayudar si hace falta.",
    ...
    device_challenge_mismatch: "La verificación de identidad de este dispositivo no coincide, lo que puede indicar manipulación. Volver a vincularlo desde tu app de escritorio suele resolverlo, y si el aviso vuelve a aparecer, support@aster.com puede ayudar.",
