...
export const es = {
  ...
  auth: {
    ...
    recovery_email_step_desc: "Añade una dirección de correo para recuperar tu cuenta si pierdes la clave de recuperación.",
    ...
    mail_desktop_desc: "Una app nativa y rápida para Windows, macOS y Linux.",
