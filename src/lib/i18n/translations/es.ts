...
export const es = {
  ...
  settings: {
    ...
    alias_export_description:
      "Elige un formato de archivo para la exportación de alias.",
    ...
    alias_export_column_address: "Direccion",
    ...
    alias_export_column_auto_create: "Creacion automatica",
    alias_export_column_color: "Color",
    alias_export_column_expires_at: "Caduca",
    alias_export_warning_title: "Este archivo no esta cifrado",
    alias_export_warning_body: "Cualquiera que lo abra podra leer todos los alias, notas y sitios web que contiene. Guardelo en su gestor de contrasenas o en una unidad cifrada.",
    alias_export_summary: "{{rows}} entradas en {{files}} archivo(s).",
    alias_export_download: "Descargar",
    alias_export_incomplete: "Solo se cargaron {{loaded}} de {{total}} alias. Vuelva a cargar sus alias e intentelo de nuevo para que la copia este completa.",
    ...
    alias_export_failed: "La exportacion fallo. No se descargo nada.",
