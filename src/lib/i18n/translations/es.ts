...
export const es = {
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "Esto afecta a los {{count}} correos.",
    confirm_bulk_action_count_description_one: "Esto afecta a 1 correo.",
    confirm_bulk_action_count_description_other: "Esto afecta a los {{count}} correos.",
    confirm_bulk_action_scope_description: "Esto afecta a los {{count}} correos de {{scope}}.",
    confirm_bulk_action_scope_description_one: "Esto afecta al correo que hay en {{scope}}.",
    confirm_bulk_action_scope_description_other: "Esto afecta a los {{count}} correos de {{scope}}.",
