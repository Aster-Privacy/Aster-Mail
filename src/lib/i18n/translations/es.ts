...
export const es = {
  ...
  settings: {
    ...
    vanguard_description: "Seguridad sofisticada para periodistas, activistas y cualquier persona con riesgo elevado. Activa protecciones avanzadas no disponibles en cuentas estándar.",
  ...
  errors: {
    ...
    unknown_error: "Error desconocido",
    unrecognized_format: "No pudimos reconocer el formato de {{name}}. Aster admite MBOX, EML, CSV y PST; guardar el archivo en uno de esos formatos permitirá ejecutar la importación.",
