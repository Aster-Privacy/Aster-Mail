...
export const tr = {
  ...
  settings: {
    ...
    gmail_sync_step_3: "Posta için bir uygulama parolası oluşturun.",
    gmail_sync_step_4: "Parolayı kopyalayıp Aster’a yapıştırın.",
    ...
    custom_category_locked_badge: "Kilitli",
    ...
    category_name: "Ad",
    category_name_placeholder: "örn. Bültenler",
    category_icon: "Simge",
    category_color: "Renk",
    category_color_accent: "Vurgu",
    category_color_blue: "Mavi",
    category_color_green: "Yeşil",
    category_color_amber: "Kehribar",
    category_color_violet: "Menekşe",
    category_color_teal: "Deniz mavisi",
    category_color_cyan: "Camgöbeği",
    category_color_rose: "Gül",
    category_color_pink: "Pembe",
    category_color_slate: "Arduvaz",
    category_match_domains: "Gönderen alan adlarını eşleştir",
    category_match_domains_placeholder: "example.com, news.example.org",
    category_match_domains_help:
      "Virgülle ayrılmış gönderen alan adı listesi. Bu alan adlarından gelen e-postalar bu kategoriye girer.",
    category_match_keywords: "Konu anahtar kelimelerini eşleştir",
    category_match_keywords_placeholder: "bülten, özet",
    category_match_keywords_help:
      "Virgülle ayrılmış kelimeler. Herhangi biri konu satırında görünürse, e-posta bu kategoriye girer.",
    ...
    alias_export_description:
      "Nelerin dahil edileceğini seçin. Dosya tarayıcınızda oluşturulur ve sunucularımıza asla gönderilmez.",
    alias_export_format_csv: "CSV (elektronik tablo)",
    alias_export_format_json: "JSON",
    alias_export_confirm_description: "Neyi indireceğinizi kontrol edin.",
    alias_export_source_aliases: "Takma adlar",
    alias_export_source_domain_addresses: "Özel alan adı adresleri",
    ...
    alias_export_column_display_name: "Görünen ad",
    alias_export_column_note: "Not",
    alias_export_column_websites: "Web siteleri",
    alias_export_column_enabled: "Etkin",
    alias_export_column_created_at: "Oluşturuldu",
    alias_export_column_directory: "Dizin",
    alias_export_column_domain: "Alan adi",
    alias_export_column_auto_create: "Otomatik oluştur",
    ...
    email_font_choice_title: "E-posta yazı tipi",
    email_font_choice_description: "E-postaları okurken kullanılan yazı tipi",
    email_font_option_match_app: "Uygulamayla aynı",
    ...
    time_zone_show_all: "Tüm saat dilimlerini göster",
    ...
    two_step_verification_description:
      "Parolanıza ek olarak bir doğrulama kodu istemenizi öneririz.",
    ...
    cancel_reason_description:
      "İptal etmeye ne karar verdirdi? İsteğe bağlıdır ve gelişmemize yardımcı olur.",
    cancel_reason_too_expensive: "Çok pahalı",
    cancel_reason_not_using: "Yeterince kullanmıyorum",
    cancel_reason_missing_feature: "İhtiyacım olan bir özellik eksik",
    cancel_reason_switched_provider: "Başka bir sağlayıcıya geçtim",
    cancel_reason_bugs: "Çok fazla hata veya sorun",
    ...
    domain_purchase_banner_title: "Kendi e-posta alan adınızı edinin",
    domain_purchase_banner_subtitle:
      "Arayın, satın alın ve saniyeler içinde e-posta almaya başlayın. DNS sizin için ayarlanır.",
    domain_purchase_banner_cta: "Alan adı satın al",
    domain_purchase_title: "Alan adı satın al",
    ...
    domain_purchase_one_year: "1 yıl",
    domain_purchase_n_years: "{{count}} yıl",
    domain_purchase_pay_with: "Ödeme yöntemi",
    domain_purchase_pay_card: "Kart",
    ...
    domain_purchase_step_dns: "DNS yapılandırılıyor",
    domain_purchase_step_activating: "Posta kutuları etkinleştiriliyor",
    domain_purchase_step_done: "Alan adı etkin",
    domain_purchase_done_note:
      "Alan adınız hazır. Artık üzerinde adresler ve takma adlar oluşturabilirsiniz.",
    domain_purchase_slow_note:
      "Normalden uzun sürüyor. Arka planda tamamlayıp e-postayla bildireceğiz.",
    ...
    domain_purchase_intro_replay: "Rehberli başlangıcı tekrar göster",
    domain_purchase_intro_examples: "Veya bir örnekle başlayın",
    domain_purchase_intro_tld_title: "Şimdi bir uzantı seçin",
    domain_purchase_intro_tld_sub:
      "Uzantı, adresinizin fiyatını ve karakterini değiştirir. Emin değilseniz Tümü seçili kalsın, size uyan her şeyi gösterelim.",
    domain_purchase_results_for: "{{name}} için bulduklarımız",
    domain_purchase_results_for_sub:
      "Size uygun olanı seçin. Ödeme yalnızca bir dakika sürer ve yeni adresiniz işlemi bitirdiğiniz anda posta almaya hazır olur.",
    domain_purchase_change_name: "Adı değiştir",
    domain_purchase_purchased_desc:
      "Aster üzerinden satın aldığınız alan adları burada görünür ve otomatik olarak özel alan adı gibi çalışır. Bir ad seçin, ödeyin ve hemen kullanmaya başlayın.",
    domain_purchase_filter_price: "Maksimum fiyat",
    domain_purchase_filter_price_any: "Tüm fiyatlar",
    domain_purchase_more_suggestions: "Daha fazla öneri oluştur",
    domain_purchase_sort_by: "Sıralama",
    domain_purchase_order_summary: "Sipariş özeti",
    domain_purchase_summary_whois: "WHOIS gizliliği",
    domain_purchase_summary_dns: "Otomatik DNS kurulumu",
    domain_purchase_summary_included: "Dahil",
    domain_purchase_total_today: "Bugünkü toplam",
    ...
    domain_purchase_sort_label: "Sırala",
    domain_purchase_sort_relevance: "Alaka düzeyi",
    domain_purchase_sort_price_low: "Fiyat: düşükten yükseğe",
    domain_purchase_sort_price_high: "Fiyat: yüksekten düşüğe",
    domain_purchase_sort_az: "Ad: A'dan Z'ye",
    domain_purchase_sort_discount: "En büyük indirim",
    domain_purchase_show_more: "Daha fazla sonuç göster",
    domain_purchase_results_count: "{{count}} sonuç",
    ...
    crypto_price_unavailable:
      "Bu plan için kripto fiyatı mevcut değil. Lütfen destek ekibiyle iletişime geçin.",
    crypto_charged_in_usd: "USD olarak tahsil edilir.",
    crypto_native_continue: "Devam",
    crypto_native_choose_method: "Nasıl ödeyeceğinizi seçin",
    crypto_native_loading_coins: "Ödeme seçenekleri yükleniyor...",
    crypto_native_on_chain: "{{chain}} ağında",
    ...
    crypto_native_expires_in: "{{time}} içinde sona eriyor",
    crypto_native_status_awaiting: "Ödeme bekleniyor",
    crypto_native_status_detected: "Ödeme algılandı",
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "Bu işlem {{count}} e-postanın tümünü etkiler.",
    confirm_bulk_action_count_description_one: "Bu işlem 1 e-postayı etkiler.",
    confirm_bulk_action_count_description_other: "Bu işlem {{count}} e-postanın tümünü etkiler.",
    confirm_bulk_action_scope_description: "Bu işlem {{scope}} içindeki {{count}} e-postanın tümünü etkiler.",
    confirm_bulk_action_scope_description_one: "Bu işlem {{scope}} içindeki 1 e-postayı etkiler.",
    confirm_bulk_action_scope_description_other: "Bu işlem {{scope}} içindeki {{count}} e-postanın tümünü etkiler.",
    ...
    translation_unavailable: "Bu ileti çevrilemedi.",
    ...
    resize_compose: "Yazma penceresini yeniden boyutlandır",
    ...
    search_section_message: "Mesaj",
    search_section_filters: "Filtreler",
    ...
    chip_any_time: "Herhangi bir zaman",
    chip_older_than_week: "Bir haftadan eski",
    chip_older_than_month: "Bir aydan eski",
    chip_older_than_six_months: "6 aydan eski",
    chip_older_than_year: "Bir yıldan eski",
    chip_custom_range: "Özel aralık",
    chip_has_attachment: "Eki var",
    chip_attachment_image: "Resim",
    chip_attachment_document: "Belge",
    chip_attachment_pdf: "PDF",
    chip_attachment_video: "Video",
    chip_is_unread: "Okunmamış",
    chip_name_or_email: "Ad veya e-posta",
    chip_no_people: "Eşleşen kişi yok",
  ...
  mail_rules: {
    ...
    rule_delete_failed:
      "Bu kural silinmedi. Yeniden deneyin. Kural hâlâ etkin.",
  ...
  secure_view: {
    ...
    reply_button: "Yanıtı gönder",
    reply_sending: "Gönderiliyor...",
    reply_sent: "Yanıtınız gönderildi.",
    reply_failed: "Yanıtınız gönderilemedi. Lütfen tekrar deneyin.",
    reply_limit_reached: "Bu mesaj yanıt sınırına ulaştı.",
    delete_button: "Mesajı sil",
    delete_confirm_prompt: "Bu mesaj silinsin mi? Bu işlem geri alınamaz.",
    delete_confirm_yes: "Sil",
  ...
  survey: {
    ...
    signup_leave_big_tech: "Big Tech'ten uzaklaşmak",
    signup_open_source: "Açık kaynak",
    signup_specific_feature: "Belirli bir özellik",
    signup_price: "Fiyat",
    signup_curiosity: "Merak",
    q_stood_out: "Diğer seçeneklere kıyasla Aster'da en çok ne öne çıktı?",
    stood_openpgp: "Standart OpenPGP, anahtarlar her yerde çalışır",
    stood_post_quantum: "Kuantum sonrası şifreleme",
    stood_open_source: "Açık kaynak (AGPL)",
    stood_germany: "Almanya'da barındırma",
    stood_price: "Fiyat",
    stood_ui: "Arayüz / kişiselleştirme",
    q_upgrade_blocker: "Ücretli bir plana geçmenizi ne engelliyor?",
    q_upgrade_trigger: "Sonunda ücretli plana geçmenizi ne sağladı?",
    trigger_storage: "Depolama alanım doldu",
    trigger_feature: "Belirli bir özellik istedim",
    trigger_support_mission: "Misyonu / projeyi desteklemek",
    trigger_switched_fully: "Başka bir sağlayıcıdan tamamen geçtim",
    q_plan_reason: "{{plan}} planını neden seçtiniz?",
    q_cancel_reason: "Planınızı iptal etmenize ne sebep olurdu?",
    q_hesitation: "Plan satın almadan önceki en büyük tereddüdünüz neydi?",
    hesitation_price: "Fiyat",
    hesitation_trust: "Henüz güvenebileceğimden emin değildim",
    hesitation_missing_feature: "Eksik bir özellik",
    hesitation_longevity: "Aster'ın kalıcı olup olmayacağını merak ettim",
    hesitation_none: "Gerçek bir tereddüt yoktu",
    option_other: "Diğer",
    other_placeholder: "Bize daha fazla anlatın",
    open_placeholder: "Cevabınız",
