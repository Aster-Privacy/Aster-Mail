...
export const tr = {
  common: {
    ...
    recipient_key_outdated_desc: "Bu alıcının yayımlanan anahtarı süresi dolmuş veya geçersiz, bu nedenle mesaj uçtan uca şifrelenemez. Yalnızca aktarım sırasında korunarak gönderilecek.",
    ...
    unblock_failed: "{{ email }} engeli kaldırılamadı. Tekrar denemek genellikle sorunu çözer. Gönderen şimdilik engelli kalıyor.",
    remove_from_allowlist_failed: "{{ email }} izin listenizden kaldırılamadı. Tekrar denemek genellikle sorunu çözer. Şimdilik izinli kalıyor.",
    bulk_unblock_failed: "Bu göndericilerin engeli kaldırılamadı. Tekrar denemek genellikle sorunu çözer. Şimdilik engelli kalıyorlar.",
    bulk_remove_allowlist_failed: "Bu göndericiler izin listenizden kaldırılamadı. Tekrar denemek genellikle sorunu çözer. Şimdilik izinli kalıyorlar.",
    ...
    n_messages_count_one: "{{count}} mesaj",
  ...
  settings: {
    ...
    criterion_passkey: "Geçiş anahtarı kaydedildi",
    criterion_read_receipts_off: "Okundu bilgileri kapalı",
    fam_kids_tab: "Çocuklar",
    fam_kids_title: "Çocuklar için ayrılmış adresler",
    fam_kids_subtitle: "Şimdi çocuğunuz için bir adres ayırın ve kurulumu daha sonra kendi parolasıyla tamamlamasına izin verin.",
    fam_kids_seats_used: "{{max}} aile koltuğundan {{used}} tanesi kullanıldı (üyeler, davetler ve rezervasyonlar)",
    fam_kids_reserve_btn: "Bir adres ayır",
    fam_kids_seats_full: "Aile grubunuz dolu. Başka bir adres ayırmak için bir koltuk boşaltın.",
    ...
    fam_kids_info_desc: "Adres çocuğunuz için ayrılır ve başkalarına kapatılır. Çocuğunuz (ya da siz) kurulumu daha sonra özel bir parolayla tamamlar ve ailenize otomatik olarak katılan gerçek bir sıfır erişimli hesap oluşturur.",
    fam_kids_nickname_label: "Takma ad (isteğe bağlı)",
    fam_kids_nickname_ph: "örn. Ahmetçik",
    fam_kids_storage_label: "Bu adres için depolama",
    fam_kids_checking: "Uygunluk kontrol ediliyor...",
    ...
    fam_kids_consent_label: "Bu çocuğun ebeveyni veya yasal vasisi olduğumu ve onun için bir hesap oluşturulmasına onay verdiğimi doğrularım.",
    fam_kids_consent_required: "Devam etmek için ebeveyn onayını doğrulayın.",
    fam_kids_link_hint: "Talep bağlantısına sahip herkes bu adresi kurabilir. Yalnızca çocuğunuzla paylaşın ve sızarsa yeniden oluşturun.",
    fam_kids_create: "Ayır",
    fam_kids_creating: "Ayrılıyor...",
    fam_kids_cancel: "İptal",
    fam_kids_created: "Adres ayrıldı · talep bağlantısı kopyalandı",
    fam_kids_create_failed: "Bu adres ayrılamadı",
    fam_kids_copy_link: "Talep bağlantısını kopyala",
    fam_kids_link_copied: "Talep bağlantısı kopyalandı",
    fam_kids_regenerate: "Bağlantıyı yeniden oluştur",
    fam_kids_regenerated: "Yeni talep bağlantısı oluşturuldu",
    fam_kids_setup_now: "Şimdi kur",
    fam_kids_release: "Serbest bırak",
    fam_kids_released: "Rezervasyon serbest bırakıldı",
    fam_kids_release_confirm: "Bu ayrılmış adres serbest bırakılsın mı? Yeniden herkese açık olacak.",
    fam_kids_status_reserved: "Ayrıldı",
    fam_kids_status_claimed: "Etkin",
    fam_kids_claimed_active: "Hesap kuruldu ve ailenize katıldı",
    fam_kids_load_failed: "Rezervasyonlar yüklenemedi",
    fam_kids_claim_setup_for: "{{address}} kuruluyor",
    fam_kids_claim_intro: "Bu aile adresinin kurulumunu tamamlamak için bir parola seçin.",
    fam_kids_claim_invalid_title: "Bu bağlantı artık geçerli değil",
    fam_kids_claim_invalid_body: "Bu talep bağlantısının süresi doldu, zaten kullanıldı veya geri alındı. Aile sahibinden yeni bir bağlantı isteyin.",
    fam_kids_claim_signed_in_title: "Başka bir hesapta oturum açtınız",
    fam_kids_claim_signed_in_body: "Bu bağlantı yeni bir çocuk hesabı kurar. Gizli/özel bir pencerede açın ya da çocuğunuzun cihazında kullanmak için kopyalayın.",
    fam_kids_release_modal_title: "Bu adres serbest bırakılsın mı?",
    fam_kids_release_modal_body: "{{address}} herkesin kaydedebilmesi için tekrar kullanıma açılacak. Bu işlem geri alınamaz.",
    fam_kids_release_btn: "Serbest bırak",
    alias_captcha_required: "Alias oluşturmak için captcha'yı tamamlayın.",
    ...
    alias_import_drop_hint: "Bir CSV (SimpleLogin, Addy.io) veya Proton Pass data.json dosyasını buraya bırakın ya da bir dosya seçin",
    ...
    alias_activity_title: "Etkinlik (son 7 gün)",
    ...
    emails_count_one: "{{count}} e-posta",
    newsletter: "Bülten",
    social: "Sosyal",
    ...
    loading_payment_form: "Yükleniyor...",
  ...
  auth: {
    link_device_upgrade_required_toast: "Bir Bridge cihazını bağlamak için Star planı veya üstü gerekir. Devam etmek için yükseltin.",
    link_device_upgrade_title: "Bu cihazı bağlamak için yükseltin",
    link_device_upgrade_description: "Bir masaüstü Bridge'i hesabınıza bağlamak için Star planı veya üstü gerekir. Aşağıdan bir plan seçin; cihazınız ödemeden hemen sonra bağlanacak.",
    link_device_upgrade_cta: "Star'a yükselt",
    link_device_upgrade_failed: "Ödeme başlatılamadı. Tekrar deneyin veya Ayarlar'da Faturalandırma'yı açın.",
    link_device_already_linked: "Bu cihaz zaten başka bir hesaba bağlı. Önce oradan bağlantısını kaldırın, sonra tekrar deneyin.",
    link_device_rate_limited: "Çok fazla deneme. Yaklaşık bir dakika bekleyip tekrar deneyin.",
    link_device_account_suspended: "Bu hesap askıya alınmış, bu yüzden şu anda yeni cihaz bağlanamıyor. Sorunu çözmek için destek ile iletişime geçin.",
    academic_offer_sending_title: "Doğrulama bağlantınız gönderiliyor",
    academic_offer_sending_body: "{{ email }} adresine %30 doğrulama bağlantısı gönderiliyor.",
    ...
    offer_welcome_subline_student: "Ücretsiz hesabınızı oluşturun, ardından öğrenci e-postanızı doğrulayarak 12 ay boyunca herhangi bir ücretli planda %30 indirim açın.",
    offer_welcome_subline_journalist: "Ücretsiz hesabınızı oluşturun, ardından basın kimlik bilgilerinizi doğrulayarak 12 ay boyunca herhangi bir ücretli planda %30 indirim açın.",
  ...
  passkeys: {
    rename_placeholder: "Bu anahtara ad ver",
    rename_failed: "Anahtar yeniden adlandırılamadı. Lütfen tekrar deneyin.",
  ...
  mail_rules: {
    ...
    templates_subtitle: "Hazır bir kuralla başlayın ve kaydetmeden önce özelleştirin.",
    templates_search_placeholder: "Şablon ara",
    ...
    tpl_folder_auto_clean_name: "Otomatik klasör temizleme",
    tpl_folder_auto_clean_desc: "Bir klasördeki e-postaları, seçtiğiniz gün sayısından eski olduklarında otomatik olarak kaldırır. Yıldızlı ve sabitlenmiş e-postalar her zaman korunur.",
    tpl_newsletters_name: "Bültenleri sırala",
    tpl_newsletters_desc: "Bir ileti bir posta listesinden geldiğinde (List-Id başlığı taşır), onu Güncellemeler kategorisine yerleştir.",
    tpl_social_name: "Sosyal bildirimleri grupla",
    tpl_social_desc: "Gönderen Facebook, LinkedIn, X/Twitter veya Instagram olduğunda, iletiyi Sosyal kategorisine taşı.",
    tpl_promotions_name: "Promosyonları yakala",
    tpl_promotions_desc: "Konu indirim, kupon veya '% indirim' içeriyorsa, iletiyi Promosyonlar kategorisine taşı.",
    tpl_calendar_name: "Takvim davetlerini topla",
    tpl_calendar_desc: "Bir ileti takvim daveti (.ics) içerdiğinde, onu Güncellemeler kategorisine yerleştir.",
    tpl_large_attachments_name: "Büyük ekleri işaretle",
    tpl_large_attachments_desc: "Bir iletide 10 MB'tan büyük bir ek olduğunda, onu seçtiğiniz bir klasöre taşıyın. Kaydetmeden önce klasörü seçin.",
    tpl_no_reply_name: "Otomatik postaları düzenle",
    tpl_no_reply_desc: "Bir ileti makine tarafından oluşturulduğunda (Auto-Submitted başlığı taşır, örn. no-reply gönderenler), onu Güncellemeler'e yerleştir.",
    tpl_receipts_name: "Makbuzları arşivle",
    tpl_receipts_desc: "Konu makbuz, fatura veya sipariş onayı içeriyorsa, gelen kutusunu atla ve iletiyi Güncellemeler'e yerleştir.",
    tpl_vip_sender_name: "Önemli bir göndereni yıldızla",
    tpl_vip_sender_desc: "Seçtiğiniz bir göndericiden posta geldiğinde, onu yıldızla ve bildirim gönder. Kaydetmeden önce gönderenin adresini girin.",
    tpl_keyword_star_name: "Anahtar kelimeye göre yıldızla",
    tpl_keyword_star_desc: "Konu seçtiğiniz bir kelime içerdiğinde, iletiyi yıldızla. Kaydetmeden önce anahtar kelimeyi girin.",
    tpl_auth_failures_name: "Şüpheli postaları beklet",
    tpl_auth_failures_desc: "Bir ileti SPF, DKIM veya DMARC denetimlerinden geçemediğinde (yaygın bir sahtecilik işareti), onu gelen kutusundan uzak tut ve okundu olarak işaretle.",
    tpl_forward_copy_name: "Bir kopya ilet",
    tpl_forward_copy_desc: "Seçtiğiniz bir göndericiden posta geldiğinde, bir kopyasını başka bir adrese ilet. Kaydetmeden önce her iki adresi de girin.",
    ...
    run_on_existing_result: "Kural {{count}} iletiye uygulandı",
    run_on_existing_failed: "Kural mevcut postada çalıştırılamadı. Tekrar deneyin.",
  ...
  folder_retention: {
    title: "Otomatik klasör temizleme",
    subtitle: "Bir klasördeki eski e-postaları otomatik olarak kaldırın. Yıldızlı ve sabitlenmiş e-postalar her zaman korunur.",
    add: "Otomatik temizleme ekle",
    empty_title: "Henüz otomatik temizlenen klasör yok",
    empty_description: "Bir klasörü otomatik olarak düzenli tutmak için bir klasör ve saklama süresi seçin.",
    edit_title: "Otomatik temizlenen klasör",
    folder: "Klasör",
    select_folder: "Bir klasör seç",
    no_folders: "Otomatik temizlemeyi kullanmak için önce özel bir klasör oluşturun.",
    retention_period: "Şundan eski e-postaları sil:",
    days_suffix: "gün",
    mode: "Temizlerken",
    mode_trash: "Çöpe taşı",
    mode_trash_hint: "Yaklaşık 30 gün boyunca kurtarılabilir",
    mode_permanent: "Kalıcı olarak sil",
    mode_permanent_hint: "Geri alınamaz",
    mode_archive: "Arşive taşı",
    mode_archive_hint: "Gelen kutusundan kaldırılır, saklanır ve kurtarılabilir",
    enabled: "Etkin",
    preview_some: "Sonraki çalıştırmada yaklaşık {{count}} e-posta temizlenecek.",
    preview_none: "Şu anda bu kurala uyan e-posta yok.",
    keeps_note: "Yıldızlı ve sabitlenmiş e-postalar her zaman korunur.",
    save: "Kaydet",
    cancel: "İptal",
    delete: "Sil",
    remove: "Kaldır",
    permanent_confirm: "Bu klasördeki {{days}} günden eski e-postalar kalıcı olarak silinsin mi? Bu işlem geri alınamaz.",
    ...
    upgrade_title: "Otomatik klasör temizleme ücretli bir özelliktir",
    upgrade_body: "Klasörleri otomatik temizlemek için Star veya üstüne yükseltin.",
