...
export const tr = {
  ...
  settings: {
    ...
    dns_instruction_set_dmarc_host: "Sunucuyu _dmarc ve ardından alan adınız olarak ayarlayın",
    ...
    credit_task_android_title: "Android için Aster uygulamasını indirin",
    credit_task_android_hint: "Oturum açtıktan sonra 10$ alacaksınız.",
    credit_task_desktop_title: "Masaüstü için Aster uygulamasını indirin",
    credit_task_desktop_hint: "Oturum açtıktan sonra 10$ alacaksınız.",
    credit_task_download_cta: "İndir",
  ...
  errors: {
    ...
    rate_limited: "Kısa sürede çok fazla işlem yaptınız. Bir an bekleyip tekrar deneyin.",
    ...
    unrecognized_format: "{{name}} dosyasının biçimini tanıyamadık. Aster; MBOX, EML, CSV ve PST formatlarını destekliyor; dosyayı bu formatlardan birinde kaydetmek içe aktarmayı çalıştırır.",
    unknown_error: "Bir şeyler beklendiği gibi çalışmadı. Bir kez daha denemek genellikle yeterli olur. Nedeni belirleyemedik.",
    health_check_failed: "Tanılama tamamlanamadı. Bir kez daha denemek genellikle yeterli olur.",
