...
export const tr = {
  ...
  settings: {
    ...
    alias_export_confirm_description: "Neyi indireceginizi kontrol edin.",
    alias_export_source_aliases: "Takma adlar",
    alias_export_source_domain_addresses: "Ozel alan adi adresleri",
    alias_export_source_directories: "Dizinler",
    alias_export_source_ghost: "Ghost takma adlar",
    alias_export_source_count: "{{count}} kayit",
    alias_export_choose_columns: "Sutunlari secin ({{count}} secili)",
    alias_export_hide_columns: "Sutunlari gizle",
    alias_export_format_label: "Dosya bicimi",
    alias_export_column_address: "Adres",
    alias_export_column_display_name: "Gorunen ad",
    alias_export_column_note: "Not",
    alias_export_column_websites: "Web siteleri",
    alias_export_column_enabled: "Etkin",
    alias_export_column_created_at: "Olusturuldu",
    alias_export_column_directory: "Dizin",
    alias_export_column_domain: "Alan adi",
    alias_export_column_auto_create: "Otomatik olustur",
    alias_export_column_color: "Renk",
    alias_export_column_expires_at: "Sona eriyor",
    alias_export_warning_title: "Bu dosya sifreli degil",
    alias_export_warning_body: "Dosyayi acan herkes icindeki tum takma adlari, notlari ve web sitelerini okuyabilir. Parola yoneticinizde veya sifreli bir diskte saklayin.",
    alias_export_summary: "{{files}} dosyada toplam {{rows}} kayit.",
    alias_export_download: "Indir",
    alias_export_incomplete: "{{total}} takma addan yalnizca {{loaded}} tanesi yuklendi. Yedegin eksiksiz olmasi icin takma adlari yeniden yukleyip tekrar deneyin.",
    alias_export_undecryptable: "{{count}} takma ad cozulemedi ve dahil edilmedi.",
    alias_export_undecryptable_ghost: "{{count}} ghost takma ad cozulemedi ve dahil edilmedi.",
    alias_export_load_failed: "Dizinler veya ghost takma adlar yuklenemedi.",
    alias_export_failed: "Disa aktarma basarisiz. Hicbir sey indirilmedi.",
