...
export const tr = {
  ...
  auth: {
    ...
    recovery_email_step_desc: "Kurtarma anahtarını kaybedersen hesabını kurtarmak için bir e-posta adresi ekle.",
    ...
    mail_desktop_desc: "Windows, macOS ve Linux için hızlı bir yerel uygulama.",
