...
export const tr = {
  common: {
    ...
    more_contact_groups: "{{count}} grup daha",
    more_contact_groups_one: "{{count}} grup daha",
    more_contact_groups_other: "{{count}} grup daha",
    new_group: "Yeni grup",
    ...
    add_contacts_to_group_hint: "En çok yazıştığınız kişileri düzenlemek için bir grup oluşturun.",
    contact_group_name_too_long: "Grup adları en fazla {{ max }} karakter olabilir.",
    ...
    delete_contact_group_confirm: "Bu grup silinsin mi? Kişileriniz adres defterinizde kalır.",
