...
export const tr = {
  common: {
    ...
    delete_account_error: "Hesabınızı şu anda silemedik. Birkaç saniye sonra tekrar denemek genellikle işe yarar ve sorun sürerse support@aster.com yardımcı olabilir.",
    ...
    delete_contact_confirm:
      "Bu kişiyi kalıcı olarak sil. Bu geri alınamaz.",
    delete_contacts_confirm:
      "Bu kişileri kalıcı olarak sil. Bu geri alınamaz.",
    ...
    account_suspended_default_reason:
      "Hesabınız bir Hizmet Şartları ihlali nedeniyle askıya alındı. support@aster.com itiraz ya da daha fazla ayrıntı için yardımcı olabilir.",
    submit_an_appeal: "Submit an appeal",
    settings_disabled_suspended:
      "Hesabınız askıdayken ayarlar kapalı. support@aster.com itiraz ya da daha fazla ayrıntı için yardımcı olabilir.",
    ...
    decrypt_try_sign_out:
      "Çıkış yapıp tekrar giriş yapmak anahtarlarınızı yeniden yükler. Mesaj hâlâ açılmazsa, support@aster.com yardımcı olabilir.",
    n_files: "{{count}} file",
  ...
  settings: {
    ...
    too_many_requests: "Bunu kısa bir sürede çok kez yaptınız. Bir an, ardından tekrar denemek işe yarar.",
  ...
  mail: {
    ...
    enter_password_to_access:
      "Parolanız \"{{folder}}\" klasörünü açar.",
  ...
  auth: {
    ...
    abuse_account_limit:
      "Otomatik güvenlik sistemimiz bu kaydı işaretledi ve hesabı oluşturamıyoruz. Bu bir hata gibi görünüyorsa, support@aster.com yardımcı olabilir.",
    abuse_flagged_message:
      "Güvenlik sistemimiz, bu ağdan gelen yeni kayıtları şimdilik durdurdu. Bu bir hata gibi görünüyorsa, support@aster.com yardımcı olabilir.",
  ...
  errors: {
    ...
    rate_limit: "Bunu kısa bir sürede çok kez yaptınız. Bir an, ardından tekrar denemek işe yarar.",
    invalid_credentials: "Bu e-posta ve parola örtüşmedi. Bir kez daha denemek ya da aster.com/reset adresinden sıfırlamak bunu çözer.",
    ...
    account_not_found: "Bu adda bir hesap bulamadık. Yazımı kontrol etmek ya da aster.com/reset adresinden sıfırlamak çoğunlukla bunu çözer.",
    login_failed: "Oturum açma tamamlanmadı. Bir kez daha denemek genellikle yeterli olur. Hesabınız kilitlenmedi.",
    decrypt_failed: "Bu parola, bu cihazdaki anahtarlarınızı açmadı. Tekrar denemek genellikle yeterli olur ve aster.com/reset adresinden bir kurtarma kodu yedek yoldur. Sunucudaki verileriniz olduğu gibi duruyor.",
    send_limit_reached:
    ...
    wrong_vault_password: "Bu parola, bu cihazda anahtarlarınızı açmadı. Bir kez daha denemek genellikle yeterli olur ve sürekli başarısız olursa aster.com/reset adresindeki kurtarma kodu yedeğinizdir. Sunucudaki verileriniz olduğu gibi.",
    vault_tampered: "Bu cihazdaki şifrelenmiş veriler beklediğimizle eşleşmiyor, bu da kurcalamaya işaret edebilir. Gözden geçirmek için Ayarlar, ardından Güvenlik bölümünü ziyaret edin ve uyarı tekrarlarsa support@aster.com ile iletişime geçin. Sunucudaki verileriniz olduğu gibi.",
    ...
    decrypt_corrupt_ciphertext: "Bu e-posta sunucuda bulunuyor ancak iletim sırasında bozulmuş görünüyor. Yenileyip bir kez daha denemek genellikle yeterli olur ve sürekli başarısız olursa support@aster.com yardımcı olabilir.",
    ...
    cdn_relay_misconfigured: "CDN aktarıcı bu yapı için yapılandırılmamış. Ayarlar'dan doğrudan bağlantıya geçmek sizi yeniden çevrimiçi yapar ve gerekirse support@aster.com yardımcı olabilir.",
    ...
    device_challenge_mismatch: "Bu cihazın kimlik denetimi eşleşmedi, bu da kurcalamaya işaret edebilir. Masaüstü uygulamanızdan yeniden eşleştirin ve uyarı tekrarlarsa support@aster.com ile iletişime geçin.",
