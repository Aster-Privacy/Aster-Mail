...
export const en: Translations = {
  common: {
    ...
    importing: "Importing...",
    import_progress: "Importing batch {{current}} of {{total}}...",
    imported: "Imported",
    skipped: "Skipped",
    failed: "Failed",
    disable: "Disable",
    ...
    newsletters_archived_partial:
      "{{count}} newsletter(s) archived, {{failed}} failed",
    n_could_not_be_archived: "{{count}} could not be archived",
    ...
    emails_snoozed_until_partial:
      "{{count}} email(s) snoozed until {{time}}, {{failed}} failed",
    ...
    new_emails_burst_body: "You have {{count}} new emails",
    ...
    contacts_deleted_partial: "{{ count }} contact(s) deleted, {{ failed }} failed",
    contacts_starred: "{{ count }} contact(s) starred",
    contacts_unstarred: "{{ count }} contact(s) unstarred",
    contacts_favorites_updated_partial: "{{ count }} contact(s) updated, {{ failed }} failed",
  ...
  settings: {
    ...
    trusted_devices_revoke_all_success:
      "Revoked {{ count }} devices",
    trusted_devices_revoke_all_partial:
      "Revoked {{ succeeded }} of {{ total }} devices, {{ failed }} failed",
    trusted_devices_revoke_all_failed: "Failed to revoke devices",
    bridge: "Bridge",
    ...
    reactions_enabled: "Send reactions",
    reactions_enabled_description:
      "Allow sending emoji reactions to messages. You can still receive reactions when this is off.",
    ...
    alias_bulk_enable_success: "{{count}} aliases enabled",
    alias_bulk_enable_partial: "{{count}} enabled, {{failed}} failed",
    alias_bulk_enable_failed: "Failed to enable aliases",
    alias_bulk_disable_success: "{{count}} aliases disabled",
    alias_bulk_disable_partial: "{{count}} disabled, {{failed}} failed",
    alias_bulk_disable_failed: "Failed to disable aliases",
    alias_bulk_delete_success: "{{count}} aliases deleted",
    alias_bulk_delete_partial: "{{count}} deleted, {{failed}} failed",
    alias_bulk_delete_failed: "Failed to delete aliases",
    ...
    alias_never_inbox: "Never send to inbox",
    alias_never_inbox_desc: "New emails to this alias skip your inbox.",
    alias_never_inbox_info: "When enabled, new emails received through this alias are kept out of your main inbox. You can still find them in All Mail and by opening this alias in the sidebar.",
    alias_never_inbox_error: "Failed to update alias delivery",
  ...
  mail: {
    ...
    body_search_unavailable_large_mailbox:
      "Message content search is unavailable for this large mailbox; showing subject and sender matches only",
  ...
  errors: {
    ...
    failed_send_reaction: "We could not send your reaction. Another attempt should do it.",
    reactions_disabled: "Sending reactions is turned off. Enable it in Settings > Behavior.",
  ...
  mail_rules: {
    ...
    run_on_existing_confirm_title: "Run rule on existing mail?",
    run_on_existing_confirm_body:
      "This applies the rule to every message already in your mailbox, not just new mail. On a large account this can take a while to finish.",
    run_on_existing_success: "Rule applied to {{count}} messages",
    run_on_existing_failed: "This rule did not run. Another attempt should do it.",
    and_label: "AND",
    or_label: "OR",
    value_placeholder: "Value",
