...
export const en: Translations = {
  ...
  settings: {
    ...
    alias_watch_title: "Alias Watch",
    alias_watch_beta_badge: "Beta",
    alias_watch_description: "Checks your main address, aliases, ghost aliases, and domain addresses against publicly disclosed breach lists, and flags any receiving a sudden spam surge. All matching happens on your device.",
    alias_watch_info: "Alias Watch checks every address you have, your main address, aliases, ghost aliases, and custom domain addresses, against publicly disclosed data breach lists. Matching works from the alias name itself, and also from any notes or linked websites you've added. It can only catch breaches that have been publicly reported for a company you've linked to an alias - it cannot detect a breach Aster or the public don't yet know about. Nothing about which company you use an alias for is ever sent to Aster. It also surfaces spam surge alerts flagged by the server for individual aliases.",
    alias_watch_active: "Alias Watch Active",
    alias_watch_enable: "Enable Alias Watch",
    alias_watch_disable: "Disable Alias Watch",
    alias_watch_enabled_toast: "Alias Watch enabled",
    alias_watch_disabled_toast: "Alias Watch disabled",
    alias_watch_coverage_title: "Watching {{count}} addresses",
    alias_watch_stat_main: "Main address",
    alias_watch_stat_aliases: "Aliases",
    alias_watch_stat_ghost: "Ghost aliases",
    alias_watch_stat_domain: "Domain addresses",
    alias_watch_scan_now: "Scan now",
    alias_watch_scanning: "Scanning...",
    alias_watch_last_scanned: "Last scanned {{date}}",
    alias_watch_never_scanned: "Not scanned yet",
    alias_watch_matches_found: "{{count}} found",
    alias_watch_scan_found: "Scan complete - {{count}} found",
    alias_watch_scan_clean: "No breaches found for any of your addresses",
    alias_watch_scan_failed: "Scan failed - check your connection and try again",
    alias_watch_match_tagged: "Tagged",
    alias_watch_match_automatic: "Auto-detected",
    alias_watch_spam_surge_title: "Unusual spam surge detected",
    alias_watch_spam_surge_detail:
      "{{observed}} messages today, usually around {{baseline}}",
    alias_watch_spam_surge_badge: "Spam surge",
    alias_breach_badge_title: "Possible breach",
    alias_breach_badge_desc: "A domain linked to this alias appears in a public data breach list. Consider disabling or deleting this alias if you no longer trust the site it was used for.",
    alias_spam_surge_badge_title: "Spam surge",
    alias_spam_surge_badge_desc: "This alias has received a sudden surge of spam or unwanted mail. Consider disabling or deleting it if you no longer need it.",
    alias_watch_disable_success: "Alias disabled",
    alias_watch_disable_failed: "Couldn't disable alias - try again",
    alias_watch_delete_success: "Alias deleted",
    alias_watch_delete_failed: "Couldn't delete alias - try again",
    ...
    encryption_key_load_failed: "Couldn't load your encryption key. Check your connection and try again.",
    ...
    info_fingerprint_description: "A short code created from your encryption key. If someone you email compares it with the code on their end and it matches, you can both be sure your messages are private and haven't been tampered with.",
    ...
    alias_auto_tag_title: "Detected company",
    alias_auto_tag_info:
      "Aster looks at senders that have emailed this alias and detects which company it's most likely used for, without ever sending that information to our servers.",
    alias_auto_tag_accept: "Add to websites",
    alias_auto_tag_accepted: "Added to alias websites",
    ...
    export_verify_description: "Confirm your account password before we prepare this export.",
    ...
    export_security_password_row_body: "You'll confirm your password, and your authenticator code if 2FA is on, before every export.",
    export_security_vault_row_title: "Encryption vault passphrase",
    export_security_vault_row_body: "Your local vault passphrase confirms this device before mail is decrypted for export.",
    export_security_vault_row_help: "This is your local device vault passphrase, not your account password. It unlocks your encryption keys on this device only.",
    ...
    export_scope_mail_help: "MBOX bundles every message into one file; .EML saves each message as its own file. Both formats work with most desktop mail clients.",
    ...
    export_scope_contacts_help: "vCard 4.0 is the universal contact format most apps import directly. The extra JSON file preserves fields vCard can't store.",
    ...
    alias_pref_auto_tag: "Auto-detect alias company",
    alias_pref_auto_tag_desc: "Automatically detect which company an alias is used for based on recent senders, and suggest adding it to that alias's websites. Requires Nova or above.",
    alias_pref_auto_tag_info: "Runs entirely on your device by looking at senders that have already emailed this alias. Nothing is sent to our servers. Requires a Nova plan or higher.",
  ...
  mail: {
    ...
    spam_reason_missing_headers: "The message is missing standard email headers",
    spam_reason_reply_to_mismatch: "The reply address does not match the sender",
    spam_reason_future_dated: "The message is dated in the future",
    spam_reason_phishing_url: "It contains a link found on a phishing blocklist",
    spam_reason_phishing_domain: "It links to a domain associated with phishing",
    spam_reason_user_spam_learning: "You previously reported spam from this sender's domain",
    spam_reason_global_domain_reputation: "The sender's domain has a poor reputation",
  ...
  passkeys: {
    ...
    delete_passkey_description: "\"{{name}}\" will be removed from your account. You will no longer be able to sign in with it.",
    delete_security_key_title: "Delete security key?",
    delete_security_key_description: "\"{{name}}\" will be removed from your account. It will no longer work as a second factor.",
