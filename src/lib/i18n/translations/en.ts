...
export const en: Translations = {
  common: {
    ...
    failed_update_alias_avatar: "Failed to update alias avatar",
    alias_display_name_updated: "Display name updated",
    failed_update_alias_display_name: "Failed to update display name",
    ...
    alias_avatars_locked: "Custom alias and domain avatars require a paid plan",
    alias_avatars_feature: "Custom alias & domain avatars",
    recovery_conflict:
      "This recovery email is already associated with another account",
    copied_to_clipboard: "Copied to clipboard",
    offline: "Offline",
    offline_features_limited: "You're offline. Some features may be limited.",
    ...
    failed_to_update_emails: "Failed to update emails",
    failed_to_archive_emails: "Failed to archive emails",
    ...
    failed_to_snooze: "Failed to snooze email",
    failed_to_unsnooze: "Failed to unsnooze email",
    conversation_moved_to_trash: "Conversation moved to trash",
    conversation_archived: "Conversation archived",
    conversation_marked_as_spam: "Conversation marked as spam",
    failed_to_mark_as_spam: "Failed to mark as spam",
    failed_to_snooze_conversations: "Failed to snooze conversations",
    ...
    failed_to_load_duplicates: "Failed to load duplicates",
    scan_failed: "Scan failed",
    dismiss_failed: "Dismiss failed",
    failed_to_load_custom_fields: "Failed to load custom fields",
    failed_to_create_field: "Failed to create field",
    failed_to_delete_field: "Failed to delete field",
    failed_to_save_value: "Failed to save value",
    ...
    failed_to_forward: "Failed to forward email",
    failed_to_schedule: "Failed to schedule email",
    fill_required_fields: "Please fill in all required fields",
    failed_to_load_sources: "Failed to load sync sources",
    failed_to_add_source: "Failed to add sync source",
    failed_to_delete_source: "Failed to delete source",
    failed_to_toggle_source: "Failed to toggle source",
    ...
    trash_empty_failed: "Failed to empty trash. Please try again.",
    ...
    failed_to_merge_contacts: "Failed to merge contacts",
    ...
    failed_to_snooze_emails: "Failed to snooze emails",
    failed_to_copy: "Failed to copy",
    error_copied_to_clipboard: "Error copied to clipboard",
    failed_to_update_contact: "Failed to update contact",
    failed_to_block_sender: "Failed to block sender",
    failed_to_rename_folder: "Failed to rename folder",
    failed_to_change_folder_color: "Failed to change folder color",
    failed_to_delete_folder: "Failed to delete folder",
    failed_to_update_folder_encryption: "Failed to update folder encryption",
    failed_to_rename_label: "Failed to rename label",
    failed_to_change_label_color: "Failed to change label color",
    failed_to_change_label_icon: "Failed to change label icon",
    ...
    failed_to_decrypt_email: "Failed to decrypt email",
    failed_to_unsubscribe: "Failed to unsubscribe",
    failed_to_disable_2fa: "Failed to disable 2FA",
    failed_to_parse_settings: "Failed to parse settings file",
    ...
    no_vault_available: "No vault available",
    offline_action_queued:
      "You're offline. Action queued for when you reconnect.",
    failed_to_update: "Failed to update",
    failed_to_load_search_results: "Failed to load search results",
    ...
    failed_to_fetch_tags: "Failed to fetch tags",
    failed_to_fetch_folders: "Failed to fetch folders",
    failed_to_unlock_folder: "Failed to unlock folder",
    failed_to_set_folder_password: "Failed to set password",
    failed_to_change_folder_password: "Failed to change password",
    failed_to_remove_folder_password: "Failed to remove password",
    incorrect_password: "Incorrect password",
    folder_no_password_protection:
      "Folder does not have password protection enabled",
    password_already_set:
      "Password is already set. Use change password instead.",
    folder_must_be_unlocked: "Folder must be unlocked first",
    cannot_remove_vault_password: "Cannot remove password from Vault folder",
    failed_to_load_snoozed_emails: "Failed to load snoozed emails",
    failed_to_load_subscriptions: "Failed to load subscriptions",
    unexpected_error: "An unexpected error occurred",
    failed_to_load_more_subscriptions: "Failed to load more subscriptions",
    failed_to_scan_subscriptions: "Failed to scan subscriptions",
    failed_to_load_drafts: "Failed to load drafts",
    failed_to_load_scheduled_emails: "Failed to load scheduled emails",
    recently_archived: "Recently Archived",
    older_items: "Older Items",
    long_term_archive: "Long-term Archive",
    failed_to_fetch_archive_stats: "Failed to fetch archive stats",
    ...
    folder_label: "Folder",
    no_email_id_provided: "No email ID provided",
    please_enter_valid_url: "Please enter a valid URL",
    csv_file_empty: "CSV file appears to be empty",
    no_valid_contacts_csv: "No valid contacts found in CSV",
    label_name_cannot_be_empty: "Label name cannot be empty",
    folder_name_cannot_be_empty: "Folder name cannot be empty",
    please_enter_password: "Please enter your password",
    rotation_failed:
      "Rotation failed. Please check your password and try again.",
    delete_account_error: "An error occurred while deleting your account.",
    encryption_vault_not_available:
      "Encryption vault not available. Please re-authenticate.",
    email_data_missing: "Email data is missing",
    later: "Later",
    ...
    failed_to_send_external_email: "Failed to send external email",
    external_account_token_missing: "External account token missing.",
    failed_to_send_via_external: "Failed to send via external account",
    offline_email_queued:
      "You're offline. Email queued for when you reconnect.",
    failed_to_queue_offline: "Failed to queue email for offline sending.",
    cannot_mix_recipients: "Cannot mix internal and external recipients.",
    empty_body_error: "Cannot send an email with no content.",
    subject_too_long: "Subject is too long. Maximum 998 characters allowed.",
    failed_to_schedule_email: "Failed to schedule email",
    failed_to_restore_draft: "Failed to restore draft.",
    enter_url: "Enter URL:",
    enter_link_text: "Enter link text:",
    conversation_marked_as_spam_toast: "Conversation marked as spam",
    failed_to_undo_spam: "Failed to undo spam action",
    conversation_moved_to_trash_toast: "Conversation moved to trash",
    failed_to_undo_trash: "Failed to undo trash action",
    ...
    image: "Image",
    system: "System",
    failed_to_permanently_delete: "Failed to permanently delete",
    failed_to_delete_emails: "Failed to delete emails",
    failed_to_mark_as_read: "Failed to mark emails as read",
    failed_to_mark_as_unread: "Failed to mark emails as unread",
    ...
    failed_to_rotate_keys: "Failed to rotate keys",
    read: "Read",
    or_conjunction: "or",
    press_label: "Press",
    ...
    failed_to_remove_label: "Failed to remove label",
    failed_to_move_email: "Failed to move email",
    failed_to_add_labels: "Failed to add labels",
    failed_to_remove_labels: "Failed to remove labels",
    ...
    auth_fail_banner_title: "Authentication failed",
    auth_fail_banner_body: "This email failed sender verification. It may be spoofed or forged.",
    ...
    device_revoked: "This device has been revoked. You have been signed out.",
    ...
    file_exceeds_max_size: "\"{{name}}\" exceeds max size of 25MB",
    total_attachments_exceed_limit: "Total attachments exceed 50MB limit",
    adding_file_would_exceed_limit:
      "Adding \"{{name}}\" would exceed the total attachment limit of 50MB",
    unsupported_file_type: "\"{{name}}\" has an unsupported file type",
    file_already_attached: "\"{{name}}\" is already attached",
    failed_to_read_named_file: "Failed to read \"{{name}}\"",
    ...
    failed_to_get_key_status: "Failed to get key status",
    unknown_rotation_error: "Unknown rotation error",
    ...
    recovery_pdf_important_warning: "IMPORTANT WARNING",
  ...
  settings: {
    ...
    storage_limit_description:
      "Upgrade your plan or delete some emails to continue receiving mail.",
    ...
    plan_not_available: "This plan is not available for purchase",
    failed_checkout: "Failed to create checkout session",
    checkout_welcome: "Welcome to Aster! Your subscription is active.",
    failed_billing_portal: "Failed to open billing portal",
    subscription_cancelled:
      "Subscription will be cancelled at the end of the billing period",
    failed_cancel_subscription: "Failed to cancel subscription",
    subscription_reactivated: "Subscription reactivated",
    failed_reactivate: "Failed to reactivate subscription",
    payment_failed_warning:
      "Your payment failed. Please update your payment method to keep your plan.",
    grace_period_remaining: "{{days}} days remaining to update payment",
    ...
    failed_switch_billing: "Failed to switch billing cycle",
    ...
    hours: "{{count}} hours",
    days: "{{count}} days",
    failed_get_auth_data: "Failed to get authentication data",
    downgrade: "Downgrade",
    upgrade: "Upgrade",
    ...
    addon_purchase_failed: "Failed to start add-on purchase. Please try again.",
    addon_cancel_failed: "Failed to cancel storage add-on. Please try again.",
    ...
    storage_approaching_title: "Storage filling up",
    storage_approaching_description:
      "You're using over 75% of your storage. Consider upgrading or cleaning up old emails.",
    storage_warning_title: "Running low on storage",
    storage_warning_description:
      "You're using over 90% of your storage. Upgrade your plan or delete emails to free up space.",
    storage_locked_title: "Storage full",
    storage_locked_description:
      "You cannot send or receive new emails. Upgrade your plan or delete emails to resume.",
    storage_locked_bounce_warning:
      "Incoming emails will be permanently bounced in {{days}} days.",
    ...
    cancel_password_required: "Please enter your password to continue.",
    cancel_password_error:
      "Failed to cancel subscription. Please check your password and try again.",
    credits: "Credits",
    credits_description:
    ...
    credits_toggle_failed: "Failed to update credit settings",
    ...
    referral_reward_info:
      "$2.00 for you, $1.00 for your friend when they subscribe to a paid plan.",
    ...
    address_save_failed: "Failed to save billing address",
    saving: "Saving...",
    redeem: "Redeem",
    redeeming: "Redeeming...",
    ...
    export_failed: "Failed to request export. Please try again.",
    biennial: "2-Year",
    ...
    please_log_in_feedback: "Please log in to send feedback.",
    failed_send_feedback: "Failed to send feedback. Please try again.",
    ...
    error_deleting_account: "An error occurred while deleting your account.",
    ...
    alias_already_taken: "This alias is already taken",
    alias_create_failed: "Failed to create alias",
    alias_generate_failed: "Failed to generate alias",
    alias_invalid: "Invalid alias",
    domain_not_available: "Selected domain is not available",
    ...
    failed_add_domain: "Failed to add domain",
    ...
    incoming_server_required: "Incoming mail server host is required",
    private_address_error:
      "Incoming mail server host cannot point to a private or loopback address",
    username_required: "Username is required",
    password_required: "Password is required",
    connection_timeout_error:
      "Connection timeout must be between 5 and 120 seconds",
    fill_server_first:
      "Please fill in server host, username, and password first",
    fill_smtp_first: "Please fill in SMTP server details first",
    fill_connection_first: "Please fill in connection details first",
    connection_test_failed: "Connection test failed",
    account_updated: "Account updated successfully",
    account_added: "Account added successfully",
    failed_update_account: "Failed to update account",
    failed_add_account: "Failed to add account",
    switch_failed: "Failed to switch account",
    unexpected_error: "An unexpected error occurred",
    failed_sync: "Failed to sync",
    failed_delete_emails_external: "Failed to delete emails",
    failed_fetch_folders_external: "Failed to fetch folders",
    ...
    please_enter_password: "Please enter your password",
    please_enter_2fa_code: "Please enter your 2FA code",
    invalid_2fa_code: "Invalid 2FA code",
    incorrect_password_error: "Incorrect password",
    failed_retrieve_auth: "Failed to retrieve authentication data",
    failed_verify_password: "Failed to verify password",
    failed_export_private_key: "Failed to export private key",
    ...
    zero_knowledge_storage: "Zero-Knowledge Storage",
    ...
    failed_publish_wkd: "Failed to publish key to WKD",
    failed_remove_wkd: "Failed to remove key from WKD",
    key_published_keyserver: "Key published to keyserver",
    failed_publish_keyserver: "Failed to publish key to keyserver",
    ...
    passwords_do_not_match_folder: "Passwords do not match",
    ...
    choose_stronger_new_password: "Please choose a stronger new password",
    enter_password_confirm_required: "Please enter your password to confirm",
    no_password_recovery_title: "No password recovery",
    no_password_recovery_desc:
      "If you forget this password, there is no way to recover access to this folder.",
    folder_protected_desc:
      "This folder is protected. Enter your password to access its contents.",
    remove_protection_warning_title: "Remove password protection",
    remove_protection_warning_desc:
      "Anyone with access to your account will be able to view this folder's contents.",
    ...
    regenerate_codes_warning:
      "All existing recovery codes will be invalidated. Type",
    ...
    host_invalid_characters:
      "{{label}} host contains invalid characters. Enter a hostname without protocol prefix.",
    host_private_address:
      "{{label}} host cannot point to a private or loopback address",
    incoming_server_invalid:
      "Incoming mail server host is invalid. Enter a hostname without protocol prefix.",
    incoming_port_error: "Incoming port must be between 1 and 65535",
    incoming_mail_server: "Incoming mail server",
    smtp_server: "SMTP server",
    smtp_server_required: "SMTP server host is required",
    smtp_server_invalid:
      "SMTP server host is invalid. Enter a hostname without protocol prefix.",
    smtp_private_address_error:
      "SMTP server host cannot point to a private or loopback address",
    smtp_port_error: "SMTP port must be between 1 and 65535",
    smtp_username_required: "SMTP username is required",
    smtp_password_required: "SMTP password is required",
    label_color_invalid:
      "Label color must be a valid hex color (e.g., #3B82F6)",
    ...
    sync_failed_detail:
      "Last sync failed at {{time}}. Try syncing again or check your account credentials.",
    ...
    connected_accounts_error: "Sync error",
    ...
    oauth_import_error: "OAuth connection failed: {{ reason }}",
    ...
    oauth_reason_provider_denied: "Access was denied by provider",
    oauth_reason_missing_code: "Authorization code missing",
    oauth_reason_missing_state: "Invalid request state",
    oauth_reason_internal_error: "Internal server error",
    oauth_reason_invalid_state: "Invalid or expired session",
    oauth_reason_expired_state: "Session expired",
    oauth_reason_invalid_provider: "Unknown provider",
    oauth_reason_provider_not_configured: "Provider not configured",
    oauth_reason_token_exchange_failed: "Token exchange failed",
    oauth_reason_encryption_error: "Encryption error",
    oauth_reason_account_creation_failed: "Account creation failed",
    oauth_reason_unknown: "Unknown error",
    ...
    oauth_folders_error: "Failed to set up folders",
    ...
    feature_locked: "This feature requires a {{plan}} plan or higher",
    ...
    failed_create_import_job: "Failed to create import job",
  ...
  mail: {
    ...
    delete_draft_confirmation:
      "This will permanently remove the draft and any unsaved changes.",
    plain_text_warning:
      "Switching to plain text will remove all formatting. This cannot be undone.",
    remove_formatting: "Remove formatting",
    ...
    empty_spam_description:
      "All {{count}} message(s) in the spam folder will be permanently deleted. This action cannot be undone.",
    empty_trash_question: "Empty trash?",
    empty_trash_description:
      "All {{count}} message(s) in the trash will be permanently deleted. This action cannot be undone.",
    folder_not_found_title: "Folder not found",
    folder_not_found_subtitle:
      "This folder may have been deleted or doesn't exist",
    tag_not_found_title: "Label not found",
    tag_not_found_subtitle: "This label may have been deleted or doesn't exist",
    folder_locked_title: "This folder is locked",
    enter_password_to_access: 'Enter your password to access "{{folder}}"',
    ...
    verification_invalid: "Signature invalid",
    verification_no_keys: "Sender keys unavailable",
  ...
  auth: {
    ...
    pair_device_warning:
      "Paired devices can access your mail without entering your password. You can revoke access any time from Settings > Trusted Devices.",
    ...
    pair_device_invalid: "Invalid pairing link",
    pair_device_failed: "Pairing failed. Please try again.",
    ...
    link_device_invalid_code: "Please enter a valid 8-character code.",
    link_device_expired_code:
      "Invalid or expired code. Check the code on your desktop app and try again.",
    link_device_failed: "Linking failed. Please try again.",
    link_device_try_again: "Something went wrong. Please try again.",
    ...
    backup_code_length_error: "Backup code must be 12 characters",
    ...
    webauthn_not_supported: "Security keys are not supported in this browser",
    recovery_codes_warning:
      "Your recovery codes are the ONLY way to regain access to your account if you forget your password. Without them, your encrypted data will be permanently lost. Are you sure you want to continue without saving them?",
    ...
    please_enter_recovery_email: "Please enter a recovery email address",
    please_enter_valid_email: "Please enter a valid email address",
    recovery_email_conflict:
      "This recovery email is already associated with another account",
    failed_save_recovery_email: "Failed to save recovery email",
    ...
    please_enter_recovery_code: "Please enter a recovery code",
    ...
    recovery_session_expired: "Recovery session expired. Please start over.",
    ...
    old_codes_invalidated:
      "Your old recovery codes have been invalidated. Save these new codes safely.",
  ...
  errors: {
    ...
    send_limit_reached: "Daily sending limit reached. Try again in {{ time }}.",
    ip_blocked: "Too many failed attempts. Try again in {{ time }}.",
    ...
    failed_to_block_sender: "Failed to block sender",
    failed_to_snooze: "Failed to snooze",
    ghost_alias_not_found: "Could not find the ghost alias for this thread",
    failed_to_resolve_ghost_alias: "Failed to resolve ghost alias",
    ghost_alias_rate_limit:
      "You have hit your limit. Please upgrade to continue using ghost aliases or wait a month.",
    ghost_alias_already_exists: "This ghost alias already exists",
    failed_to_create_ghost_alias: "Failed to create ghost alias",
    failed_to_activate_ghost_mode: "Failed to activate ghost mode",
    failed_to_queue_email: "Failed to queue email",
    failed_to_send_queued: "Failed to send",
    failed_to_send_external_queued: "Failed to send external email",
    authentication_failed: "Authentication failed",
    failed_to_snooze_email: "Failed to snooze email",
    failed_to_snooze_emails: "Failed to snooze emails",
    failed_to_unsnooze_email: "Failed to unsnooze email",
    failed_to_list_snoozed: "Failed to list snoozed emails",
    ...
    failed_encrypt_envelope: "Failed to encrypt sent envelope",
    no_authenticated_account: "No authenticated account found",
    daily_limit_reached:
      "Daily sending limit reached. Try again in {{ time }}.",
    failed_send_email: "Failed to send email",
    cannot_send_no_keys:
      "Cannot send: encryption is required but no keys found for: {{ recipients }}",
    cannot_send_no_recipient_keys:
      "Cannot send: encryption is required but no recipient keys were found",
    failed_send_external: "Failed to send external email",
    failed_queue_email: "Failed to queue email",
    no_active_account: "No active account found",
    failed_queue_reply: "Failed to queue reply",
    no_recipients: "No recipients specified",
    failed_queue_forward: "Failed to queue forward",
    failed_send: "Failed to send",
    incorrect_password: "Incorrect password.",
    no_keys_available: "No keys available.",
    session_expired_login: "Session expired. Please log in again.",
    key_material_unavailable:
      "Key material unavailable. Please log in again.",
    storage_compromised:
      "Data integrity check failed. Storage may be compromised.",
    registration_failed: "Registration failed or was cancelled",
    registration_cancelled: "Registration cancelled",
    authentication_failed_webauthn:
      "Authentication failed or was cancelled",
    authentication_cancelled: "Authentication cancelled",
    alias_empty: "Alias cannot be empty",
    alias_too_short: "Alias must be at least 3 characters",
    alias_too_long: "Alias must be 64 characters or less",
    alias_consecutive_dots: "Alias cannot contain consecutive dots",
    alias_not_available: "This alias is not available",
    alias_invalid_chars:
    ...
    domain_reserved: "Cannot use astermail.org or aster.cx domains",
    domain_invalid_format: "Invalid domain format",
    domain_invalid_label: "Invalid domain label length",
    domain_invalid_chars: "Domain contains invalid characters",
    address_empty: "Address cannot be empty",
    address_too_short: "Address must be at least 1 character",
    address_too_long: "Address must be 64 characters or less",
    address_invalid_chars:
      "Address can only contain letters, numbers, dots, underscores, and hyphens",
    address_consecutive_dots: "Address cannot contain consecutive dots",
    max_accounts: "Maximum of {{ max }} accounts allowed",
    failed_encrypt_draft: "Failed to encrypt draft content",
    failed_decrypt_draft: "Failed to decrypt draft content",
    version_conflict: "Version conflict",
    file_too_large: "File too large: {{ size }}MB exceeds {{ limit }}MB limit",
    no_emails_in_mbox: "No emails found in MBOX file",
    no_emails_in_pst: "No emails found in PST file",
    no_data_in_csv: "No data found in CSV file",
    email_skipped_size: "Email {{ number }} skipped: exceeds 50MB size limit",
    failed_parse_email: "Failed to parse email {{ number }}: {{ error }}",
    failed_parse_pst: "Failed to parse PST message: {{ error }}",
    ...
    failed_parse_pst_file:
      "Failed to parse PST file: {{ error }}. Try exporting as MBOX format from your email client.",
    no_valid_emails_csv:
  ...
  mail_rules: {
    ...
    regex_empty: "Regex pattern is required",
    regex_too_long: "Regex pattern is too long",
    last_condition_required: "At least one condition is required",
    last_action_required: "At least one action is required",
    read: "Read",
    unread: "Unread",
    none: "None",
    no_labels: "No labels",
    ...
    reorder_failed: "Failed to reorder rules",
    ...
    hint_name_required: "Rule name is required",
    hint_conditions_required: "Add at least one condition",
    hint_actions_required: "Add at least one action",
    hint_condition_incomplete: "Complete all conditions",
    hint_forward_required: "Forward target required",
    hint_snooze_required: "Snooze date required",
    hint_categorize_required: "Category required",
    ...
    expression_parse_error: "Parse error",
    cannot_render_visual:
      "This rule uses nested conditions. Switch to Expression to edit.",
  },
};
