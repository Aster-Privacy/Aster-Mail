...
export const en: Translations = {
  ...
  settings: {
    ...
    alias_watch_title: "Breach Monitoring",
    alias_watch_beta_badge: "Beta",
    alias_watch_description: "Automatically checks your main address, aliases, ghost aliases, and domain addresses against known public breach lists, and flags any receiving a sudden spam surge. All matching happens on your device.",
    alias_watch_info: "Breach Monitoring scans every address you have, your main address, aliases, ghost aliases, and custom domain addresses, against public data breach lists. Matching works automatically from the alias name itself, and also from any notes or linked websites you've added. Nothing about which company you use an alias for is ever sent to Aster. It also surfaces spam surge alerts flagged by the server for individual aliases.",
    alias_watch_active: "Breach Monitoring Active",
    alias_watch_enable: "Enable Breach Monitoring",
    alias_watch_disable: "Disable Breach Monitoring",
    alias_watch_enabled_toast: "Breach Monitoring enabled",
    alias_watch_disabled_toast: "Breach Monitoring disabled",
