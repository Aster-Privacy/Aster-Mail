...
export const en: Translations = {
  ...
  settings: {
    ...
    vanguard_description: "Sophisticated security for journalists, activists, and anyone with elevated risk. Enables advanced protections not available on standard accounts.",
    ...
    alias_import_col_domain: "Domain",
