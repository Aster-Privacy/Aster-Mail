...
export const en: Translations = {
  common: {
    ...
    unblock_failed: "We could not unblock {{ email }}. Another attempt should do it. The sender stays blocked for now.",
    remove_from_allowlist_failed: "We could not remove {{ email }} from your allowlist. Another attempt should do it. It stays allowed for now.",
    bulk_unblock_failed: "These senders were not unblocked. Another attempt should do it. They stay blocked for now.",
    bulk_remove_allowlist_failed: "These senders were not removed from your allowlist. Another attempt should do it. They stay allowed for now.",
  ...
  mail_rules: {
    ...
    run_on_existing_result: "Rule applied to {{count}} messages",
    run_on_existing_failed: "Could not run the rule on existing mail. Another attempt should do it.",
    paused_badge: "Paused",
    and_label: "AND",
    or_label: "OR",
    value_placeholder: "Value",
