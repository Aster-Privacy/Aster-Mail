...
export const en: Translations = {
  common: {
    ...
    incorrect_password: "That password did not match. Another attempt should work. Your account is not locked.",
    ...
    delete_account_error: "We could not delete your account just now. Another attempt in a moment usually works, and support@aster.com can help if it keeps failing.",
    ...
    device_revoked: "This device was removed from your account, and you have been signed out. If this was not you, change your password right away at aster.com/security.",
    ...
    account_suspended_default_reason: "Your account is suspended for a Terms of Service violation. support@aster.com can help with an appeal or more detail.",
    ...
    settings_disabled_suspended: "Settings are turned off while your account is suspended. support@aster.com can help with an appeal or more detail.",
    ...
    decrypt_try_sign_out: "Signing out and back in will reload your keys. If the message still will not open, support@aster.com can help.",
    n_files: "{{count}} file",
    ...
    account_limit_reached: "You have reached the account limit for this network. If this looks wrong, support@aster.com can help.",
  ...
  settings: {
    ...
    too_many_requests: "You have done that a lot in a short time. A moment, then another attempt, will work.",
    ...
    failed_verify_credentials: "That password did not match. Another attempt should work. Your account is unchanged.",
    ...
    incorrect_password_error: "That password did not match. Another attempt should work. Your account is not locked.",
    failed_retrieve_auth: "We could not load your sign-in info. Another attempt should do it.",
    failed_verify_password: "That password did not match. Another attempt should work.",
    ...
    oauth_reason_provider_not_configured: "This provider is not set up on Aster yet. support@aster.com can help if you need it.",
    ...
    oauth_reason_encryption_error: "We could not secure the connection just now. Another attempt should do it, and support@aster.com can help if it keeps failing.",
  ...
  auth: {
    ...
    account_flagged_notice: "Our automated security system has placed limits on your account for now, and a few features may be unavailable. The rest of your account works normally. If this looks wrong, support@aster.com can help.",
    ...
    abuse_account_limit: "Our automated security system flagged this sign-up, and we cannot create the account. If this looks like a mistake, support@aster.com can help.",
    registration_suspended: "Our security system has stopped new sign-ups from this network for now. If this looks like a mistake, support@aster.com can help.",
    abuse_flagged_message: "Our security system has stopped new sign-ups from this network for now. If this looks like a mistake, support@aster.com can help.",
  ...
  errors: {
    ...
    invalid_credentials: "That email and password did not match. Another attempt, or a reset at aster.com/reset, will sort it.",
    ...
    account_not_found: "We could not find an account with that name. Checking the spelling, or a reset at aster.com/reset, usually sorts it.",
    login_failed: "Sign-in did not finish. Another attempt should do it. Your account is not locked.",
    decrypt_failed: "That password did not unlock your keys on this device. Trying again will work, and a recovery code at aster.com/reset is the backup if it keeps failing. Your data on the server is unchanged.",
    ...
    rate_limited: "You have done that a lot in a short time. A moment, then another attempt, will work.",
    ...
    storage_compromised: "The encrypted data on this device does not match what we expected, which can indicate tampering. Signing out and back in often clears it. If the warning returns, contact support@aster.com right away. Your data on the server is untouched.",
    registration_failed: "Sign-up did not finish. Starting over and trying again usually does it. No account was created.",
    ...
    unrecognized_format: "We could not recognize the format of {{name}}. Aster supports MBOX, EML, CSV, and PST, and saving the file in one of those will let the import run.",
    unknown_error: "Something did not work as expected. Another attempt should do it. We could not pinpoint the cause.",
    health_check_failed: "The diagnostic did not finish. Another attempt should do it.",
    ...
    wrong_vault_password: "That password did not unlock your keys on this device. Another attempt should do it, and a recovery code at aster.com/reset is the backup if it keeps failing. Your data on the server is unchanged.",
    vault_tampered: "The encrypted data on this device does not match what we expected, which can indicate tampering. Visit Settings then Security to review, and if the warning returns contact support@aster.com. Your data on the server is untouched.",
    ...
    wrong_folder_password: "That folder password did not match. Another attempt should work. The folder stays locked.",
    ...
    decrypt_corrupt_ciphertext: "This email is on the server but looks corrupted on the wire. A refresh and another attempt usually does it, and support@aster.com can help if it keeps failing.",
    ...
    cdn_relay_misconfigured: "The CDN relay is not configured for this build. Switching to direct connection in Settings will get you back online, and support@aster.com can help if needed.",
    ...
    device_challenge_mismatch: "This device's identity check did not match, which can indicate tampering. Re-pair from your desktop app, and if the warning returns contact support@aster.com.",
