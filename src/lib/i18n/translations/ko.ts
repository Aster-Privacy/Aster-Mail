...
export const ko = {
  common: {
    ...
    contact_groups: "그룹",
    more_contact_groups: "그룹 {{count}}개 더 보기",
    more_contact_groups_other: "그룹 {{count}}개 더 보기",
    new_group: "새 그룹",
    ...
    add_contacts_to_group_hint: "자주 메일을 보내는 사람을 정리할 그룹을 만드세요.",
    contact_group_name_too_long: "그룹 이름은 최대 {{ max }}자까지 입력할 수 있습니다.",
    contact_group_already_exists: "같은 이름의 그룹이 이미 있습니다.",
    contact_group_limit_reached: "그룹은 최대 {{ max }}개까지 만들 수 있습니다.",
    delete_contact_group_confirm: "이 그룹을 삭제할까요? 연락처는 주소록에 그대로 남습니다.",
    failed_to_fetch_contact_groups: "그룹을 불러오지 못했습니다. 다시 시도하세요.",
    failed_to_save_contact_group: "그룹을 저장하지 못했습니다. 다시 시도하세요.",
    failed_to_create_contact_group: "그룹을 만들지 못했습니다. 다시 시도하세요.",
    failed_to_delete_contact_group: "그룹을 삭제하지 못했습니다. 다시 시도하세요.",
    ...
    contacts_removed_from_group_other: "연락처 {{count}}개를 그룹에서 삭제했습니다",
    send_email: "이메일 보내기",
