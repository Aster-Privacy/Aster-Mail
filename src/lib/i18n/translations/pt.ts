...
export const pt = {
  ...
  settings: {
    ...
    vanguard_description: "Segurança sofisticada para jornalistas, ativistas e qualquer pessoa com risco elevado. Ativa proteções avançadas não disponíveis em contas padrão.",
