...
export const pt = {
  common: {
    ...
    emoji_recent: "Utilizados recentemente",
  ...
  mail: {
    ...
    you_reacted_with_remove: "Reagiu com {{emoji}}. Clique para remover.",
  ...
  errors: {
    ...
    cannot_react_limit: "Pode adicionar até duas reações a uma mensagem. Para adicionar outra, remova uma das suas.",
