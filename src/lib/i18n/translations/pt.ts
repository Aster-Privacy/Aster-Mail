...
export const pt = {
  common: {
    ...
    unsupported_image_type:
      "Este tipo de arquivo não é suportado. Salve a imagem como PNG, JPEG, WebP ou GIF e tente novamente.",
    csv_too_large:
    ...
    inactivity_window_description:
      "Contas gratuitas inativas por esta quantidade de meses serão excluídas permanentemente. Os avisos vão para sua caixa de entrada da Aster e para o e-mail de recuperação.",
    inactivity_window_info_title: "Como funciona a política de inatividade",
    ...
    inactivity_window_step_up_description:
      "Por segurança, confirme sua senha para alterar o período de inatividade.",
    inactivity_window_months: "{{n}} meses",
    inactivity_window_saved: "Período de inatividade atualizado",
    inactivity_window_save_failed:
      "Não foi possível salvar o período de inatividade. Tente de novo.",
    ...
    discard_changes_title: "Descartar as alterações?",
    discard_changes_message:
      "As suas alterações não foram guardadas. Se fechar agora, perde-as.",
    ...
    no_icon: "Sem ícone",
    icon_group_essentials: "Essenciais",
    icon_group_mail: "Correio",
    icon_group_money: "Dinheiro",
    icon_group_work: "Trabalho",
    icon_group_school: "Escola",
    color_red: "Vermelho",
    ...
    color_pink: "Rosa",
    color_rose: "Rosa-velho",
    tag_icon_tag: "Etiqueta",
    tag_icon_folder: "Pasta",
    tag_icon_star: "Estrela",
    tag_icon_bookmark: "Marcador",
    tag_icon_flag: "Bandeira",
    tag_icon_check: "Marca de seleção",
    tag_icon_bell: "Sino",
    tag_icon_heart: "Coração",
    tag_icon_sparkles: "Brilhos",
    tag_icon_fire: "Fogo",
    tag_icon_bolt: "Raio",
    tag_icon_clock: "Relógio",
    tag_icon_info: "Informações",
    tag_icon_warning: "Aviso",
    tag_icon_envelope: "Envelope",
    tag_icon_at: "Arroba",
    tag_icon_chat: "Chat",
    tag_icon_send: "Enviar",
    tag_icon_draft: "Rascunho",
    tag_icon_document: "Documento",
    tag_icon_archive: "Arquivo",
    tag_icon_trash: "Lixeira",
    tag_icon_shield: "Escudo",
    tag_icon_lock: "Cadeado",
    tag_icon_eye_slash: "Oculto",
    tag_icon_currency: "Moeda",
    tag_icon_money: "Dinheiro",
    tag_icon_bank: "Banco",
    tag_icon_card: "Cartão",
    tag_icon_wallet: "Carteira",
    tag_icon_receipt: "Recibo",
    tag_icon_chart: "Gráfico",
    tag_icon_cart: "Carrinho",
    tag_icon_gift: "Presente",
    tag_icon_ticket: "Ingresso",
    tag_icon_crypto: "Cripto",
    tag_icon_briefcase: "Maleta",
    tag_icon_building: "Edifício",
    tag_icon_user: "Pessoa",
    tag_icon_users: "Pessoas",
    tag_icon_calendar: "Calendário",
    tag_icon_clipboard: "Área de transferência",
    tag_icon_presentation: "Apresentação",
    tag_icon_trophy: "Troféu",
    tag_icon_code: "Código",
    tag_icon_key: "Chave",
    tag_icon_link: "Link",
    tag_icon_package: "Pacote",
    tag_icon_home: "Início",
    tag_icon_truck: "Caminhão",
    tag_icon_map_pin: "Marcador de mapa",
    tag_icon_camera: "Câmera",
    tag_icon_music: "Música",
    tag_icon_cloud: "Nuvem",
    tag_icon_sun: "Sol",
    tag_icon_moon: "Lua",
    tag_icon_globe: "Globo",
    tag_icon_phone: "Telefone",
    tag_icon_news: "Notícias",
    tag_icon_bulb: "Lâmpada",
    tag_icon_tools: "Ferramentas",
    tag_icon_ban: "Bloqueado",
    icon_group_everyday: "Dia a dia",
    random: "Aleatório",
    ...
    dns_required: "Obrigatorio",
    dns_recommended: "Recomendado",
    dns_caveat_mx_replaces_existing:
      "Isto substitui os registos MX existentes. Remova os registos MX do seu fornecedor de correio anterior ou o correio novo nao chegara ao Aster.",
    dns_caveat_spf_single_record_other_senders:
      "Publique apenas um registo SPF. Se outros servicos enviarem correio por este dominio, junte os termos include: neste mesmo registo.",
    dns_caveat_dmarc_add_after_spf_dkim:
      "Adicione isto por ultimo, depois de SPF e DKIM ficarem verificados. Publicar cedo demais pode enviar o seu proprio correio para spam.",
    ...
    spam_empty_failed:
      "Não foi possível esvaziar o spam. Uma nova tentativa daqui a pouco costuma resolver. Nada foi removido.",
    ...
    cannot_move_from_view: "Não é possível mover mensagens desta visualização.",
    ...
    failed_to_load_contacts: "Os contatos não foram carregados.",
    mass_email_limited:
      "Somente os {{count}} primeiros endereços foram adicionados.",
    ...
    scheduled_connected_account:
      "O envio agendado não está disponível para contas ligadas. Envia esta mensagem agora ou escolhe um endereço Aster.",
    scheduled_no_expiry:
      "As mensagens agendadas ainda não suportam expiração. Envia agora ou remove a expiração para agendar.",
    ...
    failed_to_snooze_emails:
      "Tente novamente.",
    failed_to_copy: "Tente novamente.",
    ...
    session_expired_login:
      "Sua sessão terminou. Entre novamente para continuar. Seus dados e rascunhos estão salvos no servidor.",
    ...
    no_valid_contacts_csv:
      "Nenhum contato legível foi encontrado neste CSV. Confira os cabeçalhos das colunas e tente novamente.",
    ...
    rotation_failed:
      "A atualização das chaves não terminou. Confira sua senha e tente novamente. Suas chaves antigas continuam funcionando e seus dados estão seguros.",
    delete_account_error:
      "Não foi possível excluir sua conta agora. Tente novamente em instantes. Se o problema continuar, entre em contato com hello@astermail.org.",
    ...
    welcome_description:
      "Este tour leva cerca de um minuto. Ele cobre quatro coisas que facilitam o primeiro dia.",
    organize_with_folders: "Organize com pastas",
    organize_folders_description:
      "Arraste uma mensagem para uma pasta para arquivá-la, ou selecione várias e mova-as juntas. Para criar uma pasta, clique no + ao lado de Pastas.",
    customize_settings_description:
      "Em Configurações você adiciona um alias, conecta um domínio próprio e ativa a autenticação de dois fatores.",
    youre_ready: "Tudo pronto",
    youre_ready_description:
      "Seu e-mail é criptografado de ponta a ponta e só você tem as chaves. Pressione ? a qualquer momento para ver todos os atalhos de teclado.",
    ...
    encryption_available: "Criptografia disponível",
    encryption_available_desc:
      "Este destinatário publica uma chave de criptografia utilizável. Clique no cadeado para criptografar esta mensagem de ponta a ponta.",
    click_to_encrypt: "Clique para criptografar esta mensagem de ponta a ponta",
    click_to_disable_encryption:
      "Criptografado - clique para desativar nesta mensagem",
    encryption_status_unknown: "Estado da encriptação indisponível",
    encryption_status_unknown_desc:
      "Não foi possível verificar as chaves deste destinatário. Outra tentativa vai indicar se esta mensagem pode ser encriptada de ponta a ponta.",
    ...
    duress_confirm_title: "Tem certeza?",
    duress_confirm_subtitle: "Apagar dados locais",
    duress_confirm_desc:
      "Isso apaga deste dispositivo todos os e-mails, chaves e dados de sessão salvos localmente e encerra sua sessão.",
    duress_confirm_detail:
      "Sua conta e seus dados criptografados continuam seguros nos servidores da Aster. Você pode entrar novamente quando quiser.",
    ...
    payment_past_due_message_days:
      "Seu último pagamento não foi processado. Atualize sua forma de pagamento em até {{days}} dias para manter seu plano.",
    payment_past_due_action: "Atualizar pagamento",
    ...
    unexpected_error_refresh:
      "Algo correu mal, por isso atualize a página para continuar.",
    ...
    conversations_moved_to_inbox_bulk:
      "{{count}} conversa(s) movida(s) para a caixa de entrada",
    conversations_marked_as_not_spam_bulk:
      "{{count}} conversa(s) marcada(s) como não spam",
    bulk_action_partially_applied:
      "{{count}} de {{total}} conversas atualizadas. O restante não foi alterado.",
    bulk_action_truncated:
      "Esta execução abrangeu as primeiras {{count}} mensagens. Execute novamente para abranger o restante.",
    bulk_action_continues_in_background:
      "As mensagens restantes ainda estão sendo atualizadas em segundo plano.",
    ...
    create_contact_group: "Criar grupo",
    rename_contact_group: "Renomear grupo",
    delete_contact_group: "Excluir grupo",
    contact_group_name: "Nome do grupo",
    enter_contact_group_name: "Digite um nome de grupo",
    manage_contact_groups: "Gerenciar grupos",
    no_contact_groups_yet: "Ainda não há grupos",
    add_contacts_to_group_hint:
      "Crie um grupo para organizar as pessoas para quem você mais escreve.",
    ...
    contact_group_limit_reached: "Você pode criar até {{ max }} grupos.",
    delete_contact_group_confirm:
      "Excluir este grupo? Seus contatos permanecem no catálogo de endereços.",
    failed_to_fetch_contact_groups:
      "Os grupos não foram carregados. Tente novamente.",
    failed_to_save_contact_group: "O grupo não foi salvo. Tente novamente.",
    failed_to_create_contact_group: "O grupo não foi criado. Tente novamente.",
    failed_to_delete_contact_group:
      "O grupo não foi excluído. Tente novamente.",
    failed_to_update_contact_groups:
      "A participação no grupo não foi atualizada.",
    contacts_added_to_group: "{{count}} contatos adicionados ao grupo",
    contacts_added_to_group_one: "{{count}} contato adicionado ao grupo",
    contacts_added_to_group_other: "{{count}} contatos adicionados ao grupo",
    contacts_removed_from_group: "{{count}} contatos removidos do grupo",
    contacts_removed_from_group_one: "{{count}} contato removido do grupo",
    contacts_removed_from_group_other: "{{count}} contatos removidos do grupo",
    name_section: "Nome",
    new_email_body: "Você tem um novo e-mail",
    new_emails_body_one: "Você tem {{count}} novo e-mail",
    new_emails_body: "Você tem {{count}} novos e-mails",
    new_emails_body_other: "Você tem {{count}} novos e-mails",
    ...
    recovery_reminder_title: "Adiciona uma forma de voltar à tua conta",
    ...
    signed_out_inactivity:
      "Para proteger sua conta, você foi desconectado após um período de inatividade. Entre novamente para continuar.",
    ...
    user_agent_label: "Agente do usuário",
    ...
    removing: "Removendo...",
    upgrade_tooltip:
      "Tenha mais armazenamento, aliases e domínios personalizados",
    dns_host_leave_blank: "Deixe em branco",
    dns_host_provider_hint:
      "A {{provider}} usa este formato no campo do host. Copie exatamente como está.",
    purchase_congrats_title: "Parabéns",
    recipient_key_outdated: "A chave do destinatário está desatualizada",
    ...
    too_many_attachments:
      "Um e-mail pode levar {{count}} anexos. Envie o restante em outro e-mail.",
    more_folders_one: "mais {{count}} pasta",
    more_folders_other: "mais {{count}} pastas",
    more_labels_one: "mais {{count}} marcador",
    more_labels_other: "mais {{count}} marcadores",
    more_aliases_one: "mais {{count}} alias",
    more_aliases_other: "mais {{count}} aliases",
    in_x_minutes_one: "Em {{count}} minuto",
    in_x_minutes_other: "Em {{count}} minutos",
    minutes_remaining_one: "Falta {{count}} minuto",
    minutes_remaining_other: "Faltam {{count}} minutos",
    hours_remaining_one: "Falta {{count}} hora",
    hours_remaining_other: "Faltam {{count}} horas",
    days_remaining_one: "Falta {{count}} dia",
    days_remaining_other: "Faltam {{count}} dias",
    weeks_remaining_one: "Falta {{count}} semana",
    weeks_remaining_other: "Faltam {{count}} semanas",
    minutes_ago_long_one: "há {{count}} minuto",
    minutes_ago_long_other: "há {{count}} minutos",
    hours_ago_long_one: "há {{count}} hora",
    hours_ago_long_other: "há {{count}} horas",
    days_ago_long_one: "há {{count}} dia",
    days_ago_long_other: "há {{count}} dias",
    weeks_ago_long_one: "há {{count}} semana",
    weeks_ago_long_other: "há {{count}} semanas",
    months_ago_long_one: "há {{count}} mês",
    months_ago_long_other: "há {{count}} meses",
    emails_marked_as_read_one: "{{count}} e-mail marcado como lido",
    emails_marked_as_read_other: "{{count}} e-mails marcados como lidos",
    emails_archived_one: "{{count}} e-mail arquivado",
    emails_archived_other: "{{count}} e-mails arquivados",
    emails_moved_to_trash_one: "{{count}} e-mail movido para o lixo",
    emails_moved_to_trash_other: "{{count}} e-mails movidos para o lixo",
    emails_starred_one: "{{count}} e-mail destacado",
    emails_starred_other: "{{count}} e-mails destacados",
    emails_unstarred_one: "{{count}} e-mail sem destaque",
    emails_unstarred_other: "{{count}} e-mails sem destaque",
    emails_permanently_deleted_one: "{{count}} e-mail excluído permanentemente",
    emails_permanently_deleted_other:
      "{{count}} e-mails excluídos permanentemente",
    emails_snoozed_until_one: "{{count}} e-mail adiado até {{time}}",
    emails_snoozed_until_other: "{{count}} e-mails adiados até {{time}}",
    emails_added_to_folder_one: "{{count}} e-mail adicionado a {{folder}}",
    emails_added_to_folder_other: "{{count}} e-mails adicionados a {{folder}}",
    emails_will_reappear_one: "{{count}} e-mail reaparecerá {{time}}",
    emails_will_reappear_other: "{{count}} e-mails reaparecerão {{time}}",
    drafts_deleted_one: "{{count}} rascunho excluído permanentemente",
    drafts_deleted_other: "{{count}} rascunhos excluídos permanentemente",
    spam_emails_moved_to_trash_one:
      "{{count}} e-mail de spam movido para o lixo",
    spam_emails_moved_to_trash_other:
      "{{count}} e-mails de spam movidos para o lixo",
    spam_emails_permanently_deleted_one:
      "{{count}} e-mail de spam excluído permanentemente",
    spam_emails_permanently_deleted_other:
      "{{count}} e-mails de spam excluídos permanentemente",
    newsletters_archived_one: "{{count}} newsletter arquivada",
    newsletters_archived_other: "{{count}} newsletters arquivadas",
    conversations_marked_as_spam_bulk_one:
      "{{count}} conversa marcada como spam",
    conversations_restored_bulk_one: "{{count}} conversa restaurada",
    conversations_snoozed_bulk_one: "{{count}} conversa adiada",
    conversations_marked_as_read_bulk_one:
      "{{count}} conversa marcada como lida",
    conversations_marked_as_unread_bulk_one:
      "{{count}} conversa marcada como não lida",
    conversations_starred_bulk_one: "{{count}} conversa destacada",
    conversations_unstarred_bulk_one: "{{count}} conversa sem destaque",
    ...
    conversations_marked_as_not_spam_bulk_one:
      "{{count}} conversa marcada como não spam",
    conversations_removed_from_folder_one:
      "{{count}} conversa removida de {{folder}}",
    conversations_moved_to_folder_one:
      "{{count}} conversa movida para {{folder}}",
    conversations_removed_label_one:
      "{{count}} conversa: marcador {{label}} removido",
    conversations_added_label_one:
      "{{count}} conversa: marcador {{label}} adicionado",
    conversations_marked_as_spam_bulk_other:
      "{{count}} conversas marcadas como spam",
    conversations_restored_bulk_other: "{{count}} conversas restauradas",
    conversations_snoozed_bulk_other: "{{count}} conversas adiadas",
    ...
    conversations_starred_bulk_other: "{{count}} conversas destacadas",
    conversations_unstarred_bulk_other: "{{count}} conversas sem destaque",
    ...
    conversations_marked_as_not_spam_bulk_other:
      "{{count}} conversas marcadas como não spam",
    conversations_removed_from_folder_other:
      "{{count}} conversas removidas de {{folder}}",
    conversations_moved_to_folder_other:
      "{{count}} conversas movidas para {{folder}}",
    conversations_removed_label_other:
      "{{count}} conversas: marcador {{label}} removido",
    conversations_added_label_other:
      "{{count}} conversas: marcador {{label}} adicionado",
    contacts_deleted_one: "{{count}} contato excluído",
    contacts_deleted_other: "{{count}} contatos excluídos",
    contacts_starred_one: "{{count}} contato destacado",
    contacts_starred_other: "{{count}} contatos destacados",
    contacts_unstarred_one: "{{count}} contato sem destaque",
    contacts_unstarred_other: "{{count}} contatos sem destaque",
    taps_to_developer_mode_one: "{{count}} toque para o modo de desenvolvedor",
    taps_to_developer_mode_other:
      "{{count}} toques para o modo de desenvolvedor",
    delete_contacts_confirmation_one:
      "Tem certeza de que quer excluir {{count}} contato? Esta ação não pode ser desfeita.",
    delete_contacts_confirmation_other:
      "Tem certeza de que quer excluir {{count}} contatos? Esta ação não pode ser desfeita.",
    sender_count_one: "{{count}} remetente",
    ...
    emails_from_senders_deleted_one: "{{count}} e-mail de {{senders}} excluído",
    emails_from_senders_deleted_other:
      "{{count}} e-mails de {{senders}} excluídos",
    ...
    contact_count: "{{count}} contatos",
    tray_show: "Mostrar o Aster Mail",
    tray_quit: "Sair",
    tray_troubleshooting: "Se a janela ficar em branco",
    tray_compat_on: "Reiniciar em modo de compatibilidade",
    tray_compat_off: "Reiniciar com aceleração de hardware",
    tray_display_reset: "Redefinir o cache de exibição e reiniciar",
    push_new_message: "Você tem uma nova mensagem",
    too_many_recipients_in_field:
      "Cada campo Para, Cc e Cco comporta no máximo {{max}} endereços. Mova alguns para uma segunda mensagem para enviar esta.",
  ...
  settings: {
    ...
    plan_feat_advanced_aliases: "Aliases avançados",
    ...
    plan_feat_imap_smtp: "Use seu app de e-mail favorito (via Aster Bridge)",
    ...
    duress_pin_description:
      "Um PIN oculto que apaga os dados locais em vez de desbloquear",
    duress_pin_setup: "Configurar",
    duress_pin_change: "Alterar PIN de coação",
    duress_pin_remove: "Remover",
    duress_pin_verify_identity: "Verifique sua identidade",
    duress_pin_verify_identity_desc:
      "Digite a senha da sua conta para configurar um PIN de coação.",
    duress_pin_verify_identity_totp_desc:
      "Digite a senha da sua conta e o código de autenticação em duas etapas.",
    duress_pin_password_label: "Senha da conta",
    duress_pin_totp_label: "Código de autenticação em duas etapas",
    duress_pin_set: "Definir PIN de coação",
    duress_pin_confirm: "Confirme o PIN de coação",
    duress_pin_enabled_toast: "PIN de coação definido",
    duress_pin_disabled_toast: "PIN de coação removido",
    duress_pin_cleared_length_change:
      "O PIN de coação foi removido porque o formato de bloqueio mudou. Configure-o novamente.",
    duress_pin_changed_toast: "PIN de coação atualizado",
    duress_pin_matches_regular:
      "O PIN de coação não pode ser igual ao seu PIN normal",
    duress_pin_enter_to_remove: "Digite seu PIN de coação para removê-lo",
    duress_pin_invalid_credentials:
      "Senha ou código de autenticação incorretos",
    duress_pin_how_it_works: "Como funciona seu PIN de coação",
    duress_pin_how_it_works_body:
      "Se você digitar este PIN na tela de bloqueio, o Aster Mail apaga na hora todos os dados guardados neste dispositivo e encerra sua sessão. Sua conta não é excluída: seus e-mails e dados criptografados continuam nos servidores da Aster e voltam quando você entra de novo.",
    duress_pin_confirm_setup: "Configurar PIN de coação",
    ...
    muted_categories_empty:
      "Ativa as categorias da caixa de entrada para escolheres quais silenciar.",
    ...
    custom_category_locked_badge: "Bloqueado",
    ...
    template_name_required: "Digite um nome para este modelo.",
    template_content_required: "Adicione conteúdo a este modelo.",
    ...
    category_icon: "Ícone",
    category_color: "Cor",
    category_color_accent: "Destaque",
    category_color_blue: "Azul",
    category_color_green: "Verde",
    category_color_amber: "Âmbar",
    category_color_violet: "Violeta",
    category_color_teal: "Verde-azulado",
    category_color_cyan: "Ciano",
    category_color_rose: "Rosa",
    category_color_pink: "Fúcsia",
    category_color_slate: "Ardósia",
    category_match_domains: "Corresponder domínios do remetente",
    category_match_domains_placeholder: "example.com, news.example.org",
    category_match_domains_help:
      "Lista de domínios do remetente separados por vírgula. E-mails desses domínios vão para esta categoria.",
    category_match_keywords: "Corresponder palavras-chave do assunto",
    category_match_keywords_placeholder: "newsletter, resumo",
    category_match_keywords_help:
      "Palavras separadas por vírgula. Se alguma aparecer no assunto, o e-mail vai para esta categoria.",
    ...
    family_invite_wrong_recipient:
      "Este convite foi enviado para outro endereço. Peça a quem enviou para compartilhar o link diretamente.",
    ...
    family_feat_members_2: "2 membros, contas separadas",
    ...
    family_feat_pool_1tb: "1 TB partilhado, atribuído em privado a cada membro",
    family_feat_pool_3tb:
      "3 TB partilhados, atribuídos em privado a cada membro",
    family_feat_invite: "Convite por link ou e-mail",
    family_feat_domain_sharing: "Partilha de domínios entre membros",
    family_feat_security_policies: "Políticas de segurança (2FA obrigatória)",
    family_feat_admin_transfer: "Transferência da função de administrador",
    family_feat_org_groups: "Grupos e listas de distribuição",
    family_feat_activity_log: "Registo de atividade e auditoria",
    family_feat_org_filters: "Filtros de e-mail para toda a organização",
    family_feat_retention: "Políticas de retenção de dados",
    family_feat_storage_controls: "Controlos de armazenamento por membro",
    ...
    alias_orphaned_hint:
      "O rótulo foi criptografado com sua senha anterior, então este dispositivo não consegue lê-lo. Se você lembrar o endereço, pode restaurar o rótulo. As mensagens enviadas para este endereço continuam chegando, e você vê o endereço completo no cabeçalho de qualquer mensagem entregue.",
    alias_restore_action: "Restaurar este alias",
    alias_restore_prompt:
      "Digite o endereço. O Aster compara com este alias antes de restaurar o rótulo.",
    alias_restore_placeholder: "Endereço",
    ...
    alias_restore_failed: "Tente novamente.",
    ...
    failed_restore_alias: "Tente novamente.",
    ...
    alias_stats_replied: "{{ count }} respondido(s)",
    alias_stats_created: "Criado em {{ date }}",
    ...
    alias_display_name_label: "Nome a apresentar",
    alias_note_label: "Nota",
    alias_details_description: "Dê um nome a este alias e anote onde o usa.",
    alias_display_name_desc:
      "Mostrado como nome do remetente quando escreve a partir deste alias.",
    alias_note_desc: "Um lembrete privado sobre a utilidade deste alias.",
    alias_websites_desc: "Sites onde se registou com este alias.",
    alias_stats_description: "Quanto correio este alias já tratou.",
    alias_usage_used_of: "{{ used }} de {{ max }} aliases usados",
    alias_usage_unlock: "Obter ilimitado",
    alias_usage_nudge:
      "Os planos pagos incluem aliases ilimitados, domínios próprios, regras de alias e fixação de remetentes.",
    alias_sender_pin_mode_label: "Modo",
    alias_feature_locked_stats:
      "Melhore o seu plano para ver a atividade deste alias.",
    alias_feature_locked_delivery_log:
      "Melhore o seu plano para ver o que foi bloqueado.",
    alias_paid_badge: "Pago",
    ...
    alias_delivery_folder: "Entregar em",
    ...
    alias_delivery_label_desc:
      "Aplicar uma etiqueta a cada mensagem que chega a este alias.",
    ...
    alias_delivery_rule_note:
      'A regra "{{ rule }}" já move o correio deste alias para {{ target }}.',
    alias_delivery_rule_conflict:
      'A regra "{{ rule }}" move o correio deste alias para {{ rule_target }}, por isso não chegará a {{ target }}.',
    alias_delivery_label_rule_note:
      'A regra "{{ rule }}" já etiqueta o correio deste alias com {{ target }}.',
    alias_delivery_label_rule_conflict:
      'A regra "{{ rule }}" etiqueta o correio deste alias com {{ rule_target }}, não com {{ target }}.',
    ...
    alias_directory_separator_hint:
      "Um ponto, uma barra, um sinal de mais ou uma cerquilha funcionam antes do nome do diretório.",
    alias_bulk_enabled: "Os aliases selecionados estão ativados.",
    ...
    alias_domain_requires_plan:
      "Este domínio está disponível no plano {{plan}} e superiores.",
    ...
    alias_export_description:
      "Escolha o que incluir. O ficheiro é criado no seu navegador e nunca é enviado para os nossos servidores.",
    alias_export_format_csv: "CSV (planilha)",
    alias_export_format_json: "JSON",
    alias_export_confirm_description: "Verifique o que vai transferir.",
    alias_export_source_aliases: "Aliases",
    alias_export_source_domain_addresses: "Endereços de domínio próprio",
    ...
    alias_export_column_address: "Endereço",
    alias_export_column_display_name: "Nome a apresentar",
    alias_export_column_note: "Nota",
    alias_export_column_websites: "Sites",
    alias_export_column_enabled: "Ativo",
    alias_export_column_created_at: "Criado",
    alias_export_column_directory: "Diretório",
    alias_export_column_domain: "Domínio",
    alias_export_column_auto_create: "Criação automática",
    alias_export_column_color: "Cor",
    alias_export_column_expires_at: "Expira",
    alias_export_warning_title: "Este ficheiro não está cifrado",
    alias_export_warning_body:
      "Qualquer pessoa que o abra pode ler todos os aliases, notas e sites que contém. Guarde-o no seu gestor de palavras-passe ou numa unidade cifrada.",
    alias_export_summary: "{{count}} entradas em {{files}}.",
    alias_export_download: "Transferir",
    ...
    alias_export_undecryptable:
      "{{count}} aliases não puderam ser decifrados e não foram incluídos.",
    alias_export_undecryptable_ghost:
      "{{count}} aliases fantasma não puderam ser decifrados e não foram incluídos.",
    ...
    fam_org_sec_session_count: "{{count}} sessões ativas",
    ...
    fam_org_stat_seats_available: "{{count}} vagas disponíveis",
    ...
    color_theme_description:
      "Escolha uma paleta de cores predefinida para o app",
    ...
    custom_theme_inactive:
      "Escolha uma cor para aplicar seu tema personalizado",
    ...
    email_font_choice_title: "Fonte dos e-mails",
    email_font_choice_description: "Fonte usada ao ler e-mails",
    email_font_option_match_app: "Igual à do app",
    ...
    time_zone_show_all: "Mostrar todos os fusos horários",
    ...
    updates_description:
      "Verifique atualizações do app e configure a atualização automática",
    updates_check_now: "Verificar atualizações",
    updates_checking: "Verificando atualizações...",
    updates_up_to_date: "Você está na versão mais recente",
    updates_check_failed:
      "Não foi possível procurar atualizações. Tente novamente em instantes.",
    updates_install_failed:
      "A atualização não foi instalada. Tente novamente ou baixe a versão mais recente em astermail.org/download.",
    updates_available: "Atualização disponível: {{version}}",
    updates_current_version: "Versão atual: {{version}}",
    updates_install_and_restart: "Instalar e reiniciar",
    updates_installing: "Baixando a atualização... {{percent}}%",
    updates_downloading: "Baixando atualizacao...",
    updates_last_checked: "Última verificação: {{when}}",
    updates_never_checked: "Nunca verificado",
    updates_auto_label: "Verificar atualizações automaticamente",
    updates_auto_description:
      "O Aster Mail procura novas versões e avisa quando uma está pronta para instalar.",
    updates_release_notes: "Notas da versão",
    updates_banner_title: "O Aster Mail {{version}} está disponível",
    updates_banner_action: "Instalar agora",
    updates_unsupported:
      "As atualizações são gerenciadas pelo seu sistema operacional ou navegador",
    updates_dismiss: "Depois",
    billing: "Cobrança",
    ...
    forward_secrecy_disable_message:
      "As novas mensagens deixam de usar chaves rotativas, por isso uma chave divulgada mais tarde pode abrir mais do seu correio. Pode ativar de novo quando quiser.",
    login_alerts_disable_title: "Desativar os alertas de início de sessão?",
    login_alerts_disable_message:
      "Deixa de receber um email quando um novo dispositivo inicia sessão na sua conta.",
    ...
    forward_secrecy_setup_failed:
      "Não foi possível ativar o sigilo encaminhado. Verifique a ligação e tente novamente.",
    ...
    password_change_client_upgrade_required:
      "Esta versão do Aster Mail não consegue alterar sua senha. Atualize para a versão mais recente e tente de novo.",
    password_change_reencryption_incomplete:
      "Alguns dos seus aliases não terminaram de ser criptografados novamente, por isso sua senha não foi alterada. Tente de novo e entre em contato com o suporte se isso continuar acontecendo.",
    password_change_fingerprint_mismatch:
      "Esta sessão começou em outra rede ou outro navegador, por isso o Aster Mail não alterou sua senha. Para alterá-la, saia da conta, entre novamente e tente de novo.",
    ...
    failed_load_security_status:
      "As tuas definições de segurança não carregaram. Tenta novamente.",
    ...
    two_step_verification_description:
      "Recomendamos exigir um código de verificação além da sua senha.",
    authenticator_app: "Autenticador 2FA",
    ...
    blocked_by_os: "Ative nos ajustes de notificações do sistema",
    open_system_notification_settings: "Abrir Ajustes",
    sound_new_notifications: "Reproduzir som para novas notificações",
    badge_count_setting: "Selo de não lidos",
    badge_count_setting_description:
      "Mostrar o número de não lidos no ícone da app",
    push: "Notificações push",
    push_subscribe_failed:
      "As notificações estão ativadas, mas não foi possível configurar a entrega em segundo plano. Você recebe notificações apenas enquanto o Aster Mail está aberto.",
    ...
    toast_duration: "Duração da notificação",
    toast_duration_description: "Quanto tempo as notificações ficam na tela",
    toast_duration_default: "Padrão (2 s)",
    toast_duration_long: "Longa (5 s)",
    toast_duration_longer: "Mais longa (10 s)",
    toast_duration_longest: "Máxima (20 s)",
    send_test_notification: "Enviar notificação de teste",
    test_notification_blocked:
      "Ative as notificações no computador para testá-las.",
    ...
    emails_per_page_description:
      "Número de e-mails mostrados por página na Caixa de entrada, Arquivo e outras pastas",
    ...
    reactions_enabled_description:
      "Permite reagir a mensagens com emojis e ver as reações de outras pessoas",
    ...
    translate_incoming_description:
      "Traduza mensagens escritas noutros idiomas no seu dispositivo.",
    translate_incoming_info:
      "A tradução é feita inteiramente no seu dispositivo com modelos auto-hospedados. Nada do que lê é alguma vez enviado para um serviço de tradução.",
    translate_off: "Desligado",
    translate_ask: "Perguntar sempre",
    translate_always: "Traduzir sempre",
    translate_my_languages: "Idiomas que lê",
    translate_my_languages_description:
      "Idiomas que já lê. No modo «Perguntar sempre», o Aster não se oferece para os traduzir. Para manter um idioma intacto também no modo «Traduzir sempre», adicione-o a «Nunca traduzir».",
    ...
    translate_confirm_description:
      "O Aster traduz o correio no seu dispositivo, por isso nada do que lê é enviado para um serviço de tradução. Da primeira vez que traduz a partir de um idioma, o Aster transfere um pacote de idioma de 20 a 55 MB e guarda-o neste dispositivo. Pode remover os pacotes quando quiser.",
    translate_confirm_enable: "Ativar",
    translation_packs: "Pacotes de idioma transferidos",
    translation_packs_description:
      "Os pacotes de idioma são guardados neste dispositivo. Remova um pacote para libertar espaço. O Aster transfere-o novamente da próxima vez que traduzir esse idioma.",
    ...
    translation_packs_unavailable:
      "Este navegador não consegue guardar pacotes de idioma, por isso o Aster transfere-os sempre que traduz.",
    ...
    close_to_tray: "Continuar em execução ao fechar a janela",
    close_to_tray_description:
      "O Aster Mail fica na área de notificação para continuar a receber mensagens novas. Desative esta opção para sair ao fechar a janela.",
    ...
    compose_default_font_color: "Cor do texto predefinida",
    compose_default_font_color_description:
      "As novas mensagens começam com esta cor. Escolha a predefinição do tema para seguir o tema da aplicação.",
    ...
    billing_desc_crypto_payment:
      "{{plan}}, período de {{months}} meses, pago com {{currency}} na {{chain}}",
    billing_desc_crypto_credit:
      "{{plan}}, período de {{months}} meses, creditado em {{currency}} na {{chain}}",
    billing_desc_crypto_prepaid:
      "{{plan}}, período de {{months}} meses, pré-pago com cripto",
    credit_desc_applied_invoice: "Aplicado a uma fatura",
    credit_desc_applied_storage: "Aplicado a um complemento de armazenamento",
    credit_desc_applied_subscription_checkout:
      "Aplicado à compra de uma assinatura",
    credit_desc_applied_subscription_payment:
      "Aplicado ao pagamento de uma assinatura",
    credit_desc_returned_checkout_not_started:
      "Devolvido porque o pagamento não pôde ser iniciado",
    credit_desc_returned_checkout_incomplete:
      "Devolvido porque o pagamento não foi concluído",
    credit_desc_returned_payment_failed:
      "Devolvido porque o pagamento adiado falhou",
    credit_desc_reversed_invoice_voided:
      "Revertido porque a fatura foi anulada",
    credit_desc_reversed_refunded:
      "Revertido porque a compra foi reembolsada ou contestada",
    credit_desc_referral_commission:
      "Comissão de indicação pela assinatura de um amigo",
    credit_desc_reversal_crypto_overpayment:
      "Reversão de um crédito por pagamento excedente em cripto",
    credit_desc_reversal_prepaid_residual:
      "Reversão de um crédito por mudança de plano pré-pago",
    credit_desc_unused_prepaid:
      "Tempo pré-pago não utilizado do seu plano anterior",
    credit_desc_purchased: "Compra de {{amount}} em créditos",
    credit_desc_referral_reversed:
      "Comissão de indicação revertida: {{reason}}",
    credit_desc_install_bonus: "Bônus de instalação do app para computador",
    ...
    failed_delete_account:
      "Não foi possível excluir sua conta. Confira sua senha e tente novamente. Sua conta permanece inalterada.",
    ...
    tls_reporting: "Relatorios TLS",
    tlsrpt_record: "Registo TLS-RPT",
    tlsrpt_description:
      "Opcional mas recomendado. Os servidores recetores enviam-lhe um resumo diario quando a entrega cifrada ao seu dominio falha, para detetar problemas antes dos seus utilizadores.",
    dns_instruction_set_tlsrpt_host: "Defina o host como _smtp._tls",
    dns_instruction_set_tlsrpt_value:
      "Cole o valor TLS-RPT exatamente como aparece",
    ...
    onboarding_compose_title: "Escreva sua primeira mensagem",
    onboarding_compose_description:
      "Pressione C na sua caixa de entrada para começar a escrever. O Aster criptografa a mensagem no seu dispositivo antes do envio.",
    onboarding_search_title: "Encontre tudo, com privacidade",
    onboarding_search_description:
      "Pressione / para ir direto à busca. Refine os resultados por remetente, data ou anexos sem tirar as mãos do teclado.",
    delete_imported_emails_confirm: "Excluir e-mails importados?",
    import_delete_warning:
      "Isto elimina definitivamente as mensagens trazidas por esta importação. Não pode anular esta ação.",
    ...
    view_guide: "Ver guia",
    two_factor_guide_title: "Como funciona a autenticação de dois fatores",
    two_factor_guide_step_app:
      "Abra o app autenticador de sua preferência no seu telefone.",
    ...
    keyserver_status_awaiting: "Aguardando confirmação",
    keyserver_status_failed: "Falhou",
    keyserver_awaiting_hint:
      "A sua chave foi enviada. Verifique a sua caixa de entrada para o e-mail de confirmação de keys.openpgp.org e clique no link para concluir a publicação.",
    keyserver_failed_hint:
      "O servidor de chaves rejeitou a sua chave. Tente publicar novamente.",
    ...
    connection_timeout_error:
      "Insira um tempo limite entre 5 e 120 segundos.",
    fill_server_first:
    ...
    password_min_8: "Use pelo menos 8 caracteres.",
    ...
    new_password_min_8: "Use pelo menos 8 caracteres.",
    ...
    type_delete_placeholder: "Digite {word} aqui",
    ...
    twin_address_dismiss: "Dispensar",
    ...
    alias_usage_remaining: "Restam {{count}} aliases no seu plano",
    alias_usage_remaining_one: "Resta {{count}} alias no seu plano",
    alias_usage_remaining_other: "Restam {{count}} aliases no seu plano",
    alias_cap_upsell_benefit:
      "O {{plan}} oferece {{aliases}} aliases por {{price}} por mês.",
    alias_cap_upsell_benefit_unlimited:
      "O {{plan}} oferece aliases ilimitados por {{price}} por mês.",
    alias_cap_upsell_alternative:
      "O {{plan}} remove o limite de aliases se você precisar de mais.",
    alias_cap_upsell_cta: "Mudar para {{plan}}",
    special_offer_button: "Oferta especial",
    special_offer_title: "E-mail privado pela metade do preço",
    ...
    bimi_logo_requirements: "Arquivo SVG, quadrado, até 32 KB.",
    ...
    bimi_preview_title: "Pré-visualização",
    ...
    bimi_state_draft: "Não publicado",
    bimi_state_external: "Gerenciado em outro lugar",
    bimi_state_live: "Ativo",
    bimi_state_pending: "Aguardando DNS",
    bimi_step_logo: "Logotipo",
    bimi_step_of: "Etapa {current} de {total}",
    ...
    incoming_port_error:
      "Insira um número de porta entre 1 e 65535.",
    ...
    smtp_private_address_error:
      "Isto precisa ser um servidor de e-mail público, não um endereço local ou privado. O nome de host público fornecido pelo seu provedor vai funcionar.",
    smtp_port_error: "Insira um número de porta entre 1 e 65535.",
    ...
    unreadable_entry_hint:
      "Este dispositivo não consegue ler esta entrada. Ela continua ativa até você excluí-la.",
    unreadable_entries_notice:
      "Algumas entradas não podem ser lidas neste dispositivo, por isso não são mostradas aqui.",
    external_accounts_limit_reached:
      "Você pode conectar até 5 contas. Para adicionar outra, remova uma primeiro.",
    ...
    vacation_reply_delete_title: "Excluir a resposta de férias?",
    vacation_reply_delete_message:
      "A resposta de férias e a programação dela são removidas.",
    delete_forwarding_rule_title: "Excluir a regra de encaminhamento?",
    delete_forwarding_rule_message:
      "As mensagens que correspondem a esta regra deixam de ser encaminhadas.",
    ...
    signature_image_failed:
      "Não foi possível adicionar essa imagem. Tente outro arquivo.",
    ...
    plan_top_tier_note:
      "{{plan}} inclui o maior armazenamento de todos os planos. Se precisar de mais espaço, pode adicionar armazenamento extra.",
    plan_add_storage_link: "Adicionar mais armazenamento",
    plan_current_title: "Você está no {{plan}}",
    plan_current_note:
      "Você usou {{percent}}% do seu armazenamento, então ainda tem espaço de sobra.",
    plan_storage_tight_note:
      "Você usou {{percent}}% do seu armazenamento. {{plan}} oferece mais espaço.",
    per_year_short: "/ano",
    ...
    free_upgrade_title: "Faça mais com o {{plan}}",
    ...
    storage_overview_description:
      "Veja o que está usando seu espaço e remova o que não precisa.",
    storage_promo_title: "Economize em armazenamento extra",
    storage_promo_body:
      "Receba {{percent}}% de desconto nos primeiros {{months}} meses de armazenamento adicional.",
    storage_promo_body_singular:
      "Receba {{percent}}% de desconto no primeiro mês de armazenamento adicional.",
    storage_promo_note:
      "O desconto vale apenas para o seu primeiro complemento de armazenamento.",
    storage_select_option_first:
      "Para comprar mais armazenamento, selecione primeiro uma opção.",
    storage_promo_cta: "Ver complementos",
    storage_used_of_total: "{{used}} de {{total}} em uso",
    storage_free_space:
      "{{size}} livres, {{percent}} do seu armazenamento em uso",
    storage_breakdown_title: "O que está usando seu armazenamento",
    ...
    storage_included_with_plan: "Incluído no seu plano",
    storage_from_addons: "De complementos",
    storage_family_allocation: "Alocação da família",
    storage_total_capacity: "Capacidade total",
    storage_available: "Disponível",
    storage_cleanup_done: "Espaço liberado",
    storage_cleanup_failed: "Não foi possível liberar espaço. Tente novamente.",
    storage_cleanup_confirm:
      "Isso exclui permanentemente {{count}} itens e libera {{size}}. Não é possível desfazer.",
    ...
    plan_limit_reached:
      "Você atingiu o limite do seu plano atual. Faça upgrade do plano ou remova alguns itens para liberar espaço.",
    ...
    usage_linked_accounts: "Contas com sessão iniciada",
    upgrade_linked_accounts_note:
      "Todas as suas contas estão seguras. Este é o número de contas que este dispositivo mantém com sessão iniciada ao mesmo tempo.",
    upgrade_linked_accounts_link: "Saiba como funcionam várias contas",
    ...
    checkout_method_description: "Escolha como quer pagar.",
    checkout_method_card_note: "Renova automaticamente até você cancelar.",
    ...
    plan_everything_in: "Tudo do {{plan}}, mais",
    compare_features_show: "Comparar recursos por plano",
    compare_features_hide: "Ocultar comparação",
    ...
    cancel_impact_description:
      "Seu plano fica ativo até {{date}}. Depois disso:",
    cancel_impact_description_nodate:
      "Quando o período de cobrança atual terminar:",
    cancel_impact_loading: "Verificando o que muda na sua conta...",
    cancel_impact_unavailable:
      "Não foi possível carregar os detalhes agora. Você ainda pode continuar.",
    cancel_impact_storage: "O armazenamento cai de {{current}} para {{after}}.",
    ...
    cancel_final_description_nodate:
      "Seu plano {{plan}} será cancelado no fim do período de cobrança atual. Você mantém acesso total até lá.",
    cancel_final_confirm: "Cancelar meu plano",
    ...
    top_up_credits: "Recarregar",
    checkout_abandon_confirm: "Cancelar o pagamento",
    checkout_abandon_keep: "Continuar pagando",
    checkout_abandon_message:
      "Sua fatura é cancelada e nada é cobrado. Você pode começar de novo quando quiser.",
    ...
    checkout_leave_warning:
      "Você tem um pagamento em andamento. Se sair agora, ele não é concluído.",
    checkout_pay_amount: "Pagar {{amount}}",
    checkout_review_title: "Revisar e pagar",
    checkout_what_you_get: "O que está incluído",
    credits_method_card_note:
      "Os créditos são adicionados assim que o pagamento é aprovado.",
    credits_method_crypto_note:
      "Pague uma vez em criptomoeda. Os créditos são adicionados depois que o pagamento é confirmado na blockchain.",
    offer_modal_action: "Aproveitar esta oferta",
    offer_modal_badge: "{{percent}}% de desconto",
    offer_modal_dismiss: "Agora não",
    offer_modal_fine_print:
      "O código {{code}} é aplicado no pagamento. Um uso por conta.",
    offer_modal_price_note: "O desconto é aplicado no pagamento.",
    offer_modal_subtitle: "Mude para o {{plan}} por um preço menor.",
    offer_modal_title: "Economize {{percent}}% no seu plano",
    offer_upgrade_description: "Escolha um plano para usar seu desconto.",
    offer_upgrade_title: "Sua oferta está esperando",
    plan_cat_advanced_aliases: "Aliases avançados",
    plan_cat_contacts: "Contatos",
    plan_cat_general: "Geral",
    plan_cat_mail: "E-mail",
    plan_cat_security: "Segurança",
    plan_cat_subscriptions: "Assinaturas",
    plan_cat_support: "Suporte",
    plan_cat_vanguard: "Vanguard",
    plan_f_alias_bulk: "Ações em massa nos aliases",
    plan_f_alias_csv: "Exportação de aliases em CSV",
    plan_f_alias_import: "Importação de aliases",
    plan_f_alias_no_cooldown: "Sem espera entre aliases",
    plan_f_alias_pin: "Aliases fixados",
    plan_f_alias_transfer: "Transferência de aliases",
    plan_f_allowlist: "Lista de remetentes permitidos",
    plan_f_biometric: "Desbloqueio por biometria",
    plan_f_blocked_senders: "Remetentes bloqueados",
    plan_f_contact_import: "Importação de contatos",
    plan_f_contact_sync: "Sincronização de contatos (CardDAV)",
    plan_f_contacts: "Contatos criptografados",
    plan_f_cross_platform: "Apps para web, computador, Android e iOS",
    plan_f_custom_categories: "Categorias personalizadas da caixa de entrada",
    plan_f_email_export: "Exportação de e-mails",
    ...
    plan_f_password_emails: "E-mails protegidos por senha",
    plan_f_pgp: "Criptografia PGP",
    plan_f_phishing: "Proteção contra phishing",
    plan_f_quick_alias_reply: "Resposta rápida a partir de um alias",
    plan_f_scheduled_send: "Envio programado",
    plan_f_snooze: "Adiar e-mails",
    plan_f_sub_categories: "Categorias de assinaturas",
    plan_f_sub_scanner: "Scanner de assinaturas",
    plan_f_vanguard_app_lock: "Bloqueio do app",
    ...
    plan_tip_alias_pin:
      "Mantenha no topo da lista os aliases que você mais usa.",
    plan_tip_alias_transfer:
      "Mova um alias para outra conta Aster que seja sua.",
    plan_tip_allowlist:
      "Deixe remetentes específicos passarem, mesmo quando um filtro os bloquearia.",
    ...
    plan_tip_folder_auto_clean:
      "Exclua tudo o que for mais antigo que o tempo definido, pasta por pasta.",
    plan_tip_sub_scanner:
      "Encontre todas as newsletters e serviços que você assinou e cancele tudo em um só lugar.",
    ...
    upgrade_external_accounts_note:
      "Faça upgrade para conectar mais contas externas.",
    usage_external_accounts: "Contas externas",
    top_up_credits_description:
      "Adicione créditos à sua conta. Os créditos são usados automaticamente nas renovações do plano.",
    credit_packages_loading: "Carregando pacotes...",
    credit_packages_failed: "Os pacotes de créditos não foram carregados.",
    credit_package_bonus: "+{{ bonus }} de bônus",
    credit_package_total: "{{ total }} no total",
    ...
    no_referrals_yet:
      "Nenhum convite ainda. Compartilhe seu link para começar.",
    referral_status_pending: "Pendente",
    referral_status_completed: "Concluída",
    referral_reward_info:
      "Você e seu amigo recebem {{ amount }} de armazenamento extra cada um. O armazenamento chega depois que ele usa a conta por alguns dias e continua na sua conta enquanto ele seguir usando o Aster Mail.",
    ...
    type_delete_to_confirm: "Digite {word} para confirmar",
    ...
    connected_accounts_app_password_needed:
      "Não foi possível entrar. Esta conta precisa de uma senha de app, e não da sua senha normal.",
    ...
    connected_accounts_reauth_needed:
      "É preciso autorizar de novo. Clique em Reconectar para resolver.",
    connected_accounts_reconnect: "Reconectar",
    ...
    cancel_password_error:
      "Não foi possível cancelar seu plano. Confira sua senha e tente novamente. Seu plano e faturamento permanecem inalterados.",
    credits_description:
    ...
    domain_purchase_one_year: "1 ano",
    domain_purchase_n_years: "{{count}} anos",
    domain_purchase_pay_with: "Pagar com",
    domain_purchase_pay_card: "Cartão",
    domain_purchase_pay_crypto: "Cripto",
    domain_purchase_buy: "Comprar por {{price}}",
    domain_purchase_error: "A compra falhou. Tente novamente.",
    domain_purchase_error_taken:
      "Esse domínio acabou de ser registrado. Escolha outro.",
    ...
    domain_purchase_error_slow_down:
      "Há pedidos de domínio demais no momento. Conclua ou aguarde os que estão em andamento.",
    domain_purchase_progress_title: "Configurando {{domain}}",
    domain_purchase_step_payment: "Pagamento recebido",
    domain_purchase_step_registering: "Registrando com a NameSilo",
    domain_purchase_step_dns: "Configurando DNS",
    domain_purchase_step_activating: "Ativando caixas de e-mail",
    domain_purchase_step_done: "Domínio ativo",
    ...
    domain_purchase_empty_subtitle:
      "Digite uma palavra, um nome ou um domínio completo. Verificamos todas as extensões que vendemos e mostramos as que estão livres.",
    domain_purchase_empty_included:
      "Todo domínio inclui privacidade WHOIS, DNS configurado para você e endereços ilimitados.",
    domain_purchase_terms_inline:
      "Os domínios são registrados pela NameSilo. Ao comprar, você aceita os {{aster}}, {{registrar}} e {{icann}}. Os registros são definitivos assim que o domínio é criado.",
    domain_purchase_empty_title: "Digite algo para começar",
    domain_purchase_search_failed: "A pesquisa falhou. Tente novamente.",
    domain_purchase_search_rate_limited:
      "Muitas pesquisas. Tente novamente em um minuto.",
    domain_purchase_retry: "Tentar novamente",
    domain_purchase_step_choose: "Escolha um nome",
    domain_purchase_step_checkout: "Pagamento",
    domain_purchase_step_activate: "Ativação",
    domain_purchase_intro_title: "Vamos encontrar o seu domínio de e-mail",
    ...
    domain_purchase_sort_by: "Ordenar por",
    domain_purchase_order_summary: "Resumo do pedido",
    domain_purchase_summary_whois: "Privacidade WHOIS",
    domain_purchase_summary_dns: "Configuração automática de DNS",
    domain_purchase_summary_included: "Incluído",
    domain_purchase_total_today: "Total hoje",
    domain_purchase_years_line: "Registro de {{count}} ano(s)",
    domain_purchase_secure_checkout: "Pagamento seguro com Stripe",
    domain_purchase_crypto_warning_title: "Adicione saldo em cripto primeiro",
    ...
    domain_purchase_sort_label: "Ordenar",
    domain_purchase_sort_relevance: "Relevância",
    domain_purchase_sort_price_low: "Preço: do menor para o maior",
    domain_purchase_sort_price_high: "Preço: do maior para o menor",
    domain_purchase_sort_az: "Nome: de A a Z",
    domain_purchase_sort_discount: "Maior desconto",
    domain_purchase_show_more: "Mostrar mais resultados",
    domain_purchase_results_count: "{{count}} resultados",
    ...
    domain_purchase_leave_message: "Este link abre {{host}} em uma nova aba.",
    ...
    domain_purchase_progress_note:
      "Aguarde enquanto registramos seu domínio e configuramos suas caixas de correio. Isso geralmente leva cerca de um minuto.",
    ...
    domain_purchase_error_paused:
      "As compras de domínio estão pausadas por alguns minutos. Tente novamente em instantes.",
    domain_purchase_error_not_allowed:
      "Este domínio não está disponível na sua conta neste momento. Tente outro nome ou fale com o suporte.",
    domain_purchase_order_expired:
      "Este pedido expirou antes do pagamento. Inicie uma nova compra para obter o domínio.",
    ...
    bridge_windows_desc:
      "Baixe o instalador e execute o Aster Bridge no seu computador com Windows.",
    bridge_linux_name: "Linux",
    bridge_linux_desc:
      "Pacotes AppImage, .deb e .rpm disponíveis para as principais distribuições.",
    bridge_linux_cta: "Baixar AppImage",
    ...
    bridge_macos_desc:
      "Baixe o DMG universal para Macs com Apple Silicon e Intel.",
    bridge_macos_cta: "Baixar para macOS",
    bridge_coming_soon: "Em breve",
    bridge_info_link: "Saiba mais",
    ...
    lockdown_title: "Modo de bloqueio",
    lockdown_description:
      "Bloqueia todo o conteúdo externo, remove as prévias das notificações, desativa a sincronização em tempo real e pede confirmação antes de abrir links. Não há como ignorá-lo enquanto estiver ativo.",
    lockdown_active: "Modo de bloqueio ativo",
    lockdown_enable: "Ativar modo de bloqueio",
    lockdown_disable: "Desativar modo de bloqueio",
    lockdown_enabled_toast: "Modo de bloqueio ativado",
    lockdown_disabled_toast: "Modo de bloqueio desativado",
    lockdown_confirm_disable_title: "Desativar o modo de bloqueio?",
    lockdown_confirm_disable_desc:
      "Isso permitirá conteúdo externo, rastreamento de links e prévias nas notificações. Você pode reativar quando quiser.",
    lockdown_notification_generic: "Nova mensagem",
    lockdown_content_blocked_note: "Modo de bloqueio ativo",
    ...
    crypto_native_loading_coins: "Carregando opções de pagamento...",
    crypto_native_on_chain: "na {{chain}}",
    ...
    crypto_native_too_many_open:
      "Você tem faturas de cripto em aberto demais. Conclua ou cancele uma primeiro.",
    ...
    crypto_native_send_exactly: "Envie exatamente",
    ...
    crypto_native_usd_value_label: "Valor devido",
    crypto_native_usd_total_label: "Total da fatura",
    crypto_native_rate_locked:
      "Sua cotação está travada até esta fatura expirar.",
    crypto_native_expires_in: "Expira em {{time}}",
    crypto_native_status_awaiting: "Aguardando pagamento",
    crypto_native_status_detected: "Pagamento detectado",
    crypto_native_status_confirming: "Confirmando ({{current}}/{{required}})",
    crypto_native_status_confirming_short: "Confirmando",
    crypto_native_status_credited: "Pagamento recebido",
    crypto_native_underpaid_body:
      "Recebemos {{received}} de {{expected}} {{coin}}. Envie os {{remaining}} {{coin}} restantes para o mesmo endereço para concluir esta fatura.",
    crypto_native_manual_review: "Em análise",
    ...
    crypto_native_expired_title: "Esta fatura expirou",
    ...
    crypto_native_unavailable_body:
      "Não conseguimos falar com o servidor. Verifique sua conexão e tente novamente. Seu pagamento não foi afetado.",
    crypto_native_pending_banner:
      "Você tem um pagamento em cripto em andamento",
    crypto_native_pending_banner_action: "Retomar pagamento",
    crypto_native_pending_banner_multi:
      "Você tem {{count}} pagamentos em cripto em andamento",
    ...
    crypto_native_received_label: "Recebido até agora",
    crypto_native_invoice_ref_label: "Fatura",
    crypto_native_paying_with_label: "Pagando com",
    crypto_native_cancel_confirm_title: "Cancelar esta fatura?",
    ...
    crypto_native_coins_unavailable:
      "Não foi possível carregar as opções de pagamento em cripto.",
    crypto_native_copy_tx_hash: "Copiar hash da transação",
    crypto_native_expiry_progress:
      "Tempo restante antes que esta fatura expire",
    ...
    credit_type_admin_removal: "Remoção",
    credit_type_crypto_overpayment: "Pagamento em excesso",
    credit_type_crypto_overpayment_reversal: "Estorno de pagamento em excesso",
    credit_type_prepaid_switch_residual: "Mudança de plano",
    credit_type_prepaid_switch_residual_reversal: "Reversão da mudança",
    ...
    referral_step_share:
      "Compartilhe seu link de convite com amigos, familiares ou colegas.",
    ...
    oauth_reason_provider_denied: "O outro provedor não aceitou a conexão. Tente conectar novamente ou verifique a conta nesse provedor.",
    ...
    export_security_vault_row_help:
      "Esta é a frase-senha do cofre local deste dispositivo, não a senha da sua conta. Ela desbloqueia suas chaves de criptografia apenas neste dispositivo.",
    ...
    export_scope_mail_help:
      "O MBOX agrupa todas as mensagens em um único arquivo; o .EML salva cada mensagem separadamente. Ambos os formatos funcionam com a maioria dos clientes de e-mail de desktop.",
    ...
    export_scope_contacts_help:
      "vCard 4.0 é o formato de contato universal que a maioria dos aplicativos importa diretamente. O arquivo JSON extra preserva campos que o vCard não consegue armazenar.",
    ...
    export_progress_messages_unknown_total:
      "{{ processed }} mensagens exportadas",
    export_complete_summary_unknown_total:
      "{{ count }} mensagens foram exportadas.",
    ...
    send_read_receipts_description:
      "Permite que os remetentes saibam quando você abre as mensagens deles.",
    alias_captcha_required: "Conclua o captcha para criar um alias.",
    obscure_subject_title: "Ocultar o assunto em e-mails criptografados",
    obscure_subject_description:
      "Substitui o assunto visível por três pontos quando a mensagem é criptografada e leva o assunto real dentro da parte criptografada",
    info_obscure_subject_title: "Ocultar o assunto em e-mails criptografados",
    ...
    referral_discount_expired: "Expirado",
    referral_discount_auto_apply:
      "Aplicado automaticamente no pagamento, sem precisar digitar.",
    referral_discount_expires: "Expira em {{ date }}",
    invite_storage_line:
      "Vocês dois recebem {{ amount }} de armazenamento extra",
    invite_storage_note:
      "Crie sua conta gratuita com este link. O armazenamento chega nas duas contas assim que você começar a usar a sua.",
    invite_discount_note:
      "Além disso, {{ percent }}% de desconto se um dia você assinar um plano pago.",
    invite_cta_create_account_storage: "Criar minha conta gratuita",
    invite_friends: "Convidar amigos",
    invite_sidebar_earned: "{{ amount }} ganhos",
    referral_storage_headline:
      "Ganhe {{ amount }} de armazenamento por cada amigo que entrar",
    referral_storage_subhead:
      "Seu amigo também recebe {{ amount }}. O armazenamento chega quando ele começa a usar a conta, até {{ max }}.",
    referral_storage_earned_badge: "{{ amount }} ganhos",
    referral_active_referrals: "Ativos",
    referral_share_button: "Compartilhar convite",
    referral_show_qr: "Mostrar código QR",
    referral_hide_qr: "Ocultar código QR",
    referral_qr_hint:
      "Aponte a câmera de um celular para este código para abrir o convite.",
    referral_qr_alt: "Código QR do seu link de convite do Aster Mail",
    referral_share_title: "Venha para o Aster Mail comigo",
    referral_share_message:
      "Uso o Aster Mail para ter e-mail criptografado de ponta a ponta. Entre pelo meu link e nós dois ganhamos {{ amount }} de armazenamento extra.",
    referral_shared: "Convite compartilhado",
    referral_message_copied: "Mensagem de convite copiada",
    referral_bonus_gauge_label: "Armazenamento ganho",
    referral_bonus_max: "Máximo: {{ value }}",
    referral_status_active: "Ativo",
    referral_email_all_contacts_hint:
      "Envia uma mensagem para cada contato do seu catálogo de endereços.",
    referral_claim_title: "Você foi convidado?",
    referral_claim_description:
      "Digite o código do seu convite e vocês dois recebem {{ amount }} de armazenamento extra. Você tem até {{ date }} para adicioná-lo.",
    referral_claim_placeholder: "Código de convite",
    referral_claim_button: "Adicionar código",
    ...
    domain_step_dkim_title: "Assine os e-mails que você envia",
    domain_step_dmarc_title: "Impeça que outros se passem por você",
    domain_step_tlsrpt_title: "Receba relatórios de falhas de criptografia",
    domain_health_ok_title: "{{domain}} está funcionando",
    domain_health_ok_body:
      "Você pode enviar e receber e-mails neste domínio, e suas mensagens são assinadas para chegarem à caixa de entrada.",
    domain_health_warning_title: "O e-mail funciona, mas pode cair no spam",
    domain_health_warning_body:
      "Você recebe e-mails neste domínio. Conclua os itens abaixo para que as mensagens enviadas também sejam confiáveis.",
    domain_health_critical_title: "Você não está recebendo e-mails",
    domain_health_critical_body:
      "Os e-mails enviados para este domínio não chegam à Aster. Corrija o item abaixo e a entrega volta em poucos minutos.",
    domain_health_unknown_title: "Não conseguimos ler seu DNS",
    domain_health_unknown_body:
      "Normalmente isso significa que os registros acabaram de mudar e ainda não se propagaram. Vamos continuar verificando.",
    domain_health_recheck: "Verificar agora",
    domain_health_checking: "Verificando",
    domain_health_last_checked: "Última verificação às {{when}}",
    domain_health_auto_checking:
      "Verificando de novo automaticamente a cada poucos segundos",
    domain_check_mx_label: "Recebimento de e-mails",
    domain_check_spf_label: "Permissão para enviar",
    domain_check_dkim_label: "Assinatura de mensagens",
    domain_check_dmarc_label: "Proteção contra falsificação",
    domain_check_mx_pass:
      "Os e-mails enviados para este domínio chegam à sua caixa de entrada da Aster.",
    domain_check_spf_pass:
      "Outros provedores aceitam os e-mails que a Aster envia por você.",
    domain_check_dkim_pass:
      "Seus e-mails enviados são assinados, então não são tratados como falsos.",
    domain_check_dmarc_pass:
      "Ninguém mais pode enviar e-mails fingindo ser o seu domínio.",
    domain_check_unknown:
      "Ainda não conseguimos ler este registro. Continuamos verificando.",
    domain_check_generic_failure:
      "Este registro ainda não está configurado corretamente. Adicione o registro abaixo para resolver.",
    domain_reason_mx_missing:
      "Ninguém consegue escrever para você ainda. Seu domínio não tem rota de e-mail, então as mensagens voltam para quem enviou.",
    domain_reason_mx_points_elsewhere:
      "Os e-mails estão indo para seu provedor antigo, não para a Aster. Remova os registros MX antigos para as mensagens chegarem a esta caixa.",
    domain_reason_spf_missing:
      "Os e-mails que você envia podem ser rejeitados ou marcados como spam, porque nada avisa aos outros provedores que a Aster pode enviar por você.",
    domain_reason_spf_missing_include:
      "Seu domínio já tem um registro SPF, mas ele não lista a Aster. Adicione a Aster ou seus e-mails podem ser rejeitados.",
    domain_reason_spf_duplicate_records:
      "Você tem mais de um registro SPF. Os provedores ignoram todos eles, então junte-os em um único registro.",
    domain_reason_dkim_missing_or_stale:
      "Seus e-mails enviados não são assinados, o que os faz parecer falsos. Adicione o registro de assinatura para que sejam confiáveis.",
    domain_reason_dmarc_missing:
      "Qualquer pessoa pode enviar e-mails fingindo ser o seu domínio. Adicione este registro quando os dois acima estiverem funcionando.",
    domain_fix_show_record: "Mostrar o registro a adicionar",
    domain_fix_hide_record: "Ocultar registro",
    ...
    fam_kids_subtitle:
      "Reserve agora um endereço para seu filho e deixe que ele conclua a configuração depois com a própria senha.",
    fam_kids_seats_used: "{{used}} de {{max}} vagas da família em uso",
    fam_kids_reserve_btn: "Reservar um endereço",
    fam_kids_seats_full:
      "Seu grupo familiar está cheio. Libere uma vaga para reservar outro endereço.",
    fam_kids_empty: "Ainda não há endereços reservados.",
    fam_kids_username_label: "Endereço",
    fam_kids_username_ph: "o nome de usuário dele",
    fam_kids_info_title: "Endereços reservados para crianças",
    fam_kids_info_desc:
      "O endereço fica reservado para seu filho e bloqueado para todos os outros. Seu filho (ou você) conclui a configuração depois com uma senha privada, criando uma conta real de acesso zero que entra automaticamente na sua família.",
    fam_kids_nickname_label: "Apelido (opcional)",
    fam_kids_nickname_ph: "por exemplo, Joãozinho",
    fam_kids_storage_label: "Armazenamento para este endereço",
    fam_kids_checking: "Verificando disponibilidade...",
    fam_kids_available: "Disponível",
    fam_kids_taken: "Já está em uso",
    fam_kids_reserved_taken: "Já está reservado",
    fam_kids_invalid: "Não é um nome de usuário válido",
    fam_kids_consent_label:
      "Confirmo que sou o pai, a mãe ou o responsável legal desta criança e autorizo a criação de uma conta para ela.",
    fam_kids_consent_required:
      "Confirme o consentimento parental para continuar.",
    fam_kids_link_hint:
      "Qualquer pessoa com o link pode configurar este endereço. Compartilhe só com seu filho e gere um novo se ele vazar.",
    fam_kids_create: "Reservar",
    fam_kids_creating: "Reservando...",
    fam_kids_cancel: "Cancelar",
    fam_kids_created: "Endereço reservado · link copiado",
    fam_kids_address_reserved: "Endereço reservado",
    fam_kids_create_failed: "Não foi possível reservar esse endereço",
    fam_kids_copy_link: "Copiar link de configuração",
    fam_kids_link_copied: "Link de configuração copiado",
    fam_kids_regenerate: "Gerar novo link",
    fam_kids_regenerated: "Novo link gerado",
    fam_kids_setup_now: "Configurar agora",
    fam_kids_release: "Liberar",
    fam_kids_released: "Reserva liberada",
    fam_kids_release_confirm:
      "Liberar este endereço reservado? Ele voltará a ficar disponível para todos.",
    fam_kids_status_reserved: "Reservado",
    fam_kids_status_claimed: "Ativo",
    fam_kids_claimed_active: "Conta configurada e adicionada à sua família",
    fam_kids_load_failed: "Não foi possível carregar as reservas",
    fam_kids_claim_setup_for: "Configurando {{address}}",
    fam_kids_claim_intro:
      "Escolha uma senha para concluir a configuração deste endereço da família.",
    fam_kids_claim_invalid_title: "Este link não é mais válido",
    fam_kids_claim_invalid_body:
      "Este link expirou, já foi usado ou foi retirado. Peça um novo link a quem administra a família.",
    fam_kids_claim_signed_in_title: "Você está conectado em outra conta",
    fam_kids_claim_signed_in_body:
      "Este link configura uma nova conta infantil. Abra-o em uma janela privada ou copie-o para usar no dispositivo do seu filho.",
    fam_kids_release_modal_title: "Liberar este endereço?",
    fam_kids_release_modal_body:
      "{{address}} voltará a ficar disponível para qualquer pessoa registrar. Não é possível desfazer.",
    fam_kids_release_btn: "Liberar",
    fam_org_event_address_reserved: "Endereço reservado",
    fam_org_event_reservation_released: "Reserva liberada",
    fam_org_event_shared_mailbox_created: "Caixa compartilhada criada",
    fam_org_event_shared_mailbox_deleted: "Caixa compartilhada excluída",
    fam_org_event_shared_mailbox_grant_added:
      "Acesso à caixa compartilhada concedido",
    fam_org_event_shared_mailbox_grant_revoked:
      "Acesso à caixa compartilhada removido",
    fam_org_event_shared_mailbox_rotated:
      "Chaves da caixa compartilhada rotacionadas",
    ...
    fam_org_activity_address_reserved:
      "{{actor}} reservou um endereço para uma criança",
    fam_org_activity_reservation_released:
      "{{actor}} liberou um endereço reservado",
    fam_org_activity_shared_mailbox_created:
      "{{actor}} criou uma caixa compartilhada",
    fam_org_activity_shared_mailbox_deleted:
      "{{actor}} excluiu uma caixa compartilhada",
    fam_org_activity_shared_mailbox_grant_added:
      "{{actor}} concedeu acesso a uma caixa compartilhada",
    fam_org_activity_shared_mailbox_grant_revoked:
      "{{actor}} removeu o acesso a uma caixa compartilhada",
    fam_org_activity_shared_mailbox_rotated:
      "{{actor}} rotacionou as chaves de uma caixa compartilhada",
    fam_org_activity_group_member_added:
      "{{actor}} adicionou {{target}} a um grupo",
    fam_org_activity_group_member_added_generic:
      "{{actor}} adicionou alguém a um grupo",
    fam_org_activity_group_member_removed:
      "{{actor}} removeu {{target}} de um grupo",
    fam_org_activity_group_member_removed_generic:
      "{{actor}} removeu alguém de um grupo",
    fam_org_activity_consent_request_created:
      "{{actor}} solicitou consentimento",
    fam_org_activity_consent_declined:
      "{{actor}} recusou um pedido de consentimento",
    fam_org_activity_consent_all_accepted:
      "Todos aceitaram o pedido de consentimento",
    color_theme_pink: "Rosa-choque",
    color_theme_emerald: "Esmeralda",
    color_theme_black: "Preto",
    sign_out_everywhere_success_one:
      "Sessão encerrada em {{count}} outra sessão",
    sign_out_everywhere_success_other:
      "Sessão encerrada em {{count}} outras sessões",
    deleted_emails_count_one: "{{count}} e-mail excluído",
    deleted_emails_count_other: "{{count}} e-mails excluídos",
    external_account_count_one: "{{count}} conta externa",
    external_account_count_other: "{{count}} contas externas",
    email_count_one: "{{count}} e-mail",
    email_count_other: "{{count}} e-mails",
    allowed_senders_count_one: "{{count}} remetente permitido",
    allowed_senders_count_other: "{{count}} remetentes permitidos",
    blocked_senders_count_one: "{{count}} remetente bloqueado",
    blocked_senders_count_other: "{{count}} remetentes bloqueados",
    plan_domains_count_one: "{{count}} domínio",
    plan_domains_count_other: "{{count}} domínios",
    forwarding_rules_count_one: "{{count}} regra de encaminhamento",
    forwarding_rules_count_other: "{{count}} regras de encaminhamento",
    export_complete_errors_one: "{{count}} mensagem não pôde ser exportada.",
    export_complete_errors_other:
      "{{count}} mensagens não puderam ser exportadas.",
    export_complete_skipped_undecryptable_one:
      "{{count}} mensagem não pôde ser descriptografada e ficou de fora deste arquivo.",
    export_complete_skipped_undecryptable_other:
      "{{count}} mensagens não puderam ser descriptografadas e ficaram de fora deste arquivo.",
    export_complete_skipped_attachments_one:
      "{{count}} anexo não pôde ser descriptografado e ficou de fora deste arquivo.",
    export_complete_skipped_attachments_other:
      "{{count}} anexos não puderam ser descriptografados e ficaram de fora deste arquivo.",
    fam_consent_body_one:
      "Esta alteração afeta os dados de todos os membros da família. Uma solicitação de consentimento será enviada a {{count}} membro. A alteração só entrará em vigor quando todos os membros aceitarem.",
    fam_consent_body_other:
      "Esta alteração afeta os dados de todos os membros da família. Uma solicitação de consentimento será enviada a {{count}} membros. A alteração só entrará em vigor quando todos os membros aceitarem.",
    purge_confirm_message_one:
      "Isso excluirá permanentemente {{count}} e-mail importado de {{email}}. Esta ação não pode ser desfeita.",
    purge_confirm_message_other:
      "Isso excluirá permanentemente todos os {{count}} e-mails importados de {{email}}. Esta ação não pode ser desfeita.",
    alias_export_summary_one: "{{count}} entrada em {{files}}.",
    alias_export_summary_other: "{{count}} entradas em {{files}}.",
    app_lock_attempts_remaining_one: "Resta {{count}} tentativa",
    app_lock_attempts_remaining_other: "Restam {{count}} tentativas",
    vacation_reply_count: "{{count}} respostas enviadas",
    vacation_n_replies_sent_one: "{{count}} resposta enviada",
    vacation_n_replies_sent_other: "{{count}} respostas enviadas",
    dev_databases_count: "{{count}} bancos de dados",
    ...
    fam_org_2fa_banner_one:
      "{{count}} membro não ativou a autenticação de dois fatores",
    ...
    family_security_warning_2fa_other:
      "{{count}} membros não ativaram a autenticação de dois fatores",
    fam_org_sec_session_count_one: "{{count}} sessão ativa",
    fam_org_sec_session_count_other: "{{count}} sessões ativas",
    fam_org_stat_seats_available_one: "{{count}} vaga disponível",
    fam_org_stat_seats_available_other: "{{count}} vagas disponíveis",
  ...
  mail: {
    ...
    category_empty_updates_desc:
      "Recibos, confirmações e faturas aparecerão aqui.",
    ...
    spam_reason_dkim_fail:
      "A mensagem falhou na verificação da assinatura DKIM",
    spam_reason_dmarc_fail:
      "O domínio do remetente falhou na autenticação DMARC",
    spam_reason_missing_headers:
      "A mensagem não possui cabeçalhos de e-mail padrão",
    ...
    spam_reason_user_spam_learning:
      "Você já denunciou spam do domínio deste remetente",
    spam_reason_global_domain_reputation:
      "O domínio do remetente tem má reputação",
    spam_reason_auth_hard_fail: "Não foi possível autenticar o remetente",
    spam_reason_sender_marked_spam: "Você marcou este remetente como spam",
    ...
    receipt_feedback_thanks: "Obrigado pelo feedback",
    order_from: "Pedido de {{merchant}}",
    package_from: "Encomenda de {{carrier}}",
    order_details: "Detalhes do pedido",
    ordered_on: "Pedido em {{date}}",
    merchant: "Loja",
    order_number_label: "Número do pedido",
    show_details: "Mostrar detalhes",
    hide_details: "Ocultar detalhes",
    tracking_number: "Número de rastreamento",
    delivered_on: "Entregue em {{date}}",
    expected_by: "Previsto até {{date}}",
    shipped_on: "Enviado em {{date}}",
    shipment_update: "Atualização da remessa",
    track_package: "Rastrear encomenda",
    ...
    received_via_alias: "entregue no seu alias {{ address }}",
    ...
    search_section_message: "Mensagem",
    ...
    chip_any_time: "Qualquer data",
    chip_older_than_week: "Mais de uma semana",
    chip_older_than_month: "Mais de um mês",
    chip_older_than_six_months: "Mais de 6 meses",
    chip_older_than_year: "Mais de um ano",
    chip_custom_range: "Intervalo personalizado",
    chip_has_attachment: "Com anexo",
    chip_attachment_image: "Imagem",
    chip_attachment_document: "Documento",
    chip_attachment_pdf: "PDF",
    chip_attachment_video: "Vídeo",
    chip_is_unread: "Não lido",
    chip_name_or_email: "Nome ou e-mail",
    chip_no_people: "Nenhuma pessoa correspondente",
    chip_advanced_search: "Pesquisa avançada",
    spam_trash_hidden_notice:
      "Algumas mensagens no Spam e na Lixeira correspondem à sua pesquisa.",
    search_index_incomplete:
      "Não foi possível ler parte do seu índice de pesquisa neste dispositivo, por isso podem faltar algumas mensagens nestes resultados.",
    view_spam_trash_messages: "Ver mensagens",
    search_scope_anywhere: "E-mail, spam e lixeira",
    op_in_anywhere: "Em todos os lugares, incluindo spam e lixeira",
    ...
    archive_conversation_count: "Arquivar conversa ({{count}} mensagens)",
  ...
  auth: {
    ...
    welcome_workspace_subtitle: "Bem-vindo ao Aster. Escolha um nome de usuário para começar.",
    username_placeholder: "Usuario",
    switch_domain: "Trocar domínio",
    sign_in_domain_hint: "Escolha o domínio do seu endereço. Se não tiver certeza, qualquer um funciona.",
    terms_footer_next: "Ao clicar em Avançar acima, você confirma que leu e concorda com os seguintes documentos do Aster:",
    create_a_password: "Crie uma senha",
    recommend_strong_password: "Use pelo menos 8 caracteres. Uma senha mais longa com caracteres variados é mais forte.",
    password_recovery_key: "Chave de recuperação de senha",
    recovery_key_only_way: "Esta chave é a única forma de recuperar a sua conta se você esquecer a senha. Guarde-a em um lugar seguro.",
    ...
    recovery_email_step_desc: "Adicione um endereço de e-mail para voltar a entrar na sua conta caso perca os códigos de recuperação.",
    download_apps_title: "Baixe os apps para celular e computador",
    download_apps_desc: "Leve a sua caixa de entrada com você em todos os dispositivos.",
    ...
    notifications_step_desc: "Receba um aviso quando chegar um novo e-mail, mesmo com esta aba em segundo plano.",
    notifications_turned_on: "As notificações estão ativadas",
    notifications_blocked_hint: "As notificações estão bloqueadas. Para ativá-las, permita notificações deste site nas configurações do navegador.",
    notifications_sample_body: "Você receberá uma notificação como esta quando chegar um novo e-mail.",
    notification_preview_title: "Nova mensagem",
    notification_preview_body: "Você tem uma nova mensagem na caixa de entrada.",
    turn_on: "Ativar",
    addresses_step_title: "Crie endereços para finalidades diferentes",
    addresses_step_desc: "Adicione endereços extras para trabalho, newsletters ou compras. Todos chegam na mesma caixa de entrada.",
    address_n: "Endereço {{n}}",
    address_must_begin_end_alphanumeric: "O endereço de e-mail deve começar e terminar com uma letra ou um número.",
    custom_domain_step_title: "Personalize o seu endereço com um domínio próprio",
    custom_domain_step_desc: "Envie e receba e-mails de um endereço em um domínio que é seu.",
    custom_domain_own: "Configurar um domínio que você já tem",
    custom_domain_own_desc: "Conecte um domínio de qualquer registrador em poucos minutos.",
    custom_domain_new: "Obter um novo domínio",
    custom_domain_new_desc: "Pesquise e compre um domínio sem sair do Aster.",
    ...
    username_min_length: "Use pelo menos 3 caracteres.",
    username_max_length: "Use menos de 40 caracteres.",
    username_alphanumeric:
      "Use letras, números e pontos. Os pontos não podem ficar no início, no fim nem duplicados.",
    username_not_available: "Este nome de usuário não está disponível. Tente outro.",
    ...
    complete_captcha_first: "Conclua a verificação de segurança para continuar.",
    password_error_uppercase: "Inclua pelo menos uma letra maiúscula.",
    password_error_lowercase: "Inclua pelo menos uma letra minúscula.",
    password_error_number: "Inclua pelo menos um número.",
    password_rule_length: "Pelo menos 8 caracteres",
    password_rule_case: "Letras maiúsculas e minúsculas",
    ...
    setup_taking_longer:
      "Isso está demorando mais que o normal. Mantenha esta página aberta enquanto sua conta termina de ser configurada.",
    ...
    link_device_invalid_code:
      "Um código de vinculação tem 8 caracteres. Confira o código e tente novamente.",
    ...
    plan_family_description:
      "Armazenamento criptografado compartilhado e uma única fatura para até 6 pessoas.",
    ...
    remove_photo: "Remover foto",
    captcha_load_failed:
      "Não foi possível carregar a verificação de segurança. Confira sua conexão ou algum bloqueador de conteúdo e tente de novo.",
    ...
    plan_referral_discount_note:
      "Seu desconto de indicação é aplicado automaticamente na finalização da compra.",
    plan_referral_discount_percent_note:
      "Seu desconto de indicação de {{percent}}% já está aplicado abaixo.",
    academic_verified_title: "Você está verificado",
    academic_verified_body:
      "Seu desconto de estudante de 30% está garantido. Levando você aos planos...",
    academic_verified_continue: "Escolha seu plano",
    academic_offer_sending_title: "Enviando seu link de verificação",
    academic_offer_sending_body:
      "Enviando um link de verificação de 30% para {{ email }}.",
    offer_welcome_badge_student: "30% de desconto para estudantes",
    offer_welcome_badge_journalist: "30% de desconto para jornalistas",
    offer_welcome_headline: "Garanta seus 30% de desconto",
  ...
  passkeys: {
    ...
    section_title: "Chaves de acesso e chaves de segurança",
    section_description:
      "Use chaves de acesso para entrar com rapidez e segurança usando a biometria ou o código do seu dispositivo. As chaves de segurança usam o autenticador do dispositivo como segundo fator.",
    add_passkey: "Adicionar chave de acesso",
    add_security_key: "Adicionar chave de segurança",
    no_passkeys: "Nenhuma chave de acesso ou de segurança registrada",
    passkey_badge: "Chave de acesso",
    security_key_badge: "Chave de segurança",
    registered: "Adicionada",
    last_used: "Último uso",
    never_used: "Nunca usada",
    remove: "Remover",
    ...
    sign_in_with_passkey: "Entrar com uma chave de acesso",
    authenticating: "Autenticando…",
    vault_needs_password:
      "Digite sua senha para descriptografar seu cofre pela primeira vez.",
    unnamed_passkey: "Chave de acesso",
  ...
  errors: {
    ...
    cannot_react_own_message: "Não é possível reagir à sua própria mensagem.",
    cannot_react_draft:
    ...
    rate_limit:
      "Você está fazendo isso muito rápido. Aguarde um momento e tente novamente.",
    invalid_credentials:
      "E-mail ou senha incorretos. Tente novamente ou redefina sua senha em astermail.org/reset.",
    session_expired:
      "Sua sessão terminou. Entre novamente para continuar. Seus dados e rascunhos estão salvos no servidor.",
    try_again: "Tente novamente.",
    sign_in_domain_unsupported:
      "Entre com o endereço astermail.org ou aster.cx com que você se registrou. Endereços no seu próprio domínio chegam à mesma conta.",
    invalid_username:
      "Insira um nome de usuário entre 3 e 40 caracteres.",
    ...
    decrypt_sender_error:
      "O remetente criptografou este e-mail de um jeito que não conseguimos ler. Peça para ele enviar novamente. Seus outros e-mails não são afetados.",
    metadata_undecryptable_change:
      "Este dispositivo não consegue abrir os detalhes desta mensagem, então sua alteração não é salva. Para recarregar suas chaves, saia e entre novamente. Sua mensagem no servidor continua igual.",
    ...
    cdn_relay_misconfigured:
      "O relay de CDN não está configurado para esta versão. Mude para uma conexão direta em Configurações. Se precisar de ajuda, entre em contato com hello@astermail.org.",
    ...
    address_too_long: "Use no máximo 64 caracteres.",
    address_too_short: "Insira pelo menos um caractere.",
    ...
    domain_invalid_chars:
      "Este domínio contém caracteres não permitidos. Confira a escrita e tente novamente.",
    domain_invalid_format:
      "Insira um domínio válido.",
    domain_invalid_label:
      "Uma parte deste domínio é muito longa ou muito curta. Confira o domínio e tente novamente.",
    domain_reserved:
    ...
    failed_parse_eml:
      "Não foi possível ler este EML: {{error}}. Confira o arquivo e tente novamente.",
    failed_parse_pst:
    ...
    no_active_account:
      "Nenhuma conta conectada foi encontrada neste dispositivo. Entre para continuar.",
    ...
    no_valid_emails_csv:
      "Nenhum e-mail utilizável foi encontrado neste CSV. O arquivo precisa ter colunas como from, to, subject, body e date. Confira os cabeçalhos e tente novamente.",
  ...
  folder_retention: {
    ...
    subtitle:
      "Remova automaticamente os e-mails antigos de uma pasta. E-mails com estrela e fixados são sempre mantidos.",
    add: "Adicionar limpeza automática",
    empty_title: "Nenhuma pasta com limpeza automática",
    empty_description:
      "Escolha uma pasta e um período de retenção para mantê-la organizada automaticamente.",
    edit_title: "Limpeza automática da pasta",
    folder: "Pasta",
    select_folder: "Selecione uma pasta",
    no_folders:
      "Crie uma pasta personalizada primeiro para usar a limpeza automática.",
    retention_period: "Excluir e-mails com mais de",
    days_suffix: "dias",
    mode: "Ao limpar",
    mode_trash: "Mover para a lixeira",
    mode_trash_hint: "Recuperável por cerca de 30 dias",
    mode_permanent: "Excluir permanentemente",
    mode_permanent_hint: "Não é possível desfazer",
    mode_archive: "Mover para o arquivo",
    mode_archive_hint: "Sai da caixa de entrada, fica guardado e recuperável",
    enabled: "Ativado",
    preview_some:
    ...
    remove: "Remover",
    permanent_confirm:
      "Excluir permanentemente os e-mails com mais de {{days}} dias nesta pasta? Não é possível desfazer.",
    summary_older_than: "Com mais de {{days}} dias",
    summary_trash: "para a lixeira",
    summary_permanent: "permanentemente",
    summary_archive: "para o arquivo",
    card_badge: "Limpeza automática",
    disabled_badge: "Desativada",
    upgrade_title: "A limpeza automática de pastas é um recurso pago",
    upgrade_body:
      "Faça upgrade para o Star ou superior para limpar pastas automaticamente.",
    save_failed: "Não foi possível salvar a regra de limpeza automática.",
    load_failed: "Não foi possível carregar as regras de limpeza automática.",
    deleted_toast: "Regra de limpeza automática removida.",
    saved_toast: "Regra de limpeza automática salva.",
  },
  mail_rules: {
    expr_empty_expression: "Insira uma expressão antes de salvar.",
    expr_unterminated_string: "Falta a aspa de fechamento em um valor.",
    expr_unexpected_char: 'O caractere "{{value}}" não é permitido aqui.',
    expr_unexpected_token:
      '"{{value}}" não é esperado aqui. Verifique a grafia, as aspas e os parênteses.',
    expr_expected_rparen: "Falta um parêntese de fechamento.",
    expr_expected_field:
      "Insira aqui um nome de campo, como from.address, subject ou has_attachment.",
    expr_unknown_field:
      '"{{value}}" não é um campo que você possa usar. Tente from.address, subject, body, has_attachment, spam_score ou date_received.',
    expr_expected_operator:
      "Insira aqui um operador, como is, contains, ends_with ou greater_than.",
    expr_expected_string: 'Insira um valor entre aspas, como "example.com".',
    expr_expected_number: "Insira aqui um número.",
    expr_invalid_number: "Esse número não é válido.",
    expr_expected_is: 'A palavra "is" vai aqui.',
    expr_expected_bool_value: "Insira aqui true ou false.",
    expr_expected_bool_value_got: 'Insira aqui true ou false, não "{{value}}".',
    expr_expected_auth_value: "Insira aqui pass, fail, none ou missing.",
    expr_expected_auth_value_got:
      'Insira aqui pass, fail, none ou missing, não "{{value}}".',
    expr_expected_numeric_op:
      "Insira aqui uma comparação numérica, como >, <, = ou equals.",
    expr_expected_date_op: "Insira aqui older_than_days ou newer_than_days.",
    expr_expected_date_op_got:
      'Insira aqui older_than_days ou newer_than_days, não "{{value}}".',
    expr_bad_address_op:
      'O operador "{{value}}" não funciona em campos de endereço. Tente is, contains, starts_with, ends_with, matches_domain ou matches_regex.',
    expr_bad_text_op:
      'O operador "{{value}}" não funciona em campos de texto. Tente is, contains, starts_with, ends_with, is_empty ou matches_regex.',
    ...
    apply_to_existing_started:
      "Aplicando esta regra ao seu e-mail existente. O processo é executado em segundo plano.",
    apply_to_existing_failed:
      "Não foi possível iniciar a aplicação desta regra.",
    apply_to_existing_cancel: "Parar aplicação",
    ...
    regex_backreference:
      "Retrorreferências como \\1 não são suportadas. Reescreva o padrão sem elas.",
    regex_lookaround:
      "Lookahead e lookbehind não são suportados. Reescreva o padrão sem eles.",
    regex_invalid:
      "Este padrão regex não é válido. Confira a sintaxe e tente novamente.",
    ...
    untitled_rule_name: "Regra sem título",
    ...
    hint_move_to_required: "É preciso indicar a pasta de destino.",
    hint_labels_required: "É preciso pelo menos uma etiqueta.",
    ...
    templates_category_cleanup: "Limpar",
    templates_category_priority: "Prioridade",
    templates_category_security: "Segurança",
    tpl_folder_auto_clean_name: "Limpeza automática de pastas",
  ...
  survey: {
    ...
    remind_tomorrow: "Lembrar amanhã",
    dismiss_forever: "Não perguntar novamente",
    modal_title: "Pesquisa do Aster Mail",
    modal_subtitle:
      "Apenas uma vez, cerca de um minuto. As perguntas abertas são opcionais.",
    q_source: "Onde você ouviu falar do Aster Mail pela primeira vez?",
    source_reddit: "Reddit",
    source_youtube: "YouTube ou um criador de conteúdo",
    source_tiktok_instagram: "TikTok ou Instagram",
    source_friend: "Um amigo ou boca a boca",
    source_twitter: "X / Twitter",
    source_privacy_directory:
      "Um diretório de privacidade (Privacy Guides, PRISM Break, awesome-privacy)",
    source_search_engine: "Mecanismo de busca",
    q_signup_reason: "O que você buscava principalmente ao se cadastrar?",
    signup_e2ee: "Criptografia de ponta a ponta",
    signup_leave_big_tech: "Sair das Big Techs",
    signup_open_source: "Código aberto",
    signup_specific_feature: "Um recurso específico",
    signup_price: "Preço",
    signup_curiosity: "Curiosidade",
    q_stood_out: "O que mais se destacou no Aster em relação às outras opções?",
    stood_openpgp: "OpenPGP padrão, as chaves funcionam em qualquer lugar",
    stood_post_quantum: "Criptografia pós-quântica",
    stood_open_source: "Código aberto (AGPL)",
    stood_germany: "Hospedado na Alemanha",
    stood_price: "Preço",
    stood_ui: "A interface / personalização",
    q_upgrade_blocker: "O que impede você de assinar um plano pago?",
    q_upgrade_trigger: "O que finalmente fez você assinar um plano pago?",
    ...
    hesitation_price: "O preço",
    hesitation_trust: "Não tinha certeza se podia confiar ainda",
    hesitation_missing_feature: "Um recurso que faltava",
    hesitation_longevity: "Não sabia se o Aster continuaria existindo",
    hesitation_none: "Nenhuma hesitação real",
    option_other: "Outro",
  ...
  calendar: {
    ...
    invite_maybe: "Talvez",
    invite_no: "Não",
    invite_status_going: "Você vai",
    invite_status_maybe: "Você talvez vá",
    invite_status_declined: "Você não vai",
    invite_change_response: "Alterar",
    invite_added_toast: "Adicionado ao seu calendário",
    invite_declined_toast: "Você recusou este convite",
    invite_save_failed: "Não foi possível salvar no seu calendário",
    invite_saved_locally: "Salvo no seu calendário criptografado",
    calendar: "Calendário",
    month: "Mês",
    week: "Semana",
    day: "Dia",
  ...
  settings_search: {
    ...
    control: "Controle",
    create: "Criar",
    create_ghost_alias: "Criar um alias fantasma",
    credits: "Créditos",
    crypto: "Cripto",
    custom: "Personalizado",
    ...
    navigation_panel: "Painel de navegação",
    notification_sound: "Som das notificações",
    outlook: "Outlook",
    passkeys: "Chaves de acesso",
    password: "Senha",
    password_protected_folders: "Pastas protegidas por senha",
    payment: "Pagamento",
    ...
    proton: "Proton",
    push: "Push",
    quiet_hours: "Horas de silêncio",
    reading: "Leitura",
    reading_and_conversations: "Leitura e conversas",
    reading_pane: "Painel de leitura",
