...
export const pt = {
  common: {
    ...
    more_contact_groups: "Mais {{count}} grupos",
    more_contact_groups_one: "Mais {{count}} grupo",
    more_contact_groups_other: "Mais {{count}} grupos",
    ...
    add_contacts_to_group_hint: "Crie um grupo para organizar as pessoas para quem você mais escreve.",
    contact_group_name_too_long: "Os nomes de grupo podem ter até {{ max }} caracteres.",
    contact_group_already_exists: "Já existe um grupo com esse nome.",
    contact_group_limit_reached: "Você pode criar até {{ max }} grupos.",
    delete_contact_group_confirm: "Excluir este grupo? Seus contatos permanecem no catálogo de endereços.",
    failed_to_fetch_contact_groups: "Os grupos não foram carregados. Tente novamente.",
    ...
    failed_to_delete_contact_group: "O grupo não foi excluído. Tente novamente.",
    failed_to_update_contact_groups: "A participação no grupo não foi atualizada.",
