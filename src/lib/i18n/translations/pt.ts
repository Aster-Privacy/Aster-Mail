...
export const pt = {
  common: {
    ...
    recipient_key_outdated_desc: "A chave publicada deste destinatário está expirada ou inválida, por isso a mensagem não pode ser cifrada de ponta a ponta. Será enviada apenas protegida em trânsito.",
    ...
    unblock_failed: "Não foi possível desbloquear {{ email }}. Uma nova tentativa deve resolver. O remetente permanece bloqueado por enquanto.",
    remove_from_allowlist_failed: "Não foi possível remover {{ email }} da sua lista de permitidos. Uma nova tentativa deve resolver. Permanece permitido por enquanto.",
    bulk_unblock_failed: "Estes remetentes não foram desbloqueados. Uma nova tentativa deve resolver. Permanecem bloqueados por enquanto.",
    bulk_remove_allowlist_failed: "Estes remetentes não foram removidos da sua lista de permitidos. Uma nova tentativa deve resolver. Permanecem permitidos por enquanto.",
    ...
    n_messages_count_one: "{{count}} mensagem",
  ...
  settings: {
    ...
    fam_kids_subtitle: "Reserve agora um endereço para o seu filho e deixe-o concluir a configuração mais tarde com a sua própria palavra-passe.",
    fam_kids_seats_used: "{{used}} de {{max}} lugares familiares utilizados (membros, convites e reservas)",
    fam_kids_reserve_btn: "Reservar um endereço",
    fam_kids_seats_full: "O seu grupo familiar está cheio. Liberte um lugar para reservar outro endereço.",
    fam_kids_empty: "Ainda não há endereços reservados.",
    fam_kids_username_label: "Endereço",
    fam_kids_username_ph: "o nome de utilizador dele",
    fam_kids_info_title: "Endereços reservados para crianças",
    fam_kids_info_desc: "O endereço fica reservado para o seu filho e bloqueado para qualquer outra pessoa. O seu filho (ou você) conclui a configuração mais tarde com uma palavra-passe privada, criando uma conta real de acesso zero que se junta automaticamente à sua família.",
    fam_kids_nickname_label: "Alcunha (opcional)",
    fam_kids_nickname_ph: "ex. Joãozinho",
    fam_kids_storage_label: "Armazenamento para este endereço",
    fam_kids_checking: "A verificar a disponibilidade...",
    fam_kids_available: "Disponível",
    fam_kids_taken: "Já utilizado",
    fam_kids_reserved_taken: "Já reservado",
    fam_kids_invalid: "Nome de utilizador inválido",
    fam_kids_consent_label: "Confirmo que sou o pai, a mãe ou o tutor legal desta criança e consinto na criação de uma conta para ela.",
    fam_kids_consent_required: "Confirme o consentimento parental para continuar.",
    fam_kids_link_hint: "Qualquer pessoa com o link de resgate pode configurar este endereço. Partilhe-o apenas com o seu filho e gere-o de novo se for divulgado.",
    fam_kids_create: "Reservar",
    fam_kids_creating: "A reservar...",
    fam_kids_cancel: "Cancelar",
    fam_kids_created: "Endereço reservado · link de resgate copiado",
    fam_kids_create_failed: "Não foi possível reservar esse endereço",
    fam_kids_copy_link: "Copiar link de resgate",
    fam_kids_link_copied: "Link de resgate copiado",
    fam_kids_regenerate: "Gerar novo link",
    fam_kids_regenerated: "Novo link de resgate gerado",
    fam_kids_setup_now: "Configurar agora",
    fam_kids_release: "Libertar",
    fam_kids_released: "Reserva libertada",
    fam_kids_release_confirm: "Libertar este endereço reservado? Voltará a ficar disponível para todos.",
    fam_kids_status_reserved: "Reservado",
    fam_kids_status_claimed: "Ativo",
    fam_kids_claimed_active: "Conta configurada e associada à sua família",
    fam_kids_load_failed: "Não foi possível carregar as reservas",
    fam_kids_claim_setup_for: "A configurar {{address}}",
    fam_kids_claim_intro: "Escolha uma palavra-passe para terminar de configurar este endereço familiar.",
    fam_kids_claim_invalid_title: "Este link já não é válido",
    fam_kids_claim_invalid_body: "Este link de resgate expirou, já foi utilizado ou foi retirado. Peça um novo link ao proprietário da família.",
    fam_kids_claim_signed_in_title: "Tem sessão iniciada noutra conta",
    fam_kids_claim_signed_in_body: "Este link configura uma nova conta infantil. Abra-o numa janela privada/anónima ou copie-o para usar no dispositivo do seu filho.",
    fam_kids_release_modal_title: "Libertar este endereço?",
    fam_kids_release_modal_body: "{{address}} ficará disponível para qualquer pessoa registar. Isto não pode ser anulado.",
    fam_kids_release_btn: "Libertar",
    alias_captcha_required: "Complete o captcha para criar um alias.",
    ...
    alias_import_drop_hint: "Solte um CSV (SimpleLogin, Addy.io) ou um data.json do Proton Pass aqui, ou escolha um arquivo",
    ...
    alias_activity_title: "Atividade (últimos 7 dias)",
    ...
    loading_payment_form: "Carregando...",
  ...
  auth: {
    link_device_upgrade_required_toast: "Associar um dispositivo Bridge exige o plano Star ou superior. Faça upgrade para continuar.",
    link_device_upgrade_title: "Faça upgrade para associar este dispositivo",
    link_device_upgrade_description: "Ligar um Bridge de computador à sua conta exige o plano Star ou superior. Escolha um plano abaixo e o seu dispositivo será associado logo após o pagamento.",
    link_device_upgrade_cta: "Fazer upgrade para Star",
    link_device_upgrade_failed: "Não foi possível iniciar o pagamento. Tente novamente ou abra Faturação nas Definições.",
    link_device_already_linked: "Este dispositivo já está associado a outra conta. Desassocie-o primeiro e tente novamente.",
    link_device_rate_limited: "Demasiadas tentativas. Aguarde cerca de um minuto e tente novamente.",
    link_device_account_suspended: "Esta conta está suspensa, por isso não é possível associar novos dispositivos neste momento. Contacte o suporte para resolver.",
    academic_offer_sending_title: "A enviar o seu link de verificação",
    academic_offer_sending_body: "A enviar um link de verificação de 30% para {{ email }}.",
    offer_welcome_badge_student: "30% de desconto para estudantes",
    offer_welcome_badge_journalist: "30% de desconto para jornalistas",
    offer_welcome_headline: "Obtenha os seus 30% de desconto",
    offer_welcome_subline_student: "Crie a sua conta gratuita e depois verifique o seu email de estudante para desbloquear 30% de desconto em qualquer plano pago durante 12 meses.",
    offer_welcome_subline_journalist: "Crie a sua conta gratuita e depois verifique as suas credenciais de imprensa para desbloquear 30% de desconto em qualquer plano pago durante 12 meses.",
  ...
  mail_rules: {
    ...
    templates_subtitle: "Comece com uma regra pronta e personalize-a antes de guardar.",
    ...
    tpl_folder_auto_clean_name: "Limpeza automática de pasta",
    tpl_folder_auto_clean_desc: "Remove automaticamente os e-mails de uma pasta quando têm mais dias do que os que escolher. E-mails com estrela e fixados são sempre mantidos.",
    tpl_newsletters_name: "Organizar newsletters",
    tpl_newsletters_desc: "Quando uma mensagem vem de uma lista de correio (tem um cabeçalho List-Id), arquive-a na categoria Atualizações.",
    tpl_social_name: "Agrupar notificações sociais",
    tpl_social_desc: "Quando o remetente é o Facebook, LinkedIn, X/Twitter ou Instagram, mova a mensagem para a categoria Social.",
    tpl_promotions_name: "Detetar promoções",
    tpl_promotions_desc: "Quando o assunto menciona saldo, desconto, cupão ou '% de desconto', mova a mensagem para a categoria Promoções.",
    tpl_calendar_name: "Reunir convites de calendário",
    tpl_calendar_desc: "Quando uma mensagem contém um convite de calendário (.ics), arquive-a na categoria Atualizações.",
    tpl_large_attachments_name: "Sinalizar anexos grandes",
    tpl_large_attachments_desc: "Quando uma mensagem tem um anexo maior que 10 MB, mova-a para uma pasta à sua escolha. Escolha a pasta antes de guardar.",
    tpl_no_reply_name: "Organizar correio automatizado",
    tpl_no_reply_desc: "Quando uma mensagem é gerada por máquina (tem um cabeçalho Auto-Submitted, por ex. remetentes no-reply), arquive-a em Atualizações.",
    tpl_receipts_name: "Arquivar recibos",
    tpl_receipts_desc: "Quando o assunto menciona recibo, fatura ou confirmação de encomenda, ignore a caixa de entrada e arquive em Atualizações.",
    tpl_vip_sender_name: "Destacar um remetente importante",
    tpl_vip_sender_desc: "Quando chegar correio de um remetente à sua escolha, destaque-o e envie uma notificação. Introduza o endereço do remetente antes de guardar.",
    tpl_keyword_star_name: "Destacar por palavra-chave",
    tpl_keyword_star_desc: "Quando o assunto contém uma palavra à sua escolha, destaque a mensagem. Introduza a palavra-chave antes de guardar.",
    tpl_auth_failures_name: "Reter correio suspeito",
    tpl_auth_failures_desc: "Quando uma mensagem falha nas verificações SPF, DKIM ou DMARC (um sinal comum de falsificação), mantenha-a fora da caixa de entrada e marque-a como lida.",
    tpl_forward_copy_name: "Reencaminhar uma cópia",
    tpl_forward_copy_desc: "Quando chegar correio de um remetente à sua escolha, reencaminhe uma cópia para outro endereço. Introduza os dois endereços antes de guardar.",
    ...
    run_on_existing_result: "Regra aplicada a {{count}} mensagens",
    run_on_existing_failed: "Não foi possível executar a regra no e-mail existente. Tente novamente.",
    paused_badge: "Pausada",
    and_label: "E",
    or_label: "OU",
    value_placeholder: "Valor",
  ...
  folder_retention: {
    ...
    subtitle: "Remova automaticamente e-mails antigos de uma pasta. E-mails com estrela e fixados são sempre mantidos.",
    add: "Adicionar limpeza automática",
    empty_title: "Ainda não há pastas com limpeza automática",
    empty_description: "Escolha uma pasta e um período de retenção para a manter organizada automaticamente.",
    edit_title: "Pasta com limpeza automática",
    folder: "Pasta",
    select_folder: "Selecione uma pasta",
    no_folders: "Crie primeiro uma pasta personalizada para usar a limpeza automática.",
    retention_period: "Eliminar e-mails com mais de",
    days_suffix: "dias",
    mode: "Ao limpar",
    mode_trash: "Mover para o lixo",
    mode_trash_hint: "Recuperável durante cerca de 30 dias",
    mode_permanent: "Eliminar permanentemente",
    mode_permanent_hint: "Não pode ser anulado",
    mode_archive: "Mover para o arquivo",
    mode_archive_hint: "Removido da caixa de entrada, mantido e recuperável",
    enabled: "Ativado",
    preview_some: "Cerca de {{count}} e-mails serão limpos na próxima execução.",
    preview_none: "Atualmente nenhum e-mail corresponde a esta regra.",
    keeps_note: "E-mails com estrela e fixados são sempre mantidos.",
    save: "Guardar",
    cancel: "Cancelar",
    delete: "Eliminar",
    remove: "Remover",
    permanent_confirm: "Eliminar permanentemente os e-mails com mais de {{days}} dias nesta pasta? Isto não pode ser anulado.",
    summary_older_than: "Com mais de {{days}} dias",
    summary_trash: "para o lixo",
    summary_permanent: "permanentemente",
    summary_archive: "para o arquivo",
    card_badge: "Limpeza automática",
    disabled_badge: "Desativado",
    upgrade_title: "A limpeza automática de pastas é uma funcionalidade paga",
    upgrade_body: "Faça upgrade para Star ou superior para limpar pastas automaticamente.",
    save_failed: "Não foi possível guardar a regra de limpeza automática.",
    load_failed: "Não foi possível carregar as regras de limpeza automática.",
    deleted_toast: "Regra de limpeza automática removida.",
    saved_toast: "Regra de limpeza automática guardada.",
  },
};
