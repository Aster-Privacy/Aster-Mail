...
export const pt = {
  ...
  settings: {
    ...
    alias_export_source_domain_addresses: "Enderecos de dominio proprio",
    alias_export_source_directories: "Diretorios",
    ...
    alias_export_column_address: "Endereco",
    ...
    alias_export_column_directory: "Diretorio",
    alias_export_column_domain: "Dominio",
    alias_export_column_auto_create: "Criacao automatica",
    alias_export_column_color: "Cor",
    alias_export_column_expires_at: "Expira",
    alias_export_warning_title: "Este ficheiro nao esta cifrado",
    alias_export_warning_body: "Qualquer pessoa que o abra pode ler todos os aliases, notas e sites que contem. Guarde-o no seu gestor de palavras-passe ou numa unidade cifrada.",
    alias_export_summary: "{{rows}} entradas em {{files}} ficheiro(s).",
    alias_export_download: "Transferir",
    alias_export_incomplete: "Apenas {{loaded}} de {{total}} aliases foram carregados. Recarregue os seus aliases e tente novamente para que a copia fique completa.",
    alias_export_undecryptable: "{{count}} aliases nao puderam ser decifrados e nao foram incluidos.",
    alias_export_undecryptable_ghost: "{{count}} aliases fantasma nao puderam ser decifrados e nao foram incluidos.",
    alias_export_load_failed: "Nao foi possivel carregar os diretorios ou os aliases fantasma.",
    alias_export_failed: "A exportacao falhou. Nada foi transferido.",
