...
export const pt = {
  common: {
    ...
    sending_in_seconds: "Enviando em {{seconds}} segundo(s)...",
  ...
  settings: {
    ...
    trusted_2fa_last_used: "Último uso",
    trusted_2fa_expires: "Expira",
    ...
    switch_billing_loss: "Ao mudar de ciclo, você perderá os dias restantes do período atual.",
    ...
    plan_f_signed_in_accounts: "{{value}} contas conectadas",
    ...
    upgrade_modal_description_specific: "{{resource}} requer um plano superior. Faça upgrade para continuar.",
    ...
    promo_then_reverts: "{{price}}/mês depois",
    promo_once_reverts: "depois {{price}} uma vez",
    promo_forever: "para sempre",
    discount_first_year: "{{percent}}% de desconto no primeiro ano",
    discount_first_month: "{{percent}}% de desconto no primeiro mês",
    ...
    referral_email_body: "Olá! Estou usando o Aster Mail para e-mail privado e criptografado. Use meu link para criar sua conta: {{link}}",
    ...
    sync_progress_count: "{{synced}} de {{total}} e-mails sincronizados",
    ...
    connect_modal_title: "Conectar conta de e-mail",
    connect_modal_description: "Importe seus e-mails de outro provedor. Seus e-mails serão criptografados e armazenados com segurança.",
    ...
    oauth_folders_partial: "Algumas pastas não foram configuradas corretamente.",
    ...
    delete_domain_cooldown: "Você deve aguardar {{hours}} horas antes de adicionar este domínio novamente.",
    ...
    vacation_reply_count_one: "1 resposta enviada",
    ...
    ghost_alias_expires_in: "Expira em {{time}}",
    ...
    ghost_aliases_this_month: "{{used}} de {{total}} usados este mês",
    ...
    import_folder_prep_status: "Preparando pastas...",
    export: "Exportar",
  ...
  errors: {
    ...
    rate_limited: "Você fez muito isso em pouco tempo. Um momento, depois outra tentativa, vai funcionar.",
