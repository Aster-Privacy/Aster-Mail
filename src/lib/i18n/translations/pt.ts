...
export const pt = {
  common: {
    ...
    delete_account_error: "Não foi possível excluir sua conta agora. Outra tentativa em instantes costuma funcionar, e support@aster.com pode ajudar se continuar falhando.",
    ...
    decrypt_try_sign_out: "Sair e entrar novamente recarregará suas chaves. Se a mensagem continuar sem abrir, support@aster.com pode ajudar.",
    n_files: "{{count}} file",
    ...
    account_suspended_default_reason: "Sua conta está suspensa por violação dos Termos de Serviço. support@aster.com pode ajudar com um recurso ou mais detalhes.",
    settings_disabled_suspended: "As configurações estão desativadas enquanto sua conta está suspensa. support@aster.com pode ajudar com um recurso ou mais detalhes.",
  ...
  settings: {
    ...
    too_many_requests: "Você fez isso muitas vezes em pouco tempo. Um momento, e outra tentativa, vai funcionar.",
    ...
    info_two_factor_auth_description:
      "Adiciona uma segunda camada de segurança ao entrar. Após sua senha insere um código de 6 dígitos de uma app como Authy ou Google Authenticator.",
  ...
  auth: {
    ...
    abuse_account_limit: "Nosso sistema automático de segurança sinalizou este cadastro, e não podemos criar a conta. Se isto parece um engano, support@aster.com pode ajudar.",
    abuse_flagged_message: "Nosso sistema de segurança parou os novos cadastros a partir desta rede por enquanto. Se isto parece um engano, support@aster.com pode ajudar.",
  ...
  errors: {
    ...
    rate_limit: "Você fez isso muitas vezes em pouco tempo. Um momento, e outra tentativa, vai funcionar.",
    invalid_credentials: "Esse e-mail e senha não correspondem. Outra tentativa, ou uma redefinição em aster.com/reset, vai resolver.",
    ...
    account_not_found: "Não foi possível encontrar uma conta com esse nome. Conferir a escrita, ou uma redefinição em aster.com/reset, costuma resolver.",
    login_failed: "O login não terminou. Outra tentativa deve funcionar. Sua conta não está bloqueada.",
    decrypt_failed: "Essa senha não desbloqueou suas chaves neste dispositivo. Tentar novamente costuma funcionar, e um código de recuperação em aster.com/reset é a alternativa se continuar falhando. Seus dados no servidor permanecem inalterados.",
    ...
    wrong_vault_password: "Essa senha não desbloqueou suas chaves neste dispositivo. Outra tentativa deve funcionar, e um código de recuperação em aster.com/reset é o backup caso continue falhando. Seus dados no servidor permanecem inalterados.",
    vault_tampered: "Os dados criptografados neste dispositivo não correspondem ao esperado, o que pode indicar adulteração. Acesse Configurações e depois Segurança para revisar, e se o aviso voltar entre em contato com support@aster.com. Seus dados no servidor permanecem intactos.",
    ...
    decrypt_corrupt_ciphertext: "Este e-mail está no servidor, mas parece corrompido na transmissão. Atualizar e tentar de novo costuma resolver, e support@aster.com pode ajudar caso continue falhando.",
    ...
    cdn_relay_misconfigured: "O relay de CDN não está configurado para esta versão. Mudar para conexão direta em Configurações vai colocar você de volta online, e support@aster.com pode ajudar se necessário.",
    ...
    device_challenge_mismatch: "A verificação de identidade deste dispositivo não correspondeu, o que pode indicar adulteração. Repareie pelo aplicativo de desktop, e se o aviso voltar entre em contato com support@aster.com.",
  ...
  badges: {
    ...
    claim_failed: "Este selo não foi salvo. Outra tentativa deve funcionar.",
  },
};
