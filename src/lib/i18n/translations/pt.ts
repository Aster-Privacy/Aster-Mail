...
export const pt = {
  ...
  settings: {
    ...
    crypto_native_cancelled_title: "Pagamento cancelado",
    crypto_native_cancelled_body: "Esta fatura foi cancelada. Você pode iniciar um novo pagamento quando quiser.",
