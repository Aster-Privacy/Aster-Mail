...
export const pt = {
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "Isso afeta todos os {{count}} e-mails.",
    confirm_bulk_action_count_description_one: "Isso afeta 1 e-mail.",
    confirm_bulk_action_count_description_other: "Isso afeta todos os {{count}} e-mails.",
    confirm_bulk_action_scope_description: "Isso afeta todos os {{count}} e-mails em {{scope}}.",
    confirm_bulk_action_scope_description_one: "Isso afeta o único e-mail em {{scope}}.",
    confirm_bulk_action_scope_description_other: "Isso afeta todos os {{count}} e-mails em {{scope}}.",
