...
export const nl = {
  common: {
    ...
    contacts_deleted: "Contacten verwijderd",
    contacts_starred: "Contacten met ster gemarkeerd",
    contacts_unstarred: "Ster verwijderd van contacten",
    conversations_starred_bulk: "Gesprekken met ster gemarkeerd",
    conversations_unstarred_bulk: "Ster verwijderd van gesprekken",
    ...
    file_exceeds_max_size: "\"{{name}}\" overschrijdt de maximale bestandsgrootte van {{size}}",
    folder_fallback: "Map",
    ...
    marking_as_read_count: "{{count}} berichten als gelezen markeren...",
    mention_notification: "U bent vermeld in een e-mail",
    message_will_be_sent_shortly: "Bericht wordt binnenkort verzonden",
    more_aliases: "Meer aliassen",
    more_information: "Meer informatie",
    n_contacts_imported: "{{count}} contacten geimporteerd",
    n_emails: "{{count}} e-mails",
    n_more: "{{count}} meer",
    n_more_recipients: "{{count}} meer ontvangers",
    new_email_notification: "Nieuwe e-mail ontvangen",
    ...
    recovery_text_code_used_on: "Code gebruikt op {{date}}",
    ...
    reply_notification: "Iemand heeft uw e-mail beantwoord",
    ...
    unlock_with_biometry: "Ontgrendelen met biometrie",
    ...
    use_biometry_to_unlock: "Gebruik biometrie om te ontgrendelen",
  ...
  settings: {
    ...
    connect_modal_description: "Verbind uw externe e-mailaccount om e-mails te synchroniseren",
    connect_modal_privacy_note: "Uw inloggegevens worden versleuteld opgeslagen en worden nooit gedeeld",
    connect_modal_title: "Extern account verbinden",
    ...
    crypto_modal_price: "Prijs: {{price}}",
    ...
    delete_domain_cooldown: "U kunt dit domein de komende {{days}} dagen niet opnieuw toevoegen",
    ...
    desktop_bridge_set_up: "Desktopbrug instellen",
    ...
    dev_databases_count_one: "1 database",
    ...
    discount_first_month: "{{percent}}% korting op de eerste maand",
    discount_first_year: "{{percent}}% korting op het eerste jaar",
    ...
    export_cancelled_partial_saved: "Exporteren geannuleerd - gedeeltelijk opgeslagen bestand kan aanwezig zijn",
    ...
    export_complete_location: "Opgeslagen op: {{path}}",
    export_complete_summary: "Export voltooid: {{count}} berichten",
    export_description: "Exporteer uw e-mails naar een lokaal bestand",
    export_destination_chosen: "Bestemming: {{path}}",
    ...
    export_progress_eta: "Geschatte resterende tijd: {{time}}",
    export_progress_messages: "{{current}} van {{total}} berichten",
    ...
    ghost_alias_expires_in: "Verloopt over {{time}}",
    ...
    import_folder_prep_status: "Mappen voorbereiden...",
    ...
    oauth_folders_partial: "Sommige mappen konden niet worden aangemaakt",
    ...
    plan_f_mail_rules: "E-mailregels",
    plan_f_signed_in_accounts: "Aangemelde accounts",
    plan_f_tracker_protection: "Trackerbeveiliging",
    promo_forever: "Voor altijd {{price}}/maand",
    promo_once_reverts: "Eerste periode {{price}}, daarna {{regular}}",
    promo_then_reverts: "{{price}}/maand voor {{period}}, daarna {{regular}}",
    ...
    referral_email_body: "He, ik gebruik Aster Mail voor versleutelde e-mail. Probeer het eens! Meld je aan via mijn link: {{link}}",
    ...
    switch_billing_loss: "Als u nu downgradet, verliest u toegang tot betaalde functies",
    ...
    sync_progress_count: "{{current}} van {{total}} gesynchroniseerd",
    ...
    trusted_2fa_expires: "Verloopt: {{date}}",
    trusted_2fa_last_used: "Laatst gebruikt: {{date}}",
    ...
    trusted_devices_revoke_confirm: "Weet u zeker dat u dit apparaat wilt intrekken?",
    ...
    upgrade_modal_description_specific: "Upgrade om {{feature}} te gebruiken",
    ...
    usage_contacts: "Contacten: {{current}} van {{max}}",
    usage_filters: "Filters: {{current}} van {{max}}",
    ...
    vacation_reply_count_one: "1 automatisch antwoord verzonden",
