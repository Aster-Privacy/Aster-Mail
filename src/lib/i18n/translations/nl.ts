...
export const nl = {
  ...
  auth: {
    ...
    recovery_email_step_desc: "Voeg een e-mailadres toe om je account te herstellen als je je herstelsleutel kwijtraakt.",
    ...
    mail_desktop_desc: "Een snelle native app voor Windows, macOS en Linux.",
