...
export const nl = {
  common: {
    ...
    unsubscribe_error_manual: "We konden u niet voor u uitschrijven. Open link brengt u naar de site van de afzender om uzelf uit te schrijven.",
    ...
    delete_account_error: "We konden uw account op dit moment niet verwijderen. Een nieuwe poging zo werkt meestal, en support@aster.com kan helpen als het blijft mislukken.",
    ...
    account_suspended_default_reason: "Uw account is opgeschort wegens een schending van de gebruiksvoorwaarden. support@aster.com kan helpen met bezwaar of meer informatie.",
    submit_an_appeal: "Submit an appeal",
    settings_disabled_suspended: "Instellingen zijn uitgeschakeld zolang uw account is opgeschort. support@aster.com kan helpen met bezwaar of meer informatie.",
    ...
    decrypt_try_sign_out: "Afmelden en weer aanmelden laadt uw sleutels opnieuw. Als het bericht nog steeds niet opent, kan support@aster.com helpen.",
    n_files: "{{count}} file",
  ...
  settings: {
    ...
    error_deleting_account: "We konden uw account op dit moment niet verwijderen. Een nieuwe poging zo werkt meestal, en support@aster.com kan helpen als het blijft mislukken.",
  ...
  auth: {
    ...
    abuse_account_limit: "Ons geautomatiseerde beveiligingssysteem heeft deze aanmelding gemarkeerd, en we kunnen het account niet aanmaken. Als dit een vergissing lijkt, kan support@aster.com helpen.",
    abuse_flagged_message: "Ons beveiligingssysteem heeft nieuwe aanmeldingen vanaf dit netwerk voorlopig stopgezet. Als dit een vergissing lijkt, kan support@aster.com helpen.",
  ...
  errors: {
    ...
    invalid_credentials: "Dat e-mailadres en wachtwoord kwamen niet overeen. Een nieuwe poging of een reset op aster.com/reset lost dit op.",
    ...
    account_not_found: "We konden geen account met die naam vinden. De spelling controleren of een reset op aster.com/reset lost dit meestal op.",
    login_failed: "Aanmelden is niet voltooid. Een nieuwe poging zou werken. Uw account is niet vergrendeld.",
    decrypt_failed: "Dat wachtwoord heeft uw sleutels op dit apparaat niet ontgrendeld. Een nieuwe poging werkt, en een herstelcode op aster.com/reset is de reserveroute als het blijft mislukken. Uw gegevens op de server zijn ongewijzigd.",
    ...
    wrong_vault_password: "Dat wachtwoord heeft uw sleutels op dit apparaat niet ontgrendeld. Een nieuwe poging zou werken, en een herstelcode op aster.com/reset is de back-up als het blijft mislukken. Uw gegevens op de server zijn ongewijzigd.",
    vault_tampered: "De versleutelde gegevens op dit apparaat komen niet overeen met wat we verwachtten, wat op manipulatie kan wijzen. Ga naar Instellingen en vervolgens Beveiliging om dit te bekijken, en als de waarschuwing terugkeert neem dan contact op met support@aster.com. Uw gegevens op de server zijn onaangetast.",
    ...
    decrypt_corrupt_ciphertext: "Deze e-mail staat op de server maar lijkt onderweg beschadigd. Vernieuwen en het opnieuw proberen volstaat meestal, en support@aster.com kan helpen als het blijft mislukken.",
    ...
    cdn_relay_misconfigured: "De CDN-relay is niet geconfigureerd voor deze build. Overschakelen naar een directe verbinding in Instellingen brengt u weer online, en support@aster.com kan helpen indien nodig.",
    ...
    device_challenge_mismatch: "De identiteitscontrole van dit apparaat kwam niet overeen, wat op manipulatie kan wijzen. Koppel opnieuw vanuit uw desktop-app, en als de waarschuwing terugkeert neem dan contact op met support@aster.com.",
