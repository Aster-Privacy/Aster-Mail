...
export const nl = {
  common: {
    ...
    auth_fail_banner_title: "Authenticatie mislukt",
    auth_fail_banner_body: "Deze e-mail heeft verificatie van de afzender niet doorstaan. Het kan nep of vervalst zijn.",
