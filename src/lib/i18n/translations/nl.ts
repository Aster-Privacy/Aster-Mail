...
export const nl = {
  common: {
    ...
    checking_for_keys: "Zoeken naar sleutels…",
    ...
    import_search_placeholder: "Zoek contacten om te importeren",
    ...
    preview_contact: "Contact bekijken",
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "Dit geldt voor alle {{count}} e-mails.",
    confirm_bulk_action_count_description_one: "Dit geldt voor 1 e-mail.",
    confirm_bulk_action_count_description_other: "Dit geldt voor alle {{count}} e-mails.",
    confirm_bulk_action_scope_description: "Dit geldt voor alle {{count}} e-mails in {{scope}}.",
    confirm_bulk_action_scope_description_one: "Dit geldt voor de ene e-mail in {{scope}}.",
    confirm_bulk_action_scope_description_other: "Dit geldt voor alle {{count}} e-mails in {{scope}}.",
