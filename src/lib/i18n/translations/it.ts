...
export const it = {
  common: {
    ...
    checking_for_keys: "Ricerca delle chiavi…",
    ...
    import_search_placeholder: "Cerca i contatti da importare",
    ...
    preview_contact: "Anteprima del contatto",
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "L’operazione riguarda tutte le {{count}} email.",
    confirm_bulk_action_count_description_one: "L’operazione riguarda 1 email.",
    confirm_bulk_action_count_description_other: "L’operazione riguarda tutte le {{count}} email.",
    confirm_bulk_action_scope_description: "L’operazione riguarda tutte le {{count}} email in {{scope}}.",
    confirm_bulk_action_scope_description_one: "L’operazione riguarda l’unica email in {{scope}}.",
    confirm_bulk_action_scope_description_other: "L’operazione riguarda tutte le {{count}} email in {{scope}}.",
