...
export const it = {
  common: {
    ...
    more_contact_groups: "Altri {{count}} gruppi",
    more_contact_groups_one: "Altro {{count}} gruppo",
    more_contact_groups_other: "Altri {{count}} gruppi",
    ...
    add_contacts_to_group_hint: "Crea un gruppo per organizzare le persone a cui scrivi più spesso.",
    contact_group_name_too_long: "I nomi dei gruppi possono contenere fino a {{ max }} caratteri.",
    ...
    delete_contact_group_confirm: "Eliminare questo gruppo? I tuoi contatti restano nella rubrica.",
    failed_to_fetch_contact_groups: "I gruppi non sono stati caricati. Riprova.",
    ...
    failed_to_update_contact_groups: "L’appartenenza al gruppo non è stata aggiornata.",
