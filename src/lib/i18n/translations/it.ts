...
export const it = {
  ...
  settings: {
    ...
    alias_export_warning_title: "Questo file non e cifrato",
    alias_export_warning_body: "Chiunque lo apra puo leggere ogni alias, nota e sito web contenuto. Conservalo nel tuo gestore di password o su un disco cifrato.",
    alias_export_summary: "{{rows}} voci in {{files}} file.",
    alias_export_download: "Scarica",
    alias_export_incomplete: "Sono stati caricati solo {{loaded}} alias su {{total}}. Ricarica i tuoi alias e riprova affinche il backup sia completo.",
    ...
    alias_export_failed: "Esportazione non riuscita. Non e stato scaricato nulla.",
