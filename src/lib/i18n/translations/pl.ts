...
export const pl = {
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "Dotyczy wszystkich wiadomości: {{count}}.",
    confirm_bulk_action_count_description_one: "Dotyczy 1 wiadomości.",
    confirm_bulk_action_count_description_other: "Dotyczy wszystkich wiadomości: {{count}}.",
    confirm_bulk_action_scope_description: "Dotyczy wszystkich wiadomości w {{scope}}: {{count}}.",
    confirm_bulk_action_scope_description_one: "Dotyczy 1 wiadomości w {{scope}}.",
    confirm_bulk_action_scope_description_other: "Dotyczy wszystkich wiadomości w {{scope}}: {{count}}.",
