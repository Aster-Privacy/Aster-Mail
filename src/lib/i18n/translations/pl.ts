...
export const pl = {
  common: {
    ...
    delete_account_error: "Nie udało się usunąć konta w tej chwili. Kolejna próba za moment zwykle działa, a support@aster.com może pomóc, jeśli problem się utrzymuje.",
    ...
    account_suspended_default_reason:
      "Konto jest zawieszone z powodu naruszenia Warunków świadczenia usług. support@aster.com może pomóc z odwołaniem lub szczegółami.",
    submit_an_appeal: "Submit an appeal",
    settings_disabled_suspended:
      "Ustawienia są wyłączone, gdy konto jest zawieszone. support@aster.com może pomóc z odwołaniem lub szczegółami.",
    ...
    decrypt_try_sign_out:
      "Wylogowanie i ponowne zalogowanie odświeży klucze. Jeśli wiadomość nadal się nie otworzy, support@aster.com może pomóc.",
    n_files: "{{count}} file",
  ...
  settings: {
    ...
    too_many_requests: "Wykonano tę operację wiele razy w krótkim czasie. Chwila, a potem kolejna próba, zadziała.",
    ...
    enter_password_confirm_required:
      "Hasło jest potrzebne, aby kontynuować.",
  ...
  auth: {
    ...
    abuse_account_limit:
      "Nasz automatyczny system bezpieczeństwa oznaczył tę rejestrację i nie możemy utworzyć konta. Jeśli to wygląda na pomyłkę, support@aster.com może pomóc.",
    abuse_flagged_message:
      "Nasz system bezpieczeństwa wstrzymał nowe rejestracje z tej sieci. Jeśli to wygląda na pomyłkę, support@aster.com może pomóc.",
  ...
  errors: {
    ...
    rate_limit:
      "Wykonano tę operację wiele razy w krótkim czasie. Chwila, a potem kolejna próba, zadziała.",
    invalid_credentials: "Ten adres e-mail i hasło nie pasują. Kolejna próba lub reset na aster.com/reset to załatwią.",
    session_expired:
    ...
    invalid_username:
      "Nazwa użytkownika między 3 a 40 znaków zadziała tutaj.",
    enter_password: "Hasło jest potrzebne, aby kontynuować.",
    password_too_long: "To hasło przekracza limit długości. Krótsze zadziała.",
    account_not_found: "Nie znaleziono konta o tej nazwie. Sprawdzenie pisowni lub reset na aster.com/reset zwykle to rozwiązuje.",
    login_failed: "Logowanie nie zostało zakończone. Kolejna próba powinna to załatwić. Konto nie jest zablokowane.",
    decrypt_failed: "To hasło nie odblokowało kluczy na tym urządzeniu. Kolejna próba zadziała, a kod odzyskiwania na aster.com/reset jest zapasowym sposobem, jeśli próby nadal zawodzą. Dane na serwerze pozostają bez zmian.",
    send_limit_reached:
    ...
    wrong_vault_password: "To hasło nie odblokowało Twoich kluczy na tym urządzeniu. Kolejna próba powinna to załatwić, a kod odzyskiwania na aster.com/reset jest zapasowym rozwiązaniem, jeśli problem się utrzyma. Twoje dane na serwerze pozostają niezmienione.",
    vault_tampered: "Zaszyfrowane dane na tym urządzeniu nie zgadzają się z tym, czego oczekiwaliśmy, co może wskazywać na ingerencję. Otwórz Ustawienia, a następnie Bezpieczeństwo, aby to sprawdzić. Jeśli ostrzeżenie powróci, napisz na support@aster.com. Twoje dane na serwerze pozostają nietknięte.",
    ...
    decrypt_corrupt_ciphertext: "Ta wiadomość jest na serwerze, ale wygląda na uszkodzoną podczas przesyłania. Odświeżenie i kolejna próba zwykle to załatwiają, a support@aster.com może pomóc, jeśli problem się utrzyma.",
    ...
    cdn_relay_misconfigured: "Przekaźnik CDN nie jest skonfigurowany dla tej kompilacji. Przełączenie na połączenie bezpośrednie w Ustawieniach przywróci Cię do sieci, a support@aster.com może pomóc w razie potrzeby.",
    ...
    device_challenge_mismatch: "Weryfikacja tożsamości tego urządzenia nie zgadza się, co może wskazywać na ingerencję. Sparuj urządzenie ponownie z aplikacji na komputer, a jeśli ostrzeżenie powróci, napisz na support@aster.com.",
