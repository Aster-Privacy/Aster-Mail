...
export const pl = {
  common: {
    ...
    more_contact_groups: "Jeszcze {{count}} grup",
    more_contact_groups_one: "Jeszcze {{count}} grupa",
    more_contact_groups_other: "Jeszcze {{count}} grup",
    ...
    add_contacts_to_group_hint: "Utwórz grupę, aby uporządkować osoby, do których piszesz najczęściej.",
    contact_group_name_too_long: "Nazwa grupy może mieć maksymalnie {{ max }} znaków.",
    ...
    delete_contact_group_confirm: "Usunąć tę grupę? Kontakty pozostaną w książce adresowej.",
    failed_to_fetch_contact_groups: "Nie udało się wczytać grup. Spróbuj ponownie.",
    failed_to_save_contact_group: "Nie udało się zapisać grupy. Spróbuj ponownie.",
    failed_to_create_contact_group: "Nie udało się utworzyć grupy. Spróbuj ponownie.",
    failed_to_delete_contact_group: "Nie udało się usunąć grupy. Spróbuj ponownie.",
    failed_to_update_contact_groups: "Nie udało się zaktualizować członkostwa w grupie.",
