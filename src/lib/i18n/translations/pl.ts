...
export const pl = {
  ...
  settings: {
    ...
    alias_export_description: "Wybierz, co ma zostac uwzglednione. Plik powstaje w Twojej przegladarce i nigdy nie jest wysylany na nasze serwery.",
    alias_export_format_csv: "CSV (arkusz kalkulacyjny)",
    alias_export_format_json: "JSON",
    alias_export_confirm_description: "Sprawdz, co zamierzasz pobrac.",
    alias_export_source_aliases: "Aliasy",
    alias_export_source_domain_addresses: "Adresy wlasnej domeny",
    alias_export_source_directories: "Katalogi",
    alias_export_source_ghost: "Aliasy ghost",
    alias_export_source_count: "{{count}} wpisow",
    ...
    alias_export_column_display_name: "Nazwa wyswietlana",
    alias_export_column_note: "Notatka",
    alias_export_column_websites: "Strony",
    alias_export_column_enabled: "Wlaczony",
    ...
    alias_export_warning_body: "Kazdy, kto go otworzy, zobaczy wszystkie aliasy, notatki i strony. Przechowuj go w menedzerze hasel lub na zaszyfrowanym dysku.",
    alias_export_summary: "{{rows}} wpisow w {{files}} pliku/plikach.",
    alias_export_download: "Pobierz",
    alias_export_incomplete: "Zaladowano tylko {{loaded}} z {{total}} aliasow. Odswiez liste aliasow i sprobuj ponownie, aby kopia byla kompletna.",
    alias_export_undecryptable: "{{count}} aliasow nie udalo sie odszyfrowac i nie zostaly uwzglednione.",
    alias_export_undecryptable_ghost: "{{count}} aliasow ghost nie udalo sie odszyfrowac i nie zostaly uwzglednione.",
    alias_export_load_failed: "Nie udalo sie zaladowac katalogow ani aliasow ghost.",
    alias_export_failed: "Eksport nie powiodl sie. Nic nie zostalo pobrane.",
