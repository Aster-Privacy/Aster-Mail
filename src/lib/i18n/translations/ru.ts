...
export const ru = {
  common: {
    ...
    new_email_single: "1 новое письмо",
    new_emails_count: "{{count}} новых писем",
  ...
  auth: {
    ...
    choose_recovery_method: "Выберите метод восстановления",
    choose_recovery_method_desc: "Как вы хотите восстановить свой аккаунт?",
    use_recovery_code: "Использовать код восстановления",
    use_recovery_email: "Использовать электронную почту для восстановления",
    recovery_email_sent: "Письмо для восстановления отправлено",
    recovery_email_sent_desc:
      "Мы отправили ссылку для сброса пароля на ваш адрес для восстановления. Проверьте входящие и нажмите на ссылку для продолжения.",
    check_your_inbox: "Проверьте входящие",
    sending_recovery_email: "Отправка письма для восстановления...",
    validating_recovery_link: "Проверка ссылки для восстановления...",
    invalid_recovery_link:
      "Эта ссылка для восстановления недействительна или истекла. Пожалуйста, попробуйте снова.",
