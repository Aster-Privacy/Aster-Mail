...
export const ru = {
  common: {
    ...
    auth_fail_banner_title: "Ошибка аутентификации",
    auth_fail_banner_body: "Это письмо не прошло проверку отправителя. Оно может быть поддельным.",
  ...
  settings: {
    ...
    info_two_factor_auth_description:
      "Добавляет второй уровень защиты при входе. После пароля вы вводите 6-значный код из приложения вроде Authy или Google Authenticator.",
