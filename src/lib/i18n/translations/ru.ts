...
export const ru = {
  ...
  settings: {
    ...
    alias_orphaned_hint:
      "Его название зашифровано вашим прежним паролем, поэтому восстановить его нельзя. Письма на этот адрес по-прежнему приходят, а полный адрес виден в заголовке каждого доставленного сообщения.",
