...
export const ru = {
  common: {
    ...
    scheduled_already_sending: "Это письмо уже отправляется, поэтому изменить его больше нельзя.",
    ...
    offline_action_failed: "Изменение, сделанное офлайн, не удалось применить. Попробуйте ещё раз.",
    failed_to_update:
