...
export const ru = {
  ...
  mail: {
    ...
    search_preparing_title: "Подготовка поиска",
    search_preparing_desc:
      "Поскольку ваша почта зашифрована сквозным шифрованием, мы создаём приватный поисковый индекс прямо на вашем устройстве. Это происходит только в первый раз. После этого поиск будет мгновенным.",
    search_preparing_progress: "Подготовлено {{current}} из {{total}} сообщений",
    search_preparing_almost: "Почти готово, завершаем...",
    search_preparing_collecting: "Собираем ваши сообщения... пока {{current}}",
