...
export const ru = {
  ...
  auth: {
    ...
    recovery_email_step_desc: "Добавьте адрес электронной почты, чтобы восстановить аккаунт, если потеряете ключ восстановления.",
    ...
    mail_desktop_desc: "Быстрое нативное приложение для Windows, macOS и Linux.",
