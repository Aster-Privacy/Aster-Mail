...
export const ru = {
  ...
  settings: {
    ...
    domain_purchase_purchased_info:
      "Здесь показаны домены, купленные через Aster. Мы регистрируем их для вас с конфиденциальностью WHOIS, автоматически настраиваем весь почтовый DNS, и вы сразу можете создавать на них адреса. Каждый домен продлевается только с вашего согласия, и вы в любой момент можете перенести его к другому регистратору.",
    ...
    credit_task_refer_hint:
      "Вы и ваш друг получите по $10 после его регистрации в Aster.",
    ...
    referral_step_earn:
      "Вы оба получаете по $10 кредитов Aster, которые применяются к следующему продлению.",
    referral_step_share:
