...
export const ru = {
  common: {
    ...
    more_contact_groups: "Ещё {{count}} групп",
    more_contact_groups_one: "Ещё {{count}} группа",
    more_contact_groups_other: "Ещё {{count}} групп",
    ...
    add_contacts_to_group_hint: "Создайте группу, чтобы упорядочить людей, которым вы пишете чаще всего.",
    contact_group_name_too_long: "Название группы может содержать до {{ max }} символов.",
    contact_group_already_exists: "Группа с таким названием уже есть.",
    contact_group_limit_reached: "Вы можете создать до {{ max }} групп.",
    delete_contact_group_confirm: "Удалить эту группу? Контакты останутся в адресной книге.",
    failed_to_fetch_contact_groups: "Не удалось загрузить группы. Повторите попытку.",
    failed_to_save_contact_group: "Не удалось сохранить группу. Повторите попытку.",
    failed_to_create_contact_group: "Не удалось создать группу. Повторите попытку.",
    failed_to_delete_contact_group: "Не удалось удалить группу. Повторите попытку.",
  ...
  auth: {
    ...
    recovery_locked_out:
      "Для этого аккаунта было слишком много попыток восстановления. Повторите попытку через {{time}}. Ни один из ваших кодов не использован, поэтому все они по-прежнему у вас.",
    invalid_backup_code:
