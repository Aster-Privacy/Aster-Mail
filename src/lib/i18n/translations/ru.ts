...
export const ru = {
  common: {
    ...
    contact_encryption_info: "Когда контакт публикует открытый ключ, Aster автоматически шифрует письма, которые вы ему отправляете.",
    contact_moved_to_trash: "Контакт перемещён в корзину",
    contact_restored: "Контакт восстановлен",
    contacts_created: "Создано контактов: {{count}}",
    contacts_exported: "Контакты экспортированы",
    contacts_in_trash_notice: "Контакты в корзине удаляются безвозвратно через 30 дней.",
    ...
    delete_group_confirmation: "Удаление «{{name}}» убирает группу. Контакты из неё остаются в адресной книге.",
    deselect_contact: "Снять выделение с контакта",
    discard: "Отменить",
    discard_new_contact_message: "Начатый контакт ещё не сохранён. Если открыть другой контакт сейчас, он будет потерян.",
    duplicates_found: "Найдены дубликаты",
    email_group: "Написать группе",
    empty_trash_confirm: "Удалить все контакты из корзины безвозвратно? Это действие нельзя отменить.",
    export_selection_vcf: "Экспортировать как vCard",
    ...
    failed_to_remove_from_group: "Не удалось убрать контакт из группы.",
    ...
    group_empty_hint: "Чтобы наполнить эту группу, выберите контакты на вкладке «Контакты» и нажмите «Добавить в группу».",
    group_empty_title: "В этой группе нет контактов",
    group_modal_description: "Создавайте группы, чтобы писать сразу нескольким контактам.",
    group_name: "Название группы",
    groups: "Группы",
    import_add_to_group: "Добавить импортированные контакты в группу",
    import_clear_all: "Очистить всё",
    ...
    import_select_all: "Выбрать всё",
    import_selected_count: "Выбрано {{selected}} из {{total}}",
    manage_contacts: "Управление контактами",
    merge: "Объединить",
    merge_and_fix: "Объединить и исправить",
    merge_contacts_hint: "Выберите данные, которые нужно сохранить. Остальные контакты переместятся в корзину.",
    merge_keeps_this: "Сохранено",
    merged_contact_preview: "Объединённый контакт",
    no_contact_changes: "Изменений пока нет",
    no_contact_details: "У этого контакта пока нет данных. Нажмите «Изменить», чтобы добавить их.",
    ...
    no_groups_match: "Нет групп, подходящих под запрос",
    ...
    preview_contact: "Просмотр контакта",
    print_contacts: "Печать контактов",
    remove_from_group: "Убрать из группы",
    removed_from_group: "Убрано из группы",
    ...
    failed_to_save:
      "Изменения не сохранились. Проверка соединения и повторная попытка обычно решает вопрос. Прежняя версия остаётся на месте.",
    verification_sent:
    ...
    lock_folder_description:
      "Ваши данные уже зашифрованы. Блокировка этой папки добавляет дополнительный уровень шифрования и требует отдельной аутентификации для доступа к содержимому.",
    unlock_folder_description:
      "Папка будет разблокирована, дополнительный уровень защиты снят. Ваши данные останутся защищены стандартным шифрованием.",
    lock_extra_security:
      "Блокировка добавляет дополнительную защиту поверх существующего шифрования. Разблокировать можно в любой момент.",
    ...
    delete_folder_warning:
      "Эта папка будет удалена, и отменить это нельзя. Письма внутри останутся в учётной записи, просто не будут относиться к этой папке.",
    ...
    unsubscribe_error_manual:
      "Отписать автоматически не получилось. Кнопка Открыть ссылку ведёт на сайт отправителя для отписки вручную.",
    ...
    folder_name_too_long:
      "Имена папок ограничены {{max}} символами. Более короткое имя обычно подходит.",
    folder_already_exists:
      "Папка с таким именем уже есть. Другое имя обычно подходит.",
    label_name_too_long:
    ...
    email_render_error:
      "Отрисовать это письмо на этом устройстве не удалось. Повторное открытие или просмотр исходного кода обычно помогает. Почтовый ящик не затронут.",
    ...
    password_already_set:
      "У этой папки уже есть пароль. Для его обновления подходит вариант Сменить пароль.",
    ...
    please_enter_valid_domain:
      "Это не похоже на правильный домен. Что-то вроде example.com обычно подходит.",
    ...
    email_data_missing:
      "Содержимое этого письма загрузить не удалось. Повторное открытие из почтового ящика обычно его возвращает. Сам ящик остаётся без изменений.",
    later: "Позже",
    ...
    external_link_warning:
      "Сейчас откроется внешний сайт вне Aster. Если адрес кажется надёжным, переход по ссылке безопасен.",
    ...
    delete_contact_confirm:
      "Удалить этот контакт окончательно. Отменить это нельзя.",
    ...
    auth_fail_tooltip_dkim:
      "Подпись отправителя отсутствует или не совпадает - мы не можем подтвердить, что сообщение не было изменено.",
    auth_fail_tooltip_dmarc:
      "Собственная политика этого домена предписывает отклонять подобные сообщения.",
    auth_fail_tooltip_intro:
      "Это сообщение не прошло следующие проверки отправителя:",
    auth_fail_tooltip_spf:
      "Сервер, отправивший это сообщение, не является авторизованным отправителем для домена в строке «От».",
    ...
    failed_update_alias_websites:
      "Не удалось сохранить сайты. Попробуйте ещё раз.",
    alias_website_invalid:
      "Это не похоже на действительный адрес сайта. Попробуйте, например, example.com.",
    ...
    recovery_pdf_no_digital:
      "НЕ храните в цифровом виде и не передавайте никому",
    recovery_pdf_store_secure:
      "Храните этот документ в безопасном месте (сейф, банковская ячейка)",
    recovery_pdf_title: "Коды восстановления Aster Mail",
    recovery_pdf_unrecoverable:
      "Без этих кодов никто не сможет восстановить доступ к вашему аккаунту, если вы забудете пароль, и ваша зашифрованная почта будет безвозвратно утеряна.",
    ...
    recovery_text_unrecoverable:
      "Без этих кодов никто не сможет восстановить доступ к вашему аккаунту, если вы забудете пароль.",
    ...
    sender_unsigned_desc:
      "Это сообщение не подписано, поэтому мы не можем подтвердить, что оно действительно от этого отправителя. К конфиденциальному содержимому следует относиться с осторожностью.",
    sender_verified: "Отправитель подтверждён",
    sender_verified_desc:
      "Подпись этого сообщения совпадает с опубликованным ключом отправителя.",
  ...
  settings: {
    ...
    category_info_newsletters: "Рассылки и списки рассылки, на которые вы подписались.",
    category_info_transactions: "Заказы, платежи и чеки от магазинов и сервисов.",
    category_newsletters: "Рассылки",
    category_transactions: "Покупки",
    edit_account_tooltip: "Изменить аккаунт",
    gmail_app_password_notice: "Этот провайдер требует пароль приложения. Обычный пароль от аккаунта не подойдёт.",
    gmail_sync_continue: "Продолжить",
    gmail_sync_intro: "Создайте пароль приложения в настройках аккаунта и вставьте его сюда.",
    gmail_sync_note_unavailable: "Если пароли приложений недоступны, сначала включите двухэтапную аутентификацию, а затем проверьте снова.",
    gmail_sync_open_google: "Открыть настройки аккаунта",
    gmail_sync_setup_button: "Показать, как это сделать",
    gmail_sync_step_1: "Войдите в настройки безопасности своего аккаунта.",
    gmail_sync_step_2: "Включите двухэтапную аутентификацию, если она ещё не включена.",
    ...
    gmail_wizard_connect: "Подключить ящик",
    ...
    gmail_wizard_step_1_body: "Пароли приложений находятся в разделе безопасности аккаунта у вашего провайдера.",
    gmail_wizard_step_1_title: "Откройте настройки безопасности своего аккаунта",
    gmail_wizard_step_2_body: "Пароли приложений доступны только при включённой двухэтапной аутентификации.",
    gmail_wizard_step_2_title: "Включите двухэтапную аутентификацию",
    gmail_wizard_step_3_body: "Выберите приложение «Почта» и создайте пароль.",
    gmail_wizard_step_3_title: "Создайте пароль приложения",
    gmail_wizard_step_4_body: "Вставьте пароль приложения ниже. Aster хранит его в зашифрованном виде и использует только для синхронизации этого ящика.",
    gmail_wizard_step_4_title: "Вставьте пароль",
    gmail_wizard_title: "Подключите свой ящик",
    last_sync_tooltip: "Когда этот аккаунт синхронизировался в последний раз",
    not_synced_tooltip: "Этот аккаунт ещё не синхронизировался.",
    protocol_desc_imap: "Синхронизирует папки и поддерживает одинаковое состояние на всех устройствах.",
    protocol_desc_pop3: "Скачивает почту один раз и не оставляет ничего для синхронизации.",
    protocol_tooltip_imap: "IMAP хранит почту на сервере и синхронизирует каждое изменение на всех ваших устройствах.",
    protocol_tooltip_jmap: "JMAP — современный протокол синхронизации, который поддерживают лишь немногие провайдеры.",
    protocol_tooltip_pop3: "POP3 скачивает почту на одно устройство и не синхронизирует изменения обратно.",
    remove_account_tooltip: "Удалить аккаунт",
    show_side_panel: "Показывать боковую панель",
    show_side_panel_description: "Держите контакты и другие быстрые инструменты на панели рядом с почтой.",
    ...
    fam_welcome_step1_point1:
      "Каждый участник получает собственный адрес @astermail.org",
    fam_welcome_step1_point2:
      "Полная приватность - участники не видят письма друг друга",
    ...
    fam_welcome_step2_desc:
      "В ваш план входит общее хранилище. Решайте, сколько получит каждый участник, и меняйте это в любой момент.",
    fam_welcome_step2_point1:
      "Выделяйте хранилище каждому участнику при приглашении",
    fam_welcome_step2_point2:
      "Перемещайте хранилище между участниками ползунком",
    fam_welcome_step2_point3:
      "Участники видят только своё использование - и ничего больше",
    fam_welcome_step3_title: "Безопасность для всей семьи",
    fam_welcome_step3_desc:
      "Задавайте политики для всех участников - обязательная 2FA, лимиты сессий, контроль доступа.",
    fam_welcome_step3_point1:
      "Требуйте двухфакторную аутентификацию от всех участников",
    fam_welcome_step3_point2:
      "Задавайте тайм-ауты сессий и лимиты устройств для всех",
    fam_welcome_step3_point3:
      "Просматривайте журналы активности и соответствие в один взгляд",
    ...
    account_recovery_desc:
      "Способы вернуть доступ к аккаунту и разблокировать ваши зашифрованные данные, если вы забудете пароль.",
    ...
    resurrection_success:
      "Старые данные разблокированы. Прежние письма и псевдонимы снова открываются как обычно.",
    resurrection_failed:
    ...
    smtp_tokens_upgrade_description:
      "Создавайте учётные данные SMTP только для отправки для ваших подтверждённых собственных доменов. Доступно в тарифе Star и выше.",
    smtp_tokens_upgrade_cta: "Перейти на Star",
    smtp_tokens_no_domain_title:
      "Сначала добавьте подтверждённый собственный домен",
    smtp_tokens_no_domain_description:
      "Токены SMTP можно привязать только к подтверждённому адресу на собственном домене. Добавьте и подтвердите собственный домен, чтобы начать.",
    ...
    smtp_token_create_description:
      "Задайте имя этого токена и выберите подтверждённый адрес, с которого он сможет отправлять почту.",
    ...
    smtp_token_address_hint:
      "Почта, отправленная с этим токеном, будет приходить с этого адреса.",
    smtp_token_create_failed:
      "Не удалось создать токен. Пожалуйста, попробуйте ещё раз.",
    smtp_token_error_forbidden:
      "Для токенов SMTP требуется платный тариф, либо вы достигли лимита токенов. Чтобы продолжить, улучшите тариф или отзовите существующий токен.",
    smtp_token_error_conflict:
      "Для этого адреса уже существует активный токен. Сначала отзовите его, чтобы создать новый.",
    smtp_token_ready_title: "Токен создан",
    smtp_token_ready_description:
      "Скопируйте эти настройки в ваш почтовый клиент или приложение сейчас. Пароль показывается только один раз, и его нельзя получить повторно.",
    ...
    fam_org_sec_confirm_desc:
      "Эти изменения немедленно вступят в силу для всех участников.",
    ...
    fam_org_captcha_required:
      "Пройдите проверку captcha, чтобы отправить приглашение.",
    fam_org_left_title: "Вы покинули семейный план",
    fam_org_left_desc:
      "Ваш аккаунт остаётся активным. Вы можете снова присоединиться в любой момент по новому приглашению.",
    fam_org_invite_summary:
      "Этот участник получит {{member}}. Из вашего семейного хранилища на {{pool}} останется {{free}} для остальных.",
    fam_org_invite_summary_over:
      "{{member}} превышает объём семейного хранилища. Доступно только {{avail}} - выберите меньшее значение.",
    ...
    plan_feat_imap_smtp:
      "Используйте любимое приложение почты (через Aster Bridge)",
    ...
    category_info_primary:
      "Все, что не подходит под другую категорию. Всегда включена.",
    category_info_promotions: "Маркетинговые письма, предложения и акции.",
    category_info_social: "Уведомления из социальных сетей и сообществ.",
    category_info_updates: "Чеки, подтверждения и сервисные уведомления.",
    category_info_forums: "Сообщения из рассылок, форумов и групп обсуждений.",
    category_info_finance:
      "Выписки, счета и уведомления от банков и финансовых сервисов.",
    category_info_travel:
      "Бронирования, маршруты и подтверждения от авиакомпаний, отелей и служб такси.",
    ...
    custom_category_locked_badge: "Заблокировано",
    ...
    category_keywords_invalid:
      "Недопустимые ключевые слова: {{list}}. Используйте только обычные слова.",
    category_expand: "Развернуть",
    category_collapse: "Свернуть",
    delete_category_title: "Удалить категорию?",
    delete_category_description:
      "Вы уверены, что хотите удалить «{{name}}»? Это действие нельзя отменить.",
    custom_categories_locked:
      "Пользовательские категории недоступны на вашем текущем тарифе.",
    custom_categories_limit_reached:
      "Вы достигли лимита пользовательских категорий вашего тарифа. Обновите тариф, чтобы добавить больше.",
    edit_custom_category: "Изменить категорию",
    new_custom_category: "Новая категория",
    category_name: "Название",
    category_name_placeholder: "напр. Рассылки",
    category_icon: "Значок",
    category_color: "Цвет",
    category_color_accent: "Акцент",
    category_color_blue: "Синий",
    category_color_green: "Зелёный",
    category_color_amber: "Янтарный",
    category_color_violet: "Фиолетовый",
    category_color_teal: "Бирюзовый",
    category_color_cyan: "Голубой",
    category_color_rose: "Розовый",
    category_color_pink: "Фуксия",
    category_color_slate: "Серый",
    category_match_domains: "Сопоставлять домены отправителя",
    category_match_domains_placeholder: "example.com, news.example.org",
    category_match_domains_help:
      "Список доменов отправителя через запятую. Письма с этих доменов попадут в эту категорию.",
    category_match_keywords: "Сопоставлять ключевые слова темы",
    category_match_keywords_placeholder: "рассылка, дайджест",
    category_match_keywords_help:
      "Слова через запятую. Если хотя бы одно встречается в теме, письмо попадёт в эту категорию.",
    category_tutorial_text:
      "Совет: пользовательская категория срабатывает, если домен отправителя ИЛИ тема содержит любое из ваших ключевых слов. Пользовательские категории проверяются раньше встроенных, поэтому всегда имеют приоритет.",
    ...
    family_remove_confirm_body:
      "{{name}} сохранит доступ в течение 30 дней, после чего план вернётся к бесплатному. Почта и данные останутся у участника.",
    ...
    family_leave_confirm_body:
      "У вас будет доступ ещё 30 дней, после чего план вернётся к бесплатному. Почта и данные останутся у вас.",
    family_leave_confirm_action: "Покинуть",
    family_join_title: "Присоединиться к семейному плану в Aster Mail",
    family_join_body:
      "Вас пригласили присоединиться к приватному зашифрованному семейному почтовому плану.",
    family_join_create_account: "Создать аккаунт и присоединиться",
    family_join_login: "Войти и присоединиться",
    family_join_invalid:
      "Срок действия этой ссылки-приглашения истёк, или она больше недействительна.",
    ...
    invite_benefit_zero_access:
      "Почта с нулевым доступом и сквозным шифрованием",
    ...
    invite_not_found_body:
      "Возможно, срок её действия истёк, либо ссылка неверна. Вы всё равно можете создать бесплатный аккаунт Aster Mail.",
    ...
    family_join_2fa_body:
      "Эта семья требует двухфакторной аутентификации. После присоединения вам нужно будет включить 2FA.",
    ...
    family_join_success_body:
      "Вы присоединились к семейному плану с {{ size }} хранилища.",
    ...
    family_join_failed:
      "Не удалось добавить вас в эту семью. Возможно, срок действия приглашения истёк или оно уже использовано.",
    ...
    family_plan_grace:
      "Этот план находится в льготном периоде и завершится {{date}}.",
    ...
    family_domains_subtitle:
      "Делитесь пользовательскими доменами, чтобы участники семьи могли создавать на них псевдонимы.",
    family_domains_empty:
      "Пользовательские домены не найдены. Участники могут добавить домены в настройках «Псевдонимы и домены».",
    ...
    family_retention_enforce_hint:
      "Применить эти политики ко всем аккаунтам в этой семье",
    ...
    family_seat_upgrade_msg:
      "Использованы все места ({{count}}). Перейдите на семейный план для размещения до 6 участников.",
    ...
    minimize_sidebar_description:
      "Свернуть боковую панель до значков для экономии места",
    ...
    recently_deleted_aliases_description:
      "Восстановите удалённый псевдоним. Удалённые псевдонимы хранятся ограниченное время.",
    ...
    alias_sender_pinning_info:
      "Решите, кто может отправлять письма на этот псевдоним. «Выкл.» - проходят все. «Закрепить за первым отправителем» - привязка к тому, кто напишет первым, удобно для разовых регистраций. «Белый список» - связаться смогут только добавленные вами.",
    alias_sender_pinning_description:
      "Управляйте тем, какие отправители могут достичь этого псевдонима.",
    ...
    alias_sender_pin_mode_lock_first_hint:
      "После этого принимается только первый отправитель, написавший на этот псевдоним.",
    alias_sender_pin_mode_allowlist: "Белый список",
    alias_sender_pin_mode_allowlist_hint:
      "Принимаются только добавленные вами ниже отправители.",
    ...
    alias_sender_add_failed:
      "Этот отправитель не был добавлен. Попробуйте снова.",
    alias_sender_invalid: "Введите корректный адрес эл. почты.",
    alias_pin_mode_updated: "Закрепление отправителей обновлено",
    alias_toggle_failed:
      "Не удалось обновить псевдоним. Пожалуйста, попробуйте снова.",
    alias_enabled_toast: "Псевдоним включён",
    alias_disabled_toast: "Псевдоним отключён",
    alias_delete_failed:
      "Не удалось удалить псевдоним. Пожалуйста, попробуйте снова.",
    domain_address_delete_failed:
      "Не удалось удалить адрес. Пожалуйста, попробуйте снова.",
    domain_delete_failed:
      "Не удалось удалить домен. Пожалуйста, попробуйте снова.",
    aliases_load_failed:
      "Не удалось загрузить ваши псевдонимы. Пожалуйста, попробуйте снова.",
    alias_rules_title: "Правила",
    alias_rules_info:
      "Автоматически обрабатывайте почту до её попадания во входящие. Блокируйте письма от отправителя, перемещайте их в корзину или помечайте меткой - всё на основе того, кто отправил и что указано в теме.",
    alias_rules_description:
      "Выполнять действия над входящей почтой, соответствующей вашим условиям.",
    ...
    alias_contacts_info:
      "Добавьте кого-либо сюда, если хотите писать ему с этого псевдонима. Он будет видеть ваш псевдоним как отправителя, и ваш настоящий адрес останется скрытым. Отдельных контактов можно блокировать, не затрагивая остальных.",
    alias_contacts_description:
      "Отслеживайте отправителей через обратный псевдоним для каждого контакта и блокируйте их по отдельности.",
    ...
    alias_delivery_log_info:
      "Письма, заблокированные до попадания во входящие. Журнал хранится 30 дней.",
    ...
    alias_relay_mode_native_hint:
      "Почта остаётся в вашем зашифрованном почтовом ящике Aster.",
    alias_relay_mode_relay: "Ретрансляция",
    alias_relay_mode_relay_hint:
      "Пересылать почту на подконтрольный вам внешний адрес.",
    alias_relay_not_private_warning:
      "Ретрансляция на внешний адрес НЕ является сквозной приватностью. Провайдер получателя может читать пересылаемую почту.",
    ...
    alias_relay_destination_add_failed:
      "Этот адресат не был добавлен. Попробуйте снова.",
    ...
    alias_directories_info:
      "Выберите ключевое слово, и почта на anything.keyword@astermail.org автоматически создаст новый псевдоним на лету - без приложения. Отлично подходит для регистраций без необходимости придумывать новый адрес каждый раз.",
    alias_directories_description:
      "Почта на anything.<key>@astermail.org автоматически создаёт для вас псевдоним.",
    ...
    alias_directory_pattern_hint:
      "Отправьте на anything.{{ key }}@{{ domain }}, чтобы создать новый псевдоним.",
    alias_directory_color: "Цвет",
    alias_directory_updated: "Каталог обновлён",
    alias_feature_locked_directories:
      "Перейдите на другой план, чтобы использовать каталоги псевдонимов.",
    alias_feature_locked_rules:
      "Перейдите на другой план, чтобы использовать правила псевдонимов.",
    alias_feature_locked_relay:
      "Перейдите на другой план, чтобы использовать внешнюю ретрансляцию.",
    alias_feature_locked_contacts:
      "Перейдите на другой план, чтобы использовать контакты обратных псевдонимов.",
    ...
    feature_requires_upgrade:
      "Эта функция требует расширенного тарифного плана.",
    ...
    alias_export_source_aliases: "Псевдонимы",
    alias_export_source_domain_addresses: "Адреса собственного домена",
    ...
    alias_export_column_address: "Адрес",
    alias_export_column_display_name: "Отображаемое имя",
    alias_export_column_note: "Заметка",
    alias_export_column_websites: "Сайты",
    alias_export_column_enabled: "Включён",
    alias_export_column_created_at: "Создан",
    alias_export_column_directory: "Каталог",
    alias_export_column_domain: "Домен",
    alias_export_column_auto_create: "Автосоздание",
    ...
    alias_import_drop_hint:
      "Перетащите сюда CSV, текстовый список или экспорт JSON, либо выберите файл",
    ...
    alias_import_protonpass_encrypted_error:
      "Этот экспорт Proton Pass зашифрован. Используйте «Экспорт без шифрования» в Proton Pass, затем повторите импорт.",
    ...
    alias_pref_default_domain_desc:
      "Домен, используемый при создании новых псевдонимов.",
    alias_pref_sender_format: "Формат отображения отправителя",
    alias_pref_sender_format_desc:
      "Как отображаются имена отправителей при пересылке почты на ваш псевдоним.",
    ...
    alias_pref_unsubscribe_action_desc:
      "Что происходит при нажатии кнопки отписки в пересланном письме.",
    ...
    alias_pref_disabled_response_desc:
      "Что видит отправитель, когда его почта молча отклоняется.",
    ...
    alias_pref_delete_action_desc:
      "Выберите, отправлять ли удалённые псевдонимы в корзину (восстановимы 30 дней) или удалять сразу.",
    alias_pref_sender_format_info:
      "Как имя отправителя отображается в пересылаемых письмах.",
    alias_pref_readable_reverse_info:
      "Когда включено, обратные адреса псевдонимов содержат e-mail отправителя, чтобы вы сразу видели, кто пишет.",
    alias_pref_always_expand_info:
      "Автоматически показывает полную панель настроек каждого псевдонима вместо того, чтобы прятать её за значком шестерёнки.",
    alias_pref_unsubscribe_action_info:
      "Что происходит при нажатии кнопки отписки в пересланном письме.",
    alias_pref_disabled_response_info:
      "Что видит отправитель, когда пишет на отключённый псевдоним или заблокированному контакту.",
    alias_pref_delete_action_info:
      "Перемещение в корзину сохраняет удалённые псевдонимы восстановимыми 30 дней. Удаление сразу убирает их безвозвратно.",
    ...
    alias_transfer_warning:
      "После передачи у вас больше не будет доступа к этому псевдониму.",
    ...
    low_network_mode_description:
      "Пропускает фото профиля, фавиконки, внешние изображения и предзагрузку писем. Все письма показываются обычным текстом. Полезно при медленном или лимитированном соединении.",
    ...
    fam_org_groups_empty_desc:
      "Создайте группу, чтобы направлять письма сразу нескольким членам семьи.",
    ...
    fam_org_groups_delete_body:
      "Это навсегда удалит данную группу и исключит из неё всех участников. Это действие нельзя отменить.",
    ...
    fam_org_activity_admin_transferred:
      "{{actor}} передал права администратора {{target}}",
    fam_org_activity_admin_transferred_generic:
      "{{actor}} передал права администратора",
    ...
    fam_org_activity_security_policy_updated:
      "{{actor}} обновил политику безопасности",
    fam_org_activity_security_notify_sent:
      "{{actor}} отправил участникам напоминание о 2FA",
    ...
    fam_org_activity_invite_revoked:
      "{{actor}} отозвал приглашение для {{target}}",
    ...
    fam_org_activity_empty_desc:
      "Здесь будут отображаться присоединения участников, изменения безопасности и административные действия.",
    ...
    fam_org_filters_info_desc:
      "Правила, которые автоматически выполняются для входящей почты каждого члена семьи. Используйте их, чтобы блокировать отправителей, архивировать, помечать или перенаправлять сообщения сразу во всех аккаунтах.",
    fam_org_filters_new: "Новый фильтр",
    fam_org_filters_subtitle:
      "Фильтры применяются ко входящим ящикам всех членов семьи в рамках организации.",
    fam_org_filters_modal_title: "Новый фильтр всей организации",
    fam_org_filters_modal_desc:
      "Автоматически применяется ко входящим ящикам всех членов семьи.",
    ...
    fam_org_filters_condition_info_desc:
      "Выберите, какую часть входящего письма сопоставлять (отправитель, получатель, тему, домен или IP отправителя) и какое значение искать. Почта, которая совпадает, запускает действие ниже.",
    ...
    fam_org_filters_empty_desc:
      "Создайте фильтры, чтобы применять правила ко всем ящикам участников.",
    ...
    fam_org_domains_subtitle:
      "Предоставляйте пользовательские домены, чтобы члены семьи могли создавать на них псевдонимы.",
    ...
    fam_org_domains_empty_desc:
      "Пользовательские домены позволяют членам семьи отправлять письма со своих собственных адресов @yourdomain.com.",
    ...
    fam_org_domains_share_disabled_title:
      "Сначала подтвердите DKIM, чтобы включить предоставление",
    ...
    fam_org_sec_require_2fa_info_desc:
      "Участникам будет предложено настроить двухфакторную аутентификацию, и они не смогут получить доступ к своему почтовому ящику, пока не сделают этого. Настоятельно рекомендуется для каждого семейного тарифа.",
    ...
    fam_org_sec_grace_info_desc:
      "Сколько дней недавно присоединившийся участник может пользоваться своим аккаунтом до того, как 2FA станет обязательной. Установите 0, чтобы требовать её сразу при присоединении.",
    fam_org_sec_days: "дней",
    fam_org_sec_max_sessions: "Максимум активных сеансов на участника",
    fam_org_sec_max_sessions_desc:
      "Ограничьте число одновременных входов с устройств. Оставьте пустым, чтобы не ограничивать.",
    fam_org_sec_max_sessions_info_title:
      "Максимум активных сеансов на участника",
    fam_org_sec_max_sessions_info_desc:
      "Максимальное число устройств или браузеров, на которых участник может быть авторизован одновременно. При превышении лимита самый старый сеанс завершается.",
    ...
    fam_org_sec_auto_signout_desc:
      "Выходить участников из системы после N часов бездействия.",
    fam_org_sec_auto_signout_info_title: "Автоматический выход через",
    fam_org_sec_auto_signout_info_desc:
      "Автоматически выходить участников из системы после указанного числа часов без активности, требуя повторного входа. Оставьте пустым, чтобы никогда не завершать сеанс.",
    ...
    fam_org_ret_intro:
      'Установите лимиты для автоматического удаления старых сообщений. Изменения сохраняются автоматически. Оставьте пустым, чтобы хранить вечно. Применяется ко всем участникам, когда включено "Применять ко всем участникам".',
    ...
    fam_org_ret_trash_info:
      "Сообщения в Корзине старше указанного числа дней удаляются безвозвратно.",
    fam_org_ret_spam: "Спам",
    fam_org_ret_spam_hint: "Автоудаление спама (по умолчанию 30 дней)",
    fam_org_ret_spam_info:
      "Сообщения в папке Спам очищаются через указанное число дней. У большинства провайдеров по умолчанию 30.",
    fam_org_ret_sent: "Отправленные",
    fam_org_ret_sent_hint: "Автоудаление отправленной почты",
    fam_org_ret_sent_info:
      "Сообщения в Отправленных старше указанного числа дней удаляются. Оставьте пустым, чтобы хранить всю отправленную почту.",
    fam_org_ret_all_mail: "Вся почта",
    fam_org_ret_all_mail_hint: "Жёсткий лимит на все сообщения",
    fam_org_ret_all_mail_info:
      "Жёсткое ограничение для всех папок. Любое сообщение старше указанного числа дней удаляется, включая входящие. Используйте с осторожностью.",
    ...
    fam_org_ret_enforce_info_desc:
      "Когда включено, эти лимиты хранения применяются к каждому аккаунту участника, и участники не могут их изменить. Когда выключено, лимиты применяются только к вашему собственному аккаунту.",
    fam_org_ret_enforce_on_desc:
      "Применяется ко всем участникам - они не могут переопределить",
    fam_org_ret_enforce_off_desc:
      "Когда включено, эти лимиты применяются ко всем аккаунтам участников. Участники не могут переопределить.",
    fam_org_ret_saving: "Сохранение...",
    fam_org_ret_confirm_title: "Применить хранение ко всем участникам?",
    fam_org_ret_confirm_body:
      "Эти лимиты хранения будут применены к каждому аккаунту в этой семье. Участники не смогут их переопределить, а почта старше ваших лимитов будет безвозвратно удалена из их аккаунтов. Для уже удалённых сообщений это нельзя отменить.",
    ...
    fam_consent_body:
      "Это изменение затрагивает данные всех членов семьи. Запрос на согласие будет отправлен {{count}} участнику(-ам). Изменение вступит в силу только после того, как все участники примут его.",
    ...
    fam_ret_unsaved_consent:
      "Изменения требуют согласия участников перед сохранением",
    fam_ret_request_consent: "Запросить согласие",
    fam_consent_retention_desc:
      "Обновить политику хранения данных, затрагивающую все учётные записи участников",
    fam_consent_filter_create_desc:
      "Добавить правило фильтрации для всей организации во входящие всех участников",
    fam_consent_filter_enable_desc:
      "Включить правило фильтрации для всей организации во входящих всех участников",
    fam_consent_security_desc:
      "Обновить политику безопасности, затрагивающую все учётные записи участников",
    ...
    fam_org_cancelled_banner:
      "Ваш семейный тариф отменён - участники потеряют доступ",
    ...
    fam_org_seats_full_notice:
      "Все 2 места заняты. Перейдите на семейный тариф для до 6 участников.",
    ...
    fam_org_no_members_desc:
      "Пригласите кого-нибудь, чтобы разделить этот семейный тариф",
    fam_org_members_info_title: "Участники",
    fam_org_members_info_desc:
      "Все участники вашего семейного тарифа. У каждого участника свой отдельный зашифрованный аккаунт. Как владелец, вы можете приглашать людей, задавать объём хранилища для каждого участника, передавать права владельца или удалять участников.",
    ...
    fam_org_wizard_invite_desc:
      "Они получат письмо со ссылкой для присоединения.",
    ...
    fam_org_wizard_done_title_sent:
      "Приглашение отправлено - изучите свой тариф",
    fam_org_wizard_done_title: "Изучите свой семейный тариф",
    fam_org_wizard_done_desc_sent:
      "Приглашение отправлено на {{email}}. У них есть 7 дней, чтобы принять его.",
    fam_org_wizard_done_desc:
      "Здесь всё, что вы можете настроить во вкладках выше.",
    ...
    fam_org_wizard_grid_security_desc:
      "Требуйте 2FA и задавайте ограничения сессий для всех участников",
    fam_org_wizard_grid_groups: "Группы",
    fam_org_wizard_grid_groups_desc:
      "Создавайте общие ящики, которые направляют почту нескольким участникам",
    fam_org_wizard_grid_filters: "Фильтры",
    fam_org_wizard_grid_filters_desc:
      "Блокируйте отправителей и применяйте правила ко всем ящикам участников",
    fam_org_wizard_grid_domains: "Домены",
    fam_org_wizard_grid_domains_desc:
      "Поделитесь пользовательским доменом, чтобы участники могли с него отправлять",
    fam_org_wizard_grid_retention: "Хранение",
    fam_org_wizard_grid_retention_desc:
      "Задайте расписание автоудаления для корзины, спама и отправленной почты",
    fam_org_wizard_grid_activity: "Журнал активности",
    fam_org_wizard_grid_activity_desc:
      "Просматривайте все действия администратора: приглашения, удаления, изменения политик",
    ...
    color_theme_description: "Выберите готовую цветовую палитру для приложения",
    color_theme_default: "По умолчанию",
    color_theme_purple: "Фиолетовый",
    color_theme_green: "Зелёный",
    color_theme_rose: "Розовый",
    color_theme_orange: "Оранжевый",
    color_theme_teal: "Бирюзовый",
    color_theme_indigo: "Индиго",
    color_theme_amber: "Янтарный",
    color_theme_cyan: "Голубой",
    color_theme_slate: "Сланцевый",
    color_theme_aster_blue: "Aster Blue",
    color_theme_lime: "Лайм",
    color_theme_fuchsia: "Фуксия",
    custom_theme_title: "Своя тема",
    custom_theme_description:
      "Создайте свою цветовую палитру на основе одного цвета, безопасно сгенерированную на вашем устройстве",
    custom_theme_colors_title: "Цвета темы",
    custom_theme_color_label: "Базовый цвет",
    language_format_title: "Язык и формат",
    custom_theme_active: "Применена сейчас",
    custom_theme_inactive: "Выберите цвет, чтобы применить свою тему",
    custom_theme_role_accent: "Акцент",
    custom_theme_role_accent_hover: "Акцент (при наведении)",
    custom_theme_role_background: "Фон",
    custom_theme_role_background_secondary: "Фон (вторичный)",
    custom_theme_role_text: "Текст",
    custom_theme_role_text_secondary: "Текст (вторичный)",
    custom_theme_role_border: "Граница",
    custom_theme_reset_role: "Сбросить на автоматический",
    custom_theme_reset_all: "Сбросить всё на автоматический",
    font_choice_title: "Шрифт",
    font_choice_description: "Выберите шрифт, используемый во всём приложении",
    font_option_default: "Стандартный Aster",
    font_option_system: "Системный шрифт",
    email_font_choice_title: "Шрифт писем",
    email_font_choice_description: "Шрифт для чтения писем",
    email_font_option_match_app: "Как в приложении",
    ...
    time_zone_show_all: "Показать все часовые пояса",
    ...
    your_encryption_key: "Ваш ключ OpenPGP",
    key_fingerprint: "Код подтверждения",
    info_fingerprint_title: "Что это за код?",
    info_fingerprint_description:
      "Короткий код, созданный на основе вашего ключа шифрования. Если собеседник сверит этот код со своим и они совпадут, вы оба можете быть уверены, что переписка приватна и не была подменена.",
    copy_fingerprint: "Копировать код подтверждения",
    copy_public_key: "Копировать открытый ключ",
    view_public_key: "Показать открытый ключ",
    failed_download_codes:
      "Не удалось загрузить коды восстановления. Попробуйте снова.",
    ...
    login_alerts_sessions_title: "Оповещения о входе и сессии",
    ...
    password_last_updated: "Последнее обновление {{date}}.",
    ...
    sign_out_everywhere_success: "Завершено {{count}} других сеансов",
    ...
    two_step_verification_description:
      "Мы рекомендуем требовать код подтверждения в дополнение к паролю.",
    authenticator_app: "Приложение для 2FA",
    ...
    thread_count_position_description:
      "Выберите, где отображается значок количества цепочек относительно имени отправителя",
    ...
    compose_window_mode_description:
      "Выберите, как по умолчанию открывается окно написания",
    ...
    disable_2fa_description:
      "Введите код из приложения-аутентификатора и пароль, чтобы отключить 2FA. Это снизит безопасность вашего аккаунта.",
    ...
    two_factor_guide_step_code:
      "Введите ниже 6-значный код, сгенерированный приложением, чтобы завершить настройку.",
    verify_2fa_setup:
    ...
    info_forward_secrecy_description:
      "Ваши ключи сеанса автоматически меняются. Даже если кто-то получит ваш приватный ключ сегодня, он не сможет прочитать старые сообщения, так как каждый сеанс использовал другой ключ.",
    info_key_rotation_interval_title: "Интервал ротации ключей",
    info_key_rotation_interval_description:
      "Как часто ваш ключ шифрования заменяется. Чаще означает безопаснее, но с немного большей нагрузкой. Неделя - хорошее значение по умолчанию для большинства.",
    info_key_history_limit_title: "Лимит истории ключей",
    info_key_history_limit_description:
      "Сколько старых ключей Aster хранит для расшифровки старых писем. Слишком низкий лимит, и более старые сообщения могут стать нечитаемыми.",
    info_wkd_title: "Что такое WKD?",
    info_wkd_description:
      "Стандарт, позволяющий почтовым приложениям вроде Thunderbird или Proton автоматически находить ваш публичный ключ. Контакты могут отправлять вам зашифрованную почту без ручного обмена ключами.",
    ...
    info_folder_lock_mode_description:
      "Сеанс блокирует папку при закрытии приложения. При выходе блокирует сразу при навигации прочь, требуя пароль каждый раз при возврате.",
    info_block_remote_images_title: "Зачем блокировать внешние изображения?",
    info_block_remote_images_description:
      "Когда письмо загружает изображения с внешних серверов, отправитель видит ваш IP и время открытия. Блокировка защищает эту информацию.",
    info_remote_image_loading_title: "Параметры загрузки изображений",
    info_remote_image_loading_description:
      "Никогда: всегда блокировать. Спрашивать: показывать запрос каждый раз. Всегда: загружать без вопросов. Управляет исключениями из блокировки изображений.",
    info_tracking_protection_title: "Защита от отслеживания",
    info_tracking_protection_description:
      "Предотвращает отправку данных из писем при открытии. Отправители используют пиксели, шрифты и CSS, чтобы фиксировать, кто и когда открыл письмо.",
    info_block_tracking_links_title: "Что такое трекинговые ссылки?",
    info_block_tracking_links_description:
      "Рекламные письма добавляют к своим ссылкам скрытые метки, например utm_source, fbclid и gclid. Они сообщают отправителю, из какой кампании вы пришли, и подтверждают переход по ссылке. Aster удаляет их из каждой ссылки в письме, поэтому ссылка открывает ту же страницу и ничего не передаёт отправителю.",
    info_two_factor_auth_title: "Двухфакторная аутентификация",
    info_two_factor_auth_description:
      "Добавляет второй уровень защиты при входе. После пароля вы вводите 6-значный код из приложения-аутентификатора.",
    info_session_timeout_title: "Таймаут сеанса",
    info_session_timeout_description:
      "Автоматически завершает сеанс после периода бездействия. Полезно на общих компьютерах или для защиты, когда вы отходите.",
    info_login_alerts_title: "Оповещения о входе",
    info_login_alerts_description:
      "Отправляет письмо каждый раз, когда в ваш аккаунт входят с нового устройства или места. Помогает раано обнаружить несанкционированный доступ.",
    info_external_link_warnings_title: "Предупреждения о внешних ссылках",
    info_external_link_warnings_description:
      "Показывает предупреждение перед открытием любой ссылки за пределами Aster. Помогает замечать фишинговые попытки до перехода.",
    info_auto_discover_keys_title: "Автопоиск ключей",
    info_auto_discover_keys_description:
      "Автоматически загружает ключи шифрования для ваших контактов, чтобы отправлять им зашифрованную почту без ручной настройки.",
    info_encrypt_by_default_title: "Шифровать по умолчанию",
    info_encrypt_by_default_description:
      "Автоматически шифрует исходящие письма, когда доступен публичный ключ получателя. Не нужно включать шифрование для каждого сообщения.",
    ...
    info_spam_sensitivity_description:
      "Высокая перехватывает больше спама, но иногда может помечать настоящие письма. Низкая пропускает больше. Средняя - правильный баланс для большинства.",
    info_conversation_grouping_title: "Группировка переписок",
    info_conversation_grouping_description:
      "Группирует письма с одинаковой темой в одну ветку. Упрощает отслеживание переписки.",
    ...
    dns_instruction_set_dmarc_host:
      "Установите хост _dmarc (без вашего домена)",
    ...
    fill_smtp_first:
      "Сначала нужны данные исходящего сервера, чтобы их можно было проверить.",
    fill_connection_first:
      "Сначала нужны данные соединения, чтобы их можно было проверить.",
    ...
    no_password_recovery_desc:
      "Если этот пароль будет забыт, никто не сможет вернуть доступ к этой папке. Его сохранение в надёжном месте важно.",
    ...
    remove_protection_warning_desc:
      "После этого любой, кто вошёл в вашу учётную запись, сможет читать эту папку без отдельного пароля. С этого момента надёжность самой учётной записи становится особенно важной.",
    ...
    running_low_warning:
      "Кодов восстановления осталось мало. Новый набор и его сохранение в надёжном месте обычно лучший способ остаться под защитой.",
    ...
    alias_limit_all_used:
      "Вы использовали {{used}} из {{count}} псевдонимов в текущем плане.",
    ...
    set_host_root:
      "Установите хост @ (не вводите ваш домен; провайдер добавит его автоматически)",
    use_exact_host:
    ...
    host_invalid_characters:
      "В адресе сервера {{label}} есть символы, которые здесь нельзя использовать. Подойдёт имя хоста само по себе, например mail.example.com.",
    ...
    label_color_invalid:
      "Этот цвет нельзя использовать. Один из палитры обычно подходит.",
    smtp_test_failed:
      "Тест исходящего сервера не прошёл. Главные пункты для проверки ниже: сервер, порт и пароль.",
    ...
    sync_failed_detail:
      "Последняя синхронизация в {{time}} не завершилась. Повторная попытка или проверка пароля учётной записи обычно решает вопрос.",
    ...
    signature_alias_in_use:
      "Этот псевдоним уже используется другой подписью. Другой обычно подходит.",
    signature_placement_inherit: "Использовать общую настройку",
    signature_alias_conflict_error:
      "Этот псевдоним уже используется другой подписью. Другой здесь обычно подходит.",
    ...
    invalid_settings_format:
      "Этот файл не совпадает с ожидаемым форматом настроек. Другой экспорт обычно подходит. Текущие настройки остаются без изменений.",
    ...
    badges_title: "Значки",
    badges_description: "Покажите заработанные значки.",
    ...
    grace_period_remaining:
      "На обновление способа оплаты остаётся {{days}} дн., после чего тариф переходит на Free.",
    ...
    storage_approaching_description:
      "Использовано более 75% хранилища. Удаление части старых писем или повышение тарифа обычно лучший способ остаться под защитой до того, как место закончится.",
    ...
    cancel_reason_description:
      "Почему вы решили отменить подписку? Это необязательно и помогает нам стать лучше.",
    cancel_reason_too_expensive: "Слишком дорого",
    cancel_reason_not_using: "Пользуюсь недостаточно часто",
    cancel_reason_missing_feature: "Не хватает нужной функции",
    cancel_reason_switched_provider: "Перешёл к другому провайдеру",
    cancel_reason_bugs: "Слишком много ошибок или проблем",
    cancel_reason_privacy_trust: "Сомнения в приватности или доверии",
    ...
    referral_gauge_earned_label: "Заработано",
    total_earned: "Всего заработано",
    affiliate_program: "Партнёрская программа",
    affiliate_status_title: "Статус партнёра по программе",
    affiliate_status_description:
      "Вы участвуете в партнёрской программе Aster Mail и получаете {{ percent }}% комиссии с каждого платежа приглашённых вами подписчиков, пока они остаются подписчиками.",
    affiliate_commission_rate: "Ставка комиссии",
    affiliate_total_earned: "Всего заработано",
    affiliate_amount_owed: "Сумма к выплате",
    affiliate_paid_out: "Выплачено",
    affiliate_brand_badge: "Бренд-партнёр",
    affiliate_your_link_label: "Ваша партнёрская ссылка",
    affiliate_lifetime_cap: "Максимальный заработок в месяц: {{ value }}",
    affiliate_cap_resets_in: "Сброс через {{ days }} дн.",
    affiliate_info_hint_cap_title: "Максимальный заработок в месяц",
    affiliate_info_hint_cap:
      "Партнёрские комиссии ограничены суммой {{ value }} за календарный месяц. По достижении лимита начисление комиссий прекращается до автоматического сброса в начале следующего месяца, через {{ days }} дн.",
    affiliate_info_hint_paid_out_title: "Выплачено",
    affiliate_info_hint_paid_out:
      "Общая сумма комиссии, уже выплаченная вам по всем завершённым запросам на выплату. Это значение не сбрасывается ежемесячно.",
    affiliate_info_hint_owed_title: "Причитающаяся сумма",
    affiliate_info_hint_owed:
      "Ваш текущий невыплаченный баланс комиссии. Это сумма, доступная для запроса в качестве следующей выплаты, и она накапливается до тех пор, пока вы не запросите выплату.",
    affiliate_info_title: "Условия программы",
    affiliate_info_step_commission:
      "Комиссия начисляется по ставке {{ percent }}% от суммы платежа подписчика, до вычета применимых налогов и сборов. Она носит регулярный характер: вы получаете комиссию с каждого платежа за продление подписки приглашённого вами подписчика, пока он остаётся подписчиком, а не только с первого платежа.",
    affiliate_info_step_cap:
      "Общий заработок ограничен {{ value }} в календарный месяц на одного бренд-партнёра. Лимит автоматически сбрасывается в начале каждого месяца, и по достижении месячного лимита дополнительная комиссия не начисляется.",
    affiliate_info_step_payout:
      "Для запроса выплаты требуется минимальный доступный остаток в размере 5 $. Заявки на выплату рассматриваются вручную нашей командой и после одобрения обычно обрабатываются в течение 3-5 рабочих дней.",
    affiliate_info_step_disclosure:
      "Бренд-партнёры обязаны чётко раскрывать свои партнёрские отношения с Aster Mail везде, где продвигается программа, в соответствии с применимыми нормами раскрытия рекламной информации.",
    affiliate_info_step_tax:
      "Вы несёте единоличную ответственность за декларирование и уплату любых налогов с партнёрского дохода в вашей юрисдикции.",
    affiliate_info_step_tax_reporting:
      "Если общая сумма ваших комиссионных доходов достигает $2000 или более в течение календарного года, мы обязаны сообщить о ваших доходах в соответствующий налоговый орган. Для этого нам потребуется заполненная форма W-9 (для граждан США) или W-8BEN (для лиц, не являющихся гражданами США) в нашем архиве, а дальнейшие выплаты будут приостановлены до её получения. Если действительная форма не будет предоставлена, налоговое законодательство может потребовать от нас удержать часть будущих выплат. Мы свяжемся с вами напрямую, если это применимо к вам.",
    affiliate_info_step_account_binding:
      "Статус партнёра и бренд-партнёра привязан исключительно к одной учётной записи Aster Mail. Он не может быть предоставлен, передан или продублирован на нескольких учётных записях, принадлежащих одному и тому же лицу или организации.",
    ...
    affiliate_template_copied: "Запрос на выплату создан",
    affiliate_payout_email_body:
      "Здравствуйте,\n\nЯ хотел бы запросить выплату по партнёрской программе.\n\nID запроса: {{ request_id }}\nСтавка комиссии: {{ commission_percent }}%\nВсего заработано: {{ total_earned }}\nУже выплачено: {{ total_paid_out }}\nСумма к выплате: {{ outstanding }}\n\nСообщите, пожалуйста, о дальнейших шагах.\n\nСпасибо",
    affiliate_nothing_owed: "У вас пока нет невыплаченной суммы для запроса.",
    affiliate_payout_request_failed:
      "Не удалось создать запрос на выплату. Пожалуйста, попробуйте снова.",
    ...
    affiliate_payout_amount_below_minimum:
      "Минимальная сумма выплаты составляет 5 $.",
    affiliate_learn_more_irs_confirm_title: "Покинуть Aster Mail?",
    affiliate_learn_more_irs_confirm:
      "Вы собираетесь перейти на сайт IRS (irs.gov) в новой вкладке.",
    affiliate_payout_history_title: "История выплат",
    affiliate_payout_history_empty: "Пока нет запросов на выплату.",
    affiliate_payout_status_pending: "В ожидании",
    affiliate_payout_status_accepted: "Выплачено",
    affiliate_payout_status_rejected: "Отклонено",
    affiliate_payout_requested_on: "Запрошено {{ date }}",
    ...
    oauth_import_error:
      "Подключить учётную запись не получилось: {{reason}}. Повторная попытка или другой провайдер обычно подходит.",
    oauth_import_loading: "Подключение к {{ provider }}...",
    feature_locked:
      "Это входит в тариф {{plan}}. Повышение тарифа его включает.",
    ...
    scan_qr_code_description:
      "Отсканируйте QR-код любым удобным приложением-аутентификатором",
    ...
    rotate_keys_description_manual:
      "Введите пароль, чтобы обновить ключи шифрования. Старые письма останутся читаемыми.",
    rotate_keys_description_required:
      "Пришло время обновить ключи шифрования. Введите пароль, чтобы создать новые ключи и обеспечить прямую секретность.",
    rotating: "Обновление...",
    ...
    prices_converted_note:
      "Цены пересчитаны из долларов США и являются приблизительными. Точную сумму, включая комиссию за конвертацию, вы увидите при оформлении заказа.",
    ...
    plan_change_confirm_description:
      "Переход на {{plan}}. Оставшееся время текущего тарифа будет зачтено в новый план.",
    ...
    free_plan_banner_title: "Вы используете бесплатный тариф",
    ...
    domain_purchase_banner_title: "Получите собственный почтовый домен",
    domain_purchase_banner_subtitle:
      "Найдите, купите и начните получать почту за секунды. DNS настраивается автоматически.",
    domain_purchase_banner_cta: "Купить домен",
    domain_purchase_title: "Купить домен",
    ...
    domain_purchase_one_year: "1 год",
    domain_purchase_n_years: "{{count}} года",
    domain_purchase_pay_with: "Оплатить",
    domain_purchase_pay_card: "Картой",
    ...
    domain_purchase_step_dns: "Настройка DNS",
    domain_purchase_step_activating: "Активация почтовых ящиков",
    domain_purchase_step_done: "Домен активен",
    domain_purchase_done_note:
      "Ваш домен готов. Теперь вы можете создавать на нём адреса и псевдонимы.",
    domain_purchase_slow_note:
      "Это занимает больше времени, чем обычно. Мы завершим настройку в фоновом режиме и сообщим по почте.",
    ...
    domain_purchase_intro_replay: "Показать пошаговое начало снова",
    domain_purchase_intro_examples: "Или начните с примера",
    domain_purchase_intro_tld_title: "Теперь выберите окончание",
    domain_purchase_intro_tld_sub:
      "Окончание влияет на цену и характер адреса. Если сомневаетесь, оставьте Все, и мы покажем всё, что подходит.",
    domain_purchase_results_for: "Вот что мы нашли для {{name}}",
    domain_purchase_results_for_sub:
      "Выберите тот, который нравится. Оплата занимает всего минуту, и новый адрес сможет принимать почту сразу после завершения.",
    domain_purchase_change_name: "Изменить название",
    domain_purchase_purchased_desc:
      "Домены, купленные через Aster, появляются здесь и автоматически работают как собственные домены. Выберите имя, оплатите и пользуйтесь сразу.",
    domain_purchase_filter_price: "Максимальная цена",
    domain_purchase_filter_price_any: "Любая цена",
    domain_purchase_more_suggestions: "Предложить ещё варианты",
    domain_purchase_sort_by: "Сортировать по",
    domain_purchase_order_summary: "Сводка заказа",
    domain_purchase_summary_whois: "Приватность WHOIS",
    domain_purchase_summary_dns: "Автоматическая настройка DNS",
    domain_purchase_summary_included: "Включено",
    domain_purchase_total_today: "Итого сегодня",
    ...
    domain_purchase_sort_label: "Сортировка",
    domain_purchase_sort_relevance: "Релевантность",
    domain_purchase_sort_price_low: "Цена: по возрастанию",
    domain_purchase_sort_price_high: "Цена: по убыванию",
    domain_purchase_sort_az: "Имя: от A до Z",
    domain_purchase_sort_discount: "Максимальная скидка",
    domain_purchase_show_more: "Показать больше результатов",
    domain_purchase_results_count: "Результатов: {{count}}",
    ...
    domain_purchase_error_not_allowed:
      "Этот домен сейчас недоступен для вашего аккаунта. Попробуйте другое имя или напишите в поддержку.",
    domain_purchase_order_expired:
      "Этот заказ истёк до оплаты. Начните новую покупку, чтобы получить домен.",
    domain_purchase_order_lapsed:
      "Срок действия этого домена истёк, он больше не активен. Купите его снова, чтобы вернуть.",
    ...
    addon_limit_one_active:
      "У вас уже есть активное дополнение к хранилищу. Отмените его перед покупкой нового.",
    ...
    auto_delete_spam_description:
      "Письма в спаме старше указанного срока будут удалены навсегда.",
    ...
    block_remote_css_description:
      "Запретить письмам загружать таблицы стилей с внешних серверов",
    ...
    account_protection_hint_weak:
      "Ваш аккаунт под угрозой. Включите дополнительные параметры защиты.",
    account_protection_hint_fair:
      "Вашему аккаунту нужна дополнительная защита.",
    account_protection_hint_partial:
      "Включите больше параметров для более надёжной защиты.",
    account_protection_hint_strong: "Ваш аккаунт хорошо защищён.",
    account_security_percent_title:
      "Уровень безопасности вашего аккаунта: {{percent}}%",
    account_security_review_subtitle:
      "Регулярно проверяйте настройки безопасности вашего аккаунта и обновляйте пароль.",
    ...
    block_remote_images_description:
      "Запретить письмам загружать изображения с внешних серверов",
    ...
    block_spy_pixels_description:
      "Блокировать невидимые пиксели отслеживания, уведомляющие отправителей об открытии письма",
    block_tracking_links: "Очищать ссылки от трекеров",
    block_tracking_links_description:
      "Удалять параметры отслеживания из ссылок в письмах",
    ...
    cashapp_redirect_notice:
      "Вы будете перенаправлены в Cash App для подтверждения платежа. Вернитесь сюда после подтверждения.",
    ...
    confirm_remove_key:
      "Вы уверены, что хотите удалить этот ключ безопасности?",
    connect_modal_description:
      "Войдите в {{ provider }}, чтобы импортировать почту в Aster. Сообщения шифруются на этом устройстве перед сохранением на серверах.",
    connect_modal_privacy_note:
      "Aster запрашивает только необходимые разрешения для импорта входящих. Мы никогда не читаем, не сканируем и не продаём ваши сообщения.",
    ...
    "connection.tor_warning":
      "Весь трафик будет направлен через сеть Tor. Ожидайте снижения скорости.",
    ...
    credit_task_refer_hint:
      "Получайте процент с каждого платежа друга после оформления подписки.",
    ...
    credits_subtitle:
      "Зарабатывайте кредиты Aster, выполняя различные задания.",
    ...
    crypto_price_unavailable:
      "Оплата криптовалютой недоступна для этого тарифа. Обратитесь в службу поддержки.",
    crypto_charged_in_usd: "Списание в долларах США.",
    crypto_native_continue: "Продолжить",
    crypto_native_choose_method: "Выберите способ оплаты",
    crypto_native_loading_coins: "Загрузка способов оплаты...",
    crypto_native_on_chain: "в сети {{chain}}",
    ...
    crypto_native_received_label: "Получено на данный момент",
    ...
    crypto_select_term:
      "Выберите срок. С вас будет снята однократная плата в USDC, и тарифный план будет активен до конца срока. Не продлевается автоматически.",
    ...
    delete_domain_cooldown:
      "После удаления этот домен нельзя будет добавить снова в течение 30 дней.",
    delete_domain_warning:
      "Все адреса на этом домене перестанут получать почту сразу после удаления. Это действие нельзя отменить.",
    ...
    bridge_installations_description:
      "Каждая запись - это приложение Bridge, связанное с вашим аккаунтом. Отзыв отключает все почтовые клиенты, использующие эту установку.",
    bridge_installations_empty: "Нет подключённых установок Bridge.",
    bridge_revoke_title: "Отозвать установку?",
    bridge_revoke_message:
      "Это отключит {{ name }} и все почтовые клиенты, использующие её. Можно восстановить подключение, повторно связав Bridge.",
    bridge_revoke_all_message:
      "Это отключит все установки Bridge и все почтовые клиенты, использующие их.",
    bridge_active_now: "Активен сейчас",
    bridge_support_title: "Нужна помощь?",
    bridge_support_description:
      "Получите помощь в настройке Aster Bridge с вашим почтовым клиентом.",
    ...
    desktop_bridge_upgrade_description:
      "Подключите Apple Mail, Thunderbird или Outlook к Aster с помощью Aster Bridge. Доступно начиная с тарифа Star.",
    ...
    disconnect_confirm:
      "Вы уверены, что хотите отключить этот аккаунт? Все синхронизированные письма останутся во входящих, если вы не удалите их.",
    ...
    dkim_rotated:
      "Ключ DKIM обновлён. Добавьте новую DNS-запись ниже у вашего регистратора.",
    dkim_rotated_warning_body:
      "Обновление меняет селектор, поэтому имя хоста ниже отличается от старой записи DKIM. Создайте новую TXT-запись по этому имени хоста. Не редактируйте старую запись. Оставьте старую запись до успешной верификации, затем её можно удалить.",
    dkim_rotated_warning_title: "Добавить как новую DNS-запись",
    domain_pending_hint:
      "Нажмите «Продолжить настройку», чтобы настроить DNS-записи и подтвердить домен.",
    ...
    error_tip_spf:
      "Если запись SPF уже существует, объедините её с указанной выше. Две записи SPF аннулируют друг друга.",
    error_tip_txt:
      "Запись TXT должна содержать точное значение выше. DNS-изменения могут распространяться несколько минут.",
    export: "Экспорт",
    export_cancel: "Отменить экспорт",
    export_cancelled_partial_saved:
      "Экспорт отменён. Частичный файл сохранён: {{ location }}.",
    ...
    export_complete_summary:
      "Экспортировано {{ count }} из {{ total }} сообщений.",
    export_description:
      "Скачайте почтовый ящик как стандартный MBOX-файл или папку с отдельными .EML-сообщениями.",
    export_destination_chosen: "Сохранение: {{ location }}",
    export_destination_fallback_notice:
      "Браузер не поддерживает сохранение напрямую на диск. Экспорт будет скачан как один файл по завершении.",
    ...
    export_format_eml_hint:
      "Один .eml-файл на сообщение в выбранной папке. Каждый файл - стандартное RFC 5322-сообщение со встроенными вложениями.",
    ...
    export_rate_limited_paused:
      "Кратковременная пауза из-за серверных ограничений.",
    export_reauth_failed: "Пароль не совпал.",
    export_step_verify_title: "Подтвердите личность",
    export_verify_description:
      "Подтвердите пароль своей учётной записи, прежде чем мы подготовим этот экспорт.",
    export_verify_submit: "Подтвердить",
    export_security_section_title: "Требуется подтверждение",
    export_security_password_row_title: "Пароль аккаунта и 2FA",
    export_security_password_row_body:
      "Перед каждым экспортом вам нужно будет подтвердить пароль и код аутентификатора, если включена 2FA.",
    ...
    export_scope_mail_body:
      "Все ваши сообщения и вложения в стандартном формате mbox или .eml.",
    ...
    export_warning_body:
      "Экспортированный файл содержит сообщения в незашифрованном виде. Любая программа, читающая файлы на этом компьютере, включая облачную синхронизацию (OneDrive, iCloud, Dropbox), может их прочитать. Сохраните в месте без синхронизации.",
    ...
    ghost_aliases_description:
      "Одноразовые псевдонимы, созданные через Ghost-режим. Ваш настоящий адрес остаётся скрытым.",
    ghost_aliases_empty:
      "Пока нет ghost-псевдонимов. Используйте Ghost-режим при написании, чтобы создать один.",
    ...
    import_delete_confirm_description:
      "Это удалит все письма из этого импорта. Вы сможете импортировать их снова позже. Это действие нельзя отменить.",
    ...
    vanguard_feature_app_lock_desc:
      "Блокируйте приложение PIN-кодом, когда отходите",
    ...
    promo_once_reverts:
      "Применяется только к {{period}}, затем возвращается к {{price}}{{interval}}",
    promo_then_reverts:
      "Затем через {{months}} месяцев вернётся к {{price}}{{interval}}",
    provider_cf_add_mx:
      "Нажмите «Добавить запись», выберите MX, установите приоритет и вставьте значения ниже",
    provider_cf_add_record:
      "Нажмите «Добавить запись», выберите TXT и вставьте значения ниже",
    ...
    provider_gd_add_mx:
      "Нажмите «Добавить», выберите MX, установите приоритет и введите значения ниже",
    provider_gd_add_record:
      "Нажмите «Добавить», выберите TXT и введите значения ниже",
    provider_gd_add_txt:
      "Нажмите «Добавить», выберите TXT и введите значения ниже",
    provider_gd_login: "Войдите в аккаунт GoDaddy",
    provider_gd_manage_dns:
      "Перейдите в «Мои продукты» > ваш домен > DNS > «Управление»",
    provider_gd_save: "Нажмите «Сохранить»",
    provider_nc_add_mx:
      "Нажмите «Добавить новую запись», выберите MX, установите приоритет и введите значения ниже",
    provider_nc_add_record:
      "Нажмите «Добавить новую запись», выберите TXT и введите значения ниже",
    provider_nc_add_txt:
      "Нажмите «Добавить новую запись», выберите TXT и введите значения ниже",
    provider_nc_advanced_dns:
      "Перейдите в «Список доменов» > ваш домен > «Расширенный DNS»",
    ...
    record_not_detected:
      "Мы ещё не нашли эту DNS-запись. Изменения могут распространяться несколько минут - проверьте позже.",
    academic_discount_title: "Скидка для студентов и журналистов",
    academic_discount_description:
      "Скидка 30% на индивидуальные тарифы для подтверждённых студентов и журналистов.",
    academic_intro:
      "Подтвердите свой академический адрес электронной почты, чтобы получить персональный код скидки 30% на тарифы Star, Nova и Supernova.",
    ...
    academic_verification_sent:
      "Письмо с подтверждением отправлено. Проверьте академическую почту.",
    academic_pending_title: "Ожидает подтверждения",
    academic_pending_description:
      "Мы отправили ссылку для подтверждения на ваш академический адрес. Ссылка действительна 24 часа.",
    ...
    academic_use_at_checkout:
      "Код применяется автоматически при оплате, либо введите его вручную.",
    academic_terms:
      "Скидка 30% на 12 месяцев для индивидуальных тарифов. Активируйте в течение 90 дней.",
    academic_verified_toast:
      "Академическая почта подтверждена. Ваш код скидки готов.",
    academic_failed_toast:
      "Подтверждение не удалось. Возможно, ссылка истекла - запросите новую.",
    academic_invalid_email:
      "Используйте академический адрес (например, .edu или .ac.uk). Если у вашего университета другой домен, обратитесь в поддержку.",
    academic_email_in_use:
      "Этот академический адрес уже используется для скидки.",
    ...
    remote_image_loading_description:
      "Управлять загрузкой внешних изображений в письмах",
    ...
    show_aster_branding_description:
      "Показывать «Защищено Aster Mail» в конце исходящих писем.",
    show_aster_branding_free_note:
      "Перейдите на платный тариф, чтобы убрать водяной знак.",
    ...
    purging_progress:
      "Удаление импортированных писем… {{ current }} из {{ total }}",
    ...
    tracking_protection_enabled_description:
      "Блокировать элементы отслеживания в письмах для защиты конфиденциальности",
    tracking_protection_title: "Защита от отслеживания",
    trusted_2fa_description:
      "Устройства, которые вы отметили как доверенные, пропускают запрос 2FA на 30 дней. Смена пароля немедленно аннулирует все доверенные устройства.",
    ...
    trusted_devices_description:
      "Десктопные и мобильные приложения, связанные с вашим аккаунтом. Отзыв устройства выходит из системы и удаляет локальный ключ хранилища.",
    ...
    upgrade_inline_card_description:
      "Обновите тариф для добавления новых элементов или удалите существующие.",
    upgrade_inline_card_title: "Вы достигли лимита тарифного плана",
    upgrade_modal_description_generic:
      "Вы достигли лимита текущего тарифа. Обновите, чтобы разблокировать больше возможностей.",
    upgrade_modal_description_specific:
      "Вы достигли лимита {{resource}} на тарифе {{plan}}. Обновите, чтобы разблокировать больше.",
    ...
    upgrade_perk_features:
      "Ответ об отсутствии, отложенная отправка и многое другое",
    ...
    crypto_rate_notice:
      "Когда вы выбираете монету, мы фиксируем курс и показываем точную сумму к отправке. Курс держится 60 минут для Bitcoin и 30 минут в сетях Ethereum. Ничего не списывается, пока вы сами не отправите платёж.",
  ...
  mail: {
    ...
    bulk_delete_title: "Удалить письма безвозвратно ({{count}})?",
    bulk_delete_title_one: "Удалить 1 письмо безвозвратно?",
    bulk_delete_title_other: "Удалить письма безвозвратно ({{count}})?",
    bulk_spam_title: "Пожаловаться на письма как на спам ({{count}})?",
    bulk_spam_title_one: "Пожаловаться на 1 письмо как на спам?",
    bulk_spam_title_other: "Пожаловаться на письма как на спам ({{count}})?",
    bulk_trash_title: "Переместить письма в корзину ({{count}})?",
    bulk_trash_title_one: "Переместить 1 письмо в корзину?",
    bulk_trash_title_other: "Переместить письма в корзину ({{count}})?",
    confirm_bulk_action_count_description: "Затрагивает все письма ({{count}}).",
    confirm_bulk_action_count_description_one: "Затрагивает 1 письмо.",
    confirm_bulk_action_count_description_other: "Затрагивает все письма ({{count}}).",
    confirm_bulk_action_scope_description: "Затрагивает все письма в {{scope}} ({{count}}).",
    confirm_bulk_action_scope_description_one: "Затрагивает единственное письмо в {{scope}}.",
    confirm_bulk_action_scope_description_other: "Затрагивает все письма в {{scope}} ({{count}}).",
    remove_from_folder: "Убрать из папки",
    remove_label: "Убрать ярлык",
    sender_rule_confirm: "Создать правило",
    sender_rule_created: "Новые письма от этого отправителя теперь попадают в {{category}}.",
    sender_rule_name: "{{sender}} в {{category}}",
    sender_rule_offer: "Вы часто переносите письма от {{sender}} в {{category}}. Делать это автоматически?",
    ...
    category_empty_finance_desc:
      "Здесь будут появляться выписки, счета и уведомления от банков и финансовых сервисов.",
    category_empty_travel_title: "Нет писем о путешествиях",
    category_empty_travel_desc:
      "Здесь будут появляться бронирования, маршруты и подтверждения.",
    ...
    block_sender_on_alias_failed:
      "Не удалось заблокировать отправителя. Попробуйте снова.",
    ...
    translation_unavailable: "Не удалось перевести это сообщение.",
    ...
    resize_compose: "Изменить размер окна написания",
    ...
    delete_email_confirmation:
      "Это письмо будет удалено окончательно, и отменить это нельзя.",
    empty_trash_confirmation:
      "Всё содержимое корзины будет удалено окончательно, и отменить это нельзя.",
    ...
    cancel_scheduled_confirmation:
      "Отменить это запланированное письмо. Оно не уйдёт, и отменить это решение нельзя, хотя черновик сохранён.",
    ...
    tag_not_found_subtitle:
      "Эта метка могла быть удалена или никогда не существовала. Другая из боковой панели обычно подходит.",
    ...
    block_sender_spam_warning:
      "С этого момента новые письма от этого отправителя будут попадать сразу в спам. В списке блокировки есть возможность снять блокировку позже.",
    ...
    max_composers_warning:
      "Одновременно можно держать открытыми до трёх окон письма. Закрытие одного даёт возможность открыть другое. Черновики сохранены.",
    ...
    resume_download_action: "Возобновить",
    ...
    chip_any_time: "Любое время",
    chip_older_than_week: "Старше недели",
    chip_older_than_month: "Старше месяца",
    chip_older_than_six_months: "Старше 6 месяцев",
    chip_older_than_year: "Старше года",
    chip_custom_range: "Свой диапазон",
    chip_has_attachment: "С вложением",
    chip_attachment_image: "Изображение",
    chip_attachment_document: "Документ",
    chip_attachment_pdf: "PDF",
    chip_attachment_video: "Видео",
    chip_is_unread: "Непрочитанные",
    chip_name_or_email: "Имя или адрес",
    chip_no_people: "Нет подходящих контактов",
    ...
    search_section_message: "Письмо",
    search_section_filters: "Фильтры",
    ...
    search_message_content_help_body:
      "Ваши сообщения зашифрованы, поэтому их нужно скачать и проиндексировать на этом устройстве. Это может занять значительное место. Индекс никогда не покидает устройство и удаляется при выходе.",
    ...
    spam_auto_delete_notice:
      "Элементы в спаме будут автоматически удалены через {{ days }} дней.",
    trash_auto_delete_notice_family:
      "Элементы в корзине будут автоматически удалены через {{ days }} дней (задано администратором семьи).",
  ...
  auth: {
    ...
    use_passkey_or_key:
      "Используйте Windows Hello, Face ID или ваш ключ безопасности",
    ...
    recovery_codes_warning:
      "Без кодов восстановления никто не сможет вернуть доступ к этой учётной записи, если пароль будет забыт, и зашифрованные данные окажутся утрачены безвозвратно. Продолжить без их сохранения?",
    ...
    passwords_do_not_match_register:
      "Эти два пароля не совпали. Повторный ввод обычно решает вопрос.",
    registration_failed:
      "Регистрация не завершилась. Начать сначала и попробовать снова обычно помогает. Учётная запись не создана.",
    ...
    please_enter_recovery_email:
      "Резервный адрес помогает вернуть доступ, если пароль будет забыт.",
    please_enter_valid_email:
      "Это не похоже на правильный адрес электронной почты. Что-то вроде name@example.com обычно подходит.",
    ...
    recovery_phrase_reveal:
      "Сначала нажмите на значок глаза, чтобы показать фразу",
    recovery_phrase_saved_checkbox:
      "Я сохранил(а) свою фразу восстановления в надёжном месте",
    recovery_phrase_skip_warning:
      "Без фразы восстановления забытый пароль означает, что ваша зашифрованная почта и псевдонимы будут потеряны навсегда. Продолжить без сохранения?",
    recovery_phrase_confirm_title: "Подтвердите вашу фразу восстановления",
    recovery_phrase_confirm_desc:
      "Выберите правильные слова, чтобы подтвердить, что вы сохранили фразу.",
    ...
    forgot_method_phrase_desc:
      "Введите вашу фразу из 12 слов. Вся почта, псевдонимы и настройки будут восстановлены.",
    forgot_method_code_title: "Использовать код восстановления",
    forgot_method_code_desc:
      "Введите один из ваших кодов восстановления ASTER. Вся почта, псевдонимы и настройки будут восстановлены.",
    ...
    log_in: "Войти",
    welcome_subtitle:
      "Современная почта, зашифрованная для вас и нечитаемая для остальных.",
    ...
    device_code_expired_description:
      "Срок действия этого кода истёк. Свежий код из десктопного приложения подойдёт.",
    device_code_expires_in: "Истекает через",
    device_code_get_new: "Получить новый код",
    device_code_instruction:
      "Введите этот код на app.astermail.org/link-device, чтобы привязать аккаунт.",
    ...
    link_device_expired_code:
      "Срок действия кода истёк или он не совпал. В вашем десктопном приложении есть актуальный код.",
    link_device_failed:
    ...
    password_breach_warning:
      "Этот пароль был обнаружен в утечке данных. Рекомендуем использовать другой.",
  ...
  passkeys: {
    ...
    security_key_not_found:
      "Аутентификация отменена или аутентификатор устройства недоступен.",
    no_platform_authenticator:
      "Windows Hello не настроен на этом устройстве. Перейдите в Параметры Windows > Учетные записи > Параметры входа, чтобы добавить PIN-код, отпечаток пальца или распознавание лица.",
    saved_to_password_manager:
      "Passkey сохранён в вашем менеджере паролей. Чтобы вместо этого использовать Windows Hello, закройте диалог менеджера паролей, когда он появится.",
    passkey_hint:
  ...
  errors: {
    ...
    cannot_react_spam_or_trash:
      "Нельзя ставить реакции на сообщения в Спаме или Корзине.",
    cannot_react_reply_to:
      "Нельзя поставить реакцию на сообщение с адресом для ответа.",
    cannot_react_too_many_recipients:
      "Нельзя поставить реакцию на сообщение с более чем 20 получателями.",
    cannot_react_bcc:
    ...
    network:
      "Дотянуться до сервера не удалось. Проверка соединения и повторная попытка обычно решает вопрос.",
    unauthorized:
      "Доступа к этому действию нет. Если это похоже на ошибку, администратор сможет помочь.",
    ...
    vault_version_drift:
      "Ваше зашифрованное хранилище из более ранней версии Aster, и мы обновляем его сейчас. Ваши данные в безопасности, и это случится только один раз.",
    vault_missing_key:
    ...
    decrypt_wrong_key:
      "У нас нет нужного ключа для чтения этого письма на этом устройстве. Выход и повторный вход обычно помогают. Ваше письмо в безопасности на сервере.",
    ...
    invalid_unsubscribe_address:
      "Адрес для отписки от этого отправителя выглядит некорректно. Ссылка в самом письме позволит отписаться на сайте отправителя.",
    tor_unsupported_platform:
      "Tor недоступен на этой платформе. Десктопное или мобильное приложение может направить ваше соединение через Tor.",
    tor_native_only:
    ...
    metadata_migration_stalled:
      "Нам не удалось завершить обновление локального хранилища после нескольких попыток. Проверка соединения и повторный запуск Aster обычно помогают. Ваша почта на сервере в безопасности.",
    account_already_added:
      "Этот аккаунт уже вошёл в систему на этом устройстве. Переключитесь на него через меню аккаунтов.",
    ...
    email_skipped_size:
      "Письмо {{number}} пропущено, так как превышает лимит в 50 МБ. Импорт продолжается.",
    emails_skipped_invalid:
      "Мы пропустили {{count}} писем без отправителя или текста. Остальные импортированы.",
    ...
    no_emails_in_pst:
      "В этом PST-файле нет читаемых писем. Попробуйте другой экспорт.",
    no_keys_available:
      "Ваши закрытые ключи заблокированы на этом устройстве. Пароль их разблокирует. Ключи на сервере не изменились.",
    no_permission:
      "У вас нет доступа к этому действию. Если это ошибка, обратитесь к администратору.",
  ...
  mail_rules: {
    ...
    cannot_render_visual:
      "Это правило содержит вложенные условия, которые визуальный редактор не может отобразить. Отредактировать можно в режиме Выражений.",
    category_forums: "Обсуждения",
    ...
    delete: "Удалить",
    delete_rule_body:
      "Входящая почта больше не будет фильтроваться этим правилом.",
  ...
  badges: {
    ...
    show_in_signature_description:
      "Включать активный значок в подписи исходящих писем.",
    show_on_profile_description:
      "Показывать активный значок другим пользователям Aster.",
  },
  secure_view: {
    ...
    expires: "Истекает",
    expired:
      "Срок действия этого защищённого сообщения истёк, оно больше недоступно.",
    password_prompt:
    ...
    reply_button: "Отправить ответ",
    reply_sending: "Отправка...",
    reply_sent: "Ваш ответ отправлен.",
    reply_failed: "Не удалось отправить ответ. Пожалуйста, попробуйте ещё раз.",
    reply_limit_reached: "Это сообщение достигло лимита ответов.",
    delete_button: "Удалить сообщение",
  ...
  shared_mailboxes: {
    ...
    create_hint:
      "{{count}}/{{max}} общих ящиков. Все с доступом читают и отправляют с одного адреса.",
    limit_reached: "Ваш тариф позволяет до {{max}} общих ящиков.",
    address_placeholder: "семья",
    empty_title: "Общих ящиков пока нет",
    empty_desc:
      "Создайте адрес вроде family@astermail.org, который сможет читать и использовать вся семья - без дополнительного пароля.",
    frozen: "Заморожен",
    rotation_needed: "Обновить доступ",
    rotation_explainer:
      "Кто-то потерял доступ к этому ящику. Обновите его ключи, чтобы удалённые участники больше не могли открывать новую почту.",
    rotate: "Обновить ключи",
    rotated: "Ключи ящика обновлены",
    rotate_conflict:
      "Список участников изменился во время обновления. Он обновлён - попробуйте ещё раз.",
    revoke_rotation_pending:
      "Доступ удалён, но ключи не удалось обновить. Нажмите «Обновить доступ» - до этого участник сохраняет доступ.",
    created_grant_pending:
      "Ящик создан, но настроить ваш доступ не удалось. Откройте строку ящика и предоставьте себе доступ.",
    load_failed_retry:
      "Не удалось загрузить общие ящики. Нажмите, чтобы повторить.",
    open: "Открыть",
    ...
    delete_confirm_message:
      "Удалить {{address}}? Адрес перестанет получать почту и не сможет быть зарегистрирован снова.",
  ...
  survey: {
    ...
    signup_leave_big_tech: "Уйти от Big Tech",
    signup_open_source: "Открытый исходный код",
    signup_specific_feature: "Конкретная функция",
    signup_price: "Цена",
    signup_curiosity: "Любопытство",
    q_stood_out: "Что больше всего выделило Aster среди других вариантов?",
    stood_openpgp: "Стандартный OpenPGP, ключи работают везде",
    stood_post_quantum: "Постквантовое шифрование",
    stood_open_source: "Открытый код (AGPL)",
    stood_germany: "Хостинг в Германии",
    stood_price: "Цена",
    stood_ui: "Интерфейс / кастомизация",
    q_upgrade_blocker: "Что мешает вам перейти на платный план?",
    q_upgrade_trigger: "Что в итоге побудило вас перейти на платный план?",
    trigger_storage: "Закончилось хранилище",
    trigger_feature: "Хотел конкретную функцию",
    trigger_support_mission: "Поддержать миссию / проект",
    trigger_switched_fully: "Полностью перешёл с другого провайдера",
    q_plan_reason: "Почему вы выбрали план {{plan}}?",
    q_cancel_reason: "Что заставило бы вас отменить план?",
    q_hesitation: "Что было главным сомнением перед покупкой плана?",
    hesitation_price: "Цена",
    hesitation_trust: "Не был уверен, что могу доверять",
    hesitation_missing_feature: "Отсутствующая функция",
    hesitation_longevity: "Сомневался, что Aster просуществует долго",
    hesitation_none: "Сомнений не было",
    option_other: "Другое",
    other_placeholder: "Расскажите подробнее",
    open_placeholder: "Ваш ответ",
