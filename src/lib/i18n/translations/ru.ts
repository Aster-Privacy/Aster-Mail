...
export const ru = {
  common: {
    ...
    unexpected_error_refresh:
      "На этой странице возникла заминка. Обновление обычно её устраняет. Данные в безопасности.",
  ...
  settings: {
    ...
    info_block_tracking_links_description:
      "Ссылки в письмах часто сначала проходят через сервер отправителя для записи кликов. Это убирает перенаправления, чтобы ссылки вели прямо к цели.",
