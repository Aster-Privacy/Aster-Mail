...
export const ru = {
  common: {
    ...
    billing_alert_body:
      "Последний платёж не прошёл. Обновите способ оплаты, чтобы сохранить тариф.",
    billing_alert_body_days:
      "Последний платёж не прошёл. Обновите способ оплаты в течение {{days}} дней, чтобы сохранить тариф.",
    billing_alert_action: "Обновить оплату",
    dismiss: "Отклонить",
