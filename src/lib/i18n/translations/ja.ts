...
export const ja = {
  common: {
    ...
    recipient_key_outdated_desc: "この受信者の公開鍵は期限切れまたは無効なため、メッセージをエンドツーエンドで暗号化できません。転送時のみ保護されて送信されます。",
    ...
    unblock_failed: "{{ email }} のブロックを解除できませんでした。もう一度お試しください。この送信者は現在ブロックされたままです。",
    remove_from_allowlist_failed: "{{ email }} を許可リストから削除できませんでした。もう一度お試しください。現在は許可されたままです。",
    bulk_unblock_failed: "これらの送信者のブロックを解除できませんでした。もう一度お試しください。現在はブロックされたままです。",
    bulk_remove_allowlist_failed: "これらの送信者を許可リストから削除できませんでした。もう一度お試しください。現在は許可されたままです。",
    ...
    n_messages_count_one: "{{count}} 件のメッセージ",
  ...
  settings: {
    ...
    criterion_passkey: "パスキーを登録済み",
    criterion_read_receipts_off: "開封確認オフ",
    fam_kids_tab: "子ども",
    fam_kids_title: "子ども用に予約したアドレス",
    fam_kids_subtitle: "今すぐお子さま用のアドレスを確保し、後でお子さま自身のパスワードで設定を完了できます。",
    fam_kids_seats_used: "家族の席 {{max}} 件中 {{used}} 件を使用中（メンバー、招待、予約）",
    fam_kids_reserve_btn: "アドレスを予約",
    fam_kids_seats_full: "家族グループは満員です。別のアドレスを予約するには席を空けてください。",
    ...
    fam_kids_info_desc: "アドレスはお子さま用に確保され、他の人には使用できなくなります。お子さま（またはあなた）が後で個人のパスワードで設定を完了すると、ゼロアクセスの本物のアカウントが作成され、自動的に家族に参加します。",
    fam_kids_nickname_label: "ニックネーム（任意）",
    fam_kids_nickname_ph: "例：たろう",
    fam_kids_storage_label: "このアドレスのストレージ",
    fam_kids_checking: "利用可能か確認中...",
    fam_kids_available: "利用可能",
    fam_kids_taken: "すでに使用されています",
    fam_kids_reserved_taken: "すでに予約されています",
    fam_kids_invalid: "有効なユーザー名ではありません",
    fam_kids_consent_label: "私はこの子の親または法定後見人であり、この子のためのアカウント作成に同意することを確認します。",
    fam_kids_consent_required: "続行するには保護者の同意を確認してください。",
    fam_kids_link_hint: "受け取りリンクを持つ人は誰でもこのアドレスを設定できます。お子さまとだけ共有し、漏れた場合は再生成してください。",
    fam_kids_create: "予約",
    fam_kids_creating: "予約中...",
    fam_kids_cancel: "キャンセル",
    fam_kids_created: "アドレスを予約しました · 受け取りリンクをコピーしました",
    fam_kids_create_failed: "そのアドレスを予約できませんでした",
    fam_kids_copy_link: "受け取りリンクをコピー",
    fam_kids_link_copied: "受け取りリンクをコピーしました",
    fam_kids_regenerate: "リンクを再生成",
    fam_kids_regenerated: "新しい受け取りリンクを生成しました",
    fam_kids_setup_now: "今すぐ設定",
    fam_kids_release: "解放",
    fam_kids_released: "予約を解放しました",
    fam_kids_release_confirm: "この予約済みアドレスを解放しますか？再び全員が利用できるようになります。",
    fam_kids_status_reserved: "予約済み",
    fam_kids_status_claimed: "有効",
    fam_kids_claimed_active: "アカウントを設定し、家族に参加しました",
    fam_kids_load_failed: "予約を読み込めませんでした",
    fam_kids_claim_setup_for: "{{address}} を設定中",
    fam_kids_claim_intro: "この家族用アドレスの設定を完了するにはパスワードを選んでください。",
    fam_kids_claim_invalid_title: "このリンクは無効になりました",
    fam_kids_claim_invalid_body: "この受け取りリンクは有効期限が切れたか、すでに使用されたか、取り消されました。家族のオーナーに新しいリンクをお願いしてください。",
    fam_kids_claim_signed_in_title: "別のアカウントにサインインしています",
    fam_kids_claim_signed_in_body: "このリンクは新しい子ども用アカウントを設定します。プライベート/シークレットウィンドウで開くか、お子さまの端末で使うためにコピーしてください。",
    fam_kids_release_modal_title: "このアドレスを解放しますか？",
    fam_kids_release_modal_body: "{{address}} は誰でも登録できる状態になります。この操作は取り消せません。",
    fam_kids_release_btn: "解放",
    alias_captcha_required: "エイリアスを作成するにはキャプチャを完了してください。",
    ...
    alias_import_drop_hint: "CSV（SimpleLogin、Addy.io）またはProton Passのdata.jsonをここにドロップするか、ファイルを選択してください",
    ...
    alias_activity_title: "アクティビティ（過去7日間）",
  ...
  mail: {
    ...
    content_search_off_hint: "メッセージ本文は検索されていません。メール内のテキストを探すには本文検索を有効にしてください。",
  ...
  auth: {
    link_device_upgrade_required_toast: "Bridge デバイスをリンクするには Star プラン以上が必要です。続けるにはアップグレードしてください。",
    link_device_upgrade_title: "このデバイスをリンクするにはアップグレードしてください",
    link_device_upgrade_description: "デスクトップ版 Bridge をアカウントに接続するには Star プラン以上が必要です。以下からプランを選ぶと、決済後すぐにデバイスがリンクされます。",
    link_device_upgrade_cta: "Star にアップグレード",
    link_device_upgrade_failed: "決済を開始できませんでした。もう一度お試しいただくか、設定の「請求」を開いてください。",
    link_device_already_linked: "このデバイスはすでに別のアカウントにリンクされています。まずそちらでリンクを解除してから、もう一度お試しください。",
    link_device_rate_limited: "試行回数が多すぎます。1 分ほど待ってから、もう一度お試しください。",
    link_device_account_suspended: "このアカウントは停止されているため、現在新しいデバイスをリンクできません。解決するにはサポートにお問い合わせください。",
    academic_offer_sending_title: "確認リンクを送信しています",
    academic_offer_sending_body: "30% の確認リンクを {{ email }} に送信しています。",
    offer_welcome_badge_student: "学生割引 30%",
    offer_welcome_badge_journalist: "ジャーナリスト割引 30%",
    offer_welcome_headline: "30% オフを受け取る",
    offer_welcome_subline_student: "無料アカウントを作成し、学生用メールを確認すると、あらゆる有料プランが 12 か月間 30% オフになります。",
    offer_welcome_subline_journalist: "無料アカウントを作成し、報道関係の資格を確認すると、あらゆる有料プランが 12 か月間 30% オフになります。",
  ...
  passkeys: {
    rename_placeholder: "この鍵に名前を付ける",
    rename_failed: "鍵の名前を変更できませんでした。もう一度お試しください。",
  ...
  mail_rules: {
    ...
    templates_subtitle: "できあいのルールから始めて、保存前にカスタマイズできます。",
    templates_search_placeholder: "テンプレートを検索",
    templates_empty: "検索に一致するテンプレートはありません。",
    templates_use: "テンプレートを使う",
    templates_customize: "あなたの入力が必要です",
    templates_category_organize: "整理",
    templates_category_cleanup: "整理・削除",
    templates_category_priority: "優先度",
    templates_category_security: "セキュリティ",
    tpl_folder_auto_clean_name: "フォルダの自動クリーン",
    tpl_folder_auto_clean_desc: "選んだ日数より古くなったメールをフォルダから自動的に削除します。スター付きとピン留めのメールは常に保持されます。",
    tpl_newsletters_name: "ニュースレターを振り分け",
    tpl_newsletters_desc: "メッセージがメーリングリストから届いた場合（List-Id ヘッダーを含む）、「更新」カテゴリに振り分けます。",
    tpl_social_name: "ソーシャル通知をまとめる",
    tpl_social_desc: "送信者が Facebook、LinkedIn、X/Twitter、Instagram の場合、メッセージを「ソーシャル」カテゴリに移動します。",
    tpl_promotions_name: "プロモーションを拾う",
    tpl_promotions_desc: "件名にセール、割引、クーポン、または「% オフ」が含まれる場合、メッセージを「プロモーション」カテゴリに移動します。",
    tpl_calendar_name: "カレンダーの招待をまとめる",
    tpl_calendar_desc: "メッセージにカレンダーの招待（.ics）が含まれる場合、「更新」カテゴリに振り分けます。",
    tpl_large_attachments_name: "大きな添付ファイルにフラグを付ける",
    tpl_large_attachments_desc: "メッセージに 10 MB を超える添付ファイルがある場合、選んだフォルダに移動します。保存前にフォルダを選んでください。",
    tpl_no_reply_name: "自動送信メールを整理",
    tpl_no_reply_desc: "メッセージが自動生成されたものである場合（Auto-Submitted ヘッダーを含む、例：no-reply 送信者）、「更新」に振り分けます。",
    tpl_receipts_name: "領収書をアーカイブ",
    tpl_receipts_desc: "件名に領収書、請求書、注文確認が含まれる場合、受信トレイをスキップして「更新」に振り分けます。",
    tpl_vip_sender_name: "重要な送信者にスターを付ける",
    tpl_vip_sender_desc: "選んだ送信者からメールが届いたら、スターを付けて通知を送ります。保存前に送信者のアドレスを入力してください。",
    tpl_keyword_star_name: "キーワードでスターを付ける",
    tpl_keyword_star_desc: "件名に選んだ単語が含まれる場合、メッセージにスターを付けます。保存前にキーワードを入力してください。",
    tpl_auth_failures_name: "疑わしいメールを保留",
    tpl_auth_failures_desc: "メッセージが SPF、DKIM、DMARC のチェックに失敗した場合（なりすましの一般的な兆候）、受信トレイに入れず既読にします。",
    tpl_forward_copy_name: "コピーを転送",
    tpl_forward_copy_desc: "選んだ送信者からメールが届いたら、別のアドレスにコピーを転送します。保存前に両方のアドレスを入力してください。",
    ...
    run_on_existing_result: "{{count}} 件のメッセージにルールを適用しました",
    run_on_existing_failed: "既存のメールにルールを実行できませんでした。もう一度お試しください。",
    paused_badge: "一時停止中",
    and_label: "AND",
    or_label: "OR",
    value_placeholder: "値",
  ...
  folder_retention: {
    title: "フォルダの自動クリーン",
    subtitle: "フォルダから古いメールを自動的に削除します。スター付きとピン留めのメールは常に保持されます。",
    add: "自動クリーンを追加",
    empty_title: "自動クリーンのフォルダはまだありません",
    empty_description: "フォルダと保持期間を選ぶと、自動的に整理された状態を保てます。",
    edit_title: "自動クリーンのフォルダ",
    folder: "フォルダ",
    select_folder: "フォルダを選択",
    no_folders: "自動クリーンを使うには、まずカスタムフォルダを作成してください。",
    retention_period: "次の日数より古いメールを削除",
    days_suffix: "日",
    mode: "クリーン時",
    mode_trash: "ゴミ箱に移動",
    mode_trash_hint: "約 30 日間は復元可能",
    mode_permanent: "完全に削除",
    mode_permanent_hint: "取り消せません",
    mode_archive: "アーカイブに移動",
    mode_archive_hint: "受信トレイから外し、保持したまま復元可能",
    enabled: "有効",
    preview_some: "次回の実行で約 {{count}} 件のメールがクリーンされます。",
    preview_none: "現在、このルールに一致するメールはありません。",
    keeps_note: "スター付きとピン留めのメールは常に保持されます。",
    save: "保存",
    cancel: "キャンセル",
    delete: "削除",
    remove: "削除",
    permanent_confirm: "このフォルダ内の {{days}} 日より古いメールを完全に削除しますか？この操作は取り消せません。",
    summary_older_than: "{{days}} 日より古い",
    summary_trash: "ゴミ箱へ",
    summary_permanent: "完全に",
    summary_archive: "アーカイブへ",
    card_badge: "自動クリーン",
    disabled_badge: "オフ",
    upgrade_title: "フォルダの自動クリーンは有料機能です",
    upgrade_body: "フォルダを自動的にクリーンするには Star 以上にアップグレードしてください。",
    save_failed: "自動クリーンのルールを保存できませんでした。",
    load_failed: "自動クリーンのルールを読み込めませんでした。",
    deleted_toast: "自動クリーンのルールを削除しました。",
    saved_toast: "自動クリーンのルールを保存しました。",
  },
};
