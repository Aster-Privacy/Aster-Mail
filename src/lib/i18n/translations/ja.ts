...
export const ja = {
  ...
  settings: {
    ...
    crypto_rate_notice:
      "通貨を選ぶと為替レートを固定し、送金すべき正確な金額を表示します。レートはビットコインと Monero で 60 分間、Ethereum のネットワークで 30 分間有効です。ご自身で送金するまで、料金は一切かかりません。",
  ...
  mail: {
    ...
    tab_new_count: "新着",
    tab_unread_count: "未読 {{count}} 件", tab_counting_unread: "未読メールを集計中",
