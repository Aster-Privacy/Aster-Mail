...
export const ja = {
  common: {
    ...
    contact_groups: "グループ",
    more_contact_groups: "他 {{count}} 件のグループ",
    more_contact_groups_other: "他 {{count}} 件のグループ",
    new_group: "新しいグループ",
    ...
    add_contacts_to_group_hint: "よく連絡する相手を整理するグループを作成します。",
    contact_group_name_too_long: "グループ名は {{ max }} 文字以内で入力してください。",
    contact_group_already_exists: "この名前のグループはすでにあります。",
    contact_group_limit_reached: "グループは {{ max }} 件まで作成できます。",
    delete_contact_group_confirm: "このグループを削除しますか。連絡先はアドレス帳に残ります。",
    failed_to_fetch_contact_groups: "グループを読み込めませんでした。もう一度お試しください。",
    failed_to_save_contact_group: "グループを保存できませんでした。もう一度お試しください。",
    failed_to_create_contact_group: "グループを作成できませんでした。もう一度お試しください。",
    failed_to_delete_contact_group: "グループを削除できませんでした。もう一度お試しください。",
    failed_to_update_contact_groups: "グループのメンバーを更新できませんでした。",
    contacts_added_to_group: "{{count}} 件の連絡先をグループに追加しました",
    contacts_added_to_group_other: "{{count}} 件の連絡先をグループに追加しました",
    contacts_removed_from_group: "{{count}} 件の連絡先をグループから削除しました",
    contacts_removed_from_group_other: "{{count}} 件の連絡先をグループから削除しました",
    send_email: "メールを送信",
