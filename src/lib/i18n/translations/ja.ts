...
export const ja = {
  common: {
    ...
    sending_in_seconds: "{{seconds}}秒後に送信{{plural}}...",
  ...
  settings: {
    ...
    dns_instruction_set_dmarc_host: "ホストを_dmarcの後にドメインを付けて設定してください",
    ...
    set_host_root: "ホストをドメイン（またはルートの場合は@）に設定してください",
    ...
    credit_task_android_hint: "サインイン後に$10を受け取ります。",
    credit_task_android_title: "Android用Asterアプリをダウンロード",
    credit_task_desktop_hint: "サインイン後に$10を受け取ります。",
    credit_task_desktop_title: "デスクトップ用Asterアプリをダウンロード",
    credit_task_download_cta: "ダウンロード",
    ...
    desktop_bridge_upgrade_description: "Aster BridgeでApple Mail、Thunderbird、またはOutlookをAsterに接続できます。StarプランとそれaBoの上位プランで利用可能です。",
  ...
  errors: {
    ...
    rate_limited: "短時間に同じ操作が多すぎます。しばらく経ってからもう一度試すと通ります。",
    ...
    unrecognized_format: "{{name}} の形式を認識できませんでした。Aster は MBOX、EML、CSV、PST に対応しており、それらの形式で保存するとインポートできます。",
