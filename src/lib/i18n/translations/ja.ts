...
export const ja = {
  common: {
    ...
    delete_account_error: "現時点ではアカウントを削除できませんでした。しばらくしてからもう一度試すと通ることが多く、繰り返し失敗する場合は support@aster.com がお力になれます。",
    ...
    account_suspended_default_reason: "利用規約違反により、アカウントが停止されています。異議申し立てや詳細については support@aster.com がお力になれます。",
    submit_an_appeal: "Submit an appeal",
    settings_disabled_suspended: "アカウントが停止されている間、設定は無効になっています。異議申し立てや詳細については support@aster.com がお力になれます。",
    ...
    decrypt_try_sign_out: "サインアウトしてから再度サインインすると、鍵が再読み込みされます。それでも開けない場合は、support@aster.com がお力になれます。",
    n_files: "{{count}} file",
  ...
  settings: {
    ...
    too_many_requests: "短時間に同じ操作が多すぎます。しばらく経ってからもう一度試すと通ります。",
  ...
  auth: {
    ...
    abuse_account_limit: "自動セキュリティシステムにより、この登録はフラグされ、アカウントを作成できません。心当たりがない場合は、support@aster.com がお力になれます。",
    abuse_flagged_message: "セキュリティシステムにより、現在このネットワークからの新規登録は停止されています。心当たりがない場合は、support@aster.com がお力になれます。",
  ...
  errors: {
    ...
    rate_limit: "短時間に同じ操作が多すぎます。しばらく経ってからもう一度試すと通ります。",
    invalid_credentials: "そのメールとパスワードは一致しませんでした。もう一度試すか、aster.com/reset でリセットすると、解決することが多いです。",
    ...
    account_not_found: "その名前のアカウントは見つかりませんでした。スペルを確認するか、aster.com/reset でリセットすると、解決することが多いです。",
    login_failed: "サインインが完了しませんでした。もう一度試すと通ることが多いです。アカウントはロックされていません。",
    decrypt_failed: "そのパスワードでは、このデバイスで鍵を解除できませんでした。もう一度試すと開くことが多く、繰り返し失敗する場合は aster.com/reset のリカバリーコードがバックアップになります。サーバー上のデータには変更ありません。",
    ...
    wrong_vault_password: "そのパスワードではこのデバイスの鍵を解除できませんでした。もう一度試すと通ることが多く、aster.com/reset のリカバリーコードでも解決できます。サーバー上のデータに変更はありません。",
    vault_tampered: "このデバイスの暗号化データが想定と一致しません。改ざんの可能性があります。設定からセキュリティを開いて確認でき、警告が再び表示される場合は support@aster.com までご連絡いただけます。サーバー上のデータには影響ありません。",
    ...
    decrypt_corrupt_ciphertext: "このメールはサーバー上にありますが、通信経路で破損しているようです。更新してもう一度試すと通ることが多く、解決しない場合は support@aster.com にお問い合わせいただけます。",
    ...
    cdn_relay_misconfigured: "CDN リレーがこのビルドでは設定されていません。設定で直接接続に切り替えることで再びオンラインになれます。必要に応じて support@aster.com からサポートを受けられます。",
    device_repair_required: "このデバイスの鍵が見つかりません。デスクトップアプリから再ペアリングすることで解決します。アカウントとデータに変更はありません。",
    device_challenge_mismatch: "このデバイスのアイデンティティ確認が一致しませんでした。改ざんの可能性があります。デスクトップアプリから再ペアリングいただけます。警告が再び表示される場合は support@aster.com までご連絡いただけます。",
