...
export const ja = {
  ...
  settings: {
    ...
    custom_category_locked_badge: "ロック中",
    ...
    category_name: "名前",
    category_name_placeholder: "例: ニュースレター",
    category_icon: "アイコン",
    category_color: "色",
    category_color_accent: "アクセント",
    category_color_blue: "ブルー",
    category_color_green: "グリーン",
    category_color_amber: "アンバー",
    category_color_violet: "バイオレット",
    category_color_teal: "ティール",
    category_color_cyan: "シアン",
    category_color_rose: "ローズ",
    category_color_pink: "ピンク",
    category_color_slate: "スレート",
    category_match_domains: "送信者ドメインを一致させる",
    ...
    alias_export_source_ghost: "ゴーストエイリアス",
    alias_export_source_count: "{{count}} 件",
    alias_export_choose_columns: "列を選択（{{count}} 件選択中）",
    alias_export_hide_columns: "列を隠す",
    alias_export_format_label: "ファイル形式",
    alias_export_column_address: "アドレス",
    alias_export_column_display_name: "表示名",
    alias_export_column_note: "メモ",
    alias_export_column_websites: "ウェブサイト",
    alias_export_column_enabled: "有効",
    alias_export_column_created_at: "作成日",
    alias_export_column_directory: "ディレクトリ",
    alias_export_column_domain: "ドメイン",
    alias_export_column_auto_create: "自動作成",
    ...
    email_font_choice_title: "メールのフォント",
    email_font_choice_description: "メールの表示に使うフォント",
    email_font_option_match_app: "アプリと同じ",
    ...
    time_zone_show_all: "すべてのタイムゾーンを表示",
    date_format: "日付形式",
    ...
    basics_section_title: "基本",
    two_step_verification: "二段階認証",
    two_step_verification_description:
      "パスワードに加えて確認コードを要求することをお勧めします。",
    authenticator_app: "2FA認証アプリ",
    ...
    prices_converted_note:
      "価格は米ドルから換算した概算です。換算手数料を含む正確な金額はお支払い時に表示されます。",
    daily: "毎日",
    weekly: "毎週",
    biweekly: "隔週",
    monthly: "毎月",
    ...
    info_block_tracking_links_description:
      "宣伝メールはリンクに utm_source、fbclid、gclid などの隠しタグを付けます。これらは、どのキャンペーンから来たかを送信者に伝え、クリックしたことを知らせます。Aster はメール内のすべてのリンクからこれらを取り除くため、リンクは同じページを開きつつ送信者には何も伝えません。",
    ...
    cancel_reason_description:
      "解約を決めた理由をお聞かせください。任意ですが、改善に役立ちます。",
    cancel_reason_too_expensive: "料金が高い",
    cancel_reason_not_using: "あまり使っていない",
    cancel_reason_missing_feature: "必要な機能がない",
    cancel_reason_switched_provider: "他のサービスに乗り換えた",
    cancel_reason_bugs: "不具合や問題が多い",
    cancel_reason_privacy_trust: "プライバシーや信頼性への不安",
    ...
    domain_purchase_banner_title: "独自のメールドメインを取得",
    domain_purchase_banner_subtitle:
      "検索して購入すれば数秒でメール受信を開始。DNSは自動で設定されます。",
    domain_purchase_banner_cta: "ドメインを購入",
    domain_purchase_title: "ドメインを購入",
    ...
    domain_purchase_one_year: "1年",
    domain_purchase_n_years: "{{count}}年",
    domain_purchase_pay_with: "支払い方法",
    domain_purchase_pay_card: "カード",
    ...
    domain_purchase_step_dns: "DNSを設定中",
    domain_purchase_step_activating: "メールボックスを有効化中",
    domain_purchase_step_done: "ドメイン有効",
    domain_purchase_done_note:
      "ドメインの準備ができました。アドレスやエイリアスを作成できます。",
    domain_purchase_slow_note:
      "通常より時間がかかっています。バックグラウンドで完了し、メールでお知らせします。",
    ...
    domain_purchase_intro_replay: "ガイド付きスタートを再表示",
    domain_purchase_intro_examples: "または例から始める",
    domain_purchase_intro_tld_title: "次に末尾を選びましょう",
    domain_purchase_intro_tld_sub:
      "末尾によって価格とアドレスの印象が変わります。迷ったら「すべて」のままにしておけば、条件に合うものをすべて表示します。",
    domain_purchase_results_for: "{{name}} の検索結果",
    domain_purchase_results_for_sub:
      "気に入ったものを選んでください。購入は1分ほどで完了し、新しいアドレスはすぐにメールを受信できるようになります。",
    domain_purchase_change_name: "名前を変更",
    domain_purchase_purchased_desc:
      "Asterで購入したドメインはここに表示され、自動的にカスタムドメインとして機能します。名前を選んで支払えば、すぐに使い始められます。",
    domain_purchase_filter_price: "上限価格",
    domain_purchase_filter_price_any: "指定なし",
    domain_purchase_more_suggestions: "他の候補を生成",
    domain_purchase_sort_by: "並び替え",
    domain_purchase_order_summary: "注文内容",
    domain_purchase_summary_whois: "WHOISプライバシー",
    domain_purchase_summary_dns: "DNS自動設定",
    domain_purchase_summary_included: "込み",
    ...
    domain_purchase_sort_label: "並べ替え",
    domain_purchase_sort_relevance: "関連度",
    domain_purchase_sort_price_low: "価格が安い順",
    domain_purchase_sort_price_high: "価格が高い順",
    domain_purchase_sort_az: "名前 (A-Z)",
    domain_purchase_sort_discount: "割引率が高い順",
    domain_purchase_show_more: "さらに結果を表示",
    domain_purchase_results_count: "{{count}}件の結果",
    ...
    crypto_price_unavailable:
      "このプランの暗号資産価格はご利用いただけません。サポートまでお問い合わせください。",
    crypto_charged_in_usd: "米ドルで請求されます。",
    crypto_native_continue: "続ける",
    crypto_native_choose_method: "支払い方法を選択",
    crypto_native_loading_coins: "支払いオプションを読み込んでいます...",
    crypto_native_on_chain: "{{chain}} 上",
    ...
    crypto_native_received_label: "受取済みの金額",
    ...
    crypto_rate_notice:
      "通貨を選ぶと為替レートを固定し、送金すべき正確な金額を表示します。レートはビットコインで 60 分間、Ethereum のネットワークで 30 分間有効です。ご自身で送金するまで、料金は一切かかりません。",
  ...
  mail: {
    ...
    category_empty_updates_title: "通知はありません",
    category_empty_updates_desc: "領収書、確認、請求はここに表示されます。",
    category_empty_forums_title: "ディスカッションはありません",
    ...
    translation_show_original: "原文を表示",
    translation_show_translation: "翻訳を表示",
    translation_showing_original: "元のメッセージを表示しています。",
    translation_unavailable: "このメッセージは翻訳できませんでした。",
    ...
    search_section_message: "メール",
    search_section_filters: "フィルタ",
    ...
    resume_download_action: "再開",
    searching_message_content: "メッセージ内容を検索",
    ...
    op_in_trash: "ゴミ箱内",
    op_in_drafts: "下書き内",
    chip_any_time: "すべての期間",
    chip_older_than_week: "1週間以上前",
    chip_older_than_month: "1か月以上前",
    chip_older_than_six_months: "6か月以上前",
    chip_older_than_year: "1年以上前",
    chip_custom_range: "期間を指定",
    chip_has_attachment: "添付ファイルあり",
    chip_attachment_image: "画像",
    chip_attachment_document: "ドキュメント",
    chip_attachment_pdf: "PDF",
    chip_attachment_video: "動画",
    chip_is_unread: "未読",
    chip_name_or_email: "名前またはメールアドレス",
    chip_no_people: "一致する連絡先がありません",
  ...
  mail_rules: {
    ...
    rule_delete_failed:
      "このルールは削除されませんでした。もう一度お試しください。ルールは有効なままです。",
    ...
    auth_none: "なし",
    auth_missing: "なし",
    category_primary: "受信トレイ",
    category_important: "重要",
    category_promotions: "セール",
  ...
  survey: {
    ...
    dismiss_forever: "今後表示しない",
    modal_title: "Aster Mail アンケート",
    modal_subtitle: "一度きり、約1分です。自由記述の質問は任意です。",
    ...
    signup_leave_big_tech: "ビッグテックからの脱却",
    signup_open_source: "オープンソース",
    signup_specific_feature: "特定の機能",
    signup_price: "価格",
    signup_curiosity: "好奇心",
    q_stood_out: "他の選択肢と比べて Aster の何が最も際立っていましたか?",
    stood_openpgp: "標準の OpenPGP、鍵はどこでも使える",
    stood_post_quantum: "耐量子暗号",
    stood_open_source: "オープンソース (AGPL)",
    ...
    trigger_switched_fully: "他のプロバイダーから完全に乗り換えた",
    q_plan_reason: "{{plan}} プランを選んだ理由は何ですか?",
    q_cancel_reason: "どんなことがあればプランを解約しますか?",
    q_hesitation: "プラン購入前の最大のためらいは何でしたか?",
    hesitation_price: "価格",
    hesitation_trust: "まだ信頼できるか確信がなかった",
    hesitation_missing_feature: "足りない機能があった",
    hesitation_longevity: "Aster が続くのか不安だった",
    hesitation_none: "特にためらいはなかった",
    option_other: "その他",
    other_placeholder: "詳しく教えてください",
    open_placeholder: "回答を入力",
    optional_label: "任意",
