...
export const ar = {
  ...
  settings: {
    ...
    vanguard_description: "أمان متطور للصحفيين والناشطين وأي شخص معرض لمخاطر عالية. يتيح حمايات متقدمة غير متوفرة في الحسابات العادية.",
  ...
  auth: {
    ...
    log_in: "تسجيل الدخول",
    welcome_subtitle:
      "بريد إلكتروني حديث، مشفر لك ولا يمكن لأحد غيرك قراءته.",
