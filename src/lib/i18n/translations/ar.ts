...
export const ar = {
  common: {
    ...
    scheduled_already_sending: "هذه الرسالة قيد الإرسال بالفعل، لذا لم يعد بإمكانك تغييرها.",
    ...
    offline_action_failed: "تعذّر تطبيق تغيير أجريته أثناء عدم الاتصال. حاول مرة أخرى.",
  ...
  settings: {
    ...
    alias_restore_prompt: "أدخل العنوان. يطابقه Aster مع هذا الاسم المستعار قبل استعادة التسمية.",
    alias_restore_placeholder: "العنوان",
    alias_restore_confirm: "استعادة",
    alias_restore_mismatch: "هذا العنوان لا يطابق الاسم المستعار. تحقق من ترويسة رسالة تم تسليمها.",
    ...
    cancel_reason_placeholder_switched_provider: "إلى أي خدمة انتقلت، وما الذي أقنعك بها؟",
    ...
    cancel_reason_detail_required: "أضف إجابة قصيرة حتى نتمكن من التصرف بناءً عليها، أو تخط هذه الخطوة.",
    cancel_not_cancellable: "لا يمكن إلغاء هذا الاشتراك من التطبيق. تواصل مع الدعم لإلغائه.",
    cancel_failed: "لم يتم إلغاء خطتك، ولم يطرأ أي تغيير على فوترتك، لذا يمكنك المحاولة مرة أخرى.",
  ...
  mail: {
    ...
    schedule_time_must_be_future: "يجب أن يكون وقت الجدولة في المستقبل",
    restore: "استعادة",
