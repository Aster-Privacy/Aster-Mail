...
export const ar = {
  common: {
    ...
    delete_account_error: "تعذّر حذف حسابك الآن. محاولة أخرى بعد لحظات غالبًا ما تنجح، و support@aster.com مستعد للمساعدة إن استمر الخطأ.",
    ...
    account_suspended_default_reason:
      "حسابك معلّق بسبب مخالفة شروط الخدمة. support@aster.com مستعد للمساعدة في الاعتراض أو لمزيد من التفاصيل.",
    submit_an_appeal: "Submit an appeal",
    settings_disabled_suspended:
      "الإعدادات معطّلة طوال فترة تعليق حسابك. support@aster.com مستعد للمساعدة في الاعتراض أو لمزيد من التفاصيل.",
    ...
    decrypt_try_sign_out:
      "تسجيل الخروج ثم الدخول يعيد تحميل مفاتيحك. إن لم تُفتح الرسالة بعد ذلك، يمكن التواصل مع support@aster.com.",
    n_files: "{{count}} file",
  ...
  auth: {
    ...
    abuse_account_limit:
      "وضع نظام الأمان الآلي علامة على هذا التسجيل، وتعذّر إنشاء الحساب. إن بدا هذا خطأً، يمكن التواصل مع support@aster.com.",
    abuse_flagged_message:
      "أوقف نظام الأمان لدينا التسجيلات الجديدة من هذه الشبكة حاليًا. إن بدا هذا خطأً، يمكن التواصل مع support@aster.com.",
  ...
  errors: {
    ...
    invalid_credentials: "البريد وكلمة المرور لم يتطابقا. محاولة أخرى أو إعادة تعيين من aster.com/reset ستحل الأمر.",
    ...
    account_not_found: "تعذّر العثور على حساب بهذا الاسم. مراجعة الإملاء أو إعادة تعيين من aster.com/reset غالبًا ما تحل الأمر.",
    login_failed: "تسجيل الدخول لم يكتمل. محاولة أخرى ينبغي أن تنجح. حسابك ليس مقفلًا.",
    decrypt_failed: "كلمة المرور هذه لم تفك مفاتيحك على هذا الجهاز. محاولة أخرى قد تنجح، ورمز الاسترداد على aster.com/reset هو الخيار البديل إن استمر الخطأ. بياناتك على الخادم لم تتغير.",
    send_limit_reached:
    ...
    wrong_vault_password: "كلمة المرور هذه لم تفتح مفاتيحك على هذا الجهاز. محاولة أخرى عادةً ما تكون كافية، ويبقى رمز الاسترداد على aster.com/reset خيارًا احتياطيًا إن تكرر الأمر. بياناتك على الخادم لم تتغير.",
    vault_tampered: "البيانات المشفّرة على هذا الجهاز لا تطابق ما هو متوقع، وهذا قد يشير إلى تلاعب. تتوفر مراجعة الحالة عبر الإعدادات ثم الأمان، وفي حال عودة التحذير يمكن التواصل مع support@aster.com. بياناتك على الخادم لم تُمَس.",
    ...
    decrypt_corrupt_ciphertext: "هذا البريد موجود على الخادم لكنه يبدو تالفًا أثناء النقل. التحديث ثم محاولة جديدة يكفيان عادةً، ويمكن التواصل مع support@aster.com في حال استمرار الأمر.",
    ...
    cdn_relay_misconfigured: "ترحيل CDN غير مهيّأ لهذا الإصدار. التحويل إلى الاتصال المباشر من الإعدادات يُعيد الاتصال، ويبقى التواصل مع support@aster.com متاحًا عند الحاجة.",
    device_repair_required: "مفتاح هذا الجهاز مفقود. إعادة الإقران من تطبيق سطح المكتب تعالج الأمر. حسابك وبياناتك لم تتغير.",
    device_challenge_mismatch: "فحص هوية هذا الجهاز لم يتطابق، وقد يشير ذلك إلى تلاعب. تتوفر إعادة الإقران من تطبيق سطح المكتب، وفي حال عودة التحذير يمكن التواصل مع support@aster.com.",
