...
export const ar = {
  common: {
    ...
    sending_in_seconds: "الإرسال خلال {{seconds}} ثانية{{plural}}...",
  ...
  settings: {
    ...
    credit_task_android_title: "تنزيل تطبيق Aster لـ Android",
    credit_task_android_hint: "ستحصل على 10 دولارات بعد تسجيل الدخول.",
    credit_task_desktop_title: "تنزيل تطبيق Aster لسطح المكتب",
    credit_task_desktop_hint: "ستحصل على 10 دولارات بعد تسجيل الدخول.",
    credit_task_download_cta: "تنزيل",
  ...
  errors: {
    ...
    rate_limited: "فعلت ذلك كثيرًا في وقت قصير. لحظة ثم محاولة أخرى ستعمل.",
