...
export const ar = {
  ...
  auth: {
    ...
    recovery_email_step_desc: "أضف عنوان بريد إلكتروني لاستعادة حسابك إذا فقدت مفتاح الاستعادة.",
    ...
    mail_desktop_desc: "تطبيق أصلي سريع لأنظمة Windows وmacOS وLinux.",
