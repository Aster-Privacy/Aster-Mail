...
export const ar = {
  common: {
    ...
    recipient_key_outdated_desc: "المفتاح المنشور لهذا المستلم منتهي الصلاحية أو غير صالح، لذا لا يمكن تشفير الرسالة من طرف إلى طرف. سيتم إرسالها محمية أثناء النقل فقط.",
    ...
    unblock_failed: "تعذّر إلغاء حظر {{ email }}. حاول مرة أخرى وغالبًا ما ينجح ذلك. يبقى المرسل محظورًا في الوقت الحالي.",
    remove_from_allowlist_failed: "تعذّر إزالة {{ email }} من قائمة المسموح بهم. حاول مرة أخرى وغالبًا ما ينجح ذلك. يبقى مسموحًا به في الوقت الحالي.",
    bulk_unblock_failed: "لم يتم إلغاء حظر هؤلاء المرسلين. حاول مرة أخرى وغالبًا ما ينجح ذلك. يبقون محظورين في الوقت الحالي.",
    bulk_remove_allowlist_failed: "لم تتم إزالة هؤلاء المرسلين من قائمة المسموح بهم. حاول مرة أخرى وغالبًا ما ينجح ذلك. يبقون مسموحًا بهم في الوقت الحالي.",
    ...
    n_messages_count_one: "{{count}} رسالة",
  ...
  settings: {
    ...
    criterion_passkey: "تم تسجيل مفتاح المرور",
    criterion_read_receipts_off: "إيصالات القراءة متوقفة",
    fam_kids_tab: "الأطفال",
    fam_kids_title: "عناوين محجوزة للأطفال",
    fam_kids_subtitle: "احجز عنوانًا لطفلك الآن ودعه يكمل الإعداد لاحقًا بكلمة مروره الخاصة.",
    fam_kids_seats_used: "تم استخدام {{used}} من {{max}} من مقاعد العائلة (الأعضاء والدعوات والحجوزات)",
    fam_kids_reserve_btn: "احجز عنوانًا",
    fam_kids_seats_full: "مجموعة عائلتك ممتلئة. حرِّر مقعدًا لحجز عنوان آخر.",
    ...
    fam_kids_info_desc: "يُحجز العنوان لطفلك ويُمنع عن أي شخص آخر. يكمل طفلك (أو أنت) الإعداد لاحقًا بكلمة مرور خاصة، مُنشئًا حسابًا حقيقيًا بدون وصول ينضم تلقائيًا إلى عائلتك.",
    fam_kids_nickname_label: "اسم مستعار (اختياري)",
    fam_kids_nickname_ph: "مثال: أحمد",
    fam_kids_storage_label: "التخزين لهذا العنوان",
    ...
    fam_kids_consent_label: "أؤكد أنني والد هذا الطفل أو وصيه القانوني وأوافق على إنشاء حساب له.",
    fam_kids_consent_required: "يرجى تأكيد موافقة الوالدين للمتابعة.",
    fam_kids_link_hint: "يمكن لأي شخص لديه رابط المطالبة إعداد هذا العنوان. شاركه مع طفلك فقط وأعد إنشاءه إذا تسرّب.",
    fam_kids_create: "احجز",
    fam_kids_creating: "جارٍ الحجز...",
    fam_kids_cancel: "إلغاء",
    fam_kids_created: "تم حجز العنوان · تم نسخ رابط المطالبة",
    fam_kids_create_failed: "تعذّر حجز هذا العنوان",
    fam_kids_copy_link: "نسخ رابط المطالبة",
    fam_kids_link_copied: "تم نسخ رابط المطالبة",
    fam_kids_regenerate: "إعادة إنشاء الرابط",
    fam_kids_regenerated: "تم إنشاء رابط مطالبة جديد",
    fam_kids_setup_now: "الإعداد الآن",
    fam_kids_release: "تحرير",
    fam_kids_released: "تم تحرير الحجز",
    fam_kids_release_confirm: "هل تريد تحرير هذا العنوان المحجوز؟ سيصبح متاحًا للجميع مرة أخرى.",
    fam_kids_status_reserved: "محجوز",
    fam_kids_status_claimed: "نشط",
    fam_kids_claimed_active: "تم إعداد الحساب وانضمامه إلى عائلتك",
    fam_kids_load_failed: "تعذّر تحميل الحجوزات",
    fam_kids_claim_setup_for: "جارٍ إعداد {{address}}",
    fam_kids_claim_intro: "اختر كلمة مرور لإكمال إعداد عنوان العائلة هذا.",
    fam_kids_claim_invalid_title: "لم يعد هذا الرابط صالحًا",
    fam_kids_claim_invalid_body: "انتهت صلاحية رابط المطالبة هذا، أو تم استخدامه بالفعل، أو تم سحبه. اطلب رابطًا جديدًا من مالك العائلة.",
    fam_kids_claim_signed_in_title: "لقد سجّلت الدخول إلى حساب آخر",
    fam_kids_claim_signed_in_body: "ينشئ هذا الرابط حساب طفل جديدًا. افتحه في نافذة خاصة/تصفح متخفٍّ، أو انسخه لاستخدامه على جهاز طفلك.",
    fam_kids_release_modal_title: "هل تريد تحرير هذا العنوان؟",
    fam_kids_release_modal_body: "سيصبح {{address}} متاحًا لأي شخص لتسجيله. لا يمكن التراجع عن ذلك.",
    fam_kids_release_btn: "تحرير",
    alias_captcha_required: "أكمل رمز التحقق لإنشاء اسم مستعار.",
    browse_folder: "اختر مجلدًا",
    ...
    alias_import_drop_hint: "أفلِت ملف CSV (SimpleLogin أو Addy.io) أو ملف data.json الخاص بـ Proton Pass هنا، أو اختر ملفًا",
    ...
    alias_activity_title: "النشاط (آخر 7 أيام)",
    ...
    loading_payment_form: "جارٍ التحميل...",
  ...
  mail: {
    ...
    content_search_off_hint: "لم يتم البحث في محتوى الرسائل. فعّل البحث في المحتوى للعثور على النص داخل الرسائل.",
  ...
  auth: {
    link_device_upgrade_required_toast: "يتطلب ربط جهاز Bridge خطة Star أو أعلى. قم بالترقية للمتابعة.",
    link_device_upgrade_title: "قم بالترقية لربط هذا الجهاز",
    link_device_upgrade_description: "يتطلب توصيل Bridge لسطح المكتب بحسابك خطة Star أو أعلى. اختر خطة أدناه وسيُربط جهازك بعد الدفع مباشرة.",
    link_device_upgrade_cta: "الترقية إلى Star",
    link_device_upgrade_failed: "تعذّر بدء الدفع. حاول مرة أخرى أو افتح الفوترة في الإعدادات.",
    link_device_already_linked: "هذا الجهاز مرتبط بالفعل بحساب آخر. ألغِ ربطه هناك أولاً ثم حاول مرة أخرى.",
    link_device_rate_limited: "محاولات كثيرة جدًا. انتظر نحو دقيقة ثم حاول مرة أخرى.",
    link_device_account_suspended: "هذا الحساب موقوف، لذا لا يمكن ربط أجهزة جديدة الآن. تواصل مع الدعم لحل المشكلة.",
    academic_offer_sending_title: "جارٍ إرسال رابط التحقق الخاص بك",
    academic_offer_sending_body: "جارٍ إرسال رابط تحقق بخصم 30% إلى {{ email }}.",
    ...
    offer_welcome_subline_student: "أنشئ حسابك المجاني، ثم تحقّق من بريدك الجامعي لتفعيل خصم 30% على أي خطة مدفوعة لمدة 12 شهرًا.",
    offer_welcome_subline_journalist: "أنشئ حسابك المجاني، ثم تحقّق من اعتماداتك الصحفية لتفعيل خصم 30% على أي خطة مدفوعة لمدة 12 شهرًا.",
  ...
  passkeys: {
    rename_placeholder: "أدخل اسمًا لهذا المفتاح",
    rename_failed: "تعذّر إعادة تسمية المفتاح. حاول مرة أخرى.",
  ...
  mail_rules: {
    ...
    templates_customize: "يتطلب تفصيلاً منك",
    templates_category_organize: "تنظيم",
    templates_category_cleanup: "تنظيف",
    templates_category_priority: "الأولوية",
    templates_category_security: "الأمان",
    tpl_folder_auto_clean_name: "تنظيف تلقائي للمجلد",
    tpl_folder_auto_clean_desc: "يزيل تلقائيًا الرسائل من مجلد عندما تتجاوز عدد الأيام الذي تختاره. تُحفظ دائمًا الرسائل المميّزة بنجمة والمثبّتة.",
    tpl_newsletters_name: "فرز النشرات البريدية",
    tpl_newsletters_desc: "عندما تصل رسالة من قائمة بريدية (تحمل ترويسة List-Id)، صنّفها ضمن فئة التحديثات.",
    tpl_social_name: "تجميع إشعارات التواصل الاجتماعي",
    tpl_social_desc: "عندما يكون المُرسِل Facebook أو LinkedIn أو X/Twitter أو Instagram، انقل الرسالة إلى فئة التواصل الاجتماعي.",
    tpl_promotions_name: "التقاط العروض الترويجية",
    tpl_promotions_desc: "عندما يذكر الموضوع تخفيضات أو خصمًا أو قسيمة أو '% خصم'، انقل الرسالة إلى فئة العروض الترويجية.",
    tpl_calendar_name: "تجميع دعوات التقويم",
    tpl_calendar_desc: "عندما تحتوي رسالة على دعوة تقويم (.ics)، صنّفها ضمن فئة التحديثات.",
    tpl_large_attachments_name: "الإشارة إلى المرفقات الكبيرة",
    tpl_large_attachments_desc: "عندما تحتوي رسالة على مرفق أكبر من 10 ميجابايت، انقلها إلى مجلد تختاره. اختر المجلد قبل الحفظ.",
    tpl_no_reply_name: "ترتيب البريد الآلي",
    tpl_no_reply_desc: "عندما تكون الرسالة مُنشأة آليًا (تحمل ترويسة Auto-Submitted، مثل مرسلي no-reply)، صنّفها ضمن التحديثات.",
    tpl_receipts_name: "أرشفة الإيصالات",
    tpl_receipts_desc: "عندما يذكر الموضوع إيصالاً أو فاتورة أو تأكيد طلب، تجاوز صندوق الوارد وصنّفها ضمن التحديثات.",
    tpl_vip_sender_name: "تمييز مُرسِل مهم بنجمة",
    tpl_vip_sender_desc: "عندما يصل بريد من مُرسِل تختاره، ميّزه بنجمة وأرسل إشعارًا. أدخل عنوان المُرسِل قبل الحفظ.",
    tpl_keyword_star_name: "التمييز بنجمة حسب الكلمة المفتاحية",
    tpl_keyword_star_desc: "عندما يحتوي الموضوع على كلمة تختارها، ميّز الرسالة بنجمة. أدخل الكلمة المفتاحية قبل الحفظ.",
    tpl_auth_failures_name: "حجز البريد المشبوه",
    tpl_auth_failures_desc: "عندما تفشل رسالة في فحوص SPF أو DKIM أو DMARC (علامة شائعة على الانتحال)، أبقِها خارج صندوق الوارد وضع علامة مقروءة عليها.",
    tpl_forward_copy_name: "إعادة توجيه نسخة",
    tpl_forward_copy_desc: "عندما يصل بريد من مُرسِل تختاره، أعد توجيه نسخة إلى عنوان آخر. أدخل العنوانين قبل الحفظ.",
    ...
    run_on_existing_result: "تم تطبيق القاعدة على {{count}} رسالة",
    run_on_existing_failed: "تعذّر تشغيل القاعدة على البريد الموجود. حاول مرة أخرى.",
    paused_badge: "متوقفة",
    and_label: "AND",
    or_label: "OR",
    value_placeholder: "القيمة",
  ...
  folder_retention: {
    ...
    subtitle: "احذف تلقائيًا الرسائل القديمة من مجلد. تُحفظ دائمًا الرسائل المميّزة بنجمة والمثبّتة.",
    add: "إضافة تنظيف تلقائي",
    empty_title: "لا توجد مجلدات بتنظيف تلقائي بعد",
    empty_description: "اختر مجلدًا وفترة احتفاظ للحفاظ عليه مرتبًا تلقائيًا.",
    edit_title: "مجلد بتنظيف تلقائي",
    folder: "مجلد",
    select_folder: "اختر مجلدًا",
    no_folders: "أنشئ أولاً مجلدًا مخصصًا لاستخدام التنظيف التلقائي.",
    retention_period: "حذف الرسائل الأقدم من",
    days_suffix: "يوم",
    mode: "عند التنظيف",
    mode_trash: "نقل إلى المهملات",
    mode_trash_hint: "قابلة للاسترداد لنحو 30 يومًا",
    mode_permanent: "حذف نهائي",
    mode_permanent_hint: "لا يمكن التراجع عنه",
    mode_archive: "نقل إلى الأرشيف",
    mode_archive_hint: "تُزال من صندوق الوارد وتُحفظ ويمكن استردادها",
    enabled: "مُفعّل",
    preview_some: "سيتم تنظيف نحو {{count}} رسالة في التشغيل التالي.",
    preview_none: "لا توجد حاليًا رسائل تطابق هذه القاعدة.",
    keeps_note: "تُحفظ دائمًا الرسائل المميّزة بنجمة والمثبّتة.",
    save: "حفظ",
    cancel: "إلغاء",
    delete: "حذف",
    remove: "إزالة",
    permanent_confirm: "هل تريد حذف الرسائل الأقدم من {{days}} يومًا في هذا المجلد نهائيًا؟ لا يمكن التراجع عن ذلك.",
    summary_older_than: "أقدم من {{days}} يومًا",
    summary_trash: "إلى المهملات",
    ...
    upgrade_body: "قم بالترقية إلى Star أو أعلى لتنظيف المجلدات تلقائيًا.",
