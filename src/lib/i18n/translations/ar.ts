...
export const ar = {
  ...
  settings: {
    ...
    alias_orphaned_hint:
      "تم تشفير تسميته بكلمة مرورك السابقة، لذا لا يمكن استعادتها. لا يزال البريد المرسل إلى هذا العنوان يصل، ويمكنك رؤية العنوان الكامل في ترويسة أي رسالة يسلّمها.",
