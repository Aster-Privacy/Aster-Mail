...
export const ar = {
  common: {
    ...
    more_contact_groups: "{{count}} مجموعات أخرى",
    more_contact_groups_one: "{{count}} مجموعة أخرى",
    more_contact_groups_other: "{{count}} مجموعات أخرى",
    ...
    add_contacts_to_group_hint: "أنشئ مجموعة لتنظيم الأشخاص الذين تراسلهم أكثر من غيرهم.",
    contact_group_name_too_long: "يمكن أن يصل طول اسم المجموعة إلى {{ max }} حرفًا.",
    contact_group_already_exists: "توجد مجموعة بهذا الاسم بالفعل.",
    contact_group_limit_reached: "يمكنك إنشاء ما يصل إلى {{ max }} مجموعة.",
    delete_contact_group_confirm: "هل تريد حذف هذه المجموعة؟ تبقى جهات الاتصال في دفتر العناوين.",
    ...
    contacts_added_to_group_other: "تمت إضافة {{count}} جهات اتصال إلى المجموعة",
    contacts_removed_from_group: "تمت إزالة {{count}} جهات اتصال من المجموعة",
    contacts_removed_from_group_one: "تمت إزالة {{count}} جهة اتصال من المجموعة",
    contacts_removed_from_group_other: "تمت إزالة {{count}} جهات اتصال من المجموعة",
  ...
  settings: {
    ...
    crypto_rate_notice:
      "عند اختيارك عملة، نثبّت سعر الصرف ونعرض لك المبلغ الدقيق المطلوب إرساله. يظل السعر ساريًا 60 دقيقة على Bitcoin و30 دقيقة على شبكات Ethereum. ولا يُخصم منك شيء حتى ترسل الدفعة بنفسك.",
    ...
    gmail_sync_note_unavailable:
      "إذا لم تجد كلمات مرور التطبيقات، ففعّل التحقق بخطوتين أولًا ثم أعد المحاولة.",
    ...
    gmail_sync_step_2: "فعّل التحقق بخطوتين إن لم يكن مفعّلًا.",
    ...
    gmail_wizard_step_1_body:
      "تجد كلمات مرور التطبيقات في قسم أمان الحساب لدى مزوّدك.",
    gmail_wizard_step_1_title: "افتح إعدادات أمان حسابك",
    gmail_wizard_step_2_body:
      "تظهر كلمات مرور التطبيقات فقط عند تفعيل التحقق بخطوتين.",
    ...
    gmail_wizard_step_4_body:
      "الصق كلمة مرور التطبيق أدناه. يخزّنها Aster مشفّرة ويستخدمها لمزامنة صندوق البريد هذا فقط.",
  ...
  auth: {
    ...
    recovery_locked_out:
      "جرت محاولات استرداد كثيرة على هذا الحساب. يمكنك المحاولة مرة أخرى خلال {{time}}. لم يُستخدم أي من رموزك، لذا ما زالت لديك كلها.",
    invalid_backup_code:
