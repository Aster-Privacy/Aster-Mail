...
export const zh_CN = {
  common: {
    ...
    recovery_codes_reminder_title: "保存你的恢复代码",
    recovery_codes_reminder_body:
      "Aster 用你的密码加密邮件，因此没有人能替你重置密码。恢复代码是回到加密邮件的唯一方式。",
    recovery_codes_reminder_action: "获取恢复代码",
    recovery_codes_low_reminder_title: "恢复代码所剩不多",
    recovery_codes_low_reminder_body:
      "每个代码只能用一次，你还剩 {{count}} 个。请获取新代码，以免被锁定在账户之外。",
    recovery_codes_low_reminder_action: "获取新代码",
    recovery_phrase_migrate_title: "改用恢复代码",
    recovery_phrase_migrate_body:
      "恢复短语即将停用。请立即获取恢复代码，以便日后仍能找回账户。",
    recovery_phrase_migrate_action: "获取代码",
  ...
  settings: {
    ...
    recovery_codes_row_desc: "一次性代码，可恢复你的账户和所有加密数据。",
    recovery_codes_generate: "获取代码",
    recovery_codes_regenerate: "获取新代码",
    recovery_codes_regenerate_warning: "获取新代码后，当前代码会立即失效。",
    recovery_codes_show: "显示代码",
    recovery_codes_get_new_title: "获取新的恢复代码？",
    recovery_codes_confirm_title: "验证身份",
    recovery_codes_confirm_desc: "输入密码即可查看恢复代码。",
    recovery_codes_title: "你的恢复代码",
    recovery_codes_status: "创建于 {{date}}。剩余 {{remaining}}/{{total}}。",
    recovery_codes_low:
      "恢复代码所剩不多。请获取新代码，以免被锁定在账户之外。",
    recovery_codes_used: "已使用",
    recovery_codes_unavailable: "此设备未存储你的代码。获取新代码即可查看。",
  ...
  auth: {
    ...
    print_codes: "打印",
    codes_copied: "已复制代码。",
    i_saved_these_codes: "我已保存这些代码",
    review_security_title: "检查你的安全设置",
    review_security_desc: "你的密码已更改，账户已恢复。",
    review_devices_signed_out: "其他设备已退出登录。",
    review_two_step_off: "两步验证已关闭。",
    review_turn_on: "开启",
    review_recovery_email_kept: "你的恢复邮箱仍已设置。",
    review_no_recovery_email: "没有恢复邮箱。",
    review_add: "添加",
    review_codes_left: "还剩 {{count}} 个恢复代码。",
