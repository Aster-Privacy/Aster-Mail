...
export const zh_CN = {
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "此操作会影响全部 {{count}} 封邮件。",
    confirm_bulk_action_count_description_one: "此操作会影响 1 封邮件。",
    confirm_bulk_action_count_description_other: "此操作会影响全部 {{count}} 封邮件。",
    confirm_bulk_action_scope_description: "此操作会影响 {{scope}} 中的全部 {{count}} 封邮件。",
    confirm_bulk_action_scope_description_one:
      "此操作会影响{{scope}}中的 1 封邮件。",
    confirm_bulk_action_scope_description_other: "此操作会影响 {{scope}} 中的全部 {{count}} 封邮件。",
