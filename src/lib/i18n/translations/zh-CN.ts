...
export const zh_CN = {
  ...
  auth: {
    ...
    enter_email_associated: "输入与您的账户关联的邮箱地址",
    ...
    choose_recovery_method: "选择恢复方式",
    choose_recovery_method_desc: "您希望如何恢复账户？",
    use_recovery_code: "使用恢复代码",
    use_recovery_email: "使用恢复邮箱",
    recovery_email_sent: "恢复邮件已发送",
    recovery_email_sent_desc:
      "我们已向您的恢复邮箱发送了密码重置链接。请检查收件箱并点击链接继续。",
    check_your_inbox: "检查收件箱",
    sending_recovery_email: "发送恢复邮件中...",
    validating_recovery_link: "验证恢复链接中...",
    invalid_recovery_link: "此恢复链接无效或已过期。请重试。",
