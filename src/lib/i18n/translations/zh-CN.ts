...
export const zh_CN = {
  ...
  settings: {
    ...
    alias_export_description: "选择要包含的内容。文件在您的浏览器中生成，绝不会发送到我们的服务器。",
    ...
    alias_export_warning_body: "任何打开它的人都能看到其中的全部别名、备注和网站。请保存在密码管理器或加密磁盘中。",
    alias_export_summary: "共 {{rows}} 条，分为 {{files}} 个文件。",
    alias_export_download: "下载",
    alias_export_incomplete: "{{total}} 个别名中仅加载了 {{loaded}} 个。请重新加载别名后再试，以确保备份完整。",
    alias_export_undecryptable: "{{count}} 个别名无法解密，未包含在内。",
    alias_export_undecryptable_ghost: "{{count}} 个幽灵别名无法解密，未包含在内。",
