...
export const zh_CN = {
  ...
  settings: {
    ...
    too_many_requests: "短时间内这项操作过多，等一下再试一次可以。",
    ...
    trusted_devices_created: "添加于 {{date}}",
    trusted_devices_last_seen: "最近使用：{{date}}",
    trusted_devices_never: "从未",
    trusted_devices_revoke: "撤销",
    trusted_devices_revoke_confirm: "确定要撤销此设备的信任吗？",
    ...
    trusted_2fa_expires: "到期：{{date}}",
    trusted_2fa_last_used: "最近使用：{{date}}",
    ...
    ghost_aliases_this_month: "本月使用：{{count}}/{{limit}}",
    ghost_alias_active: "活跃",
    ghost_alias_expired_grace: "宽限期",
    ghost_alias_expires_in: "{{time}}后过期",
    ...
    import_folder_prep_status: "正在准备文件夹...",
    ...
    sync_progress_count: "已同步 {{count}} 封邮件",
    ...
    oauth_folders_partial: "部分文件夹已加载",
    ...
    upgrade_modal_description_specific: "升级以解锁此功能。",
    ...
    plan_f_mail_rules: "邮件规则",
    plan_f_signed_in_accounts: "{{value}} 个登录账户",
    ...
    promo_forever: "永久折扣",
    promo_once_reverts: "下次到期后恢复原价",
    promo_then_reverts: "{{period}} 后恢复原价",
    per_two_years: "/两年",
    payment_processing_delayed: "支付处理中，可能需要几分钟。我们会发邮件确认。",
    subscription_activated: "订阅已激活",
    switch_billing_loss: "切换后您将失去当前的促销折扣。确定要继续吗？",
    downgrade_scheduled: "您的方案将在当前计费周期结束时降级。",
    refer_a_friend: "推荐朋友",
    referral_email_subject: "加入 Aster Mail",
    referral_email_body: "我在使用 Aster Mail，一款端到端加密的私密邮件服务。用我的推荐链接注册可以获得奖励：",
    ...
    credit_task_desktop_title: "安装桌面应用",
    credit_task_desktop_hint: "下载并安装 Aster Mail 桌面应用",
    ...
    dev_checking: "检查中...",
    dev_databases_count_one: "1 个数据库",
  ...
  errors: {
    ...
    rate_limit: "短时间内这项操作过多，等一下再试一次可以。",
    ...
    rate_limited: "您在短时间内进行了太多此类操作。稍等片刻再试一次即可。",
    ...
    unrecognized_format: "我们无法识别 {{name}} 的格式。Aster 支持 MBOX、EML、CSV 和 PST，将文件保存为其中一种格式可以让导入运行。",
