...
export const zh_CN = {
  ...
  settings: {
    ...
    auto_delete_trash_after: "自动清空回收站的时间",
    auto_delete_trash_description: "超过此期限的回收站邮件将被永久删除",
    ...
    retention_days_count: "{{ days }}天",
    retention_180_days: "180天",
    retention_365_days: "365天",
