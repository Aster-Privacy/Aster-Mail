...
export const zh_CN = {
  common: {
    ...
    add_new_group: "新建群组",
    add_to_group: "添加到群组",
    added_to_group: "已添加到群组",
    app_lock_attempts_remaining_one: "还剩 {{count}} 次机会",
    birthdays_upcoming: "有 {{count}} 个生日即将到来",
    bulk_create_hint:
      "每行填写一个联系人。若要同时保存姓名和邮箱地址，请把地址放在尖括号中。",
    bulk_create_placeholder: "Ada Lovelace <ada@example.com>",
    bulk_create_ready: "{{count}} 个联系人可以创建",
    change_history: "更改记录",
    clear_selection: "清除选择",
    contact_restored: "联系人已恢复",
    contacts_created: "已创建 {{count}} 个联系人",
    contacts_deleted_one: "已删除 {{count}} 个联系人",
    contacts_exported: "联系人已导出",
    contacts_merged: "联系人已合并",
    contacts_starred_one: "已为 {{count}} 个联系人加星标",
    contacts_unstarred_one: "已取消 {{count}} 个联系人的星标",
    contacts_updated_stat: "已更新",
    conversations_added_label_one: "{{count}}个会话已添加标签 {{label}}",
    conversations_marked_as_not_spam_bulk_one:
      "{{count}}个会话已标记为非垃圾邮件",
    conversations_marked_as_read_bulk_one: "{{count}}个会话已标记为已读",
    conversations_marked_as_spam_bulk_one: "{{count}}个会话已标记为垃圾邮件",
    conversations_marked_as_unread_bulk_one: "{{count}}个会话已标记为未读",
    conversations_moved_to_folder_one: "{{count}}个会话已移至 {{folder}}",
    conversations_moved_to_inbox_bulk_one: "{{count}}个会话已移至收件箱",
    conversations_removed_from_folder_one:
      "{{count}}个会话已从 {{folder}} 中移除",
    conversations_removed_label_one: "{{count}}个会话已移除标签 {{label}}",
    conversations_restored_bulk_one: "{{count}}个会话已恢复",
    conversations_snoozed_bulk_one: "{{count}}个会话已延后",
    conversations_starred_bulk_one: "{{count}}个会话已加星标",
    conversations_unstarred_bulk_one: "{{count}}个会话已取消星标",
    create_contact: "创建联系人",
    create_multiple_contacts: "创建多个联系人",
    days_ago_long_one: "{{count}} 天前",
    days_remaining_one: "剩余 {{count}} 天",
    ...
    emails_added_to_folder_one: "{{count}}封邮件已添加到 {{folder}}",
    emails_archived_one: "{{count}}封邮件已归档",
    emails_from_senders_archived_one:
      "已归档来自 {{senders}} 的 {{count}} 封邮件",
    emails_from_senders_deleted_one:
      "已删除来自 {{senders}} 的 {{count}} 封邮件",
    emails_marked_as_read_one: "{{count}}封邮件已标记为已读",
    emails_moved_to_trash_one: "{{count}}封邮件已移至回收站",
    emails_permanently_deleted_one: "{{count}}封邮件已永久删除",
    emails_snoozed_until_one: "{{count}}封邮件已延后至 {{time}}",
    emails_starred_one: "{{count}}封邮件已加星标",
    emails_unstarred_one: "{{count}}封邮件已取消星标",
    emails_will_reappear_one: "{{count}}封邮件将于 {{time}} 重新出现",
    entry_count_one: "{{count}} 条记录",
    export_selection_vcf: "导出为 vCard",
    failed_to_add_to_group: "无法将联系人添加到群组。",
    failed_to_create_group: "无法创建群组。",
    failed_to_delete_group: "无法删除群组。",
    failed_to_remove_from_group: "无法将联系人移出群组。",
    file_count_one: "{{count}} 个文件",
    frequent_contacts: "常用",
    frequent_contacts_hint: "你来往最频繁的联系人会显示在这里。",
    group_created: "群组已创建",
    group_deleted: "群组已删除",
    group_empty_title: "此群组中没有联系人",
    group_name: "群组名称",
    groups: "群组",
    hours_ago_long_one: "{{count}} 小时前",
    hours_remaining_one: "剩余 {{count}} 小时",
    images_count_one: "{{count}} 张图片",
    import_add_to_group: "将导入的联系人添加到群组",
    import_clear_all: "全部清除",
    import_no_group: "不加入群组",
    import_search_placeholder: "搜索要导入的联系人",
    import_select_all: "全选",
    in_x_minutes_one: "{{count}} 分钟后",
    manage_contacts: "管理联系人",
    merge: "合并",
    merge_and_fix: "合并并修正",
    merged_contact_preview: "合并后的联系人",
    minutes_ago_long_one: "{{count}} 分钟前",
    minutes_remaining_one: "剩余 {{count}} 分钟",
    months_ago_long_one: "{{count}} 个月前",
    more_aliases_one: "另外 {{count}} 个别名",
    more_folders_one: "另外 {{count}} 个文件夹",
    more_labels_one: "另外 {{count}} 个标签",
    n_conversations_archived_one: "{{count}}个会话已归档",
    n_conversations_moved_to_trash_one: "{{count}}个会话已移至回收站",
    newsletters_archived_one: "{{count}}份订阅邮件已归档",
    no_duplicates_found: "没有需要修正的重复联系人",
    no_frequent_contacts: "还没有常用联系人",
    no_groups_match: "没有与搜索匹配的群组",
    no_other_contacts: "没有其他联系人",
    security_center: "安全中心",
    other_contacts: "其他",
    other_contacts_hint: "从邮件中保存、但还没有姓名的地址会显示在这里。",
    preview_contact: "预览联系人",
    print_contacts: "打印联系人",
    remove_from_group: "移出群组",
    removed_from_group: "已移出群组",
    search_groups: "搜索群组",
    select_contact: "选择联系人",
    sender_count_one: "{{count}} 位发件人",
    share_contact: "分享联系人",
    some_contacts_not_created: "部分联系人未能创建。",
    spam_emails_moved_to_trash_one: "{{count}}封垃圾邮件已移至回收站",
    spam_emails_permanently_deleted_one: "{{count}}封垃圾邮件已永久删除",
    taps_to_developer_mode_one: "再点按 {{count}} 次进入开发者模式",
    trash_days_left: "还剩 {{count}} 天",
    weeks_ago_long_one: "{{count}} 周前",
    weeks_remaining_one: "剩余 {{count}} 周",
    delete_folder_account_password: "账户密码",
    delete_folder_step_up_hint: "该文件夹受密码保护。请输入账户密码以删除它。",
    delete_folder_totp_code: "双重验证码",
    delete_folder_purge_option: "永久销毁其中的邮件",
    ...
    failed_remove_profile_picture: "请重试。",
    remove_photo: "移除照片",
    ...
    unsupported_image_type:
      "不支持此文件类型。请将图片保存为 PNG、JPEG、WebP 或 GIF 后重试。",
    csv_too_large:
    ...
    contacts: "联系人",
    send_feedback: "发送反馈",
    send_feedback_to_aster: "向 Aster 发送反馈",
    folders: "文件夹",
    add_to_folders: "添加到文件夹",
    more: "更多",
    mail: "邮件",
    labels: "标签",
    ...
    inactivity_window: "闲置期限",
    inactivity_window_description:
      "闲置达到此月数的免费账户将被永久删除。提醒会发送到你的 Aster 收件箱和恢复邮箱。",
    inactivity_window_info_title: "闲置政策的运作方式",
    ...
    inactivity_window_step_up_description:
      "为了安全，请确认密码后再更改闲置期限。",
    inactivity_window_months: "{{n}} 个月",
    inactivity_window_saved: "闲置期限已更新",
    inactivity_window_save_failed: "闲置期限保存失败。请重试。",
    ...
    discard_changes_title: "要放弃更改吗？",
    discard_changes_message: "更改尚未保存。如果现在关闭，更改将丢失。",
    ...
    set_as_default: "设为默认",
    billing_alert_body: "付款未成功。访问权限即将受限。",
    billing_alert_body_days: "付款未成功。访问权限将在 {{days}} 天后受限。",
    billing_alert_action: "付款",
    dismiss: "忽略",
    load_content: "加载",
    open_link: "打开链接",
    no_icon: "无图标",
    ...
    tag_icon_folder: "文件夹",
    tag_icon_star: "星标",
    tag_icon_bookmark: "书签",
    tag_icon_flag: "旗标",
    tag_icon_check: "勾选",
    tag_icon_bell: "铃铛",
    tag_icon_heart: "爱心",
    tag_icon_sparkles: "闪光",
    tag_icon_fire: "火焰",
    tag_icon_bolt: "闪电",
    tag_icon_clock: "时钟",
    tag_icon_info: "信息",
    tag_icon_warning: "警告",
    tag_icon_envelope: "信封",
    tag_icon_at: "@符号",
    tag_icon_chat: "聊天",
    tag_icon_send: "发送",
    tag_icon_draft: "草稿",
    tag_icon_document: "文档",
    tag_icon_archive: "归档",
    tag_icon_trash: "回收站",
    tag_icon_shield: "盾牌",
    tag_icon_lock: "锁",
    tag_icon_eye_slash: "隐藏",
    tag_icon_currency: "货币",
    tag_icon_money: "金钱",
    tag_icon_bank: "银行",
    tag_icon_card: "卡片",
    tag_icon_wallet: "钱包",
    ...
    tag_icon_gift: "礼物",
    tag_icon_ticket: "票券",
    tag_icon_crypto: "加密货币",
    tag_icon_briefcase: "公文包",
    tag_icon_building: "建筑",
    tag_icon_user: "个人",
    tag_icon_users: "群组",
    tag_icon_calendar: "日历",
    tag_icon_clipboard: "剪贴板",
    tag_icon_presentation: "演示",
    tag_icon_trophy: "奖杯",
    tag_icon_code: "代码",
    tag_icon_key: "钥匙",
    tag_icon_link: "链接",
    ...
    email_sent: "邮件已发送。",
    undo_send_too_late: "此邮件已发送，无法撤回。",
    ...
    failed_to_mark_as_spam: "请重试。",
    failed_to_snooze_conversations: "请重试。",
    ...
    scan_failed: "请重试。",
    dismiss_failed: "请重试。",
    failed_to_load_custom_fields: "请重试。",
    failed_to_create_field: "请重试。",
    ...
    failed_to_delete_field: "请重试。",
    failed_to_save_value: "请重试。",
    ...
    failed_to_restore_conversations: "请重试。",
    ...
    cannot_move_from_view: "无法从此视图移动邮件。",
    ...
    export_all: "全部导出",
    no_contacts: "暂无联系人",
    failed_to_load_contacts: "未能加载联系人。",
    mass_email_limited: "仅添加了前 {{count}} 个地址。",
    ...
    session_expired_login:
      "您的会话已结束。请重新登录以继续。您的数据和草稿已保存在服务器上。",
    ...
    failed_to_update: "请重试。",
    failed_to_load_search_results: "请重试。",
    failed_to_fetch_tags: "请重试。",
    ...
    welcome_description: "这个导览约需一分钟，介绍让第一天更轻松的四件事。",
    organize_with_folders: "用文件夹整理",
    organize_folders_description:
      "把邮件拖到文件夹即可归档，也可以选中多封一起移动。要新建文件夹，请点击文件夹旁边的 + 。",
    customize_settings_description:
      "在设置中，你可以添加别名、连接自定义域名并开启两步验证。",
    youre_ready: "一切就绪",
    youre_ready_description:
      "你的邮件采用端到端加密，密钥只在你手中。随时按 ? 查看全部键盘快捷键。",
    skip_tour: "跳过引导",
    get_started: "开始使用",
    setup_complete: "设置完成！",
    ...
    encryption_available: "可用加密",
    encryption_available_desc:
      "该收件人已发布可用的加密密钥。点击锁形图标即可对此邮件进行端到端加密。",
    click_to_encrypt: "点击对此邮件进行端到端加密",
    click_to_disable_encryption: "已加密 - 点击可对此邮件关闭",
    encryption_status_unknown: "无法获取加密状态",
    encryption_status_unknown_desc:
      "我们无法检查该收件人的密钥。再试一次即可知道此邮件能否端到端加密。",
    ...
    message_marked_as_spam: "消息已标记为垃圾邮件",
    undo_failed: "请重试。",
    expired: "已过期",
    expires_in: "将在 ",
    ...
    forward_attachments_unavailable: "部分附件无法添加到此邮件。",
    image: "图片",
    system: "系统",
    failed_to_permanently_delete: "请重试。",
    failed_to_delete_emails: "请重试。",
    failed_to_mark_as_read: "请重试。",
    failed_to_mark_as_unread: "请重试。",
    n_conversations_archived: "{{ count }}个对话已归档",
    n_conversations_archived_other: "{{count}}个会话已归档",
    n_conversations_moved_to_trash: "{{ count }}个对话已移至回收站",
    n_conversations_moved_to_trash_other: "{{count}}个会话已移至回收站",
    ...
    app_lock_attempts_remaining: "还剩 {{count}} 次机会",
    app_lock_try_again_in: "{{s}}秒后重试",
    duress_confirm_title: "确定要继续吗？",
    duress_confirm_subtitle: "清除本地数据",
    duress_confirm_desc:
      "这会从本设备清除所有本地保存的邮件、密钥和会话数据，并将你退出登录。",
    duress_confirm_detail:
      "你的账户和加密数据仍安全保存在 Aster 的服务器上。你随时可以重新登录恢复访问。",
    duress_confirm_proceed: "清除本地数据",
    secure_send: "安全发送",
    ...
    locked_data_banner_message: "你的部分较早的加密数据已锁定。",
    ...
    payment_past_due_message_days:
      "上次付款未成功。请在 {{days}} 天内更新付款方式以保留当前套餐。",
    payment_past_due_action: "更新付款",
    subscriptions: "订阅",
    ...
    signed_out_inactivity:
      "为保护您的账户，您在一段时间无操作后已退出登录。请重新登录以继续。",
    ...
    new_emails_body_one: "您有 {{count}} 封新邮件",
    new_emails_body: "您有 {{count}} 封新邮件",
    new_emails_body_other: "您有 {{count}} 封新邮件",
    ...
    contact_count_other: "{{count}} 位联系人",
    n_of_n_contacts: "{{ total }} 中的 {{ filtered }}",
    contact_groups: "群组",
    new_group: "新建群组",
    create_contact_group: "创建群组",
    rename_contact_group: "重命名群组",
    delete_contact_group: "删除群组",
    contact_group_name: "群组名称",
    enter_contact_group_name: "请输入群组名称",
    manage_contact_groups: "管理群组",
    no_contact_groups_yet: "暂无群组",
    add_contacts_to_group_hint: "创建群组，整理你最常联系的人。",
    contact_group_name_too_long: "群组名称最多 {{ max }} 个字符。",
    contact_group_already_exists: "已存在同名群组。",
    contact_group_limit_reached: "你最多可以创建 {{ max }} 个群组。",
    delete_contact_group_confirm:
      "要删除此群组吗？你的联系人仍会保留在通讯录中。",
    failed_to_fetch_contact_groups: "群组未加载。请重试。",
    failed_to_save_contact_group: "群组未保存。请重试。",
    failed_to_create_contact_group: "群组未创建。请重试。",
    failed_to_delete_contact_group: "群组未删除。请重试。",
    failed_to_update_contact_groups: "群组成员未更新。",
    contacts_added_to_group: "已将 {{count}} 位联系人添加到群组",
    contacts_added_to_group_other: "已将 {{count}} 位联系人添加到群组",
    contacts_removed_from_group: "已将 {{count}} 位联系人从群组中移除",
    contacts_removed_from_group_other: "已将 {{count}} 位联系人从群组中移除",
    send_email: "发送邮件",
    ...
    unexpected_error_refresh: "出现了问题，请刷新页面以继续。",
    ...
    unknown_error: "请重试。",
    unsaved_changes_title: "要舍弃更改吗？",
    unsaved_changes_body: "你输入的信息尚未保存。现在关闭此表单会将其删除。",
    unknown_sender: "未知",
    ...
    recovery_reminder_title: "添加找回账户的方式",
    recovery_reminder_body:
      "Aster 用你的密码加密邮件，因此没有人能替你重置密码。添加恢复邮箱以保留访问方式。",
    recovery_reminder_action: "添加恢复邮箱",
    recovery_reminder_later: "稍后",
    plan_prompt_title: "你正在使用免费方案",
    plan_prompt_body: "付费方案提供更多存储空间、自定义域名和无限别名。",
    plan_prompt_action: "查看方案",
    plan_prompt_dismiss: "关闭",
    ...
    go_to_inbox: "前往收件箱",
    removing: "正在移除...",
    upgrade_tooltip: "获得更多存储空间、别名和自定义域名",
    dns_host_leave_blank: "留空",
    dns_host_provider_hint: "{{provider}} 的主机字段使用此格式。请完全照抄。",
    purchase_congrats_title: "恭喜",
    recipient_key_outdated: "收件人的密钥已过期",
    ...
    too_many_attachments:
      "一封邮件最多可携带 {{count}} 个附件。其余的可以另发一封邮件。",
    more_folders_other: "另外 {{count}} 个文件夹",
    more_labels_other: "另外 {{count}} 个标签",
    more_aliases_other: "另外 {{count}} 个别名",
    in_x_minutes_other: "{{count}} 分钟后",
    minutes_remaining_other: "剩余 {{count}} 分钟",
    hours_remaining_other: "剩余 {{count}} 小时",
    days_remaining_other: "剩余 {{count}} 天",
    weeks_remaining_other: "剩余 {{count}} 周",
    minutes_ago_long_other: "{{count}} 分钟前",
    hours_ago_long_other: "{{count}} 小时前",
    days_ago_long_other: "{{count}} 天前",
    weeks_ago_long_other: "{{count}} 周前",
    months_ago_long_other: "{{count}} 个月前",
    emails_marked_as_read_other: "{{count}}封邮件已标记为已读",
    emails_archived_other: "{{count}}封邮件已归档",
    emails_moved_to_trash_other: "{{count}}封邮件已移至回收站",
    emails_starred_other: "{{count}}封邮件已加星标",
    emails_unstarred_other: "{{count}}封邮件已取消星标",
    emails_permanently_deleted_other: "{{count}}封邮件已永久删除",
    emails_snoozed_until_other: "{{count}}封邮件已延后至 {{time}}",
    emails_added_to_folder_other: "{{count}}封邮件已添加到 {{folder}}",
    emails_will_reappear_other: "{{count}}封邮件将于 {{time}} 重新出现",
    drafts_deleted_other: "{{count}}封草稿已永久删除",
    spam_emails_moved_to_trash_other: "{{count}}封垃圾邮件已移至回收站",
    spam_emails_permanently_deleted_other: "{{count}}封垃圾邮件已永久删除",
    newsletters_archived_other: "{{count}}份订阅邮件已归档",
    conversations_marked_as_spam_bulk_other: "{{count}}个会话已标记为垃圾邮件",
    conversations_restored_bulk_other: "{{count}}个会话已恢复",
    conversations_snoozed_bulk_other: "{{count}}个会话已延后",
    conversations_marked_as_read_bulk_other: "{{count}}个会话已标记为已读",
    conversations_marked_as_unread_bulk_other: "{{count}}个会话已标记为未读",
    conversations_starred_bulk_other: "{{count}}个会话已加星标",
    conversations_unstarred_bulk_other: "{{count}}个会话已取消星标",
    conversations_moved_to_inbox_bulk_other: "{{count}}个会话已移至收件箱",
    conversations_marked_as_not_spam_bulk_other:
      "{{count}}个会话已标记为非垃圾邮件",
    conversations_removed_from_folder_other:
      "{{count}}个会话已从 {{folder}} 中移除",
    conversations_moved_to_folder_other: "{{count}}个会话已移至 {{folder}}",
    conversations_removed_label_other: "{{count}}个会话已移除标签 {{label}}",
    conversations_added_label_other: "{{count}}个会话已添加标签 {{label}}",
    contacts_deleted_other: "已删除 {{count}} 个联系人",
    contacts_starred_other: "已为 {{count}} 个联系人加星标",
    contacts_unstarred_other: "已取消 {{count}} 个联系人的星标",
    taps_to_developer_mode_other: "再点按 {{count}} 次进入开发者模式",
    delete_contacts_confirmation_other:
      "确定要删除 {{count}} 个联系人吗？此操作无法撤销。",
    sender_count_other: "{{count}} 位发件人",
    email_count_other: "{{count}} 封邮件",
    entry_count_other: "{{count}} 条记录",
    file_count_other: "{{count}} 个文件",
    emails_from_senders_archived_other:
      "已归档来自 {{senders}} 的 {{count}} 封邮件",
    emails_from_senders_deleted_other:
      "已删除来自 {{senders}} 的 {{count}} 封邮件",
    app_lock_attempts_remaining_other: "还剩 {{count}} 次机会",
    sender_count: "{{count}} 位发件人",
    email_count: "{{count}} 封邮件",
    entry_count: "{{count}} 条记录",
    file_count: "{{count}} 个文件",
    images_count_other: "{{count}} 张图片",
    contact_count: "{{count}} 位联系人",
    tray_show: "显示 Aster Mail",
    tray_quit: "退出",
    tray_troubleshooting: "如果窗口是空白的",
    tray_compat_on: "以兼容模式重新启动",
    tray_compat_off: "启用硬件加速并重新启动",
    tray_display_reset: "重置显示缓存并重新启动",
    push_new_message: "您有一封新邮件",
    too_many_recipients_in_field:
      "收件人、抄送和密送每个字段最多容纳 {{max}} 个地址。将其中一部分移到第二封邮件即可发送这一封。",
    too_many_recipients_in_message:
      "一封邮件在收件人、抄送和密送中最多送达 {{max}} 个地址。把名单拆成多封较小的邮件即可发送。",
    credit_balance_changed:
      "结算页面打开期间，您的信用额度发生了变化。关闭结算并重新开始，即可使用当前的额度。",
    add_birthdays: "添加生日",
    add_birthdays_hint: "为联系人添加生日，Aster 会提前提醒你。",
    change_photo: "更改照片",
    checking_for_keys: "正在查找密钥",
    compose_to_selection: "给所选联系人写邮件",
    contact_change_undone: "已撤消更改",
    contact_encryption_info:
      "当联系人公布公钥后，Aster 会自动加密你发给对方的邮件。",
    contact_moved_to_trash: "联系人已移到废纸篓",
    contacts_in_trash_notice: "废纸篓中的联系人将在 30 天后永久删除。",
    contacts_moved_to_trash: "联系人已移到废纸篓",
    delete_group_confirmation:
      "删除“{{name}}”只会移除该群组，其中的联系人仍保留在通讯录中。",
    discard_new_contact_message:
      "你开始创建的联系人尚未保存。现在打开另一个联系人会丢失它。",
    duplicates_found: "发现重复的联系人",
    email_group: "给群组写邮件",
    empty_trash_confirm: "要永久删除废纸篓中的所有联系人吗？此操作无法撤消。",
    export_selection_csv: "导出为 CSV",
    export_selection: "导出所选项",
    failed_to_load_groups: "无法载入你的群组。",
    failed_to_move_to_trash: "无法将联系人移到废纸篓。",
    group_contact_count: "{{count}} 个联系人",
    group_empty_hint:
      "若要填充此群组，请在“联系人”标签页中选择联系人，然后使用“添加到群组”。",
    group_modal_description: "创建群组，一次给多个联系人写邮件。",
    import_nothing_selected: "请至少选择一个要导入的联系人。",
    import_selected_count: "已选择 {{total}} 个中的 {{selected}} 个",
    merge_contacts_hint: "选择要保留的信息，其他联系人会移到废纸篓。",
    merge_keeps_this: "保留此项",
    no_contact_changes: "还没有更改",
    no_contact_details: "此联系人还没有任何信息。点按“编辑”来添加。",
    no_contacts_in_trash: "废纸篓是空的",
    no_email: "没有邮箱地址",
    no_groups_yet: "还没有群组",
    no_published_key: "没有已公布的密钥",
    open_contacts: "打开联系人",
    review_duplicates: "查看重复的联系人",
  ...
  settings: {
    ...
    bill_encrypted_export: "加密导出",
    bill_external_accounts: "外部账户",
    bill_key_rotation: "密钥轮换",
    bill_members: "成员",
    bill_priority_support: "优先支持",
    bill_protected_folders: "受保护文件夹",
    bill_receipt_tracking: "收据跟踪",
    bill_shared_aliases: "共享别名",
    bill_shared_storage: "共享存储空间",
    ...
    bill_aliases: "别名",
    bill_all_good: "一切正常",
    bill_almost_at_limit: "接近上限",
    bill_almost_full: "即将用满",
    bill_billed_monthly: "按月计费，可随时取消。",
    bill_billed_yearly: "{{total}} 每年一次性计费",
    bill_bonus: "+{{amount}} 赠送",
    bill_buy: "购买",
    bill_cancels_on: "{{date}} 到期",
    bill_compare_plans: "比较套餐",
    bill_credits: "余额",
    bill_current_plan: "当前套餐",
    bill_custom_domains: "自定义域名",
    bill_family: "家庭",
    bill_history: "账单记录",
    bill_individual: "个人",
    bill_limit_reached: "已达上限",
    bill_manage_plan: "管理套餐",
    bill_of: "{{used}} / {{limit}}",
    bill_paid_until_crypto: "已付费至 {{date}}",
    bill_pay_monthly: "按月付费",
    bill_pay_with_card: "银行卡支付",
    bill_pay_with_crypto: "加密货币支付",
    bill_pay_yearly: "按年付费",
    bill_payment: "付款方式",
    bill_payment_subtitle: "银行卡和账单信息",
    bill_plans: "套餐",
    bill_recent_transactions: "近期交易",
    bill_recommended: "推荐",
    bill_renew_with_crypto: "用加密货币续订",
    bill_renews_on: "{{date}} 续订",
    bill_save_percent: "节省 {{percent}}%",
    bill_status_active: "已激活",
    bill_status_canceled: "已取消",
    bill_status_ends: "{{date}} 结束",
    bill_status_payment_needed: "需要付款",
    bill_top_up: "充值",
    bill_top_ups_unavailable: "充值功能暂时不可用。",
    bill_up_to: "最多 {{count}} 个",
    bill_update_payment: "更新",
    bill_upgrade: "升级",
    bill_use_credits_renewals: "用余额支付续订",
    bill_use_credits_renewals_body: "在从您的银行卡扣款之前会先使用您的余额。",
    ...
    alias_export_summary_one: "{{files}} 中共 {{count}} 条记录。",
    allowed_senders_count_one: "{{count}} 位允许的发件人",
    app_lock_attempts_remaining_one: "还剩 {{count}} 次机会",
    app_password_create_link: "创建应用专用密码",
    app_password_required: "需要应用专用密码",
    blocked_senders_count_one: "{{count}} 位已屏蔽的发件人",
    category_info_transactions: "来自商店和服务的订单、付款和收据。",
    deleted_emails_count_one: "已删除 {{count}} 封邮件",
    edit_account_tooltip: "编辑账户",
    email_count_one: "{{count}} 封邮件",
    export_complete_errors_one: "有 {{count}} 封邮件无法导出。",
    ...
    external_account_count_one: "{{count}} 个外部账户",
    fam_consent_body_one:
      "此更改会影响所有家庭成员的数据。系统将向 {{count}} 位成员发送同意请求。所有成员接受后更改才会生效。",
    fam_org_2fa_banner_one: "{{count}} 位成员尚未启用双重验证",
    fam_org_activity_events_one: "{{count}} 个事件",
    fam_org_members_count_one:
      "已使用 {{max}} 个席位中的 {{used}} 个 · {{count}} 个可用",
    fam_org_sec_session_count_one: "{{count}} 个活跃会话",
    fam_org_stat_seats_available_one: "{{count}} 个可用席位",
    ...
    purge_confirm_message_one:
      "此操作将永久删除从 {{email}} 导入的 {{count}} 封邮件。此操作无法撤销。",
    remove_account_tooltip: "移除账户",
    show_side_panel: "显示侧边栏",
    show_side_panel_description: "把联系人和其他快捷工具放在邮件旁边的面板中。",
    sign_out_everywhere_success_one: "已从另外 {{count}} 个会话中退出登录",
    sync_now_tooltip: "立即同步",
    vacation_n_replies_sent_one: "已发送 {{count}} 条回复",
    ...
    duress_pin: "胁迫 PIN 码",
    duress_pin_description: "一个隐藏的 PIN 码，输入后不解锁而是清除本地数据",
    duress_pin_setup: "设置",
    duress_pin_change: "更改胁迫 PIN 码",
    duress_pin_remove: "移除",
    duress_pin_verify_identity: "验证你的身份",
    duress_pin_verify_identity_desc: "输入账户密码以设置胁迫 PIN 码。",
    duress_pin_verify_identity_totp_desc: "输入账户密码和两步验证代码。",
    duress_pin_password_label: "账户密码",
    duress_pin_totp_label: "两步验证代码",
    duress_pin_set: "设置胁迫 PIN 码",
    duress_pin_confirm: "确认胁迫 PIN 码",
    duress_pin_enabled_toast: "已设置胁迫 PIN 码",
    duress_pin_disabled_toast: "已移除胁迫 PIN 码",
    duress_pin_cleared_length_change:
      "锁定格式已更改，因此胁迫 PIN 码已移除。请重新设置。",
    duress_pin_changed_toast: "已更新胁迫 PIN 码",
    duress_pin_matches_regular: "胁迫 PIN 码不能与常用 PIN 码相同",
    duress_pin_enter_to_remove: "输入胁迫 PIN 码以移除它",
    duress_pin_invalid_credentials: "密码或验证代码不正确",
    duress_pin_how_it_works: "胁迫 PIN 码的运作方式",
    duress_pin_how_it_works_body:
      "只要在锁定屏幕上输入这个 PIN 码，Aster Mail 就会立即清除本设备上保存的全部数据并将你退出登录。账户不会被删除：加密的邮件和数据仍保存在 Aster 的服务器上，重新登录即可恢复。",
    duress_pin_confirm_setup: "设置胁迫 PIN 码",
    ...
    category_info_primary: "不属于其他分类的所有邮件，始终开启。",
    category_info_promotions: "营销邮件、优惠和促销活动。",
    category_info_social: "来自社交网络和社区的通知。",
    category_info_updates: "收据、确认信和服务通知。",
    category_info_forums: "来自邮件列表、论坛和讨论组的消息。",
    ...
    category_name: "名称",
    category_name_placeholder: "例如：新闻订阅",
    category_icon: "图标",
    category_color: "颜色",
    category_color_accent: "强调色",
    category_color_blue: "蓝色",
    category_color_green: "绿色",
    category_color_amber: "琥珀色",
    category_color_violet: "紫罗兰",
    category_color_teal: "蓝绿色",
    category_color_cyan: "青色",
    category_color_rose: "玫瑰色",
    category_color_pink: "粉色",
    category_color_slate: "石板灰",
    ...
    family_feat_members_2: "2 位成员，独立账户",
    family_feat_members_6: "最多 6 位成员，独立账户",
    family_feat_everything_nova: "每位成员均享 Nova 全部功能",
    family_feat_everything_supernova: "每位成员均享 Supernova 全部功能",
    family_feat_pool_1tb: "1 TB 共享空间，按成员私密分配",
    family_feat_pool_3tb: "3 TB 共享空间，按成员私密分配",
    family_feat_invite: "通过链接或邮件邀请",
    family_feat_domain_sharing: "成员之间共享域名",
    family_feat_security_policies: "安全策略（强制两步验证）",
    family_feat_admin_transfer: "转移管理员角色",
    family_feat_org_groups: "组织群组与通讯组列表",
    family_feat_activity_log: "活动日志与审计追踪",
    family_feat_org_filters: "组织级邮件过滤器",
    family_feat_retention: "数据保留策略",
    family_feat_storage_controls: "按成员管理存储空间",
    ...
    family_activity_events: "{{count}} 个事件",
    ...
    family_security_warning_2fa: "{{count}} 位成员尚未启用双重验证",
    ...
    alias_orphaned_hint:
      "它的标签使用你之前的密码加密，因此本设备无法读取。如果你还记得该地址，可以恢复标签。发送到该地址的邮件仍会送达，你可以在收到的邮件标头中看到完整地址。",
    alias_restore_action: "恢复此别名",
    alias_restore_prompt: "输入地址。Aster 会先与此别名核对，然后恢复标签。",
    alias_restore_placeholder: "地址",
    alias_restore_confirm: "恢复",
    alias_restore_mismatch: "该地址与此别名不符。请查看已送达邮件的标头。",
    alias_restore_failed: "请重试。",
    recently_deleted_load_failed: "请重试。",
    ghost_aliases_info:
    ...
    alias_display_name_label: "显示名称",
    alias_note_label: "备注",
    alias_details_description: "为该别名命名，并记下它的用途。",
    alias_display_name_desc: "从该别名发信时显示的发件人名称。",
    alias_note_desc: "记录该别名用途的私密备注。",
    alias_websites_desc: "使用该别名注册过的网站。",
    ...
    alias_delivery_folder_desc: "选择发往此别名的邮件落入哪里。默认为收件箱。",
    ...
    alias_delivery_label_error: "请重试。",
    ...
    alias_directory_separator_hint: "目录名称前可以使用点、斜杠、加号或井号。",
    alias_bulk_enabled: "所选别名已开启。",
    alias_bulk_disabled: "所选别名已关闭。",
    alias_bulk_update_partial_failed:
      "{{total}} 个别名中有 {{count}} 个未更新。",
    alias_bulk_delete_partial_failed:
      "{{total}} 个别名中有 {{count}} 个未删除。别名创建 30 天后才能删除。",
    ...
    alias_export_description:
      "选择要包含的内容。文件在您的浏览器中生成，绝不会发送到我们的服务器。",
    alias_export_format_csv: "CSV(表格)",
    alias_export_format_json: "JSON",
    alias_export_confirm_description: "请确认您将要下载的内容。",
    alias_export_source_aliases: "别名",
    alias_export_source_domain_addresses: "自定义域名地址",
    alias_export_source_directories: "目录",
    alias_export_source_ghost: "幽灵别名",
    alias_export_source_count: "{{count}} 条",
    alias_export_choose_columns: "选择列（已选 {{count}} 项）",
    alias_export_hide_columns: "隐藏列",
    alias_export_format_label: "文件格式",
    alias_export_column_address: "地址",
    alias_export_column_display_name: "显示名称",
    alias_export_column_note: "备注",
    alias_export_column_websites: "网站",
    alias_export_column_enabled: "已启用",
    alias_export_column_created_at: "创建时间",
    alias_export_column_directory: "目录",
    alias_export_column_domain: "域名",
    alias_export_column_auto_create: "自动创建",
    alias_export_column_color: "颜色",
    alias_export_column_expires_at: "过期时间",
    alias_export_warning_title: "此文件未加密",
    alias_export_warning_body:
      "任何打开它的人都能看到其中的全部别名、备注和网站。请保存在密码管理器或加密磁盘中。",
    alias_export_summary: "{{files}} 中共 {{count}} 条记录。",
    alias_export_download: "下载",
    alias_export_incomplete:
      "{{total}} 个别名中仅加载了 {{loaded}} 个。请重新加载别名后再试，以确保备份完整。",
    alias_export_undecryptable: "{{count}} 个别名无法解密，未包含在内。",
    alias_export_undecryptable_ghost:
      "{{count}} 个幽灵别名无法解密，未包含在内。",
    alias_export_load_failed: "无法加载目录或幽灵别名。",
    ...
    fam_org_2fa_banner: "{{count}} 位成员尚未启用双重验证",
    ...
    fam_org_sec_session_count: "{{count}} 个活跃会话",
    ...
    fam_org_stat_unassigned: "未分配",
    fam_org_stat_seats_available: "{{count}} 个可用席位",
    ...
    fam_org_invalid_storage: "请输入至少 1 GB 的存储空间",
    ...
    email_font_choice_title: "邮件字体",
    email_font_choice_description: "阅读邮件时使用的字体",
    email_font_option_match_app: "与应用一致",
    email_address: "邮箱地址",
    ...
    time_zone_auto: "自动（设备时区）",
    time_zone_search_placeholder: "搜索城市或地区",
    time_zone_no_results: "没有匹配的时区",
    time_zone_show_all: "显示所有时区",
    date_format: "日期格式",
    ...
    updates: "更新",
    updates_description: "检查应用更新并设置自动更新",
    updates_check_now: "检查更新",
    updates_checking: "正在检查更新...",
    updates_up_to_date: "你使用的已是最新版本",
    updates_check_failed: "检查更新失败。请稍后重试。",
    updates_install_failed:
      "更新未能安装。请重试，或从 astermail.org/download 下载最新版本。",
    updates_available: "有可用更新：{{version}}",
    updates_current_version: "当前版本：{{version}}",
    updates_install_and_restart: "安装并重启",
    updates_installing: "正在下载更新... {{percent}}%",
    updates_downloading: "正在下载更新...",
    updates_last_checked: "上次检查：{{when}}",
    updates_never_checked: "从未检查",
    updates_auto_label: "自动检查更新",
    updates_auto_description: "Aster Mail 会查找新版本，并在可以安装时通知你。",
    updates_release_notes: "版本说明",
    updates_banner_title: "Aster Mail {{version}} 已发布",
    updates_banner_action: "立即安装",
    updates_unsupported: "更新由你的操作系统或浏览器管理",
    updates_dismiss: "稍后",
    billing: "账单",
    ...
    login_alerts_sessions_title: "登录提醒与会话",
    ...
    forward_secrecy_disable_message:
      "新邮件将不再使用轮换密钥，因此日后泄露的密钥可以解开更多邮件。你可以随时重新开启。",
    login_alerts_disable_title: "关闭登录提醒？",
    login_alerts_disable_message:
      "当有新设备登录你的账户时，你将不再收到邮件提醒。",
    turn_off_action: "关闭",
    forward_secrecy_enabled_description: "密钥每{{frequency}}轮换一次",
    forward_secrecy_disabled_description: "自动轮换加密密钥以增强安全性",
    forward_secrecy_setup_failed: "无法开启前向保密。请检查网络连接后重试。",
    ...
    password_change_client_upgrade_required:
      "此版本的 Aster Mail 无法更改您的密码。请更新到最新版本，然后再试一次。",
    password_change_reencryption_incomplete:
      "部分别名未完成重新加密，因此您的密码未更改。请再试一次；如果问题仍然存在，请联系支持团队。",
    ...
    failed_load_security_status: "无法加载你的安全设置。请重试。",
    load_more_sessions: "加载更多 {{count}} 个会话",
    two_fa_enabled: "已启用（剩余{{count}}个备份代码）",
    two_fa_add_security: "使用 2FA 为账户添加额外的安全保护",
    basics_section_title: "基本设置",
    two_step_verification: "两步验证",
    two_step_verification_description: "我们建议在密码之外再要求一个验证码。",
    authenticator_app: "2FA 验证器",
    enable_2fa: "启用 2FA",
    setup_2fa: "设置",
    ...
    blocked_by_os: "请在系统通知设置中开启",
    open_system_notification_settings: "打开设置",
    sound_new_notifications: "新通知时播放提示音",
    badge_count_setting: "未读角标",
    badge_count_setting_description: "在应用图标上显示未读数量",
    push: "推送",
    push_subscribe_failed:
      "通知已开启，但无法设置后台推送。只有在 Aster Mail 打开时才会收到通知。",
    ...
    toast_duration: "通知显示时长",
    toast_duration_description: "通知在屏幕上停留的时间",
    toast_duration_default: "默认（2 秒）",
    toast_duration_long: "长（5 秒）",
    toast_duration_longer: "更长（10 秒）",
    toast_duration_longest: "最长（20 秒）",
    send_test_notification: "发送测试通知",
    test_notification_blocked: "请先开启桌面通知以进行测试。",
    quiet_hours: "免打扰时段",
    ...
    never_manual: "从不（仅手动）",
    auto_advance: "归档或删除后",
    reactions_enabled: "回应",
    reactions_enabled_description: "允许使用表情符号回应邮件并显示他人的回应",
    ...
    translate_confirm_description:
      "Aster 在你的设备上翻译邮件，因此你阅读的内容不会发送到翻译服务。首次从某种语言翻译时，Aster 会下载 20 到 55 MB 的语言包并保存在此设备上。你可以随时移除语言包。",
    translate_confirm_enable: "开启",
    translation_packs: "已下载的语言包",
    translation_packs_description:
      "语言包保存在此设备上。移除语言包可释放空间。下次翻译该语言时，Aster 会重新下载。",
    ...
    translation_packs_unavailable:
      "此浏览器无法保存语言包，因此 Aster 每次翻译时都会下载。",
    ...
    close_to_tray_description:
      "Aster Mail 会留在通知区域，新邮件仍然可以接收。关闭此选项后，关闭窗口即退出。",
    time_format: "时间格式",
    ...
    clear_cache_confirm_message:
      "此操作会清除本设备上的缓存数据并重新加载 Aster Mail。你可能需要重新登录。",
    current_plan: "当前套餐",
    free: "免费",
    ...
    billing_desc_crypto_payment:
      "{{plan}}，{{months}} 个月，通过 {{chain}} 上的 {{currency}} 支付",
    billing_desc_crypto_credit:
      "{{plan}}，{{months}} 个月，通过 {{chain}} 上的 {{currency}} 入账",
    billing_desc_crypto_prepaid:
      "{{plan}}，{{months}} 个月，已使用加密货币预付",
    credit_desc_applied_invoice: "已用于账单",
    credit_desc_applied_storage: "已用于存储空间附加项",
    credit_desc_applied_subscription_checkout: "已用于订阅结算",
    credit_desc_applied_subscription_payment: "已用于订阅付款",
    credit_desc_returned_checkout_not_started: "因无法开始结算而退回",
    credit_desc_returned_checkout_incomplete: "因结算未完成而退回",
    credit_desc_returned_payment_failed: "因延迟付款失败而退回",
    credit_desc_reversed_invoice_voided: "因账单作废而撤销",
    credit_desc_reversed_refunded: "因购买已退款或被质疑而撤销",
    credit_desc_referral_commission: "好友订阅带来的推荐佣金",
    credit_desc_reversal_crypto_overpayment: "撤销加密货币超额付款额度",
    credit_desc_reversal_prepaid_residual: "撤销预付套餐变更额度",
    credit_desc_unused_prepaid: "上一个套餐中未使用的预付时长",
    credit_desc_purchased: "购买了 {{amount}} 的额度",
    credit_desc_referral_reversed: "推荐佣金已撤销：{{reason}}",
    credit_desc_install_bonus: "桌面应用安装奖励",
    credit_desc_crypto_overpayment: "{{chain}} 上的 {{currency}} 超额付款额度",
    ...
    feedback_category_general: "反馈",
    feedback_category_idea: "建议",
    feedback_category_bug: "错误",
    too_many_requests: "操作太频繁了。请稍候再试。",
    please_log_in_feedback: "登录之后就可以发送反馈。",
    failed_send_feedback: "请重试。",
    ...
    search_history: "搜索历史",
    folders_limit: "文件夹",
    onboarding_compose_title: "写下第一封邮件",
    onboarding_compose_description:
      "在收件箱中按 C 即可开始撰写。Aster 会在邮件离开设备之前在本地完成加密。",
    onboarding_search_title: "私密地找到任何邮件",
    onboarding_search_description:
      "按 / 直接进入搜索。无需离开键盘，即可按发件人、日期或附件缩小范围。",
    delete_imported_emails_confirm: "删除已导入的邮件？",
    import_delete_warning: "此操作会永久删除本次导入带入的邮件，且无法撤销。",
    ...
    alias_too_new_message:
      "新别名在创建后会保留 30 天才能删除，这一个从 {{date}} 开始可以移除。升级到 Supernova 即可立即删除别名。",
    ghost_alias_too_new_title: "该幽灵别名创建时间过短，暂无法停用",
    ghost_alias_too_new_message:
      "新的幽灵别名在创建后会保留 30 天才能停用，这一个从 {{date}} 开始可以停用。升级到 Supernova 即可立即停用幽灵别名。",
    ...
    keyserver_status_awaiting: "等待确认",
    keyserver_status_failed: "失败",
    keyserver_awaiting_hint:
      "密钥已上传。请在收件箱中查找来自 keys.openpgp.org 的确认邮件，并点击链接以完成发布。",
    keyserver_failed_hint: "密钥服务器拒绝了您的密钥。请重新发布。",
    ...
    address_change_intro_lead: "继续之前，请阅读将发生的变化。",
    address_change_keep_old_title: "你保留 {{email}}",
    address_change_keep_old_body:
      "发送到该地址的邮件仍会进入你的收件箱，你也仍可用它在所有设备上登录。",
    address_change_no_limit_title: "旧地址仍然属于你",
    address_change_no_limit_body: "它不计入别名上限，别人无法占用，也无法删除。",
    address_change_once_title: "每 30 天可更改一次",
    address_change_once_body: "本次更改后，你可以在 {{date}} 再次更改。",
    ...
    address_change_permanent_body: "{{email}} 无法再成为你的主地址。",
    ...
    primary_address_info: "Supernova 方案允许你每 30 天更改一次地址。旧地址仍然属于你：它会继续接收邮件，也仍可用于登录。",
    ...
    address_change_locked_cooldown_unknown:
      "你在过去 30 天内更改过地址，因此暂时无法再次更改。",
    address_change_once_unknown: "本次更改后，你可以在 30 天后再次更改。",
    ...
    connection_timeout_error: "请输入 5 到 120 秒之间的超时值。",
    ...
    new_password_min_8: "请使用至少 8 个字符。",
    ...
    type_delete_placeholder: "在此输入 {word}",
    ...
    bimi_adj_added_title: "已添加标题。",
    bimi_adj_converted_inline_styles: "已将内联样式转换为属性。",
    bimi_adj_derived_view_box: "已添加 viewBox。",
    bimi_adj_removed_doctype: "已移除文档类型声明。",
    bimi_adj_removed_editor_data: "已移除编辑器数据。",
    bimi_adj_removed_metadata: "已移除元数据。",
    bimi_adj_removed_position: "已移除位置偏移。",
    bimi_adj_removed_size: "已移除固定宽度和高度。",
    bimi_adj_removed_unsupported_attributes: "已移除不支持的属性。",
    bimi_adj_set_tiny_ps_profile: "已将 SVG 配置文件设为 Tiny PS。",
    bimi_adjustments_title: "Aster 已调整您的文件以满足要求：",
    bimi_auto_checking: "此页面打开期间，Aster 会自动检查记录。",
    bimi_check_again: "再次检查",
    bimi_checking: "正在检查",
    ...
    bimi_err_empty: "图像为空。",
    bimi_err_external_reference: "此文件链接到外部资源，这是不允许的。",
    bimi_err_invalid_reference: "此文件包含损坏的内部引用。",
    bimi_err_invalid_value: "此文件包含不允许的属性值。",
    bimi_err_malformed: "此文件不是有效的 SVG。",
    bimi_err_missing_view_box: "图像没有 viewBox。请导出带有 viewBox 的图像。",
    bimi_err_not_square: "徽标不是正方形。请将宽度和高度设为相同。",
    bimi_err_not_svg: "此文件不是 SVG 图像。",
    bimi_err_not_utf8: "此文件不是文本格式的 SVG 文件。",
    bimi_err_raster_image: "此文件包含嵌入的位图图像。请仅使用矢量形状。",
    bimi_err_script_content: "此文件包含脚本，这是不允许的。",
    bimi_err_text_not_outlined: "徽标包含文字。请在导出前将文字转换为轮廓。",
    ...
    bimi_error_not_svg_file: "请选择 SVG 文件。",
    bimi_error_throttled: "请稍候，然后重试。",
    bimi_errors_title: "此文件无法用作品牌徽标：",
    ...
    bimi_preview_inbox_title: "在收件箱中的样子",
    ...
    bimi_req_auth_ok: "SPF 和 DKIM 已验证。",
    bimi_req_auth_title: "邮件身份验证",
    bimi_req_dmarc_title: "DMARC 强制执行",
    bimi_req_not_checked: "尚未检查。",
    bimi_requirements_title: "要求",
    bimi_row_attention: "您的徽标已发布，但有一项要求已不再满足。",
    bimi_row_draft: "您的徽标已准备就绪。发布后即可开始使用。",
    bimi_row_external: "此域名的 BIMI 记录指向其他主机。",
    bimi_row_inactive: "请完成此域名的设置，以添加品牌徽标。",
    bimi_row_live: "您的徽标已发布。",
    bimi_row_off: "在支持品牌徽标的收件箱中，于您的邮件旁显示徽标。",
    bimi_row_pending: "请添加 DNS 记录，然后再次检查。",
    bimi_row_pending_managed: "正在发布您的 DNS 记录。这可能需要几分钟。",
    bimi_rule_safe: "不含脚本或外部链接",
    bimi_rule_size: "经 Aster 优化后不超过 32 KB",
    bimi_rule_square: "正方形，宽度和高度相同",
    bimi_rule_svg: "SVG 文件",
    bimi_rule_vector: "仅限矢量图形，文字已转为轮廓",
    bimi_rules_title: "文件要求",
    bimi_set_up: "设置",
    bimi_state_attention: "需要处理",
    bimi_state_draft: "未发布",
    bimi_state_external: "由其他服务管理",
    bimi_state_live: "已生效",
    bimi_state_pending: "等待 DNS",
    bimi_step_logo: "徽标",
    bimi_step_of: "第 {current} 步，共 {total} 步",
    bimi_step_publish: "发布",
    bimi_title: "品牌徽标",
    bimi_turn_off: "关闭",
    ...
    incoming_port_error: "请输入 1 到 65535 之间的端口号。",
    ...
    smtp_private_address_error:
      "这里需要的是公网邮件服务器，而不是本地或私有地址。可以使用您的服务商提供的公网主机名。",
    smtp_port_error: "请输入 1 到 65535 之间的端口号。",
    ...
    entire_domain: "整个域名",
    unreadable_entry_title: "无法读取的条目",
    unreadable_entry_hint: "此设备无法读取此条目。在你删除之前，它仍然生效。",
    unreadable_entries_notice: "部分条目无法在此设备上读取，因此未在此处显示。",
    external_accounts_limit_reached:
      "最多可连接 5 个账户。若要添加新账户，请先移除一个。",
    no_allowed_senders: "没有已允许的发件人",
    failed_to_load_allowlist: "请重试。",
    failed_to_load_blocklist: "请重试。",
    ...
    no_emails_in_file:
      "在所选文件中未找到邮件。请确认每个文件都是受支持的格式（MBOX、EML、CSV 或 PST）。",
    import_failed: "请重试。",
    ...
    vacation_reply_delete_title: "删除假期回复？",
    vacation_reply_delete_message: "假期回复及其时间安排将被删除。",
    delete_forwarding_rule_title: "删除转发规则？",
    delete_forwarding_rule_message: "符合此规则的邮件将不再转发。",
    ...
    promo_error_invalid: "此促销代码无效。请检查代码后重试。",
    promo_error_expired: "此促销代码已过期或不再可用。",
    promo_error_not_for_plan: "此促销代码不适用于该套餐。",
    promo_error_not_for_plan_change: "更换套餐时无法使用此促销代码。",
    promo_error_discount_active:
      "你的订阅已享有折扣，因此无法再添加其他促销代码。",
    ...
    plan_change_discount_forever: "每次付款均享{{discount}}",
    plan_change_discount_months: "{{count}}个月内享{{discount}}",
    plan_change_discount_months_one: "{{count}}个月内享{{discount}}",
    plan_change_discount_months_other: "{{count}}个月内享{{discount}}",
    plan_change_discount_label: "促销代码 {{code}}",
    plan_change_price_before_discount: "折扣前价格",
    ...
    storage_overview_description:
      "查看哪些内容占用了空间，并清理不需要的内容。",
    storage_promo_title: "扩容更划算",
    storage_promo_body: "扩容前 {{months}} 个月享 {{percent}}% 折扣。",
    storage_promo_body_singular: "扩容首月享 {{percent}}% 折扣。",
    storage_promo_note: "优惠仅适用于首次购买的存储扩容。",
    storage_select_option_first: "要购买更多存储空间，请先选择一个选项。",
    storage_promo_cta: "查看扩容",
    storage_used_of_total: "已使用 {{used}}，共 {{total}}",
    storage_free_space: "剩余 {{size}}，已使用 {{percent}}",
    storage_breakdown_title: "存储空间占用情况",
    ...
    storage_included_with_plan: "套餐包含",
    storage_from_addons: "来自扩容",
    storage_family_allocation: "家庭分配",
    storage_total_capacity: "总容量",
    storage_available: "可用",
    storage_cleanup_done: "已释放空间",
    storage_cleanup_failed: "无法释放空间，请重试。",
    storage_cleanup_confirm:
      "此操作将永久删除 {{count}} 个项目并释放 {{size}}，且无法撤销。",
    ...
    storage_full: "您的存储空间已满。升级方案或移除一些邮件即可腾出空间。",
    plan_limit_reached:
      "您已达到当前方案的上限。请升级方案或移除一些条目以腾出空间。",
    ...
    promo_invalid: "此促销码无效。请检查促销码后重试。",
    ...
    autorenew_notice_short:
      "使用银行卡付款时，方案将自动续订。若要避免下次扣款，请在续订日期前于“设置”中取消。",
    payment_complete: "付款完成",
    payment_success: "付款成功！",
    payment_failed:
      "无法从您的支付方式扣款。请重试，或在“设置”>“账单”中更新支付方式。",
    payment_activation_pending:
      "付款已成功，但套餐尚未生效。请稍后刷新页面。如果仍未生效，请联系支持团队。",
    ...
    plan_everything_in: "包含 {{plan}} 的全部功能，另加",
    compare_features_show: "按套餐比较功能",
    compare_features_hide: "隐藏比较",
    ...
    adding_card: "添加中...",
    card_added: "支付方式已添加",
    payment_retry_succeeded: "付款已完成，你的方案继续生效。",
    payment_retry_failed: "银行拒绝了这张卡，请换一种付款方式。",
    ...
    cancel_reason_description:
      "是什么让您决定取消？此项为选填，能帮助我们改进。",
    cancel_reason_too_expensive: "价格太高",
    cancel_reason_not_using: "使用得不够多",
    cancel_reason_missing_feature: "缺少我需要的功能",
    cancel_reason_switched_provider: "已改用其他服务商",
    cancel_reason_bugs: "问题或故障太多",
    cancel_reason_privacy_trust: "对隐私或信任有顾虑",
    cancel_reason_just_testing: "只是试用一下",
    cancel_reason_other: "其他原因",
    cancel_reason_text_placeholder: "还有什么想补充的吗？（选填）",
    cancel_reason_placeholder_too_expensive: "多少价格你会觉得合适？",
    cancel_reason_placeholder_not_using: "怎样才能让你经常用起来？",
    cancel_reason_placeholder_missing_feature: "你需要哪项功能？",
    cancel_reason_placeholder_switched_provider:
      "你换到了哪个服务？是什么打动了你？",
    cancel_reason_placeholder_bugs: "哪个问题对你影响最大？",
    ...
    top_up_credits: "充值",
    checkout_abandon_confirm: "取消付款",
    checkout_abandon_keep: "继续付款",
    checkout_abandon_message:
      "账单将被取消，不会产生任何扣款。你可以随时重新开始。",
    ...
    checkout_pay_amount: "支付 {{amount}}",
    checkout_review_title: "确认并付款",
    checkout_what_you_get: "包含内容",
    credits_method_card_note: "付款通过后，余额会立即入账。",
    credits_method_crypto_note:
      "使用加密货币一次性付款。付款在链上确认后，余额会入账。",
    offer_modal_action: "领取优惠",
    offer_modal_badge: "{{percent}}% 折扣",
    offer_modal_dismiss: "暂不",
    offer_modal_fine_print: "优惠码 {{code}} 在结账时生效，每个账户限用一次。",
    offer_modal_price_note: "折扣在结账时生效。",
    offer_modal_subtitle: "以更低的价格升级到 {{plan}}。",
    offer_modal_title: "订阅可省 {{percent}}%",
    offer_upgrade_description: "选择一个套餐来使用折扣。",
    offer_upgrade_title: "优惠正在等你",
    plan_cat_advanced_aliases: "高级别名",
    plan_cat_contacts: "联系人",
    plan_cat_general: "常规",
    plan_cat_mail: "邮件",
    plan_cat_security: "安全",
    plan_cat_subscriptions: "订阅",
    plan_cat_support: "支持",
    plan_cat_vanguard: "Vanguard",
    plan_f_alias_bulk: "别名批量操作",
    plan_f_alias_csv: "别名 CSV 导出",
    plan_f_alias_import: "别名导入",
    plan_f_alias_no_cooldown: "创建别名无需等待",
    plan_f_alias_pin: "置顶别名",
    plan_f_alias_transfer: "别名转移",
    plan_f_allowlist: "发件人允许名单",
    plan_f_biometric: "生物识别解锁",
    plan_f_blocked_senders: "已屏蔽的发件人",
    plan_f_contact_import: "联系人导入",
    plan_f_contact_sync: "联系人同步（CardDAV）",
    plan_f_contacts: "加密联系人",
    plan_f_cross_platform: "网页、桌面、Android 和 iOS 应用",
    plan_f_custom_categories: "自定义收件箱分类",
    plan_f_email_export: "邮件导出",
    plan_f_email_import: "邮件导入",
    plan_f_expiration: "限时邮件",
    plan_f_folder_auto_clean: "文件夹自动清理",
    plan_f_folders: "文件夹和标签",
    plan_f_key_management: "密钥管理",
    plan_f_link_warnings: "可疑链接提醒",
    plan_f_one_click_unsub: "一键退订",
    plan_f_password_emails: "密码保护的邮件",
    plan_f_pgp: "PGP 加密",
    plan_f_phishing: "钓鱼防护",
    plan_f_quick_alias_reply: "用别名快速回复",
    plan_f_scheduled_send: "定时发送",
    plan_f_snooze: "邮件延后处理",
    plan_f_sub_categories: "订阅分类",
    plan_f_sub_scanner: "订阅扫描",
    plan_f_vanguard_app_lock: "应用锁",
    plan_f_vanguard_lockdown_mode: "封锁模式",
    plan_f_wkd: "网络密钥目录",
    plan_tip_alias_bulk: "一次启用、停用或删除多个别名。",
    plan_tip_alias_csv: "把所有别名连同规则和状态导出为 CSV 文件。",
    plan_tip_alias_import: "一步把别名从其他服务商迁移过来。",
    plan_tip_alias_no_cooldown: "连续创建别名，中间无需等待。",
    plan_tip_alias_pin: "把最常用的别名固定在列表顶部。",
    plan_tip_alias_transfer: "把别名转移到你名下的另一个 Aster 账户。",
    plan_tip_allowlist: "即使过滤器会拦截，也让指定发件人的邮件通过。",
    plan_tip_contact_sync:
      "把联系人同步到 macOS 和 iOS 的“通讯录”、Android 上的 DAVx5，或任何 CardDAV 客户端。需要设备上运行 Aster Bridge 配套应用。",
    plan_tip_custom_categories:
      "创建自己的收件箱标签页，并决定哪些邮件进入其中。",
    plan_tip_email_export: "把邮件下载为标准归档文件，随处都能打开。",
    plan_tip_email_import:
      "通过 IMAP 从其他服务商迁移邮件，文件夹结构保持不变。",
    plan_tip_expiration: "设定一个日期，到期后邮件会从收件人处自动删除。",
    plan_tip_extra_alias_domains:
      "在更多 Aster 域名上创建别名，而不只是 astermail.org。",
    plan_tip_folder_auto_clean: "按文件夹删除超过你设定期限的邮件。",
    plan_tip_sub_scanner:
      "找出你订阅过的每一份邮件通讯和服务，在一个地方统一退订。",
    plan_tip_vanguard_app_lock:
      "每次打开 Aster 时都要求输入设备密码或验证生物识别。",
    plan_tip_vanguard_lockdown_mode:
      "在你关闭之前，屏蔽远程内容、外部链接和新发件人。",
    plan_tip_wkd:
      "在你自己的域名上发布公钥，任何人都能找到它并给你发送加密邮件。",
    stripe_secure_short: "由 Stripe 保障",
    upgrade_external_accounts_note: "升级套餐即可连接更多外部账户。",
    usage_external_accounts: "外部账户",
    top_up_credits_description: "为账户充值。余额会自动用于套餐续订。",
    credit_packages_loading: "正在加载套餐...",
    credit_packages_failed: "未能加载点数包。",
    credit_package_bonus: "额外赠送 {{ bonus }}",
    credit_package_total: "共 {{ total }}",
    buy_credits: "购买余额",
    buy_credits_crypto: "使用加密货币支付",
    buying_credits: "正在跳转...",
    credit_purchase_error: "无法开始结账。请重试。",
    credit_pay_card: "银行卡",
    credit_pay_crypto: "加密货币",
    credits_added_to_account: "余额已添加到你的账户。",
    in_credits: "余额",
    credit_transactions: "积分交易",
    referral_program: "推荐计划",
    referral_program_description:
      "邀请好友加入 Aster Mail。好友开始使用账户后，你们双方各获得 {{ amount }} 额外存储空间。",
    ...
    no_referrals_yet: "还没有邀请。分享你的链接即可开始。",
    referral_status_pending: "待处理",
    referral_status_completed: "已完成",
    referral_reward_info:
      "你和好友各获得 {{ amount }} 额外存储空间。好友使用账户几天后存储空间到账，只要他们继续使用 Aster Mail，空间就一直保留在你的账户中。",
    ...
    type_delete_to_confirm: "输入 {word} 以确认",
    deleting_label: "删除中...",
    ...
    domain_purchase_banner_title: "获取您自己的邮箱域名",
    domain_purchase_banner_subtitle:
      "搜索、购买,几秒钟内即可开始收信。DNS 自动配置。",
    domain_purchase_banner_cta: "购买域名",
    domain_purchase_title: "购买域名",
    ...
    domain_purchase_one_year: "1 年",
    domain_purchase_n_years: "{{count}} 年",
    domain_purchase_pay_with: "支付方式",
    domain_purchase_pay_card: "银行卡",
    domain_purchase_pay_crypto: "加密货币",
    ...
    domain_purchase_intro_replay: "再次显示引导流程",
    domain_purchase_intro_examples: "或从示例开始",
    domain_purchase_intro_tld_title: "现在选择一个后缀",
    domain_purchase_intro_tld_sub:
      "后缀会影响价格和地址的风格。如果拿不定主意，保持选择全部，我们会展示所有合适的选项。",
    domain_purchase_results_for: "这是我们为 {{name}} 找到的结果",
    domain_purchase_results_for_sub:
      "选一个你喜欢的。支付只需一分钟，完成后新地址即可立刻接收邮件。",
    domain_purchase_change_name: "更改名称",
    domain_purchase_purchased_desc:
      "通过 Aster 购买的域名会显示在这里,并自动作为自定义域名使用。选个名字,付款,立即开始使用。",
    domain_purchase_filter_price: "最高价格",
    domain_purchase_filter_price_any: "不限价格",
    domain_purchase_more_suggestions: "生成更多建议",
    domain_purchase_sort_by: "排序方式",
    domain_purchase_order_summary: "订单摘要",
    domain_purchase_summary_whois: "WHOIS 隐私保护",
    domain_purchase_summary_dns: "自动 DNS 配置",
    domain_purchase_summary_included: "已包含",
    domain_purchase_total_today: "今日合计",
    ...
    domain_purchase_manage_description: "查看此注册信息，并在到期前续费。",
    domain_purchase_manage_status: "状态",
    domain_purchase_manage_status_active: "有效",
    domain_purchase_manage_status_expiring: "即将到期",
    domain_purchase_manage_registered: "注册时间",
    domain_purchase_manage_expires: "到期时间",
    domain_purchase_manage_term: "期限",
    domain_purchase_manage_paid: "已付金额",
    domain_purchase_manage_auto_renew_note:
      "此域名不会自动续费。若要继续持有，请在到期日之前续费。",
    domain_purchase_manage_dns: "打开域名设置",
    domain_purchase_manage_support_note:
      "如需将此域名转移到其他注册商或咨询退款，请联系支持团队。",
    domain_purchase_manage_support_subject: "关于 {{domain}} 的帮助",
    domain_purchase_filter_all: "全部",
    domain_purchase_filter_available: "可注册",
    domain_purchase_filter_taken: "已被注册",
    domain_purchase_sort_label: "排序",
    domain_purchase_sort_relevance: "相关性",
    domain_purchase_sort_price_low: "价格从低到高",
    domain_purchase_sort_price_high: "价格从高到低",
    domain_purchase_sort_az: "名称 A 到 Z",
    domain_purchase_sort_discount: "折扣最大",
    domain_purchase_show_more: "显示更多结果",
    domain_purchase_results_count: "{{count}} 个结果",
    ...
    connected_accounts_reconnect: "重新连接",
    ...
    trusted_2fa_revoke_confirm: "此设备下次登录时需要输入验证码。",
    trusted_2fa_revoke_all_confirm:
      "所有受信任的设备下次登录时都需要输入验证码。",
    ...
    security_keys_desktop_note:
      "你可以在 app.astermail.org 的 Aster 网页版中添加安全密钥。在这里可以查看和移除已有的密钥。",
    passkeys_desktop_note:
      "你可以在 app.astermail.org 的 Aster 网页版中添加通行密钥。在这里可以查看和移除已有的通行密钥。",
    app_lock_pin: "PIN 锁定",
    ...
    lockdown_description:
      "屏蔽所有外部内容，移除通知预览，关闭实时同步，并在打开链接前要求确认。启用期间无法绕过。",
    lockdown_active: "锁定模式已启用",
    lockdown_enable: "启用锁定模式",
    lockdown_disable: "关闭锁定模式",
    lockdown_enabled_toast: "已启用锁定模式",
    lockdown_disabled_toast: "已关闭锁定模式",
    lockdown_confirm_disable_title: "要关闭锁定模式吗？",
    lockdown_confirm_disable_desc:
      "这会重新允许外部内容、链接跟踪和通知预览。你随时可以再次启用。",
    lockdown_notification_generic: "新消息",
    lockdown_content_blocked_note: "锁定模式已启用",
    lockdown_link_warning_title: "正在打开外部链接",
    lockdown_link_warning_body: "这会向以下方暴露你的 IP 地址：",
    lockdown_info:
      "Lockdown Mode closes every in-session data leak vector. External images, fonts, and CSS are blocked with no bypass.",
    lockdown_badge: "锁定",
    lockdown_must_disable_first: "请先关闭锁定模式，再关闭 Vanguard。",
    remove_key: "移除",
    ...
    never_used: "从未使用",
    bridge: "Bridge",
    bridge_description: "将 Aster 连接到任何 IMAP 或 SMTP 邮件客户端",
    bridge_download_windows: "下载 Windows 版",
    bridge_download_msi: "MSI",
    bridge_app_name: "Aster Bridge",
    bridge_windows_name: "Windows",
    bridge_windows_desc:
      "下载安装程序，在你的 Windows 电脑上运行 Aster Bridge。",
    bridge_linux_name: "Linux",
    bridge_linux_desc: "提供适用于主流发行版的 AppImage、.deb 和 .rpm 软件包。",
    bridge_linux_cta: "下载 AppImage",
    ...
    bridge_other_formats: "其他格式",
    bridge_arch_x64: "x86-64",
    bridge_arch_arm64: "ARM64",
    bridge_format_msi_desc: "适用于通过组策略管理的安装",
    bridge_format_appimage_desc: "可在大多数发行版上运行",
    bridge_format_deb_desc: "Debian、Ubuntu 及其衍生版",
    bridge_format_rpm_desc: "Fedora、RHEL 和 openSUSE",
    bridge_format_pacman_desc: "Arch Linux 及其衍生版",
    bridge_download_started: "已开始下载",
    bridge_download_failed: "下载未开始。请重试。",
    bridge_support_help_desc: "设置指南和常见问题解答",
    bridge_support_discord_desc: "向团队和其他 Aster 用户提问",
    bridge_support_reddit_desc: "关注公告并参与讨论",
    bridge_support_github_desc: "查看源代码并报告问题",
    bridge_all_platforms: "所有平台",
    bridge_upgrade_benefit_clients: "支持 Apple Mail、Thunderbird 和 Outlook",
    bridge_upgrade_benefit_local: "在本地运行，你的邮件始终保持加密",
    ...
    bridge_coming_soon: "即将推出",
    bridge_info_link: "了解更多",
    ...
    security_center_protection_score: "保护评分",
    security_center_encryption_title: "端到端加密",
    security_center_encryption_detail:
      "邮件、联系人和文件在到达 Aster 之前先在您的设备上加密。",
    security_center_identity_key: "身份密钥",
    ...
    export_progress_working: "正在准备导出。",
    ...
    spam_settings_load_failed:
      "垃圾邮件设置未能加载，因此这些值可能与你的帐户不一致。",
    dev_mode_needs_unlock: "请解锁保险库后再更改开发者模式。",
    translate_languages_keep_one: "至少保留一种用于翻译的语言。",
    ...
    oauth_reason_account_creation_failed: "请重试。",
    ...
    crypto_native_loading_coins: "正在加载支付方式...",
    crypto_native_on_chain: "在 {{chain}} 上",
    ...
    crypto_native_received_title: "已收到付款",
    crypto_native_received_body: "已收到全额款项，正在处理中。无需再次付款。",
    crypto_native_send_exactly: "请准确发送",
    ...
    crypto_native_expires_in: "{{time}} 后过期",
    crypto_native_status_awaiting: "等待付款",
    crypto_native_status_detected: "已检测到付款",
    ...
    crypto_native_received_label: "已收到金额",
    ...
    invoice_status_refunded: "已退款",
    invoice_status_reversed: "已撤销",
    invoice_status_uncollectible: "无法收取",
    invoice_status_void: "已作废",
    invoice_status_voided: "已作废",
    ...
    referral_email_body:
      "你好：\n\n我用 Aster Mail 已经有一段时间了，体验很不错。所有内容都是端到端加密的，除了你自己，没有人能读到你的邮件，运营方也不行。\n\n如果你想试试，这是我的邀请链接：\n\n{{ referral_link }}\n\n你开始使用后，我们双方各获得 {{ amount }} 额外存储空间，你也能有所收获。\n\n祝好",
    referral_how_it_works: "工作原理",
    referral_step_share: "把邀请链接分享给朋友、家人或同事。",
    referral_step_signup: "他们通过你的链接创建账户并开始使用。",
    referral_step_earn:
      "你们各获得 {{ amount }} 额外存储空间，最多 {{ max }}。",
    referral_rewards: "奖励",
    referral_loading_contacts: "正在加载联系人...",
    referral_no_contacts: "没有联系人可以邀请",
    send_referral_to_contacts: "向所有联系人发送邮件",
    ...
    credit_type_refunded: "已退款",
    credit_type_spent: "已使用",
    credit_type_clawback: "收回",
    credit_type_admin_removal: "移除",
    credit_type_crypto_overpayment: "多付款",
    credit_type_crypto_overpayment_reversal: "多付款冲正",
    credit_type_prepaid_switch_residual: "套餐变更",
    credit_type_prepaid_switch_residual_reversal: "套餐变更撤销",
    credits_title: "积分",
    ...
    email_label: "邮箱",
    vacation_n_replies_sent: "已发送 {{count}} 条回复",
    ...
    send_read_receipts_description: "让发件人知道你何时打开了他们的邮件。",
    alias_captcha_required: "请完成验证码以创建别名。",
    obscure_subject_title: "隐藏加密邮件的主题",
    obscure_subject_description:
      "当邮件加密时，用三个点替换可见主题，并把真实主题放在加密部分中",
    info_obscure_subject_title: "隐藏加密邮件的主题",
    ...
    referral_discount_expired: "已过期",
    referral_discount_auto_apply: "结账时自动应用，无需输入。",
    referral_discount_expires: "{{ date }} 到期",
    invite_storage_line: "你们双方各获得 {{ amount }} 额外存储空间",
    invite_storage_note:
      "使用此链接创建免费账户。你开始使用自己的账户后，两个账户都会收到存储空间。",
    invite_discount_note:
      "如果日后升级到付费套餐，还可享 {{ percent }}% 折扣。",
    invite_cta_create_account_storage: "创建我的免费账户",
    invite_friends: "邀请好友",
    invite_sidebar_earned: "已获得 {{ amount }}",
    referral_storage_headline:
      "每邀请一位好友加入，即可获得 {{ amount }} 存储空间",
    referral_storage_subhead:
      "你的好友同样获得 {{ amount }}。好友开始使用账户后存储空间到账，最多 {{ max }}。",
    referral_storage_earned_badge: "已获得 {{ amount }}",
    referral_active_referrals: "有效",
    referral_share_button: "分享邀请",
    referral_show_qr: "显示二维码",
    referral_hide_qr: "隐藏二维码",
    referral_qr_hint: "用手机相机对准此二维码即可打开邀请。",
    referral_qr_alt: "你的 Aster Mail 邀请链接二维码",
    referral_share_title: "来 Aster Mail 和我一起用",
    referral_share_message:
      "我用 Aster Mail 收发端到端加密邮件。通过我的链接加入，我们双方各获得 {{ amount }} 额外存储空间。",
    referral_shared: "邀请已分享",
    referral_message_copied: "邀请内容已复制",
    referral_bonus_gauge_label: "已获得的存储空间",
    referral_bonus_max: "上限：{{ value }}",
    referral_status_active: "有效",
    referral_email_all_contacts_hint: "向通讯录中的每位联系人发送一封邮件。",
    referral_claim_title: "有人邀请你了吗？",
    referral_claim_description:
      "输入邀请中的代码，你们双方各获得 {{ amount }} 额外存储空间。请在 {{ date }} 前添加。",
    referral_claim_placeholder: "邀请代码",
    referral_claim_button: "添加代码",
    ...
    domain_purchase_not_released: "域名购买尚未上线，将在后续更新中推出。",
    domain_step_ownership_title: "证明你拥有该域名",
    domain_step_mx_title: "在你的域名上接收邮件",
    domain_step_spf_title: "允许 Aster 代表你发送邮件",
    domain_step_dkim_title: "为你发出的邮件签名",
    domain_step_dmarc_title: "阻止他人冒充你",
    domain_step_tlsrpt_title: "接收加密失败报告",
    domain_health_ok_title: "{{domain}} 运行正常",
    domain_health_ok_body:
      "你可以在该域名上收发邮件，邮件也已签名，能进入收件箱。",
    domain_health_warning_title: "邮件可以收发，但可能被归为垃圾邮件",
    domain_health_warning_body:
      "你已能在该域名上收邮件。请完成下面的项目，让你发出的邮件也被信任。",
    domain_health_critical_title: "你没有在接收邮件",
    domain_health_critical_body:
      "发送到该域名的邮件没有到达 Aster。修复下面的问题后，几分钟内即可恢复投递。",
    domain_health_unknown_title: "我们无法读取你的 DNS",
    domain_health_unknown_body:
      "这通常表示记录刚刚更改，尚未生效。我们会继续检查。",
    domain_health_recheck: "立即检查",
    domain_health_checking: "正在检查",
    domain_health_last_checked: "上次检查时间：{{when}}",
    domain_health_auto_checking: "每隔几秒自动重新检查",
    domain_check_mx_label: "接收邮件",
    domain_check_spf_label: "发送授权",
    domain_check_dkim_label: "邮件签名",
    domain_check_dmarc_label: "防冒充保护",
    domain_check_mx_pass: "发送到该域名的邮件会到达你的 Aster 收件箱。",
    domain_check_spf_pass: "其他服务商会接受 Aster 代表你发送的邮件。",
    domain_check_dkim_pass: "你发出的邮件已签名，不会被视为伪造。",
    domain_check_dmarc_pass: "其他人无法冒用你的域名发送邮件。",
    domain_check_unknown: "我们还无法读取这条记录，仍在检查。",
    domain_check_generic_failure:
      "这条记录尚未正确设置。添加下面的记录即可修复。",
    domain_reason_mx_missing:
      "目前还没人能给你发邮件。你的域名没有邮件路由，邮件会被退回给发件人。",
    domain_reason_mx_points_elsewhere:
      "邮件正被投递到你的旧服务商，而不是 Aster。删除旧的 MX 记录，邮件才会到达此邮箱。",
    domain_reason_spf_missing:
      "你发出的邮件可能被拒收或标为垃圾邮件，因为没有任何记录告诉其他服务商 Aster 可以代表你发送。",
    domain_reason_spf_missing_include:
      "你的域名已有 SPF 记录，但其中没有 Aster。请把 Aster 加入其中，否则你发出的邮件可能被拒收。",
    domain_reason_spf_duplicate_records:
      "你有多条 SPF 记录。服务商会全部忽略，请将它们合并为一条。",
    domain_reason_dkim_missing_or_stale:
      "你发出的邮件未签名，看起来像伪造邮件。添加签名记录后，邮件才会被信任。",
    domain_reason_dmarc_missing:
      "任何人都能冒用你的域名发送邮件。等上面两项生效后，再添加这条记录。",
    domain_fix_show_record: "显示需要添加的记录",
    domain_fix_hide_record: "隐藏记录",
    ...
    fam_kids_subtitle:
      "现在为孩子保留一个地址，让他们以后用自己的密码完成设置。",
    fam_kids_seats_used: "已使用 {{max}} 个家庭席位中的 {{used}} 个",
    fam_kids_reserve_btn: "保留一个地址",
    fam_kids_seats_full: "你的家庭群组已满。请释放一个席位后再保留新地址。",
    fam_kids_empty: "暂无保留的地址。",
    fam_kids_username_label: "地址",
    fam_kids_username_ph: "孩子的用户名",
    fam_kids_info_title: "为儿童保留的地址",
    fam_kids_info_desc:
      "该地址将为你的孩子保留，其他人无法注册。孩子（或你）以后用一个私密密码完成设置，从而创建一个真正的零访问账户，并自动加入你的家庭。",
    fam_kids_nickname_label: "昵称（可选）",
    fam_kids_nickname_ph: "例如：小明",
    fam_kids_storage_label: "该地址的存储空间",
    fam_kids_checking: "正在检查可用性…",
    fam_kids_available: "可用",
    fam_kids_taken: "已被占用",
    fam_kids_reserved_taken: "已被保留",
    fam_kids_invalid: "用户名无效",
    fam_kids_consent_label:
      "我确认自己是该儿童的父母或法定监护人，并同意为其创建账户。",
    fam_kids_consent_required: "请确认家长同意后再继续。",
    fam_kids_link_hint:
      "任何拿到此链接的人都能设置该地址。请只分享给你的孩子，若外泄请重新生成。",
    fam_kids_create: "保留",
    fam_kids_creating: "正在保留…",
    fam_kids_cancel: "取消",
    fam_kids_created: "地址已保留 · 链接已复制",
    fam_kids_address_reserved: "地址已保留",
    fam_kids_create_failed: "无法保留该地址",
    fam_kids_copy_link: "复制设置链接",
    fam_kids_link_copied: "设置链接已复制",
    fam_kids_regenerate: "重新生成链接",
    fam_kids_regenerated: "已生成新链接",
    fam_kids_setup_now: "立即设置",
    fam_kids_release: "释放",
    fam_kids_released: "保留已释放",
    fam_kids_release_confirm: "要释放这个保留的地址吗？它将重新对所有人开放。",
    fam_kids_status_reserved: "已保留",
    fam_kids_status_claimed: "已启用",
    fam_kids_claimed_active: "账户已设置并加入你的家庭",
    fam_kids_load_failed: "无法加载保留记录",
    fam_kids_claim_setup_for: "正在设置 {{address}}",
    fam_kids_claim_intro: "设置密码以完成该家庭地址的配置。",
    fam_kids_claim_invalid_title: "此链接已失效",
    fam_kids_claim_invalid_body:
      "此链接已过期、已被使用或已被撤回。请向家庭管理者索取新链接。",
    fam_kids_claim_signed_in_title: "你已登录到另一个账户",
    fam_kids_claim_signed_in_body:
      "此链接用于设置新的儿童账户。请在隐私窗口中打开，或复制后在孩子的设备上使用。",
    fam_kids_release_modal_title: "要释放此地址吗？",
    fam_kids_release_modal_body:
      "{{address}} 将重新开放给任何人注册。此操作无法撤销。",
    fam_kids_release_btn: "释放",
    fam_org_event_address_reserved: "地址已保留",
    fam_org_event_reservation_released: "保留已释放",
    fam_org_event_shared_mailbox_created: "已创建共享邮箱",
    fam_org_event_shared_mailbox_deleted: "已删除共享邮箱",
    fam_org_event_shared_mailbox_grant_added: "已授予共享邮箱访问权限",
    fam_org_event_shared_mailbox_grant_revoked: "已移除共享邮箱访问权限",
    fam_org_event_shared_mailbox_rotated: "已轮换共享邮箱密钥",
    fam_org_event_consent_request_created: "已请求同意",
    fam_org_event_consent_declined: "已拒绝同意",
    fam_org_event_consent_all_accepted: "同意已完成",
    fam_org_activity_address_reserved: "{{actor}} 为一名儿童保留了地址",
    fam_org_activity_reservation_released: "{{actor}} 释放了一个保留地址",
    fam_org_activity_shared_mailbox_created: "{{actor}} 创建了共享邮箱",
    fam_org_activity_shared_mailbox_deleted: "{{actor}} 删除了共享邮箱",
    fam_org_activity_shared_mailbox_grant_added:
      "{{actor}} 授予了共享邮箱的访问权限",
    fam_org_activity_shared_mailbox_grant_revoked:
      "{{actor}} 移除了共享邮箱的访问权限",
    fam_org_activity_shared_mailbox_rotated: "{{actor}} 轮换了共享邮箱的密钥",
    fam_org_activity_group_member_added:
      "{{actor}} 将 {{target}} 加入了一个群组",
    fam_org_activity_group_member_added_generic:
      "{{actor}} 将一位成员加入了群组",
    fam_org_activity_group_member_removed: "{{actor}} 将 {{target}} 移出了群组",
    fam_org_activity_group_member_removed_generic:
      "{{actor}} 将一位成员移出了群组",
    fam_org_activity_consent_request_created: "{{actor}} 请求了同意",
    fam_org_activity_consent_declined: "{{actor}} 拒绝了同意请求",
    fam_org_activity_consent_all_accepted: "所有人都已接受同意请求",
    color_theme_pink: "粉色",
    color_theme_emerald: "翡翠绿",
    color_theme_black: "黑色",
    sign_out_everywhere_success_other: "已从另外 {{count}} 个会话中退出登录",
    deleted_emails_count_other: "已删除 {{count}} 封邮件",
    external_account_count_other: "{{count}} 个外部账户",
    email_count_other: "{{count}} 封邮件",
    allowed_senders_count_other: "{{count}} 位允许的发件人",
    blocked_senders_count_other: "{{count}} 位已屏蔽的发件人",
    plan_domains_count_other: "{{count}} 个域名",
    forwarding_rules_count_other: "{{count}} 条转发规则",
    export_complete_errors_other: "有 {{count}} 封邮件无法导出。",
    ...
    purge_confirm_message_other:
      "此操作将永久删除从 {{email}} 导入的 {{count}} 封邮件。此操作无法撤销。",
    alias_export_summary_other: "{{files}} 中共 {{count}} 条记录。",
    app_lock_attempts_remaining_other: "还剩 {{count}} 次机会",
    vacation_reply_count: "已发送 {{count}} 条回复",
    vacation_n_replies_sent_other: "已发送 {{count}} 条回复",
    dev_databases_count: "{{count}} 个数据库",
    fam_org_activity_events_other: "{{count}} 个事件",
    family_activity_events_other: "{{count}} 个事件",
    fam_org_2fa_banner_other: "{{count}} 位成员尚未启用双重验证",
    family_security_warning_2fa_other: "{{count}} 位成员尚未启用双重验证",
    fam_org_sec_session_count_other: "{{count}} 个活跃会话",
    fam_org_stat_seats_available_other: "{{count}} 个可用席位",
    fam_org_members_count_other:
      "已使用 {{max}} 个席位中的 {{used}} 个 · {{count}} 个可用",
    account_resume_tooltip: "继续同步",
    category_info_newsletters: "你订阅的更新和邮件列表。",
    category_newsletters: "邮件订阅",
    category_transactions: "购买",
  ...
  mail: {
    ...
    bulk_delete_title: "要永久删除 {{count}} 封邮件吗？",
    bulk_delete_title_one: "要永久删除 1 封邮件吗？",
    bulk_delete_title_other: "要永久删除 {{count}} 封邮件吗？",
    bulk_spam_title_one: "要把 1 封邮件举报为垃圾邮件吗？",
    bulk_trash_title_one: "要把 1 封邮件移到废纸篓吗？",
    links_cleaned_count_one: "已清理 {{count}} 个链接",
    more_folders_count_one: "另外 {{count}} 个文件夹",
    move_n_conversations_one: "移动{{count}}个对话",
    param_removed_from_n_links_one: "已从 {{count}} 个链接中移除 {{param}}",
    remote_images_blocked_count_one: "已拦截 {{count}} 张外部图片",
    ...
    category_empty_updates_desc: "收据、确认和账单会显示在这里。",
    category_empty_forums_title: "没有讨论",
    ...
    reply_all: "回复所有人",
    react: "回应",
    already_reacted: "您已使用此表情回应过",
    remove_your_reaction: "删除你的 {emoji} 回应",
    you_reacted_with: "您使用 {{emoji}} 回应了",
    you_reacted_with_remove: "你用 {{emoji}} 做出了回应。点击即可移除。",
    reacted_with: "{{name}} 使用 {{emoji}} 回应了",
    forward: "转发",
    to: "收件人",
    cc: "抄送",
    bcc: "密送",
    ...
    translation_show_original: "显示原文",
    translation_show_translation: "显示译文",
    translation_showing_original: "正在显示原始邮件。",
    translation_unavailable: "无法翻译此邮件。",
    ...
    find_emails_from: "查找来自{{sender}}的邮件",
    move_to: "移动到",
    label: "标签",
    ...
    spam_reason_dkim_fail: "邮件未通过 DKIM 签名验证",
    spam_reason_dmarc_fail: "发件人域名未通过 DMARC 认证",
    spam_reason_missing_headers: "邮件缺少标准邮件头",
    spam_reason_reply_to_mismatch: "回复地址与发件人不一致",
    spam_reason_future_dated: "邮件日期为未来时间",
    spam_reason_phishing_url: "包含钓鱼拦截列表中的链接",
    spam_reason_phishing_domain: "链接指向与钓鱼相关的域名",
    spam_reason_user_spam_learning: "您之前举报过来自该发件人域名的垃圾邮件",
    spam_reason_global_domain_reputation: "发件人域名信誉不佳",
    spam_reason_auth_hard_fail: "无法验证发件人身份",
    spam_reason_sender_marked_spam: "您已将该发件人标记为垃圾邮件",
    block_sender: "屏蔽发件人",
    ...
    scanning_for_newsletters: "正在扫描订阅邮件...",
    archiving_newsletters: "正在归档订阅邮件...",
    ...
    spam_email_sender_message:
      "此邮件会移至垃圾邮件，当前视图中该发件人的其他邮件也会一并移动。该发件人的新邮件也会进入垃圾邮件。",
    ...
    empty_all_title: "这里还没有邮件",
    empty_all_subtitle: "除垃圾邮件和废纸篓外，账户中的所有邮件都会显示在这里",
    ...
    contacts: "联系人",
    scheduled_for: "定时发送于",
    scheduled_send_failed: "无法发送此邮件。请选择新的发送时间后重试。",
    section_pinned: "已置顶",
    section_primary: "主要",
    ...
    receipt_feedback_thanks: "感谢您的反馈",
    order_from: "来自{{merchant}}的订单",
    package_from: "来自{{carrier}}的包裹",
    order_details: "订单详情",
    ordered_on: "{{date}}下单",
    merchant: "商家",
    ...
    hide_details: "隐藏详情",
    tracking_number: "追踪号",
    delivered_on: "{{date}}已送达",
    expected_by: "预计{{date}}送达",
    shipped_on: "{{date}}已发货",
    shipment_update: "物流更新",
    track_package: "追踪包裹",
    ...
    pdf_password_protected: "受密码保护",
    move_1_conversation: "移动1个对话",
    move_n_conversations: "移动{{ count }}个对话",
    move_n_conversations_other: "移动{{count}}个对话",
    view_message: "查看消息",
    ...
    search_section_message: "邮件",
    search_section_filters: "筛选条件",
    ...
    showing_results_for: "显示「{{corrected}}」的搜索结果",
    search_instead_for: "改为搜索「{{original}}」",
    ...
    resume_download_action: "继续",
    searching_message_content: "搜索邮件内容",
    ...
    op_in_drafts: "在草稿中",
    chip_any_time: "任何时间",
    chip_older_than_week: "一周以前",
    chip_older_than_month: "一个月以前",
    chip_older_than_six_months: "6 个月以前",
    chip_older_than_year: "一年以前",
    chip_custom_range: "自定义时间范围",
    chip_has_attachment: "有附件",
    chip_attachment_image: "图片",
    chip_attachment_document: "文档",
    chip_attachment_pdf: "PDF",
    chip_attachment_video: "视频",
    chip_is_unread: "未读",
    chip_name_or_email: "姓名或邮箱",
    chip_no_people: "没有匹配的联系人",
    chip_advanced_search: "高级搜索",
    spam_trash_hidden_notice: "垃圾邮件和回收站中有符合搜索条件的邮件。",
    search_index_incomplete:
      "无法在此设备上读取部分搜索索引，因此这些结果中可能缺少一些邮件。",
    view_spam_trash_messages: "查看邮件",
    search_scope_anywhere: "邮件、垃圾邮件和回收站",
    op_in_anywhere: "所有位置，包括垃圾邮件和回收站",
    ...
    newest_first: "最新在前",
    oldest_first: "最早在前",
    archive_conversation_count: "归档会话（{{count}} 封邮件）",
    move_conversation_to_trash_count: "将会话移到回收站（{{count}} 封邮件）",
    translation_unsupported: "暂不支持{{language}}。",
    translation_unsupported_info_title: "为什么没有翻译",
    translation_unavailable_info_title: "为什么没有翻译",
    translation_unsupported_info_body:
      "翻译完全在你的设备上进行，因此只支持 Aster 附带的语言包。目前还没有{{language}}的语言包，也没有任何内容发送到服务器。",
    translation_unsupported_info_body_list:
      "翻译完全在你的设备上进行，因此只支持 Aster 附带的语言包。目前还没有{{language}}的语言包。当前可用：{{languages}}。没有任何内容发送到服务器。",
    ...
    remote_images_blocked_count_other: "已拦截 {{count}} 张外部图片",
    bulk_spam_title: "要把 {{count}} 封邮件举报为垃圾邮件吗？",
    bulk_spam_title_other: "要把 {{count}} 封邮件举报为垃圾邮件吗？",
    bulk_trash_title: "要把 {{count}} 封邮件移到废纸篓吗？",
    bulk_trash_title_other: "要把 {{count}} 封邮件移到废纸篓吗？",
    confirm_bulk_action_count_description:
      "此操作会影响全部 {{count}} 封邮件。",
    confirm_bulk_action_count_description_other:
      "此操作会影响全部 {{count}} 封邮件。",
    confirm_bulk_action_scope_description:
      "此操作会影响{{scope}}中的全部 {{count}} 封邮件。",
    confirm_bulk_action_scope_description_other:
      "此操作会影响{{scope}}中的全部 {{count}} 封邮件。",
    remove_from_folder: "移出文件夹",
    sender_rule_created: "此发件人的新邮件今后会进入{{category}}。",
    sender_rule_name: "把 {{sender}} 归入{{category}}",
    sender_rule_offer:
      "你经常把 {{sender}} 的邮件移到{{category}}。要自动处理吗？",
  },
  auth: {
    ...
    default_account: "默认",
    storage_of_used: "已使用 {{used}}／共 {{total}}",
    hide_more_accounts: "隐藏其他账户",
    show_more_accounts: "显示其他账户",
    change_photo: "更换头像",
    active_account: "活动",
    ...
    welcome_workspace_subtitle: "欢迎使用 Aster。选择一个用户名开始。",
    username_placeholder: "用户名",
    switch_domain: "切换域名",
    ...
    mail_mobile_desc: "在手机上阅读和发送加密邮件。",
    mail_desktop: "Mail Desktop",
    mail_desktop_desc: "适用于 Windows、macOS 和 Linux 的桌面应用。",
    ...
    custom_domain_step_desc: "使用属于你自己的域名地址收发邮件。",
    custom_domain_own: "设置你已拥有的域名",
    custom_domain_own_desc: "几分钟内即可接入任意注册商的域名。",
    custom_domain_new: "获取新域名",
    custom_domain_new_desc: "无需离开 Aster 即可搜索并购买域名。",
    recovery_email_required_gate_title: "需要恢复邮箱",
    recovery_email_required_gate_desc:
      "创建附加账户需要提供恢复邮箱。这有助于保护您的所有账户。",
    username_min_length: "请使用至少 3 个字符。",
    ...
    password_max_length_register: "请使用少于 128 个字符。",
    password_invalid_chars: "可使用的字符是标准键盘字符。",
    password_error_length: "密码至少需要 8 个字符。",
    complete_captcha_first: "完成安全验证后继续。",
    password_error_uppercase: "至少包含一个大写字母。",
    password_error_lowercase: "至少包含一个小写字母。",
    password_error_number: "至少包含一个数字。",
    password_rule_length: "至少 8 个字符",
    password_rule_case: "包含大写和小写字母",
    password_rule_number: "至少一个数字",
    passwords_match: "两次输入的密码一致",
    download_codes_pdf: "下载为 PDF",
    ...
    plan_family_description: "最多 6 人共享的加密存储空间，只需一份账单。",
    plan_starter_description: "更多存储空间和别名，满足日常个人使用。",
    plan_pro_description: "为高级用户提供充裕的存储空间和别名。",
    plan_free_name: "免费",
    ...
    remove_photo: "移除照片",
    captcha_load_failed:
      "安全验证无法加载。请检查网络连接或内容拦截器，然后重试。",
    academic_verified_signin_note:
      "学生身份已验证。登录后，结账时会自动应用 30% 折扣。",
    academic_failed_signin_note:
      "该验证链接已过期或已被使用。请登录后在“账单”设置中重新申请。",
    link_device_upgrade_required_toast:
      "关联 Bridge 设备需要 Star 或更高套餐。请升级后继续。",
    link_device_upgrade_title: "升级后即可关联此设备",
    link_device_upgrade_description:
      "将桌面版 Bridge 连接到账户需要 Star 或更高套餐。请在下方选择套餐，结账后设备会立即关联。",
    link_device_upgrade_cta: "升级到 Star",
    link_device_upgrade_failed:
      "无法开始结账。请重试，或在“设置”中打开“账单”。",
    link_device_already_linked:
      "此设备已关联到另一个账户。请先在那里解除关联，然后重试。",
    link_device_rate_limited: "尝试次数过多。请等待约一分钟后重试。",
    link_device_account_suspended:
      "此账户已被暂停，目前无法关联新设备。请联系支持人员处理。",
    product_updates_notice:
      "你还会偶尔在收件箱中收到产品更新，可以在“设置”中关闭。",
    plan_academic_discount_note: "验证邮箱后，30% 折扣会在结账时自动应用。",
    plan_referral_discount_note: "结账时会自动应用你的推荐折扣。",
    plan_referral_discount_percent_note:
      "你的 {{percent}}% 推荐折扣已在下方生效。",
    academic_verified_title: "验证成功",
    academic_verified_body: "你的 30% 学生折扣已锁定。正在前往套餐页面...",
    academic_verified_continue: "选择套餐",
    academic_offer_sending_title: "正在发送验证链接",
    academic_offer_sending_body: "正在向 {{ email }} 发送 30% 折扣的验证链接。",
    offer_welcome_badge_student: "学生 30% 折扣",
    offer_welcome_badge_journalist: "记者 30% 折扣",
    offer_welcome_headline: "领取你的 30% 折扣",
    offer_welcome_subline_student:
      "创建免费账户，然后验证学生邮箱，即可在 12 个月内享受任意付费套餐 30% 折扣。",
    offer_welcome_subline_journalist:
      "创建免费账户，然后验证记者证件，即可在 12 个月内享受任意付费套餐 30% 折扣。",
  },
  passkeys: {
    ...
    section_title: "通行密钥和安全密钥",
    section_description:
      "使用通行密钥，通过设备生物识别或 PIN 码快速安全地登录。安全密钥以设备验证器作为第二重验证。",
    add_passkey: "添加通行密钥",
    add_security_key: "添加安全密钥",
    no_passkeys: "尚未注册通行密钥或安全密钥",
    passkey_badge: "通行密钥",
    security_key_badge: "安全密钥",
    registered: "已添加",
    last_used: "上次使用",
    never_used: "从未使用",
    remove: "移除",
    ...
    removed: "已移除通行密钥",
    register_success: "已注册通行密钥",
    register_failed: "注册失败，请重试。",
    registering: "正在注册…",
    not_supported:
      "你的浏览器不支持通行密钥。请改用较新的浏览器，例如 Chrome、Safari 或 Firefox。",
    sign_in_with_passkey: "使用通行密钥登录",
    authenticating: "正在验证…",
    vault_needs_password: "请输入密码，以首次解密你的保险库。",
    unnamed_passkey: "通行密钥",
    unnamed_security_key: "安全密钥",
    rename: "重命名",
    rename_saved: "名称已更新",
    rename_placeholder: "为此密钥命名",
    rename_failed: "无法重命名此密钥，请重试。",
  },
  errors: {
    auth_salt_collision:
      "由于服务器发送了不安全的值，登录已停止，没有解锁任何内容。请先联系支持团队，然后再重试。",
    upload_too_large: "上传内容过大。请移除或压缩一个文件后重试。",
    ...
    rate_limit: "操作太频繁了。请稍候再试。",
    invalid_credentials:
      "邮箱或密码错误。请重试，或前往 astermail.org/reset 重置密码。",
    session_expired:
      "您的会话已结束。请重新登录以继续。您的数据和草稿已保存在服务器上。",
    try_again: "请重试。",
    sign_in_domain_unsupported:
      "请使用注册时的 astermail.org 或 aster.cx 地址登录。您自有域名的地址指向同一个账户。",
    invalid_username: "请输入 3 到 40 个字符的用户名。",
    enter_password: "需要您的密码才能继续。",
    password_too_long: "这个密码超过了长度限制，缩短一些就可以。",
    account_not_found:
      "未找到该名称对应的账户。请检查拼写，或前往 astermail.org/reset 重置密码。",
    login_failed: "请重试。",
    decrypt_failed:
    ...
    wrong_vault_password:
      "该密码未能在此设备上解锁您的密钥。请重试。如果仍然失败，请前往 astermail.org/reset 使用恢复码。您在服务器上的数据没有变化。",
    vault_tampered:
    ...
    decrypt_sender_error:
      "发件人加密这封邮件的方式我们无法读取。请让发件人重新发送。您的其他邮件不受影响。",
    ...
    tor_plugin_missing:
      "此设备上未安装 Tor 模块。请重新安装应用，或在“设置”中切换为直连。",
    cdn_relay_misconfigured:
      "此构建版本未配置 CDN 中继。请在“设置”中切换为直连。如需帮助，请联系 hello@astermail.org。",
    device_repair_required:
      "此设备的密钥缺失。请从桌面应用重新配对此设备。您的账户和数据没有变化。",
    ...
    no_permission:
      "您没有执行该操作的权限。如果这看起来有误，您的管理员可以提供帮助。",
    invalid_request: "无法处理该请求。请刷新页面后重试。",
    conflict: "其他人或其他操作先更改了这个内容。刷新将显示最新版本。",
    rate_limited: "操作太频繁了。请稍候再试。",
    internal_error:
      "服务器在我们这一侧遇到了一些问题。稍后再试一次通常可以。我们正在跟进。",
    connection_failed:
    ...
    that_provider: "该服务商",
    too_many_recipients:
      "此邮件的收件人超过了单封邮件可发送的数量。你的账户每次最多可发送给 {{max}} 位收件人，该上限会在第一周内提高。分批发送即可。草稿已保存。",
    recipient_concentration:
      "你向{{domain}}的地址发送的数量已达到我们每小时允许的上限。一次向同一个服务商发送这么多邮件会导致我们的邮件服务器被封锁。{{time}} 后再试即可。草稿已保存。",
    attachments_too_large:
      "这些附件总计超过 {{size}}，超出您套餐中单封邮件的上限。移除或压缩一个文件即可发送。您的草稿已保存。",
    too_many_attachments:
      "此邮件的附件超过 {{max}} 个，超出单封邮件的上限。移除几个即可发送。您的草稿已保存。",
    failed_send_email: "请重试。",
    cannot_send_no_keys:
    ...
    unknown_error: "请重试。",
    health_check_failed: "请重试。",
    unexpected_health_check_error: "请重试。",
    all_emails_rejected:
      "此文件中的全部 {{count}} 封邮件都已跳过，因为每封邮件都缺少发件人或正文，所以没有导入任何内容。请检查源导出文件后重试。",
    post_quantum_unavailable:
      "Aster 账户之间的邮件采用后量子加密，而 {{recipients}} 尚未发布后量子密钥。请对方打开 Aster 或更新 App，然后重试。你的草稿已保存。",
  },
  folder_retention: {
    title: "文件夹自动清理",
    subtitle: "自动移除文件夹中的旧邮件。星标邮件和置顶邮件始终保留。",
    add: "添加自动清理",
    empty_title: "尚未设置自动清理的文件夹",
    empty_description: "选择一个文件夹并设置保留期限，让它自动保持整洁。",
    edit_title: "文件夹自动清理",
    folder: "文件夹",
    select_folder: "选择文件夹",
    no_folders: "请先创建自定义文件夹，然后再使用自动清理。",
    retention_period: "删除早于以下天数的邮件",
    days_suffix: "天",
    mode: "清理方式",
    mode_trash: "移到回收站",
    mode_trash_hint: "约 30 天内可恢复",
    mode_permanent: "永久删除",
    mode_permanent_hint: "无法撤消",
    mode_archive: "移到归档",
    mode_archive_hint: "移出收件箱，仍会保留且可恢复",
    enabled: "已启用",
    preview_some: "下次运行时将清理约 {{count}} 封邮件。",
    preview_none: "目前没有邮件符合此规则。",
    keeps_note: "星标邮件和置顶邮件始终保留。",
    save: "保存",
    cancel: "取消",
    delete: "删除",
    remove: "移除",
    permanent_confirm:
      "要永久删除此文件夹中早于 {{days}} 天的邮件吗？此操作无法撤消。",
    summary_older_than: "早于 {{days}} 天",
    summary_trash: "移到回收站",
    summary_permanent: "永久删除",
    summary_archive: "移到归档",
    card_badge: "自动清理",
    disabled_badge: "已关闭",
    upgrade_title: "文件夹自动清理是付费功能",
    upgrade_body: "升级到 Star 或更高方案，即可自动清理文件夹。",
    save_failed: "无法保存自动清理规则。",
    load_failed: "无法加载自动清理规则。",
    deleted_toast: "已移除自动清理规则。",
    saved_toast: "已保存自动清理规则。",
  },
  mail_rules: {
    expr_empty_expression: "保存前请输入表达式。",
    expr_unterminated_string: "某个值缺少右引号。",
    expr_unexpected_char: "此处不允许使用字符“{{value}}”。",
    expr_unexpected_token: "此处不应出现“{{value}}”。请检查拼写、引号和括号。",
    expr_expected_rparen: "缺少右括号。",
    expr_expected_field:
      "请在此处输入字段名，例如 from.address、subject 或 has_attachment。",
    expr_unknown_field:
      "“{{value}}”不是可用的字段。请尝试 from.address、subject、body、has_attachment、spam_score 或 date_received。",
    expr_expected_operator:
      "请在此处输入运算符，例如 is、contains、ends_with 或 greater_than。",
    expr_expected_string: '请输入带引号的值，例如 "example.com"。',
    expr_expected_number: "请在此处输入数字。",
    expr_invalid_number: "该数字无效。",
    expr_expected_is: "此处应为“is”。",
    expr_expected_bool_value: "请在此处输入 true 或 false。",
    expr_expected_bool_value_got:
      "此处请输入 true 或 false，而不是“{{value}}”。",
    expr_expected_auth_value: "请在此处输入 pass、fail、none 或 missing。",
    expr_expected_auth_value_got:
      "此处请输入 pass、fail、none 或 missing，而不是“{{value}}”。",
    expr_expected_numeric_op: "请在此处输入数值比较，例如 >、<、= 或 equals。",
    expr_expected_date_op: "请在此处输入 older_than_days 或 newer_than_days。",
    expr_expected_date_op_got:
      "此处请输入 older_than_days 或 newer_than_days，而不是“{{value}}”。",
    expr_bad_address_op:
      "运算符“{{value}}”不适用于地址字段。请尝试 is、contains、starts_with、ends_with、matches_domain 或 matches_regex。",
    expr_bad_text_op:
      "运算符“{{value}}”不适用于文本字段。请尝试 is、contains、starts_with、ends_with、is_empty 或 matches_regex。",
    ...
    apply_to_existing_started: "正在将此规则应用到现有邮件。处理将在后台进行。",
    apply_to_existing_failed: "无法开始应用此规则。",
    apply_to_existing_cancel: "停止应用",
    apply_to_existing_cancel_failed: "无法停止此运行。",
    apply_to_existing_queued: "排队中...",
    ...
    regex_backreference: "不支持 \\1 这类反向引用。请改写不使用它们的模式。",
    regex_lookaround: "不支持先行断言和后行断言。请改写不使用它们的模式。",
    regex_invalid: "此正则表达式模式无效。请检查语法后重试。",
    ...
    hint_move_to_required: "这里需要指定目标文件夹。",
    hint_labels_required: "这里至少需要一个标签。",
    remove_action: "移除操作",
    ...
    templates_button: "模板",
    templates_title: "规则模板",
    templates_subtitle: "从现成的规则开始，保存前可自行调整。",
    templates_search_placeholder: "搜索模板",
    templates_empty: "没有与搜索匹配的模板。",
    templates_use: "使用模板",
    templates_customize: "需要你补充一项内容",
    templates_category_organize: "整理",
    templates_category_cleanup: "清理",
    templates_category_priority: "优先级",
    templates_category_security: "安全",
    tpl_folder_auto_clean_name: "文件夹自动清理",
    ...
    tpl_large_attachments_desc:
      "当邮件的附件超过 10 MB 时，移到你指定的文件夹。保存前请先选择文件夹。",
    tpl_no_reply_name: "整理自动邮件",
    tpl_no_reply_desc:
      "当邮件由系统自动生成（带有 Auto-Submitted 标头，例如 no-reply 发件人）时，归入通知。",
    tpl_receipts_name: "归档收据",
    tpl_receipts_desc:
      "当主题中出现收据、发票或订单确认时，跳过收件箱并归入通知。",
    tpl_vip_sender_name: "为重要发件人加星标",
    tpl_vip_sender_desc:
      "当收到你指定发件人的邮件时，为其加星标并发送通知。保存前请填写发件人地址。",
    tpl_keyword_star_name: "按关键词加星标",
    tpl_keyword_star_desc:
      "当主题包含你指定的词时，为邮件加星标。保存前请填写关键词。",
    tpl_auth_failures_name: "拦下可疑邮件",
    tpl_auth_failures_desc:
      "当邮件未通过 SPF、DKIM 或 DMARC 校验（常见的伪造迹象）时，不放入收件箱并标为已读。",
  },
  badges: {
    title: "徽章",
  ...
  secure_view: {
    ...
    deleted: "此安全邮件已被删除，不再可用。",
    reply_label: "发送回复",
    reply_placeholder: "输入你的回复……",
    reply_button: "发送回复",
    reply_sending: "发送中……",
    reply_sent: "你的回复已发送。",
    reply_failed: "无法发送回复，请重试。",
    reply_limit_reached: "此邮件已达到回复上限。",
    delete_button: "删除邮件",
    delete_confirm_prompt: "删除此邮件？此操作无法撤销。",
  ...
  survey: {
    ...
    dismiss_forever: "不再询问",
    modal_title: "Aster Mail 问卷",
    modal_subtitle: "仅此一次,大约一分钟。开放式问题为选填。",
    ...
    signup_e2ee: "端到端加密",
    signup_leave_big_tech: "摆脱大型科技公司",
    signup_open_source: "开源",
    signup_specific_feature: "某个特定功能",
    signup_price: "价格",
    signup_curiosity: "好奇心",
    q_stood_out: "与其他选择相比,Aster 最突出的是什么?",
    stood_openpgp: "标准 OpenPGP,密钥随处可用",
    stood_post_quantum: "后量子加密",
    stood_open_source: "开源 (AGPL)",
    stood_germany: "托管在德国",
    stood_price: "价格",
    stood_ui: "界面 / 自定义",
    q_upgrade_blocker: "是什么阻碍了您升级到付费套餐?",
    q_upgrade_trigger: "最终是什么促使您升级到付费套餐?",
    trigger_storage: "存储空间不够了",
    trigger_feature: "想要某个特定功能",
    trigger_support_mission: "支持使命 / 项目",
    trigger_switched_fully: "从其他服务商完全迁移过来",
    q_plan_reason: "您为什么选择 {{plan}} 套餐?",
    q_cancel_reason: "什么情况会让您取消套餐?",
    q_hesitation: "购买套餐前您最大的顾虑是什么?",
    hesitation_price: "价格",
    hesitation_trust: "还不确定是否可以信任",
    hesitation_missing_feature: "缺少某个功能",
    hesitation_longevity: "担心 Aster 能否长期运营",
    hesitation_none: "没有真正的顾虑",
    option_other: "其他",
    other_placeholder: "告诉我们更多",
    open_placeholder: "您的回答",
    optional_label: "选填",
  ...
  calendar: {
    ...
    invite_maybe: "可能",
    invite_no: "否",
    invite_status_going: "你将参加",
    invite_status_maybe: "你可能参加",
    invite_status_declined: "你不参加",
    invite_change_response: "更改",
    invite_added_toast: "已添加到你的日历",
    invite_declined_toast: "你已拒绝此邀请",
    invite_save_failed: "无法保存到你的日历",
    invite_saved_locally: "已保存到你的加密日历",
    calendar: "日历",
    month: "月",
    week: "周",
    day: "日",
    ...
    no_upcoming_events_hint: "你创建的活动会显示在这里。",
    new_event: "新建活动",
    edit_event: "编辑活动",
    delete_event: "删除活动",
    delete_event_confirmation: "要删除“{{title}}”吗？此操作无法撤销。",
    event_title: "标题",
    event_title_placeholder: "添加标题",
    starts: "开始",
    ends: "结束",
    location: "地点",
    location_placeholder: "添加地点",
    description: "说明",
    description_placeholder: "添加备注",
    reminder: "提醒",
    reminder_none: "不提醒",
    reminder_at_start: "开始时",
    reminder_minutes_before: "提前 {{count}} 分钟",
    title_required: "请为此活动添加标题",
    invalid_dates: "请输入有效的开始和结束时间",
    ...
    weekday_fri: "周五",
    weekday_sat: "周六",
    calendar_navigation: "日历导航",
    aster_calendar: "Aster 日历",
    back_to_mail: "返回 Mail",
    my_calendars: "我的日历",
  },
  settings_search: {
    two_factor: "两步验证",
    ...
    checkup: "检查",
    children: "儿童",
    children_accounts: "儿童账户",
    code: "代码",
    composing_and_replies: "撰写与回复",
    configuration: "配置",
    confirmations: "确认",
    connect_apple_mail: "连接 Apple Mail",
    connect_thunderbird: "连接 Thunderbird",
    contact_support: "联系支持",
    content_protection: "内容保护",
    control: "控制",
    create: "创建",
    create_ghost_alias: "创建幽灵别名",
    credits: "额度",
    crypto: "加密货币",
    custom: "自定义",
    custom_domain: "自定义域名",
    ...
    ghost_aliases: "幽灵别名",
    gmail: "Gmail",
    html_signature: "HTML 签名",
    hardware_keys: "安全密钥",
    imap: "IMAP",
    imap_settings: "IMAP 设置",
    import_from_imap: "从 IMAP 导入",
    import_from_proton: "从 Proton 导入",
    import_key: "导入密钥",
    invite: "邀请",
    invite_a_friend: "邀请好友",
    invite_family_member: "邀请家庭成员",
    invoices: "账单",
    key_rotation: "密钥轮换",
    key_algorithm: "密钥算法",
    keyboard: "键盘",
    ...
    masked_email: "隐藏邮件地址",
    members: "成员",
    motion_and_layout: "动效与布局",
    navigation_panel: "导航面板",
    notification_sound: "通知声音",
    outlook: "Outlook",
    passkeys: "通行密钥",
    password: "密码",
    password_protected_folders: "密码保护的文件夹",
    payment: "付款",
    payment_method: "付款方式",
    performance: "性能",
    plain_text_signature: "纯文本签名",
    plan: "套餐",
    position: "位置",
    profile: "个人资料",
    proton: "Proton",
    ...
    quiet_hours: "免打扰时段",
    reading: "阅读",
    reading_and_conversations: "阅读与会话",
    reading_pane: "阅读窗格",
    recovery: "恢复",
    referral_code: "推荐码",
    rename_hardware_key: "重命名安全密钥",
    rename_passkey: "重命名通行密钥",
    report_a_bug: "报告问题",
    request_logs: "请求日志",
    revoke_smtp_token: "吊销 SMTP 令牌",
    revoke_device: "吊销设备",
    rotate_encryption_key: "轮换加密密钥",
    smtp_settings: "SMTP 设置",
    screen_reader: "屏幕阅读器",
    security: "安全",
    security_checkup: "安全检查",
    send_delay: "发送延迟",
    sending: "发送",
    session: "会话",
    sessions: "会话列表",
    settings: "设置",
    setup: "初始设置",
    sign_out_device: "退出该设备",
    sound: "声音",
    spam: "垃圾邮件",
    spam_filter: "垃圾邮件过滤",
    stats: "统计",
    storage: "存储空间",
    storage_add_on: "存储附加项",
    subscriptions: "订阅",
    support: "支持",
    swipe: "滑动",
    system_theme: "跟随系统主题",
