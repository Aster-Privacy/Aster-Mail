...
export const zh_CN = {
  ...
  settings: {
    ...
    gmail_wizard_step_1_body: "应用专用密码位于你服务商账户的安全部分。",
    gmail_wizard_step_1_title: "打开你的账户安全设置",
    gmail_wizard_step_2_body: "只有开启两步验证后才能使用应用专用密码。",
  ...
  mail: {
    ...
    bulk_spam_title: "要将 {{count}} 封邮件举报为垃圾邮件吗？",
    bulk_spam_title_one: "要把 1 封邮件举报为垃圾邮件吗？",
    bulk_spam_title_other: "要将 {{count}} 封邮件举报为垃圾邮件吗？",
    bulk_trash_title: "要将 {{count}} 封邮件移到回收站吗？",
    bulk_trash_title_one: "要把 1 封邮件移到废纸篓吗？",
    bulk_trash_title_other: "要将 {{count}} 封邮件移到回收站吗？",
