...
export const zh_CN = {
  common: {
    ...
    recipient_key_outdated_desc: "该收件人发布的密钥已过期或无效，因此无法对邮件进行端到端加密。邮件将仅在传输过程中受保护发送。",
    ...
    unblock_failed: "无法解除对 {{ email }} 的屏蔽。请再试一次，通常即可解决。该发件人暂时仍处于屏蔽状态。",
    remove_from_allowlist_failed: "无法将 {{ email }} 从允许列表中移除。请再试一次，通常即可解决。它暂时仍处于允许状态。",
    bulk_unblock_failed: "未能解除这些发件人的屏蔽。请再试一次，通常即可解决。它们暂时仍处于屏蔽状态。",
    bulk_remove_allowlist_failed: "未能将这些发件人从允许列表中移除。请再试一次，通常即可解决。它们暂时仍处于允许状态。",
    ...
    n_messages_count_one: "{{count}} 封邮件",
  ...
  settings: {
    ...
    fam_kids_tab: "儿童",
    fam_kids_title: "为孩子预留的地址",
    fam_kids_subtitle: "现在为孩子预留一个地址，让他们稍后用自己的密码完成设置。",
    fam_kids_seats_used: "已使用 {{max}} 个家庭席位中的 {{used}} 个（成员、邀请和预留）",
    fam_kids_reserve_btn: "预留一个地址",
    fam_kids_seats_full: "你的家庭群组已满。请释放一个席位以预留另一个地址。",
    fam_kids_empty: "尚无预留的地址。",
    fam_kids_username_label: "地址",
    fam_kids_username_ph: "他们的用户名",
    fam_kids_info_title: "已预留的儿童地址",
    fam_kids_info_desc: "该地址会为你的孩子保留，并对其他人锁定。你的孩子（或你）稍后用私密密码完成设置，创建一个真正的零访问账户并自动加入你的家庭。",
    fam_kids_nickname_label: "昵称（可选）",
    fam_kids_nickname_ph: "例如：小明",
    fam_kids_storage_label: "此地址的存储空间",
    fam_kids_checking: "正在检查可用性...",
    fam_kids_available: "可用",
    fam_kids_taken: "已被占用",
    fam_kids_reserved_taken: "已被预留",
    fam_kids_invalid: "不是有效的用户名",
    fam_kids_consent_label: "我确认自己是该儿童的父母或法定监护人，并同意为其创建账户。",
    fam_kids_consent_required: "请确认家长同意以继续。",
    fam_kids_link_hint: "任何拥有认领链接的人都可以设置此地址。请仅与你的孩子分享，如泄露请重新生成。",
    fam_kids_create: "预留",
    fam_kids_creating: "正在预留...",
    fam_kids_cancel: "取消",
    fam_kids_created: "地址已预留 · 认领链接已复制",
    fam_kids_create_failed: "无法预留该地址",
    fam_kids_copy_link: "复制认领链接",
    fam_kids_link_copied: "认领链接已复制",
    fam_kids_regenerate: "重新生成链接",
    fam_kids_regenerated: "已生成新的认领链接",
    fam_kids_setup_now: "立即设置",
    fam_kids_release: "释放",
    fam_kids_released: "预留已释放",
    fam_kids_release_confirm: "释放这个预留的地址吗？它将重新对所有人开放。",
    fam_kids_status_reserved: "已预留",
    fam_kids_status_claimed: "已激活",
    fam_kids_claimed_active: "账户已设置并加入你的家庭",
    fam_kids_load_failed: "无法加载预留",
    fam_kids_claim_setup_for: "正在设置 {{address}}",
    fam_kids_claim_intro: "选择一个密码以完成此家庭地址的设置。",
    fam_kids_claim_invalid_title: "此链接已失效",
    fam_kids_claim_invalid_body: "此认领链接已过期、已被使用或已被撤回。请向家庭所有者索取新链接。",
    fam_kids_claim_signed_in_title: "你已登录到另一个账户",
    fam_kids_claim_signed_in_body: "此链接用于设置新的儿童账户。请在隐私/无痕窗口中打开，或复制后在孩子的设备上使用。",
    fam_kids_release_modal_title: "释放此地址吗？",
    fam_kids_release_modal_body: "{{address}} 将开放供任何人注册。此操作无法撤销。",
    ...
    alias_import_drop_hint: "将 CSV（SimpleLogin、Addy.io）或 Proton Pass 的 data.json 拖到此处，或选择文件",
    ...
    alias_activity_title: "活动（最近 7 天）",
  ...
  auth: {
    link_device_upgrade_required_toast: "连接 Bridge 设备需要 Star 或更高套餐。升级后即可继续。",
    link_device_upgrade_title: "升级以连接此设备",
    link_device_upgrade_description: "将桌面版 Bridge 连接到你的账户需要 Star 或更高套餐。在下方选择套餐，付款后你的设备即会连接。",
    link_device_upgrade_cta: "升级到 Star",
    link_device_upgrade_failed: "无法开始结账。请重试或在设置中打开账单。",
    link_device_already_linked: "此设备已连接到另一个账户。请先在那里解除连接，然后重试。",
    link_device_rate_limited: "尝试次数过多。请等待约一分钟后重试。",
    link_device_account_suspended: "此账户已被暂停，因此目前无法连接新设备。请联系支持以解决。",
    academic_offer_sending_title: "正在发送你的验证链接",
    academic_offer_sending_body: "正在向 {{ email }} 发送 30% 的验证链接。",
    offer_welcome_badge_student: "学生 30% 折扣",
    offer_welcome_badge_journalist: "记者 30% 折扣",
    offer_welcome_headline: "领取你的 30% 折扣",
    offer_welcome_subline_student: "创建你的免费账户，然后验证你的学生邮箱，即可在 12 个月内任意付费套餐享受 30% 折扣。",
    offer_welcome_subline_journalist: "创建你的免费账户，然后验证你的记者证件，即可在 12 个月内任意付费套餐享受 30% 折扣。",
  ...
  mail_rules: {
    ...
    templates_subtitle: "从现成规则开始，保存前进行自定义。",
    templates_search_placeholder: "搜索模板",
    templates_empty: "没有与你的搜索匹配的模板。",
    templates_use: "使用模板",
    templates_customize: "需要你提供一项信息",
    ...
    tpl_folder_auto_clean_desc: "当邮件超过你选择的天数时，自动从文件夹中删除。加星标和置顶的邮件始终保留。",
    tpl_newsletters_name: "整理订阅邮件",
    tpl_newsletters_desc: "当邮件来自邮件列表（带有 List-Id 头）时，将其归入“更新”类别。",
    tpl_social_name: "归类社交通知",
    tpl_social_desc: "当发件人是 Facebook、LinkedIn、X/Twitter 或 Instagram 时，将邮件移至“社交”类别。",
    tpl_promotions_name: "捕捉促销邮件",
    tpl_promotions_desc: "当主题提到促销、折扣、优惠券或“% off”时，将邮件移至“促销”类别。",
    tpl_calendar_name: "收集日历邀请",
    tpl_calendar_desc: "当邮件包含日历邀请（.ics）时，将其归入“更新”类别。",
    tpl_large_attachments_name: "标记大附件",
    tpl_large_attachments_desc: "当邮件包含大于 10 MB 的附件时，将其移至你选择的文件夹。保存前请先选择文件夹。",
    tpl_no_reply_name: "整理自动邮件",
    tpl_no_reply_desc: "当邮件是机器生成的（带有 Auto-Submitted 头，例如 no-reply 发件人）时，将其归入“更新”。",
    tpl_receipts_name: "归档收据",
    tpl_receipts_desc: "当主题提到收据、发票或订单确认时，跳过收件箱并归入“更新”。",
    tpl_vip_sender_name: "为重要发件人加星标",
    tpl_vip_sender_desc: "当你选择的发件人来信时，为其加星标并发送通知。保存前请输入发件人地址。",
    tpl_keyword_star_name: "按关键词加星标",
    tpl_keyword_star_desc: "当主题包含你选择的词语时，为邮件加星标。保存前请输入关键词。",
    tpl_auth_failures_name: "扣留可疑邮件",
    tpl_auth_failures_desc: "当邮件未通过 SPF、DKIM 或 DMARC 检查（伪造的常见迹象）时，将其排除在收件箱之外并标记为已读。",
    tpl_forward_copy_name: "转发一份副本",
    tpl_forward_copy_desc: "当你选择的发件人来信时，将副本转发到另一个地址。保存前请输入两个地址。",
    ...
    run_on_existing_result: "已将规则应用于 {{count}} 封邮件",
    run_on_existing_failed: "无法对现有邮件运行该规则。请重试。",
    paused_badge: "已暂停",
    and_label: "且",
    or_label: "或",
    value_placeholder: "值",
  ...
  folder_retention: {
    title: "文件夹自动清理",
    subtitle: "自动删除文件夹中的旧邮件。加星标和置顶的邮件始终保留。",
    add: "添加自动清理",
    empty_title: "尚无自动清理的文件夹",
    empty_description: "选择一个文件夹和保留期限，即可自动保持整洁。",
    edit_title: "自动清理文件夹",
    folder: "文件夹",
    select_folder: "选择一个文件夹",
    no_folders: "请先创建一个自定义文件夹以使用自动清理。",
    ...
    mode_permanent: "永久删除",
    mode_permanent_hint: "无法撤销",
    mode_archive: "移至归档",
    mode_archive_hint: "从收件箱移除，保留并可恢复",
    enabled: "已启用",
    preview_some: "下次运行时将清理约 {{count}} 封邮件。",
    preview_none: "当前没有邮件符合此规则。",
    keeps_note: "加星标和置顶的邮件始终保留。",
    save: "保存",
    cancel: "取消",
    delete: "删除",
    remove: "移除",
    permanent_confirm: "永久删除此文件夹中早于 {{days}} 天的邮件吗？此操作无法撤销。",
    summary_older_than: "早于 {{days}} 天",
    summary_trash: "移至回收站",
    summary_permanent: "永久",
    summary_archive: "移至归档",
    card_badge: "自动清理",
    disabled_badge: "已关闭",
    upgrade_title: "文件夹自动清理是付费功能",
    upgrade_body: "升级到 Star 或更高套餐即可自动清理文件夹。",
    save_failed: "无法保存自动清理规则。",
    load_failed: "无法加载自动清理规则。",
    deleted_toast: "已删除自动清理规则。",
