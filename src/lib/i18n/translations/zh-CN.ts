...
export const zh_CN = {
  common: {
    ...
    contacts_in_trash_notice: "回收站中的联系人将在 30 天后被永久删除。",
    contacts_merged: "联系人已合并",
    contacts_moved_to_trash: "联系人已移到回收站",
    ...
    empty_trash_confirm: "要永久删除回收站中的所有联系人吗？此操作无法撤销。",
    ...
    failed_to_load_groups: "无法加载你的群组。",
    failed_to_move_to_trash: "无法将联系人移到回收站。",
    ...
    import_nothing_selected: "请至少选择一位要导入的联系人。",
    import_search_placeholder: "搜索要导入的联系人",
    import_select_all: "全选",
    import_selected_count: "已选择 {{selected}}/{{total}}",
    in_x_minutes_one: "{{count}} 分钟后",
    manage_contacts: "管理联系人",
    merge: "合并",
    merge_and_fix: "合并并修正",
    merge_contacts_hint: "选择要保留的信息。其他联系人会移到回收站。",
    merge_keeps_this: "保留",
    ...
    no_contact_changes: "暂无更改",
    no_contact_details: "此联系人尚无任何信息。选择“编辑”即可添加。",
    no_contacts_in_trash: "回收站是空的",
