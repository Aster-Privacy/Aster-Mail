...
export const zh_CN = {
  common: {
    ...
    delete_account_error: "我们暂时无法删除您的账户，稍后再试一次通常可以成功；如果一直失败，可以联系 support@aster.com。",
    ...
    decrypt_try_sign_out: "退出后重新登录会重新加载您的密钥。如果邮件仍然无法打开，可以联系 support@aster.com。",
    n_files: "{{count}} file",
    ...
    account_suspended_default_reason: "您的账户因违反服务条款而被暂停。如需申诉或了解更多详情，可以联系 support@aster.com。",
    settings_disabled_suspended: "您的账户暂停期间，设置已关闭。如需申诉或了解更多详情，可以联系 support@aster.com。",
  ...
  auth: {
    ...
    abuse_account_limit: "我们的自动安全系统标记了这次注册，因此我们无法创建该账户。如果这看起来是误判，可以联系 support@aster.com。",
    abuse_flagged_message: "我们的安全系统暂时阻止了来自这个网络的新注册。如果这看起来是误判，可以联系 support@aster.com。",
  ...
  errors: {
    ...
    invalid_credentials: "这个邮箱与密码不匹配，再试一次，或前往 aster.com/reset 重置，可以解决。",
    ...
    account_not_found: "我们没有找到该名称对应的账户，检查一下拼写，或前往 aster.com/reset 重置，通常可以解决。",
    login_failed: "登录未能完成，再试一次应该可以。您的账户没有被锁定。",
    decrypt_failed: "在这台设备上，这个密码没能解开您的密钥。再试一次通常可以成功；如果一直失败，aster.com/reset 上的恢复码可以作为备用方式。服务器上的数据未发生变化。",
    ...
    wrong_vault_password: "该密码未能在此设备上解锁您的密钥。再试一次通常就能成功，如果仍不行，可在 aster.com/reset 使用恢复码作为备用。您在服务器上的数据未受影响。",
    vault_tampered: "此设备上的加密数据与预期不符，可能存在被篡改的迹象。可前往“设置”然后“安全”查看，如果该提示再次出现，请联系 support@aster.com。您在服务器上的数据未受影响。",
    ...
    decrypt_corrupt_ciphertext: "这封邮件在服务器上存在，但传输中看起来已损坏。刷新后再试一次通常可以解决，如果仍不行，可联系 support@aster.com 协助。",
    ...
    cdn_relay_misconfigured: "此构建版本未配置 CDN 中继。在“设置”中切换为直连通常可以恢复在线，如有需要可联系 support@aster.com 协助。",
    device_repair_required: "此设备的密钥缺失。从您的桌面应用重新配对通常可以解决。您的账户和数据未受影响。",
    device_challenge_mismatch: "此设备的身份验证不匹配，可能存在被篡改的迹象。请从您的桌面应用重新配对，如果该提示再次出现，请联系 support@aster.com。",
