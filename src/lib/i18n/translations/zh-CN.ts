...
export const zh_CN = {
  common: {
    ...
    set_as_default: "设为默认",
    billing_alert_body: "上次付款未成功。请更新付款方式以保留你的套餐。",
    billing_alert_body_days: "上次付款未成功。请在 {{days}} 天内更新付款方式以保留你的套餐。",
    billing_alert_action: "更新付款方式",
    dismiss: "忽略",
    load_content: "加载",
    open_link: "打开链接",
    no_icon: "无图标",
  ...
  settings: {
    ...
    alias_export_summary: "共 {{rows}} 条，分为 {{files}} 个文件。",
    ...
    cancel_reason_placeholder_switched_provider: "你换到了哪个服务？是什么打动了你？",
    ...
    cancel_reason_detail_required: "写一句简短的说明，我们才能据此改进，或者跳过这一步。",
