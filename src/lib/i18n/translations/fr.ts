...
export const fr = {
  ...
  settings: {
    ...
    vanguard_description: "Sécurité avancée pour les journalistes, militants et toute personne à risque élevé. Active des protections avancées indisponibles sur les comptes standard.",
