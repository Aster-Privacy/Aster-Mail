...
export const fr = {
  ...
  passkeys: {
    ...
    security_key_hint: "Utilise l'authentificateur de votre appareil - Windows Hello, Touch ID ou Face ID. Si votre gestionnaire de mots de passe s'ouvre, fermez-le.",
