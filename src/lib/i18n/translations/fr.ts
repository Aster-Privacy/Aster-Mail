...
export const fr = {
  ...
  mail: {
    ...
    confirm_bulk_action_count_description: "Cela concerne les {{count}} e-mails.",
    confirm_bulk_action_count_description_one: "Cela concerne 1 e-mail.",
    confirm_bulk_action_count_description_other: "Cela concerne les {{count}} e-mails.",
    confirm_bulk_action_scope_description: "Cela concerne les {{count}} e-mails de {{scope}}.",
    confirm_bulk_action_scope_description_one: "Cela concerne l’e-mail de {{scope}}.",
    confirm_bulk_action_scope_description_other: "Cela concerne les {{count}} e-mails de {{scope}}.",
