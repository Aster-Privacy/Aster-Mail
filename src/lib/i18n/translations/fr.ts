...
export const fr = {
  common: {
    ...
    adding_file_would_exceed_limit: "L'ajout de ce fichier dépasserait la limite",
    ...
    contacts_deleted: "Contacts supprimés",
    contacts_starred: "Contacts marqués d'une étoile",
    contacts_unstarred: "Étoile retirée des contacts",
    ...
    file_already_attached: "Ce fichier est déjà joint",
    file_exceeds_max_size: "Le fichier dépasse la taille maximale",
    folder_fallback: "Dossier",
    found_n_contacts: "{n} contacts trouvés",
    ...
    import_n_contacts: "Importer {n} contacts",
    ...
    marking_as_read_count: "{count} marqué(s) comme lu(s)",
    mention_notification: "Vous avez été mentionné",
    message_will_be_sent_shortly: "Le message sera envoyé dans un instant",
    more_aliases: "Plus d'alias",
    n_contacts_imported: "{n} contacts importés",
    n_emails: "{n} e-mails",
    n_more: "{n} de plus",
    n_more_recipients: "{n} destinataire(s) supplémentaire(s)",
    new_email_notification: "Nouvel e-mail",
    ...
    recovery_text_code_used_on: "Code utilisé le",
    ...
    reply_notification: "Nouvelle réponse",
    ...
    unlock_with_biometry: "Déverrouiller avec la biométrie",
    ...
    use_biometry_to_unlock: "Utiliser la biométrie pour déverrouiller",
  ...
  settings: {
    ...
    connect_modal_description: "Connectez votre compte pour importer vos e-mails.",
    connect_modal_privacy_note: "Vos identifiants ne sont jamais stockés.",
    connect_modal_title: "Connecter un compte",
    ...
    credit_task_android_hint: "Gagnez des crédits en installant l'application Android.",
    credit_task_android_title: "Installer sur Android",
    credit_task_desktop_hint: "Gagnez des crédits en installant l'application de bureau.",
    credit_task_desktop_title: "Installer sur ordinateur",
    credit_task_download_cta: "Télécharger",
    ...
    crypto_modal_price: "Montant : {price}",
    ...
    desktop_bridge_set_up: "Configurer",
    ...
    dev_databases_count_one: "1 base de données",
    dev_databases_count_other: "{count} bases de données",
    dev_days_ago: "Il y a {days} jour(s)",
    dev_encryption_label: "Chiffrement",
    dev_hours_ago: "Il y a {hours} heure(s)",
    ...
    dev_minutes_ago: "Il y a {minutes} minute(s)",
    dev_none: "Aucun",
    dev_none_registered: "Aucun enregistré",
    dev_password_kdf_label: "KDF du mot de passe",
    dev_seconds_ago: "Il y a {seconds} seconde(s)",
    ...
    export_progress_eta: "Temps restant estimé : {time}",
    export_progress_messages: "{count} messages traités",
    ...
    ghost_alias_expires_in: "Expire dans {time}",
    ...
    ghost_aliases_this_month: "Ce mois-ci",
    ...
    import_folder_prep_status: "Préparation des dossiers...",
    ...
    n_minutes: "{n} minute(s)",
    n_skipped: "{n} ignoré(s)",
    ...
    oauth_folders_partial: "Certains dossiers n'ont pas pu être configurés",
    ...
    plan_f_mail_rules: "Règles de messagerie",
    plan_f_tracker_protection: "Protection contre le suivi",
    promo_forever: "Pour toujours",
    promo_once_reverts: "Première période, puis tarif normal",
    promo_then_reverts: "Puis {price}",
    ...
    referral_email_body: "J'utilise Aster Mail, un service de messagerie privé et chiffré. Rejoignez-moi avec mon lien de parrainage.",
    ...
    switch_billing_loss: "Changer de cycle de facturation entraînera une perte de la remise.",
    ...
    sync_progress_count: "{count} e-mail(s) synchronisé(s)",
    ...
    trusted_2fa_expires: "Expire le {date}",
    trusted_2fa_last_used: "Dernière utilisation : {date}",
    ...
    trusted_devices_created: "Ajouté le {date}",
    ...
    trusted_devices_last_seen: "Dernière activité : {date}",
    ...
    trusted_devices_revoke_confirm: "Révoquer cet appareil de confiance ?",
    ...
    upgrade_modal_description_specific: "Cette fonctionnalité est disponible avec {plan}.",
    ...
    vacation_n_replies_sent: "{n} réponses automatiques envoyées",
    vacation_one_reply_sent: "1 réponse automatique envoyée",
    vacation_reply_count_one: "1 réponse",
  ...
  mail: {
    ...
    add_link_to_selection: "Ajouter un lien à la sélection",
    advanced_search: "Recherche avancée",
    all_in_folder_selected: "Tous les éléments du dossier sélectionnés",
    all_on_page_selected: "Tous les éléments de la page sélectionnés",
    all_search_results_for: "Tous les résultats pour",
    attachment_singular: "pièce jointe",
    bounced: "Rejeté",
    copy_headers: "Copier les en-têtes",
    create_filter: "Créer un filtre",
    delivered: "Livré",
    download_file_named: "Télécharger {name}",
    ...
    filter_before: "Avant",
    filter_date: "Date",
    filter_filename: "Nom de fichier",
    filter_folder: "Dossier",
    filter_from: "De",
    filter_has_type: "Type de pièce jointe",
    filter_id: "Identifiant",
    filter_in: "Dans",
    filter_label: "Étiquette",
    filter_larger: "Plus grand que",
    ...
    folder_item_count_singular: "1 élément",
    font: "Police",
    fonts: "Polices",
    ...
    last_forwarded: "Dernier transfert",
    ...
    n_blocked: "{n} bloqué(s)",
    n_forwarded: "{n} transféré(s)",
    n_messages: "{n} message(s)",
    no_emails_match_query: "Aucun e-mail ne correspond à la recherche",
    ...
    notification_mention: "Vous avez été mentionné",
    notification_new_email: "Nouvel e-mail",
    notification_reply: "Nouvelle réponse",
    ...
    param_removed_from_n_links: "Paramètre supprimé de {n} lien(s)",
    ...
    trash_auto_delete_notice: "Les éléments de la corbeille sont supprimés après 30 jours.",
  ...
  auth: {
    ...
    device_code_expires_in: "Expire dans {time}",
    ...
    pair_device_confirm: "Confirmer l'association",
  ...
  errors: {
    ...
    all_emails_rejected: "Tous les e-mails ont été rejetés",
    ...
    cannot_send_no_keys: "Impossible d'envoyer : aucune clé disponible",
    ...
    email_skipped_size: "E-mail ignoré - trop volumineux",
    ...
    failed_parse_csv: "Échec de l'analyse du fichier CSV",
    failed_parse_email: "Échec de l'analyse de l'e-mail",
    failed_parse_eml: "Échec de l'analyse du fichier EML",
    failed_parse_pst: "Échec de l'analyse du fichier PST",
    failed_parse_pst_file: "Échec de l'ouverture du fichier PST",
    ...
    max_accounts: "Nombre maximum de comptes atteint",
    ...
    unknown_error: "Erreur inconnue",
    unrecognized_format: "Format non reconnu",
