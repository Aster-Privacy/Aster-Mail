...
export const fr = {
  ...
  settings: {
    ...
    alias_export_confirm_description: "Verifiez ce que vous allez telecharger.",
    alias_export_source_aliases: "Alias",
    alias_export_source_domain_addresses: "Adresses de domaine personnalise",
    alias_export_source_directories: "Repertoires",
    alias_export_source_ghost: "Alias fantomes",
    alias_export_source_count: "{{count}} entrees",
    alias_export_choose_columns: "Choisir les colonnes ({{count}} selectionnees)",
    ...
    alias_export_column_display_name: "Nom affiche",
    alias_export_column_note: "Note",
    alias_export_column_websites: "Sites web",
    alias_export_column_enabled: "Active",
    alias_export_column_created_at: "Cree le",
    alias_export_column_directory: "Repertoire",
    alias_export_column_domain: "Domaine",
    alias_export_column_auto_create: "Creation automatique",
    alias_export_column_color: "Couleur",
    alias_export_column_expires_at: "Expire le",
    alias_export_warning_title: "Ce fichier n'est pas chiffre",
    alias_export_warning_body: "Toute personne qui l'ouvre peut lire chaque alias, note et site web qu'il contient. Conservez-le dans votre gestionnaire de mots de passe ou sur un disque chiffre.",
    alias_export_summary: "{{rows}} entrees reparties sur {{files}} fichier(s).",
    alias_export_download: "Telecharger",
    alias_export_incomplete: "Seuls {{loaded}} alias sur {{total}} ont ete charges. Rechargez vos alias et reessayez pour que la sauvegarde soit complete.",
    alias_export_undecryptable: "{{count}} alias n'ont pas pu etre dechiffres et ne sont pas inclus.",
    alias_export_undecryptable_ghost: "{{count}} alias fantomes n'ont pas pu etre dechiffres et ne sont pas inclus.",
    alias_export_load_failed: "Impossible de charger les repertoires ou les alias fantomes.",
    alias_export_failed: "Echec de l'exportation. Rien n'a ete telecharge.",
