...
export const fr = {
  common: {
    ...
    unexpected_error_refresh:
      "Une erreur inattendue est survenue. Actualisez la page pour continuer. Vos données ne sont pas affectées.",
  ...
  auth: {
    ...
    manage_account: "Gérer votre compte Aster",
