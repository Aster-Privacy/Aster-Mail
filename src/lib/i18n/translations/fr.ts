...
export const fr = {
  common: {
    ...
    more_contact_groups: "{{count}} autres groupes",
    more_contact_groups_one: "{{count}} autre groupe",
    more_contact_groups_other: "{{count}} autres groupes",
    ...
    add_contacts_to_group_hint: "Créez un groupe pour organiser les personnes à qui vous écrivez le plus.",
    contact_group_name_too_long: "Les noms de groupe peuvent comporter jusqu’à {{ max }} caractères.",
    ...
    delete_contact_group_confirm: "Supprimer ce groupe ? Vos contacts restent dans votre carnet d’adresses.",
    failed_to_fetch_contact_groups: "Les groupes n’ont pas été chargés. Réessayez.",
    failed_to_save_contact_group: "Le groupe n’a pas été enregistré. Réessayez.",
    failed_to_create_contact_group: "Le groupe n’a pas été créé. Réessayez.",
    failed_to_delete_contact_group: "Le groupe n’a pas été supprimé. Réessayez.",
    failed_to_update_contact_groups: "L’appartenance au groupe n’a pas été mise à jour.",
