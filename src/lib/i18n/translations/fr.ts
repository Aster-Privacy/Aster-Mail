...
export const fr = {
  common: {
    ...
    delete_account_error: "Nous n'avons pas pu supprimer votre compte tout de suite. Un autre essai dans un instant fonctionne en général, et support@aster.com peut aider si cela continue d'échouer.",
    ...
    decrypt_try_sign_out: "Se déconnecter puis se reconnecter rechargera vos clés. Si le message ne s'ouvre toujours pas, support@aster.com peut vous aider.",
    n_files: "{{count}} file",
    ...
    settings_disabled_suspended: "Les paramètres sont désactivés pendant que votre compte est suspendu. support@aster.com peut aider pour un appel ou plus de détails.",
    submit_an_appeal: "Submit an appeal",
    account_suspended_default_reason: "Votre compte est suspendu pour une violation des conditions d'utilisation. support@aster.com peut aider pour un appel ou plus de détails.",
  ...
  auth: {
    ...
    abuse_account_limit: "Notre système de sécurité automatisé a signalé cette inscription, et nous ne pouvons pas créer le compte. Si cela semble être une erreur, support@aster.com peut vous aider.",
    abuse_flagged_message: "Notre système de sécurité a arrêté pour l'instant les nouvelles inscriptions depuis ce réseau. Si cela semble être une erreur, support@aster.com peut vous aider.",
  ...
  errors: {
    ...
    invalid_credentials: "Ce courriel et ce mot de passe ne correspondaient pas. Un autre essai, ou une réinitialisation sur aster.com/reset, réglera la chose.",
    ...
    account_not_found: "Nous n'avons pas pu trouver un compte avec ce nom. Vérifier l'orthographe, ou une réinitialisation sur aster.com/reset, suffit en général.",
    login_failed: "La connexion ne s'est pas terminée. Un autre essai devrait suffire. Votre compte n'est pas verrouillé.",
    decrypt_failed: "Ce mot de passe n'a pas déverrouillé vos clés sur cet appareil. Réessayer fonctionnera, et un code de récupération sur aster.com/reset est la solution de secours si cela continue d'échouer. Vos données sur le serveur sont inchangées.",
    ...
    wrong_vault_password: "Ce mot de passe n'a pas déverrouillé vos clés sur cet appareil. Un autre essai devrait suffire, et un code de récupération sur aster.com/reset reste la solution de secours si cela échoue encore. Vos données sur le serveur sont inchangées.",
    vault_tampered: "Les données chiffrées sur cet appareil ne correspondent pas à ce que nous attendions, ce qui peut indiquer une altération. Rendez-vous dans Paramètres puis Sécurité pour vérifier, et si l'avertissement revient, contactez support@aster.com. Vos données sur le serveur restent intactes.",
    ...
    decrypt_corrupt_ciphertext: "Cet e-mail est sur le serveur mais paraît corrompu en transit. Une actualisation et un autre essai suffisent généralement, et support@aster.com peut vous aider si cela échoue encore.",
    ...
    cdn_relay_misconfigured: "Le relais CDN n'est pas configuré pour cette version. Passer à une connexion directe dans Paramètres vous remettra en ligne, et support@aster.com peut vous aider si besoin.",
    ...
    device_challenge_mismatch: "La vérification d'identité de cet appareil n'a pas correspondu, ce qui peut indiquer une altération. Ré-appairez-le depuis votre application de bureau, et si l'avertissement revient, contactez support@aster.com.",
