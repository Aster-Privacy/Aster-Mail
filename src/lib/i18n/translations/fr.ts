...
export const fr = {
  ...
  auth: {
    ...
    recovery_email_step_desc: "Ajoutez une adresse e-mail pour récupérer votre compte si vous perdez votre clé de récupération.",
    ...
    mail_desktop_desc: "Une application native et rapide pour Windows, macOS et Linux.",
