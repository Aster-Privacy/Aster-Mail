...
export const fr = {
  common: {
    ...
    recipient_key_outdated_desc: "La clé publiée de ce destinataire est expirée ou invalide, le message ne peut donc pas être chiffré de bout en bout. Il sera envoyé protégé uniquement en transit.",
    ...
    unblock_failed: "Impossible de débloquer {{ email }}. Un nouvel essai devrait suffire. L'expéditeur reste bloqué pour l'instant.",
    remove_from_allowlist_failed: "Impossible de retirer {{ email }} de votre liste d'autorisations. Un nouvel essai devrait suffire. Il reste autorisé pour l'instant.",
    bulk_unblock_failed: "Ces expéditeurs n'ont pas été débloqués. Un nouvel essai devrait suffire. Ils restent bloqués pour l'instant.",
    bulk_remove_allowlist_failed: "Ces expéditeurs n'ont pas été retirés de votre liste d'autorisations. Un nouvel essai devrait suffire. Ils restent autorisés pour l'instant.",
  ...
  settings: {
    ...
    fam_kids_subtitle: "Réservez dès maintenant une adresse pour votre enfant et laissez-le terminer la configuration plus tard avec son propre mot de passe.",
    fam_kids_seats_used: "{{used}} sur {{max}} places familiales utilisées (membres, invitations et réservations)",
    fam_kids_reserve_btn: "Réserver une adresse",
    fam_kids_seats_full: "Votre groupe familial est complet. Libérez une place pour réserver une autre adresse.",
    fam_kids_empty: "Aucune adresse réservée pour l'instant.",
    fam_kids_username_label: "Adresse",
    fam_kids_username_ph: "leur nom d'utilisateur",
    fam_kids_info_title: "Adresses réservées pour enfants",
    fam_kids_info_desc: "L'adresse est réservée pour votre enfant et bloquée pour toute autre personne. Votre enfant (ou vous) termine la configuration plus tard avec un mot de passe privé, créant un véritable compte à accès zéro qui rejoint automatiquement votre famille.",
    fam_kids_nickname_label: "Surnom (facultatif)",
    fam_kids_nickname_ph: "ex. Julien",
    ...
    fam_kids_consent_label: "Je confirme être le parent ou le tuteur légal de cet enfant et je consens à créer un compte pour lui.",
    fam_kids_consent_required: "Veuillez confirmer le consentement parental pour continuer.",
    fam_kids_link_hint: "Toute personne disposant du lien de récupération peut configurer cette adresse. Partagez-le uniquement avec votre enfant et régénérez-le en cas de fuite.",
    fam_kids_create: "Réserver",
    fam_kids_creating: "Réservation...",
    fam_kids_cancel: "Annuler",
    fam_kids_created: "Adresse réservée · lien de récupération copié",
    fam_kids_create_failed: "Impossible de réserver cette adresse",
    fam_kids_copy_link: "Copier le lien de récupération",
    fam_kids_link_copied: "Lien de récupération copié",
    fam_kids_regenerate: "Régénérer le lien",
    fam_kids_regenerated: "Nouveau lien de récupération généré",
    fam_kids_setup_now: "Configurer maintenant",
    fam_kids_release: "Libérer",
    fam_kids_released: "Réservation libérée",
    fam_kids_release_confirm: "Libérer cette adresse réservée ? Elle redeviendra disponible pour tout le monde.",
    ...
    fam_kids_claim_intro: "Choisissez un mot de passe pour terminer la configuration de cette adresse familiale.",
    fam_kids_claim_invalid_title: "Ce lien n'est plus valide",
    fam_kids_claim_invalid_body: "Ce lien de récupération a expiré, a déjà été utilisé ou a été retiré. Demandez un nouveau lien au propriétaire de la famille.",
    fam_kids_claim_signed_in_title: "Vous êtes connecté à un autre compte",
    fam_kids_claim_signed_in_body: "Ce lien configure un nouveau compte enfant. Ouvrez-le dans une fenêtre privée ou de navigation privée, ou copiez-le pour l'utiliser sur l'appareil de votre enfant.",
    fam_kids_release_modal_title: "Libérer cette adresse ?",
    fam_kids_release_modal_body: "{{address}} deviendra disponible pour être enregistrée par n'importe qui. Cette action est irréversible.",
    fam_kids_release_btn: "Libérer",
    alias_captcha_required: "Veuillez compléter le captcha pour créer un alias.",
    browse_folder: "Sélectionner un dossier",
    ...
    alias_import_drop_hint: "Déposez ici un CSV (SimpleLogin, Addy.io) ou un fichier data.json de Proton Pass, ou choisissez un fichier",
    ...
    alias_activity_title: "Activité (7 derniers jours)",
    ...
    loading_payment_form: "Chargement...",
  ...
  auth: {
    link_device_upgrade_required_toast: "Associer un appareil Bridge nécessite un forfait Star ou supérieur. Passez à un forfait supérieur pour continuer.",
    link_device_upgrade_title: "Passez à un forfait supérieur pour associer cet appareil",
    link_device_upgrade_description: "Connecter un Bridge de bureau à votre compte nécessite un forfait Star ou supérieur. Choisissez un forfait ci-dessous et votre appareil sera associé juste après le paiement.",
    link_device_upgrade_cta: "Passer à Star",
    link_device_upgrade_failed: "Impossible de démarrer le paiement. Réessayez ou ouvrez Facturation dans les paramètres.",
    link_device_already_linked: "Cet appareil est déjà associé à un autre compte. Dissociez-le d'abord, puis réessayez.",
    link_device_rate_limited: "Trop de tentatives. Attendez environ une minute, puis réessayez.",
    link_device_account_suspended: "Ce compte est suspendu, il n'est donc pas possible d'associer de nouveaux appareils pour le moment. Contactez le support pour régler cela.",
    academic_offer_sending_title: "Envoi de votre lien de vérification",
    academic_offer_sending_body: "Envoi d'un lien de vérification de 30 % à {{ email }}.",
    offer_welcome_badge_student: "30 % de réduction étudiant",
    offer_welcome_badge_journalist: "30 % de réduction journaliste",
    offer_welcome_headline: "Obtenez vos 30 % de réduction",
    offer_welcome_subline_student: "Créez votre compte gratuit, puis vérifiez votre e-mail étudiant pour débloquer 30 % de réduction sur n'importe quel forfait payant pendant 12 mois.",
    offer_welcome_subline_journalist: "Créez votre compte gratuit, puis vérifiez vos accréditations de presse pour débloquer 30 % de réduction sur n'importe quel forfait payant pendant 12 mois.",
  ...
  passkeys: {
    rename_placeholder: "Nommer cette clé",
    rename_failed: "Impossible de renommer la clé. Veuillez réessayer.",
  ...
  mail_rules: {
    ...
    templates_subtitle: "Partez d'une règle prête à l'emploi et personnalisez-la avant d'enregistrer.",
    ...
    tpl_folder_auto_clean_name: "Nettoyage automatique du dossier",
    tpl_folder_auto_clean_desc: "Supprime automatiquement les e-mails d'un dossier lorsqu'ils dépassent le nombre de jours que vous choisissez. Les e-mails suivis et épinglés sont toujours conservés.",
    tpl_newsletters_name: "Trier les newsletters",
    tpl_newsletters_desc: "Lorsqu'un message provient d'une liste de diffusion (il contient un en-tête List-Id), classez-le dans la catégorie Mises à jour.",
    tpl_social_name: "Regrouper les notifications sociales",
    tpl_social_desc: "Lorsque l'expéditeur est Facebook, LinkedIn, X/Twitter ou Instagram, déplacez le message vers la catégorie Réseaux sociaux.",
    tpl_promotions_name: "Repérer les promotions",
    tpl_promotions_desc: "Lorsque l'objet mentionne solde, remise, coupon ou '% de réduction', déplacez le message vers la catégorie Promotions.",
    tpl_calendar_name: "Rassembler les invitations d'agenda",
    tpl_calendar_desc: "Lorsqu'un message contient une invitation d'agenda (.ics), classez-le dans la catégorie Mises à jour.",
    tpl_large_attachments_name: "Signaler les pièces jointes volumineuses",
    tpl_large_attachments_desc: "Lorsqu'un message comporte une pièce jointe de plus de 10 Mo, déplacez-le vers un dossier de votre choix. Choisissez le dossier avant d'enregistrer.",
    tpl_no_reply_name: "Ranger le courrier automatisé",
    tpl_no_reply_desc: "Lorsqu'un message est généré automatiquement (il contient un en-tête Auto-Submitted, ex. expéditeurs no-reply), classez-le dans Mises à jour.",
    tpl_receipts_name: "Archiver les reçus",
    tpl_receipts_desc: "Lorsque l'objet mentionne reçu, facture ou confirmation de commande, contournez la boîte de réception et classez-le dans Mises à jour.",
    tpl_vip_sender_name: "Mettre en avant un expéditeur clé",
    tpl_vip_sender_desc: "Lorsqu'un e-mail arrive d'un expéditeur de votre choix, mettez-le en avant et envoyez une notification. Saisissez l'adresse de l'expéditeur avant d'enregistrer.",
    tpl_keyword_star_name: "Mettre en avant par mot-clé",
    tpl_keyword_star_desc: "Lorsque l'objet contient un mot de votre choix, mettez le message en avant. Saisissez le mot-clé avant d'enregistrer.",
    tpl_auth_failures_name: "Retenir le courrier suspect",
    tpl_auth_failures_desc: "Lorsqu'un message échoue à ses vérifications SPF, DKIM ou DMARC (signe fréquent d'usurpation), gardez-le hors de la boîte de réception et marquez-le comme lu.",
    tpl_forward_copy_name: "Transférer une copie",
    tpl_forward_copy_desc: "Lorsqu'un e-mail arrive d'un expéditeur de votre choix, transférez une copie vers une autre adresse. Saisissez les deux adresses avant d'enregistrer.",
    ...
    run_on_existing_result: "Règle appliquée à {{count}} messages",
    run_on_existing_failed: "Impossible d'appliquer la règle au courrier existant. Un nouvel essai devrait fonctionner.",
  ...
  folder_retention: {
    ...
    subtitle: "Supprimez automatiquement les anciens e-mails d'un dossier. Les e-mails suivis et épinglés sont toujours conservés.",
    add: "Ajouter un nettoyage automatique",
    empty_title: "Aucun dossier en nettoyage automatique pour l'instant",
    empty_description: "Choisissez un dossier et une période de conservation pour le garder rangé automatiquement.",
    edit_title: "Dossier en nettoyage automatique",
    folder: "Dossier",
    select_folder: "Sélectionner un dossier",
    no_folders: "Créez d'abord un dossier personnalisé pour utiliser le nettoyage automatique.",
    retention_period: "Supprimer les e-mails datant de plus de",
    days_suffix: "jours",
    ...
    mode_permanent_hint: "Irréversible",
    mode_archive: "Déplacer vers les archives",
    mode_archive_hint: "Retiré de la boîte de réception, conservé et récupérable",
    enabled: "Activé",
    preview_some: "Environ {{count}} e-mails seront nettoyés lors de la prochaine exécution.",
    ...
    delete: "Supprimer",
    remove: "Retirer",
    permanent_confirm: "Supprimer définitivement les e-mails de plus de {{days}} jours dans ce dossier ? Cette action est irréversible.",
    summary_older_than: "Datant de plus de {{days}} jours",
    summary_trash: "vers la corbeille",
    summary_permanent: "définitivement",
    summary_archive: "vers les archives",
    card_badge: "Nettoyage auto",
    disabled_badge: "Désactivé",
    upgrade_title: "Le nettoyage automatique des dossiers est une fonctionnalité payante",
    upgrade_body: "Passez à Star ou supérieur pour nettoyer les dossiers automatiquement.",
