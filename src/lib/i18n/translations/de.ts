...
export const de = {
  common: {
    ...
    delete_account_error:
      "Ihr Konto ließ sich gerade nicht löschen. Ein erneuter Versuch in einem Moment genügt meist, und support@aster.com hilft gern, falls es weiter scheitert.",
    ...
    decrypt_try_sign_out:
      "Ein Abmelden und erneutes Anmelden lädt Ihre Schlüssel neu. Sollte die Nachricht weiterhin nicht öffnen, hilft support@aster.com gern weiter.",
    n_files: "{{count}} file",
    ...
    settings_disabled_suspended:
      "Einstellungen sind deaktiviert, solange Ihr Konto gesperrt ist. support@aster.com hilft bei einem Einspruch oder weiteren Details gern weiter.",
    submit_an_appeal: "Submit an appeal",
    account_suspended_default_reason:
      "Ihr Konto ist wegen eines Verstoßes gegen die Nutzungsbedingungen gesperrt. support@aster.com hilft bei einem Einspruch oder weiteren Details gern weiter.",
  ...
  settings: {
    ...
    too_many_requests:
      "Sie haben das in kurzer Zeit häufig getan. Ein Moment, dann ein erneuter Versuch, funktioniert.",
  ...
  auth: {
    ...
    abuse_account_limit:
      "Unser automatisches Sicherheitssystem hat diese Registrierung markiert, das Konto kann daher nicht erstellt werden. Falls dies fehlerhaft erscheint, hilft support@aster.com gern weiter.",
    abuse_flagged_message:
      "Unser Sicherheitssystem hat neue Registrierungen aus diesem Netzwerk vorerst gestoppt. Falls dies fehlerhaft erscheint, hilft support@aster.com gern weiter.",
  ...
  errors: {
    ...
    rate_limit: "Sie haben das in kurzer Zeit häufig getan. Ein Moment, dann ein erneuter Versuch, funktioniert.",
    invalid_credentials: "Diese E-Mail und dieses Passwort stimmten nicht überein. Ein erneuter Versuch oder ein Zurücksetzen unter aster.com/reset klärt das.",
    ...
    account_not_found: "Ein Konto mit diesem Namen ließ sich nicht finden. Ein Blick auf die Schreibweise oder ein Zurücksetzen unter aster.com/reset klärt das meist.",
    ...
    decrypt_failed:
      "Dieses Passwort hat Ihre Schlüssel auf diesem Gerät nicht entsperrt. Ein erneuter Versuch genügt meist, und ein Wiederherstellungscode unter aster.com/reset ist der Rückweg, falls es weiter scheitert. Ihre Daten auf dem Server bleiben unverändert.",
    ...
    wrong_vault_password: "Dieses Passwort hat Ihre Schlüssel auf diesem Gerät nicht entsperrt. Ein erneuter Versuch genügt meist, und ein Wiederherstellungscode unter aster.com/reset ist die Absicherung, falls es weiterhin nicht klappt. Ihre Daten auf dem Server bleiben unverändert.",
    vault_tampered: "Die verschlüsselten Daten auf diesem Gerät stimmen nicht mit dem erwarteten Stand überein, was auf eine Manipulation hindeuten kann. Unter Einstellungen, Sicherheit lässt sich das prüfen, und bei wiederkehrender Warnung hilft support@aster.com. Ihre Daten auf dem Server bleiben unangetastet.",
    ...
    decrypt_corrupt_ciphertext: "Diese E-Mail liegt auf dem Server, wirkt aber bei der Übertragung beschädigt. Ein Aktualisieren und ein erneuter Versuch genügen meist, und support@aster.com hilft, falls es weiterhin nicht klappt.",
    ...
    cdn_relay_misconfigured: "Das CDN-Relay ist für diesen Build nicht konfiguriert. Ein Wechsel auf direkte Verbindung in den Einstellungen bringt Sie wieder online, und support@aster.com hilft bei Bedarf.",
    ...
    device_challenge_mismatch: "Die Identitätsprüfung dieses Geräts stimmte nicht überein, was auf eine Manipulation hindeuten kann. Ein erneutes Koppeln über die Desktop-App hilft, und bei wiederkehrender Warnung steht support@aster.com bereit.",
