...
export const de = {
  ...
  settings: {
    ...
    alias_export_description: "Wahlen Sie aus, was enthalten sein soll. Die Datei wird in Ihrem Browser erstellt und niemals an unsere Server gesendet.",
    alias_export_format_csv: "CSV (Tabelle)",
    alias_export_format_json: "JSON",
    alias_export_confirm_description: "Prufen Sie, was Sie herunterladen.",
    ...
    alias_export_source_count: "{{count}} Eintrage",
    alias_export_choose_columns: "Spalten wahlen ({{count}} ausgewahlt)",
    ...
    alias_export_column_expires_at: "Lauft ab",
    alias_export_warning_title: "Diese Datei ist nicht verschlusselt",
    alias_export_warning_body: "Wer sie offnet, kann jeden Alias, jede Notiz und jede Webseite darin lesen. Bewahren Sie sie in Ihrem Passwortmanager oder auf einem verschlusselten Laufwerk auf.",
    alias_export_summary: "{{rows}} Eintrage in {{files}} Datei(en).",
    alias_export_download: "Herunterladen",
    alias_export_incomplete: "Nur {{loaded}} von {{total}} Aliasen wurden geladen. Laden Sie Ihre Aliase neu und versuchen Sie es erneut, damit die Sicherung vollstandig ist.",
    alias_export_undecryptable: "{{count}} Aliase konnten nicht entschlusselt werden und sind nicht enthalten.",
    alias_export_undecryptable_ghost: "{{count}} Ghost-Aliase konnten nicht entschlusselt werden und sind nicht enthalten.",
