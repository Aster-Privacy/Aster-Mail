...
const TEXT_ENTER: Transition = { duration: 0.18, ease: EASE_STANDARD };
const SWAP_FROM_OPACITY = 0.35;
...
export function TranslationBanner({
  ...
  const swap_from = reduce_motion ? 1 : SWAP_FROM_OPACITY;
