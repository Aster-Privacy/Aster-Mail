...
export function ShareModal({ is_open, on_close }: ShareModalProps) {
  ...
  const handle_copy_link = () => {
    ...
    navigator.clipboard.writeText("https://astermail.org/invite");
  ...
  const handle_whatsapp_share = () => {
    const text = encodeURIComponent(
      "Check out Aster Mail - A better way to manage your emails! https://astermail.org/invite",
    );
  ...
  return (
    <Modal is_open={is_open} on_close={handle_close} size="md">
      <ModalHeader>
        <ModalTitle>Share Aster Mail</ModalTitle>
        <ModalDescription>
          Invite friends to experience encrypted email
        </ModalDescription>
      </ModalHeader>
      ...
      <div className="px-6 pb-4 space-y-5">
        <div>
          ...
          <div className="flex gap-2">
            <input
              className="flex-1 rounded-lg border px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
          ...
          >
            <div
              ...
              style={{
                ...
                color: copy_success ? "#22c55e" : "#3b82f6",
              }}
            >
              {copy_success ? (
            ...
            <div className="flex-1 text-left">
              ...
              >
                {copy_success ? "Link copied!" : "astermail.org/invite"}
              </p>
            </div>
            <span
