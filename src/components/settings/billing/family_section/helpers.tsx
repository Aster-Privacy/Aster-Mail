...
export function last_seen_relative(iso: string | null | undefined, t: TFn): string {
...
export function activity_event_text(t: TFn, entry: { event_type: string; actor_username: string | null; target_username: string | null }): string {
