...
export const SETTINGS_SEARCH_REGISTRY: SearchEntry[] = [
  ...
  // ── Encryption ────────────────────────────────────────────────────────────
  {
    ...
    label_key: "settings.export_public_key_label",
    section: "encryption",
    breadcrumb: "Encryption > Keys",
    crumb_key: "settings_search.keys",
    keywords: [
      "download public key",
      "share public key",
      "key algorithm",
  ...
  },
  {
    ...
    label_key: "settings.export_private_key_label",
    section: "encryption",
    breadcrumb: "Encryption > Keys",
    crumb_key: "settings_search.keys",
    keywords: [
  ...
  },
  {
    ...
    crumb_key: "settings_search.key_rotation",
    keywords: [
  ...
  },
  {
    ...
    label_key: "settings.feature_recovery_codes",
    section: "encryption",
    breadcrumb: "Encryption > Recovery",
    crumb_key: "settings_search.recovery",
    keywords: ["regenerate codes", "backup codes"],
  },
  {
  ...
  {
    label: "Hide subject on encrypted mail",
    label_key: "settings.obscure_subject_title",
    section: "encryption",
    breadcrumb: "Encryption > Control",
    crumb_key: "settings_search.control",
    keywords: [
      "obscure subject",
      "protected headers",
      "encrypted subject",
  ...
  { label: "Downloaded language packs", label_key: "settings.translation_packs", section: "behavior", breadcrumb: "Behavior > Translation", crumb_key: "settings_search.translation", keywords: ["language pack", "download", "storage", "offline", "remove models"] },
  ...
  { label: "Show side panel",      label_key: "settings.show_side_panel", section: "behavior", breadcrumb: "Behavior > Navigation Panel", crumb_key: "settings_search.navigation_panel", keywords: ["contacts rail", "side panel", "disable side panel"] },
