...
export type results_sort = "relevance" | "price_low" | "price_high" | "az" | "discount";
...
export function discount_percent(r: DomainSearchResult): number | null {
  ...
  const pct = Math.round(((r.renewal_price_cents - r.price_cents) / r.renewal_price_cents) * 100);
...
function compare_price(a: DomainSearchResult, b: DomainSearchResult, dir: 1 | -1): number {
...
function compare_discount(a: DomainSearchResult, b: DomainSearchResult): number {
