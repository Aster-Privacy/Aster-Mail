...
function describe_semicircle_arc(
  center_x: number,
  center_y: number,
  radius: number,
  start_angle: number,
...
interface ReferralRingStatProps {
  value: number;
  max: number;
  color_class: string;
...
interface ReferralProgressGaugeProps {
  percent: number;
  earned_label: string;
  earned_value: string;
}

function ReferralProgressGauge({
  percent,
  earned_label,
  earned_value,
}: ReferralProgressGaugeProps) {
    ...
    <div className="mb-5">
      ...
      <div className="rounded-2xl border border-edge-secondary p-5 bg-surf-tertiary">
        ...
        <div className="flex flex-col items-center mb-5">
          <ReferralProgressGauge
            percent={affiliate_cap_percent}
            earned_label={t("settings.affiliate_total_earned")}
            earned_value={format_price(
              my_affiliate_status.earned_this_month_cents,
            )}
          />
            ...
            {referral_info.max_credits_cents > 0 && (
              <div className="pt-2 flex flex-col items-center">
                <ReferralProgressGauge
                  ...
                  earned_label={t("settings.referral_gauge_earned_label")}
                  earned_value={format_price(total_earned_cents)}
                />
