...
> = {
  ...
  auto_discover_keys: (v) => typeof v === "boolean",
  require_encryption: (v) => typeof v === "boolean",
  show_encryption_indicators: (v) => typeof v === "boolean",
  publish_to_wkd: (v) => typeof v === "boolean",
  publish_to_keyservers: (v) => typeof v === "boolean",
