...
export const SUBJECT_KEYWORDS: KeywordRule[] = [
  ...
  {
    pattern: /\bexclusive\s+offer\b/i,
    category: "promotions",
    weight: 70,
    field: "subject",
  },
  {
    pattern: /\bdeal\s+of\b/i,
    category: "promotions",
    weight: 65,
    field: "subject",
  },
  ...
  {
    pattern: /\border\s+(confirmation|confirmed)\b/i,
    category: "updates",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bshipping\s+(confirmation|update)\b/i,
    category: "updates",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bdelivery\s+(confirmation|update)\b/i,
    category: "updates",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\byour\s+order\b/i,
    category: "updates",
    weight: 75,
    field: "subject",
  },
  ...
  {
    pattern: /\bpayment\s+(received|confirmed)\b/i,
    category: "updates",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\baccount\s+(statement|update)\b/i,
    category: "updates",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bpassword\s+reset\b/i,
    category: "updates",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bverify\s+your\b/i,
    category: "updates",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\bconfirm\s+your\b/i,
    category: "updates",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bsecurity\s+alert\b/i,
    category: "updates",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bsign-?in\s+(alert|notification)\b/i,
    category: "updates",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\btracking\s+(number|info)\b/i,
    category: "updates",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\bhas\s+shipped\b/i,
    category: "updates",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bout\s+for\s+delivery\b/i,
    category: "updates",
    weight: 95,
    field: "subject",
  },
  {
    pattern: /\bwas\s+delivered\b/i,
    category: "updates",
    weight: 95,
    field: "subject",
  },
  ...
  {
    pattern: /\bconnect(ed|ion)?\s+with\s+you\b/i,
    category: "social",
    weight: 70,
    field: "subject",
  },
  {
    pattern: /\badded\s+you\b/i,
    category: "social",
    weight: 75,
    field: "subject",
  },
  {
    pattern: /\bfollowing\s+you\b/i,
    category: "social",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bfriend\s+request\b/i,
    category: "social",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\btagged\s+(you|in)\b/i,
    category: "social",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bmentioned\s+you\b/i,
    category: "social",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bcommented\s+on\b/i,
    category: "social",
    weight: 70,
    field: "subject",
  },
  {
    pattern: /\bliked\s+(your|a)\b/i,
    category: "social",
    weight: 70,
    field: "subject",
  },
  {
    pattern: /\bshared\s+(your|a)\b/i,
    category: "social",
    weight: 65,
    field: "subject",
  },
  {
    pattern: /\bmessage\s+from\b/i,
    category: "social",
    weight: 60,
    field: "subject",
  },
  {
    pattern: /\bnew\s+follower\b/i,
    category: "social",
    weight: 85,
    field: "subject",
  },
  ...
  {
    pattern: /\bweekly\s+summary\b/i,
    category: "forums",
    weight: 55,
    field: "subject",
  },
  {
    pattern: /\bdaily\s+digest\b/i,
    category: "forums",
    weight: 65,
    field: "subject",
  },
  {
    pattern: /\bmailing\s+list\b/i,
    category: "forums",
    weight: 70,
    field: "subject",
  },
  ...
  {
    pattern: /\b(your\s+)?purchase\s+(confirmation|complete|receipt)\b/i,
    category: "purchases",
    weight: 95,
    field: "subject",
  },
  {
    pattern: /\bthank\s+you\s+for\s+(your\s+)?(order|purchase)\b/i,
    category: "purchases",
    weight: 95,
    field: "subject",
  },
  {
    pattern: /\border\s+(confirmation|receipt|#\s*\d+)\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\breceipt\s+(for|from)\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\byour\s+(order|purchase)\s+receipt\b/i,
    category: "purchases",
    weight: 95,
    field: "subject",
  },
  {
    pattern: /\byour\s+receipt\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bpayment\s+(receipt|confirmation|successful)\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\btransaction\s+(receipt|complete|successful)\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\binvoice\s+#?\s*\d+/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\byou\s+(bought|purchased)\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\border\s+(placed|received|processed)\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bsuccessful\s+(payment|purchase|transaction)\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\bdigital\s+(purchase|download|receipt)\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\bsubscription\s+(confirmation|started|renewed|receipt)\b/i,
    category: "purchases",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bpurchased\s+on\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\bwe\s+received\s+your\s+(order|payment)\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\byour\s+payment\s+(was\s+)?received\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bcharge\s+(confirmation|receipt)\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
  {
    pattern: /\b(e-?)?receipt\s+for\s+your\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bconfirming\s+your\s+(order|purchase)\b/i,
    category: "purchases",
    weight: 90,
    field: "subject",
  },
  {
    pattern: /\bmoney\s+sent\b/i,
    category: "purchases",
    weight: 80,
    field: "subject",
  },
  {
    pattern: /\bpayment\s+to\b/i,
    category: "purchases",
    weight: 75,
    field: "subject",
  },
  {
    pattern: /\byou\s+paid\b/i,
    category: "purchases",
    weight: 85,
    field: "subject",
  },
...
export const BODY_KEYWORDS: KeywordRule[] = [
  {
    pattern: /\bunsubscribe\b/i,
    category: "promotions",
    weight: 40,
    field: "body",
  },
  {
    pattern: /\bclick\s+here\s+to\s+unsubscribe\b/i,
    category: "promotions",
    weight: 50,
    field: "body",
  },
  {
    pattern: /\bmanage\s+(your\s+)?preferences\b/i,
    category: "promotions",
    weight: 35,
    field: "body",
  },
  {
    pattern: /\bopt[\s-]?out\b/i,
    category: "promotions",
    weight: 40,
    field: "body",
  },
  {
    pattern: /\bemail\s+preferences\b/i,
    category: "promotions",
    weight: 35,
    field: "body",
  },
  {
    pattern: /\bno\s+longer\s+wish\s+to\s+receive\b/i,
    category: "promotions",
    weight: 50,
    field: "body",
  },
  ...
  {
    pattern: /\border\s+#?\d+/i,
    category: "updates",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\btracking\s+#?\w+/i,
    category: "updates",
    weight: 75,
    field: "body",
  },
  {
    pattern: /\btotal:\s*\$[\d,.]+/i,
    category: "updates",
    weight: 65,
    field: "body",
  },
  {
    pattern: /\bsubtotal:\s*\$[\d,.]+/i,
    category: "updates",
    weight: 65,
    field: "body",
  },
  ...
  {
    pattern: /\bpurchase\s+total[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 85,
    field: "body",
  },
  {
    pattern: /\border\s+total[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 80,
    field: "body",
  },
  {
    pattern: /\bgrand\s+total[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 85,
    field: "body",
  },
  {
    pattern: /\bamount\s+(paid|charged)[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 85,
    field: "body",
  },
  {
    pattern: /\btotal\s+charged[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 85,
    field: "body",
  },
  {
    pattern: /\bthank\s+you\s+for\s+(your\s+)?(purchase|order|payment)\b/i,
    category: "purchases",
    weight: 75,
    field: "body",
  },
  {
    pattern: /\bpurchase\s+(details|summary)\b/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\border\s+(details|summary)\b/i,
    category: "purchases",
    weight: 65,
    field: "body",
  },
  {
    pattern: /\bpayment\s+(method|details)[:\s]/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\bbilling\s+(address|information)[:\s]/i,
    category: "purchases",
    weight: 65,
    field: "body",
  },
  {
    pattern: /\bitem\s+quantity[:\s]/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\bunit\s+price[:\s]/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\bprice[:\s]*[\$€£¥][\d,.]+/i,
    category: "purchases",
    weight: 60,
    field: "body",
  },
  ...
  {
    pattern: /\bcard\s+ending\s+in\s+[\d*x]{4}\b/i,
    category: "purchases",
    weight: 85,
    field: "body",
  },
  {
    pattern: /\bending\s+in\s+[\d*x]{4}\b/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\btransaction\s+(id|number)[:\s]/i,
    category: "purchases",
    weight: 75,
    field: "body",
  },
  {
    pattern: /\bconfirmation\s+(number|code)[:\s]/i,
    category: "purchases",
    weight: 75,
    field: "body",
  },
  {
    pattern: /\border\s+(number|id)[:\s]*#?\s*[\w-]+/i,
    category: "purchases",
    weight: 80,
    field: "body",
  },
  {
    pattern: /\byou\s+(paid|purchased|bought)\b/i,
    category: "purchases",
    weight: 75,
    field: "body",
  },
  ...
  {
    pattern: /\bshipping[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 60,
    field: "body",
  },
  {
    pattern: /\bdelivery\s+fee[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 65,
    field: "body",
  },
  {
    pattern: /\bservice\s+fee[:\s]*[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 60,
    field: "body",
  },
  {
    pattern: /\bdiscount[:\s]*-?[\$€£¥]?[\d,.]+/i,
    category: "purchases",
    weight: 60,
    field: "body",
  },
  {
    pattern: /\bpromo\s+(code|applied)[:\s]/i,
    category: "purchases",
    weight: 55,
    field: "body",
  },
  {
    pattern: /\bpayment\s+received\b/i,
    category: "purchases",
    weight: 80,
    field: "body",
  },
  {
    pattern: /\bpayment\s+successful\b/i,
    category: "purchases",
    weight: 85,
    field: "body",
  },
  {
    pattern: /\btransaction\s+complete\b/i,
    category: "purchases",
    weight: 80,
    field: "body",
  },
  {
    pattern: /\breceipt\s+number[:\s]/i,
    category: "purchases",
    weight: 80,
    field: "body",
  },
  {
    pattern: /\binvoice\s+(number|id)[:\s]/i,
    category: "purchases",
    weight: 75,
    field: "body",
  },
  {
    pattern: /\bpurchase\s+date[:\s]/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
  {
    pattern: /\bquantity[:\s]*\d+/i,
    category: "purchases",
    weight: 50,
    field: "body",
  },
  {
    pattern: /\bsold\s+by[:\s]/i,
    category: "purchases",
    weight: 60,
    field: "body",
  },
  {
    pattern: /\bview\s+(your\s+)?(order|receipt|invoice)\b/i,
    category: "purchases",
    weight: 65,
    field: "body",
  },
  {
    pattern: /\bdownload\s+(your\s+)?(receipt|invoice)\b/i,
    category: "purchases",
    weight: 70,
    field: "body",
  },
