...
export async function update_import_job(
  ...
  return api_client.put(`/email-import/jobs/${job_id}`, request);
}

export async function delete_import_job(
  job_id: string,
): Promise<ApiResponse<DeleteJobResponse>> {
  return api_client.delete(`/email-import/jobs/${job_id}`);
}
...
export async function check_duplicates(
  ...
  return api_client.post(`/email-import/jobs/${job_id}/check-duplicates`, {
    message_id_hashes,
  });
}
...
export async function store_imported_emails(
  ...
  return api_client.post(`/email-import/jobs/${job_id}/emails`, { emails });
}
