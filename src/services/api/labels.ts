...
export type LabelDefinition = FolderDefinition;
export type LabelsListResponse = FoldersListResponse;
export type ListLabelsParams = ListFoldersParams;
export type CreateLabelRequest = CreateFolderRequest;
export type CreateLabelResponse = CreateFolderResponse;
export type UpdateLabelRequest = UpdateFolderRequest;
export type BulkDeleteLabelsRequest = BulkDeleteFoldersRequest;
export type BulkDeleteLabelsResponse = BulkDeleteFoldersResponse;
export type BulkReorderLabelsRequest = BulkReorderFoldersRequest;
export type BulkReorderLabelsResponse = BulkReorderFoldersResponse;
export type LabelStatsResponse = FolderStatsResponse;
export type LabelCountsResponse = FolderCountsResponse;

export const list_labels = list_folders;
export const get_label = get_folder;
export const create_label = create_folder;
export const update_label = update_folder;
export const delete_label = delete_folder;
export const bulk_delete_labels = bulk_delete_folders;
export const bulk_reorder_labels = bulk_reorder_folders;
export const get_label_stats = get_folder_stats;
export const get_label_counts = get_folder_counts;
