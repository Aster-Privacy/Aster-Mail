...
export const API_ENDPOINTS = {
  core: {
    ...
    recovery: {
      ...
      email_backup: "/core/v1/recovery/email-backup",
      email_initiate: "/core/v1/recovery/email-initiate",
      email_validate: "/core/v1/recovery/email-validate",
    },
    onboarding: {
  ...
  mail: {
    ...
    attachments: {
      ...
      by_mail: (mail_id: string) => `/mail/v1/attachments/by-mail/${mail_id}`,
  ...
  external_accounts: {
    oauth: {
      providers: "/mail/v1/external_accounts/oauth/providers",
      authorize: "/mail/v1/external_accounts/oauth/authorize",
    },
  },
  contacts: {
    base: "/contacts/v1",
  ...
  addresses: {
    aliases: {
      ...
      ghost: {
        base: "/addresses/v1/aliases/ghost",
        expire: (id: string) => `/addresses/v1/aliases/ghost/${id}/expire`,
        extend: (id: string) => `/addresses/v1/aliases/ghost/${id}/extend`,
        thread_lookup: "/addresses/v1/aliases/ghost/thread-lookup",
      },
    },
    domains: {
  ...
  crypto: {
    ...
    keys: {
      ...
      prekeys: "/crypto/v1/keys/prekeys",
      prekey_count: "/crypto/v1/keys/prekeys/count",
      prekey_status: "/crypto/v1/keys/prekeys/status",
    },
    ratchet: {
