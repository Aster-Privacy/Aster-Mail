...
const create_mock_vault = (): EncryptedVault => ({
  identity_key: "-----BEGIN PGP PRIVATE KEY BLOCK-----\nmock_identity_key\n-----END PGP PRIVATE KEY BLOCK-----",
  signed_prekey: "-----BEGIN PGP PUBLIC KEY BLOCK-----\nmock_signed_prekey\n-----END PGP PUBLIC KEY BLOCK-----",
  signed_prekey_private: "-----BEGIN PGP PRIVATE KEY BLOCK-----\nmock_signed_prekey_private\n-----END PGP PRIVATE KEY BLOCK-----",
...
describe("Security Properties", () => {
  ...
  it("should use authenticated encryption", async () => {
    ...
    const corrupted_backup: VaultBackup = {
      ...backup,
      encrypted_data:
        backup.encrypted_data.slice(0, -10) +
        "AAAAAAAAAA",
    };
