...
describe("Envelope Encryption/Decryption", () => {
  ...
  describe("decrypt_envelope", () => {
    ...
    it("should return null for corrupted data", async () => {
      const decrypted = await decrypt_envelope("corrupted_data_here", "password");
...
describe("Metadata Encryption", () => {
  ...
  describe("decrypt_metadata", () => {
    ...
    it("should return null for wrong context", async () => {
      ...
      const encrypted = await encrypt_metadata(original, master_key, "context1");
      const decrypted = await decrypt_metadata(encrypted!, master_key, "context2");
...
describe("is_encrypted_blob", () => {
  ...
  it("should return false for wrong field types", () => {
    ...
    expect(
      is_encrypted_blob({ encrypted_data: "data", nonce: "nonce", version: "1" })
    ).toBe(false);
  });
});
