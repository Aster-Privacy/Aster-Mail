...
let __aster_worker_url_resolver = () =>
    new URL('./worker/translator-worker.js', import.meta.url);

export function setWorkerUrlResolver(resolver) {
    __aster_worker_url_resolver = resolver;
}
 ...
 */
 export class TranslatorBacking {
     ...
     */
    async loadWorker() {
        const worker = new Worker(__aster_worker_url_resolver());
