...
const refresh_mock = vi.fn(async () => "");
...
describe("SignInPage when the captcha refresh fails mid-loop", () => {
  beforeEach(() => {
  ...
  it("reports the captcha failure instead of the first domain's credentials error", async () => {
    ...
    expect(set_error_mock).toHaveBeenCalledWith("auth.captcha_load_failed");
