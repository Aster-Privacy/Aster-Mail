...
function MobileFmtDivider() {
  return <div className="mx-1 h-5 w-px bg-[var(--border-secondary)]" />;
}
    ...
    return (
      <div className="flex h-full flex-col">
          ...
          <div>
            ...
            <div className="overflow-hidden rounded-xl border border-[var(--border-secondary)] bg-[var(--mobile-bg-card)]">
              ...
              >
                ...
                <MobileFmtButton
                  active={rich_editor.format_state.active_formats.has("italic")}
                  on_press={rich_editor.toggle_italic}
                  title={t("mail.italic")}
                >
                  <svg
                    className="h-4 w-4"
                ...
                <MobileFmtButton
                  ...
                  on_press={rich_editor.toggle_underline}
                ...
                <MobileFmtButton
                  ...
                  on_press={rich_editor.toggle_strikethrough}
                ...
                <MobileFmtButton
                  ...
                  on_press={rich_editor.toggle_unordered_list}
                ...
                <MobileFmtButton
                  ...
                  on_press={rich_editor.toggle_ordered_list}
                ...
                <MobileFmtButton
                  ...
                  on_press={rich_editor.insert_blockquote}
                  title={t("mail.blockquote")}
                >
                  <svg
                    className="h-4 w-4"
                    fill="currentColor"
                ...
                <MobileFmtButton
                  ...
                  on_press={handle_open_link_dialog}
                ...
                <MobileFmtButton
                  on_press={() => image_input_ref.current?.click()}
            ...
            <div className="rounded-xl border border-[var(--border-secondary)] bg-[var(--mobile-bg-card)] overflow-hidden">
              <div className="divide-y divide-[var(--border-primary)]">
                {[
                  {
                    value: null,
                    label: t("settings.signature_placement_inherit"),
                  },
                  {
                    value: "below" as SignaturePlacement,
                    label: t("settings.below_quoted_text"),
                  },
                  {
                    value: "above" as SignaturePlacement,
        ...
        <LinkDialog
          ...
          on_insert={(url, text) => rich_editor.insert_link(url, text)}
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto pb-8">
        ...
        <SettingsGroup title={t("settings.signature_placement")}>
          <OptionList
            on_change={(v) => update_preference("signature_placement", v, true)}
            options={[
