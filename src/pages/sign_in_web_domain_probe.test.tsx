...
describe("SignInPage domain probing in the browser", () => {
  beforeEach(() => {
  ...
  it("still tries the second domain so the account is found", async () => {
    ...
    expect(login_user_mock).toHaveBeenCalledTimes(2);
    expect(set_error_mock).toHaveBeenCalledWith("Invalid credentials");
    expect(set_error_mock).not.toHaveBeenCalledWith(
